...
| **[REQ-03] ユースケース台帳** | [requirements/REQ-03-use_case_ledger.md](../requirements/REQ-03-use_case_ledger.md) | 6大ペルソナ（経営/研究/PSIRT/AI/Dev/LLM）の業務課題と全20ユースケース・価値創出フローを定義。 | **Use Case Ledger** | ST, PM, 全エージェント | ST | 業務シナリオ・新機能追加時 |
