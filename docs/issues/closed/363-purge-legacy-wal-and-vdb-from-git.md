...
本 Issue では、これらを `git rm` により Git インデックスから安全に除外・パージし、Git 管理対象データの純度とルール適合性を回復する。
...
### Git インデックス・管理対象
- [x] `outputs/wal/cycle_20260827_143822.checkpoint.json`
- [x] `outputs/wal/cycle_20260827_143822.wal.jsonl`
- [x] `outputs/wal/cycle_20260827_143945.checkpoint.json`
- [x] `outputs/wal/cycle_20260827_143945.wal.jsonl`
- [x] `outputs/wal/cycle_20260827_144629.checkpoint.json`
- [x] `outputs/wal/cycle_20260827_144629.wal.jsonl`
- [x] `outputs/wal/cycle_20260828_001101.checkpoint.json`
- [x] `outputs/wal/cycle_20260828_001101.wal.jsonl`
- [x] `outputs/database/metrics.vdb`

### テストスイート（固定ファイル依存の有無の検証）
- [x] `tests/database/` 配下の WAL 関連テスト
...
2. **Git インデックスからの安全なパージ**:
   - `git rm outputs/wal/cycle_20260827_*.json outputs/wal/cycle_20260827_*.jsonl outputs/wal/cycle_20260828_*.json outputs/wal/cycle_20260828_*.jsonl outputs/database/metrics.vdb` を実行。
3. **`.gitignore` 整合性検証**:
...
- [x] `git ls-files outputs/wal/` が 0 件であること。
- [x] `git ls-files outputs/database/metrics.vdb` が 0 件であること。
- [x] リポジトリの `.gitignore` 設定に従い、ローカルでの WAL / VDB 生成時に Git 差分が発生しないこと。
