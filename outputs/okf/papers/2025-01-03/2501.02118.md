...
title_ja: "K-Gate Lock: Multi-Key Logic Locking Using Input Encoding Against Oracle-Guided Attacks（セキュリティ分析論文）"
description: "K-Gate Lock: Multi-Key Logic Locking Using Input Encoding Against Oracle-Guided Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.02118v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-03/2501.02118_meta.json"
  published_date: "2025-01-03T22:07:38Z"
  authors:
    - "Kevin Lopez"
    - "Amin Rezaei"
trust:
...
### (日本語題名: K-Gate Lock: Multi-Key Logic Locking Using Input Encoding Against Oracle-Guided Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.02118v1`](https://arxiv.org/abs/2501.02118v1) | Raw Meta = [`2501.02118_meta.json`](../../raw_data/2025-01-03/2501.02118_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「K-Gate Lock: Multi-Key Logic Locking Using Input Encoding Against Oracle-Guided Attacks（セキュリティ分析論文）」（原題: K-Gate Lock: Multi-Key Logic Locking Using Input Encoding Against Oracle-Guided Attacks / arXiv: 2501.02118v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.02118v1`
- **論文URL**: [https://arxiv.org/abs/2501.02118v1](https://arxiv.org/abs/2501.02118v1)
- **PDFリンク**: [https://arxiv.org/pdf/2501.02118v1.pdf](https://arxiv.org/pdf/2501.02118v1.pdf)
- **著者**: Kevin Lopez, Amin Rezaei
- **公開日時**: `2025-01-03T22:07:38Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-03/2501.02118_meta.json) | [`PDF`](../../raw_data/2025-01-03/2501.02118.pdf) | [`TXT`](../../raw_data/2025-01-03/2501.02118.txt)
