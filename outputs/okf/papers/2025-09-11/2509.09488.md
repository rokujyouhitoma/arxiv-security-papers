...
title_ja: "Prompt Pirates Need a Map: Stealing Seeds helps Stealing Prompts（セキュリティ分析論文）"
description: "Prompt Pirates Need a Map: Stealing Seeds helps Stealing Prompts（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.09488v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-11/2509.09488_meta.json"
  published_date: "2025-09-11T14:21:59Z"
  authors:
    - "Felix Mächtle"
    - "Ashwath Shetty"
    - "Jonas Sander"
...
### (日本語題名: Prompt Pirates Need a Map: Stealing Seeds helps Stealing Prompts（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.09488v1`](https://arxiv.org/abs/2509.09488v1) | Raw Meta = [`2509.09488_meta.json`](../../raw_data/2025-09-11/2509.09488_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Prompt Pirates Need a Map: Stealing Seeds helps Stealing Prompts（セキュリティ分析論文）」（原題: Prompt Pirates Need a Map: Stealing Seeds helps Stealing Prompts / arXiv: 2509.09488v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.09488v1`
- **論文URL**: [https://arxiv.org/abs/2509.09488v1](https://arxiv.org/abs/2509.09488v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.09488v1.pdf](https://arxiv.org/pdf/2509.09488v1.pdf)
- **著者**: Felix Mächtle, Ashwath Shetty, Jonas Sander, Nils Loose, Sören Pirk, Thomas Eisenbarth
- **公開日時**: `2025-09-11T14:21:59Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-11/2509.09488_meta.json) | [`PDF`](../../raw_data/2025-09-11/2509.09488.pdf) | [`TXT`](../../raw_data/2025-09-11/2509.09488.txt)
