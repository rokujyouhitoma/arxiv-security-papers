...
title_ja: "PrivyWave: Privacy-Aware Wireless Sensing of Heartbeat（セキュリティ分析論文）"
description: "PrivyWave: Privacy-Aware Wireless Sensing of Heartbeat（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.02993v2"
tags:
  - "executive-summary"
  - "eess.SP"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-04/2511.02993_meta.json"
  published_date: "2025-11-04T20:54:59Z"
  authors:
    - "Yixuan Gao"
    - "Tanvir Ahmed"
    - "Zekun Chang"
...
### (日本語題名: PrivyWave: Privacy-Aware Wireless Sensing of Heartbeat（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.02993v2`](https://arxiv.org/abs/2511.02993v2) | Raw Meta = [`2511.02993_meta.json`](../../raw_data/2025-11-04/2511.02993_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「PrivyWave: Privacy-Aware Wireless Sensing of Heartbeat（セキュリティ分析論文）」（原題: PrivyWave: Privacy-Aware Wireless Sensing of Heartbeat / arXiv: 2511.02993v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.02993v2`
- **論文URL**: [https://arxiv.org/abs/2511.02993v2](https://arxiv.org/abs/2511.02993v2)
- **PDFリンク**: [https://arxiv.org/pdf/2511.02993v2.pdf](https://arxiv.org/pdf/2511.02993v2.pdf)
- **著者**: Yixuan Gao, Tanvir Ahmed, Zekun Chang, Thijs Roumen, Rajalakshmi Nandakumar
- **公開日時**: `2025-11-04T20:54:59Z`
- **カテゴリ**: `cs.CR, cs.HC, eess.SP`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-04/2511.02993_meta.json) | [`PDF`](../../raw_data/2025-11-04/2511.02993.pdf) | [`TXT`](../../raw_data/2025-11-04/2511.02993.txt)
