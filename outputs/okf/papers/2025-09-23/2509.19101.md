...
title_ja: "Trigger Where It Hurts: Unveiling Hidden Backdoors through Sensitivity with Sensitron（セキュリティ分析論文）"
description: "Trigger Where It Hurts: Unveiling Hidden Backdoors through Sensitivity with Sensitron（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.19101v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-23/2509.19101_meta.json"
  published_date: "2025-09-23T14:49:00Z"
  authors:
    - "Gejian Zhao"
    - "Hanzhou Wu"
    - "Xinpeng Zhang"
...
### (日本語題名: Trigger Where It Hurts: Unveiling Hidden Backdoors through Sensitivity with Sensitron（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.19101v1`](https://arxiv.org/abs/2509.19101v1) | Raw Meta = [`2509.19101_meta.json`](../../raw_data/2025-09-23/2509.19101_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Trigger Where It Hurts: Unveiling Hidden Backdoors through Sensitivity with Sensitron（セキュリティ分析論文）」（原題: Trigger Where It Hurts: Unveiling Hidden Backdoors through Sensitivity with Sensitron / arXiv: 2509.19101v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.19101v1`
- **論文URL**: [https://arxiv.org/abs/2509.19101v1](https://arxiv.org/abs/2509.19101v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.19101v1.pdf](https://arxiv.org/pdf/2509.19101v1.pdf)
- **著者**: Gejian Zhao, Hanzhou Wu, Xinpeng Zhang
- **公開日時**: `2025-09-23T14:49:00Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-23/2509.19101_meta.json) | [`PDF`](../../raw_data/2025-09-23/2509.19101.pdf) | [`TXT`](../../raw_data/2025-09-23/2509.19101.txt)
