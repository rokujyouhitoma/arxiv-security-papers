...
title_ja: "Turn Your Face Into An Attack Surface: Screen Attack Using Facial Reflections in Video Conferencing（セキュリティ分析論文）"
description: "Turn Your Face Into An Attack Surface: Screen Attack Using Facial Reflections in Video Conferencing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.06729v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-08/2604.06729_meta.json"
  published_date: "2026-04-08T06:51:14Z"
  authors:
    - "Yong Huang"
    - "Yanzhao Lu"
    - "Mingyang Chen"
...
### (日本語題名: Turn Your Face Into An Attack Surface: Screen Attack Using Facial Reflections in Video Conferencing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.06729v1`](https://arxiv.org/abs/2604.06729v1) | Raw Meta = [`2604.06729_meta.json`](../../raw_data/2026-04-08/2604.06729_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Turn Your Face Into An Attack Surface: Screen Attack Using Facial Reflections in Video Conferencing（セキュリティ分析論文）」（原題: Turn Your Face Into An Attack Surface: Screen Attack Using Facial Reflections in Video Conferencing / arXiv: 2604.06729v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.06729v1`
- **論文URL**: [https://arxiv.org/abs/2604.06729v1](https://arxiv.org/abs/2604.06729v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.06729v1.pdf](https://arxiv.org/pdf/2604.06729v1.pdf)
- **著者**: Yong Huang, Yanzhao Lu, Mingyang Chen, En Zhang, Jiazi Li, Wanqing Tu
- **公開日時**: `2026-04-08T06:51:14Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-08/2604.06729_meta.json) | [`PDF`](../../raw_data/2026-04-08/2604.06729.pdf) | [`TXT`](../../raw_data/2026-04-08/2604.06729.txt)
