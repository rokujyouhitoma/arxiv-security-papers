...
title_ja: "NCCR: to Evaluate the Robustness of Neural Networks and Adversarial Examples（セキュリティ分析論文）"
description: "NCCR: to Evaluate the Robustness of Neural Networks and Adversarial Examples（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.21483v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-29/2507.21483_meta.json"
  published_date: "2025-07-29T03:58:20Z"
  authors:
    - "Shi Pu"
    - "Fu Song"
    - "Wenjie Wang"
...
### (日本語題名: NCCR: to Evaluate the Robustness of Neural Networks and Adversarial Examples（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.21483v2`](https://arxiv.org/abs/2507.21483v2) | Raw Meta = [`2507.21483_meta.json`](../../raw_data/2025-07-29/2507.21483_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「NCCR: to Evaluate the Robustness of Neural Networks and Adversarial Examples（セキュリティ分析論文）」（原題: NCCR: to Evaluate the Robustness of Neural Networks and Adversarial Examples / arXiv: 2507.21483v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.21483v2`
- **論文URL**: [https://arxiv.org/abs/2507.21483v2](https://arxiv.org/abs/2507.21483v2)
- **PDFリンク**: [https://arxiv.org/pdf/2507.21483v2.pdf](https://arxiv.org/pdf/2507.21483v2.pdf)
- **著者**: Shi Pu, Fu Song, Wenjie Wang
- **公開日時**: `2025-07-29T03:58:20Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-29/2507.21483_meta.json) | [`PDF`](../../raw_data/2025-07-29/2507.21483.pdf) | [`TXT`](../../raw_data/2025-07-29/2507.21483.txt)
