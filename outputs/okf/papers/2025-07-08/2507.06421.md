...
title_ja: "Never Trust the Manufacturer, Never Trust the Client: A Novel Method for Streaming STL Files for Secure Additive manufacturing（セキュリティ分析論文）"
description: "Never Trust the Manufacturer, Never Trust the Client: A Novel Method for Streaming STL Files for Secure Additive manufacturing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.06421v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-08/2507.06421_meta.json"
  published_date: "2025-07-08T21:59:21Z"
  authors:
...
### (日本語題名: Never Trust the Manufacturer, Never Trust the Client: A Novel Method for Streaming STL Files for Secure Additive manufacturing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.06421v2`](https://arxiv.org/abs/2507.06421v2) | Raw Meta = [`2507.06421_meta.json`](../../raw_data/2025-07-08/2507.06421_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Never Trust the Manufacturer, Never Trust the Client: A Novel Method for Streaming STL Files for Secure Additive manufacturing（セキュリティ分析論文）」（原題: Never Trust the Manufacturer, Never Trust the Client: A Novel Method for Streaming STL Files for Secure Additive manufacturing / arXiv: 2507.06421v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.06421v2`
- **論文URL**: [https://arxiv.org/abs/2507.06421v2](https://arxiv.org/abs/2507.06421v2)
- **PDFリンク**: [https://arxiv.org/pdf/2507.06421v2.pdf](https://arxiv.org/pdf/2507.06421v2.pdf)
- **著者**: Seyed Ali Ghazi Asgar, Narasimha Reddy, Satish T. S. Bukkapatnam
- **公開日時**: `2025-07-08T21:59:21Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-08/2507.06421_meta.json) | [`PDF`](../../raw_data/2025-07-08/2507.06421.pdf) | [`TXT`](../../raw_data/2025-07-08/2507.06421.txt)
