...
title_ja: "Fun with flags: How Compilers Break and Fix Constant-Time Code（セキュリティ分析論文）"
description: "Fun with flags: How Compilers Break and Fix Constant-Time Code（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.06112v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-08/2507.06112_meta.json"
  published_date: "2025-07-08T15:52:17Z"
  authors:
    - "Antoine Geimer"
    - "Clementine Maurice"
trust:
...
### (日本語題名: Fun with flags: How Compilers Break and Fix Constant-Time Code（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.06112v1`](https://arxiv.org/abs/2507.06112v1) | Raw Meta = [`2507.06112_meta.json`](../../raw_data/2025-07-08/2507.06112_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Fun with flags: How Compilers Break and Fix Constant-Time Code（セキュリティ分析論文）」（原題: Fun with flags: How Compilers Break and Fix Constant-Time Code / arXiv: 2507.06112v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.06112v1`
- **論文URL**: [https://arxiv.org/abs/2507.06112v1](https://arxiv.org/abs/2507.06112v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.06112v1.pdf](https://arxiv.org/pdf/2507.06112v1.pdf)
- **著者**: Antoine Geimer, Clementine Maurice
- **公開日時**: `2025-07-08T15:52:17Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-08/2507.06112_meta.json) | [`PDF`](../../raw_data/2025-07-08/2507.06112.pdf) | [`TXT`](../../raw_data/2025-07-08/2507.06112.txt)
