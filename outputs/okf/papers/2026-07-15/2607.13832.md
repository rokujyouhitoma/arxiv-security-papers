---
type: "security-paper"
title: "Reveal, Correct, Then Pay: Encrypted Mempools and Perpetual Funding Security"
title_ja: "Reveal, Correct, Then Pay: Encrypted Mempools and Perpetual Funding Security（セキュリティ分析論文）"
description: "Reveal, Correct, Then Pay: Encrypted Mempools and Perpetual Funding Security（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.13832v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.GT"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-15/2607.13832_meta.json"
  published_date: "2026-07-15T13:42:13Z"
  authors:
    - "Benjamin Marsh"
trust:
...
### (日本語題名: Reveal, Correct, Then Pay: Encrypted Mempools and Perpetual Funding Security（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.13832v1`](https://arxiv.org/abs/2607.13832v1) | Raw Meta = [`2607.13832_meta.json`](../../raw_data/2026-07-15/2607.13832_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Reveal, Correct, Then Pay: Encrypted Mempools and Perpetual Funding Security（セキュリティ分析論文）」（原題: Reveal, Correct, Then Pay: Encrypted Mempools and Perpetual Funding Security / arXiv: 2607.13832v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.13832v1`
- **論文URL**: [https://arxiv.org/abs/2607.13832v1](https://arxiv.org/abs/2607.13832v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.13832v1.pdf](https://arxiv.org/pdf/2607.13832v1.pdf)
- **著者**: Benjamin Marsh
- **公開日時**: `2026-07-15T13:42:13Z`
- **カテゴリ**: `cs.CR, cs.GT`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-15/2607.13832_meta.json) | [`PDF`](../../raw_data/2026-07-15/2607.13832.pdf) | [`TXT`](../../raw_data/2026-07-15/2607.13832.txt)
