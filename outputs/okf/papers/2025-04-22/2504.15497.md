...
title_ja: "Scalable APT Malware Classification via Parallel Feature Extraction and GPU-Accelerated Learning（セキュリティ分析論文）"
description: "Scalable APT Malware Classification via Parallel Feature Extraction and GPU-Accelerated Learning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.15497v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-22/2504.15497_meta.json"
  published_date: "2025-04-22T00:05:05Z"
  authors:
    - "Noah Subedar"
    - "Taeui Kim"
...
### (日本語題名: Scalable APT Malware Classification via Parallel Feature Extraction and GPU-Accelerated Learning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.15497v1`](https://arxiv.org/abs/2504.15497v1) | Raw Meta = [`2504.15497_meta.json`](../../raw_data/2025-04-22/2504.15497_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Scalable APT Malware Classification via Parallel Feature Extraction and GPU-Accelerated Learning（セキュリティ分析論文）」（原題: Scalable APT Malware Classification via Parallel Feature Extraction and GPU-Accelerated Learning / arXiv: 2504.15497v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.15497v1`
- **論文URL**: [https://arxiv.org/abs/2504.15497v1](https://arxiv.org/abs/2504.15497v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.15497v1.pdf](https://arxiv.org/pdf/2504.15497v1.pdf)
- **著者**: Noah Subedar, Taeui Kim, Saathwick Venkataramalingam
- **公開日時**: `2025-04-22T00:05:05Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-22/2504.15497_meta.json) | [`PDF`](../../raw_data/2025-04-22/2504.15497.pdf) | [`TXT`](../../raw_data/2025-04-22/2504.15497.txt)
