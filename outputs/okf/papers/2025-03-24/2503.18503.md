...
title_ja: "Deterministic Certification of Graph Neural Networks against Graph Poisoning Attacks with Arbitrary Perturbations（セキュリティ分析論文）"
description: "Deterministic Certification of Graph Neural Networks against Graph Poisoning Attacks with Arbitrary Perturbations（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.18503v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-24/2503.18503_meta.json"
  published_date: "2025-03-24T09:59:44Z"
  authors:
    - "Jiate Li"
    - "Meng Pang"
    - "Yun Dong"
...
### (日本語題名: Deterministic Certification of Graph Neural Networks against Graph Poisoning Attacks with Arbitrary Perturbations（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.18503v1`](https://arxiv.org/abs/2503.18503v1) | Raw Meta = [`2503.18503_meta.json`](../../raw_data/2025-03-24/2503.18503_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Deterministic Certification of Graph Neural Networks against Graph Poisoning Attacks with Arbitrary Perturbations（セキュリティ分析論文）」（原題: Deterministic Certification of Graph Neural Networks against Graph Poisoning Attacks with Arbitrary Perturbations / arXiv: 2503.18503v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.18503v1`
- **論文URL**: [https://arxiv.org/abs/2503.18503v1](https://arxiv.org/abs/2503.18503v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.18503v1.pdf](https://arxiv.org/pdf/2503.18503v1.pdf)
- **著者**: Jiate Li, Meng Pang, Yun Dong, Binghui Wang
- **公開日時**: `2025-03-24T09:59:44Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-24/2503.18503_meta.json) | [`PDF`](../../raw_data/2025-03-24/2503.18503.pdf) | [`TXT`](../../raw_data/2025-03-24/2503.18503.txt)
