...
title_ja: "Context Switching for Secure Multi-programming of Near-Term Quantum Computers（セキュリティ分析論文）"
description: "Context Switching for Secure Multi-programming of Near-Term Quantum Computers（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.07048v3"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.ET"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-09/2504.07048_meta.json"
  published_date: "2025-04-09T17:05:16Z"
  authors:
    - "Avinash Kumar"
    - "Meng Wang"
    - "Chenxu Liu"
...
### (日本語題名: Context Switching for Secure Multi-programming of Near-Term Quantum Computers（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.07048v3`](https://arxiv.org/abs/2504.07048v3) | Raw Meta = [`2504.07048_meta.json`](../../raw_data/2025-04-09/2504.07048_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Context Switching for Secure Multi-programming of Near-Term Quantum Computers（セキュリティ分析論文）」（原題: Context Switching for Secure Multi-programming of Near-Term Quantum Computers / arXiv: 2504.07048v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.07048v3`
- **論文URL**: [https://arxiv.org/abs/2504.07048v3](https://arxiv.org/abs/2504.07048v3)
- **PDFリンク**: [https://arxiv.org/pdf/2504.07048v3.pdf](https://arxiv.org/pdf/2504.07048v3.pdf)
- **著者**: Avinash Kumar, Meng Wang, Chenxu Liu, Ang Li, Prashant J. Nair, Poulami Das
- **公開日時**: `2025-04-09T17:05:16Z`
- **カテゴリ**: `cs.CR, cs.ET`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-09/2504.07048_meta.json) | [`PDF`](../../raw_data/2025-04-09/2504.07048.pdf) | [`TXT`](../../raw_data/2025-04-09/2504.07048.txt)
