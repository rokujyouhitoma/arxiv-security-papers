...
title_ja: "SPARK: Security Knowledge Priming and Representation-Guided Knowledge Activation for LLM-based Secure Code Generation（セキュリティ分析論文）"
description: "SPARK: Security Knowledge Priming and Representation-Guided Knowledge Activation for LLM-based Secure Code Generation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.16244v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-15/2606.16244_meta.json"
  published_date: "2026-06-15T05:43:37Z"
  authors:
    - "Xiaoyun Xu"
    - "Lichao Wu"
    - "Jona te Lintelo"
...
### (日本語題名: SPARK: Security Knowledge Priming and Representation-Guided Knowledge Activation for LLM-based Secure Code Generation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.16244v1`](https://arxiv.org/abs/2606.16244v1) | Raw Meta = [`2606.16244_meta.json`](../../raw_data/2026-06-15/2606.16244_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SPARK: Security Knowledge Priming and Representation-Guided Knowledge Activation for LLM-based Secure Code Generation（セキュリティ分析論文）」（原題: SPARK: Security Knowledge Priming and Representation-Guided Knowledge Activation for LLM-based Secure Code Generation / arXiv: 2606.16244v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.16244v1`
- **論文URL**: [https://arxiv.org/abs/2606.16244v1](https://arxiv.org/abs/2606.16244v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.16244v1.pdf](https://arxiv.org/pdf/2606.16244v1.pdf)
- **著者**: Xiaoyun Xu, Lichao Wu, Jona te Lintelo, Siyu Zhang, Stjepan Picek
- **公開日時**: `2026-06-15T05:43:37Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-15/2606.16244_meta.json) | [`PDF`](../../raw_data/2026-06-15/2606.16244.pdf) | [`TXT`](../../raw_data/2026-06-15/2606.16244.txt)
