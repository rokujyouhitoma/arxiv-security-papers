...
title_ja: "Differentially Private Synthetic Data via APIs 3: Using Simulators Instead of Foundation Model（セキュリティ分析論文）"
description: "Differentially Private Synthetic Data via APIs 3: Using Simulators Instead of Foundation Model（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.05505v3"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-08/2502.05505_meta.json"
  published_date: "2025-02-08T09:50:30Z"
  authors:
    - "Zinan Lin"
    - "Tadas Baltrusaitis"
    - "Wenyu Wang"
...
### (日本語題名: Differentially Private Synthetic Data via APIs 3: Using Simulators Instead of Foundation Model（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.05505v3`](https://arxiv.org/abs/2502.05505v3) | Raw Meta = [`2502.05505_meta.json`](../../raw_data/2025-02-08/2502.05505_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Differentially Private Synthetic Data via APIs 3: Using Simulators Instead of Foundation Model（セキュリティ分析論文）」（原題: Differentially Private Synthetic Data via APIs 3: Using Simulators Instead of Foundation Model / arXiv: 2502.05505v3）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.05505v3`
- **論文URL**: [https://arxiv.org/abs/2502.05505v3](https://arxiv.org/abs/2502.05505v3)
- **PDFリンク**: [https://arxiv.org/pdf/2502.05505v3.pdf](https://arxiv.org/pdf/2502.05505v3.pdf)
- **著者**: Zinan Lin, Tadas Baltrusaitis, Wenyu Wang, Sergey Yekhanin
- **公開日時**: `2025-02-08T09:50:30Z`
- **カテゴリ**: `cs.LG, cs.CR, cs.CV, stat.ML`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-08/2502.05505_meta.json) | [`PDF`](../../raw_data/2025-02-08/2502.05505.pdf) | [`TXT`](../../raw_data/2025-02-08/2502.05505.txt)
