...
title_ja: "MAStrike: Shapley-Guided Collusive Red-Teaming on Multi-Agent Systems（セキュリティ分析論文）"
description: "MAStrike: Shapley-Guided Collusive Red-Teaming on Multi-Agent Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.12918v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-11/2606.12918_meta.json"
  published_date: "2026-06-11T05:21:39Z"
  authors:
    - "Chejian Xu"
    - "Zhaorun Chen"
    - "Jingyang Zhang"
...
### (日本語題名: MAStrike: Shapley-Guided Collusive Red-Teaming on Multi-Agent Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.12918v2`](https://arxiv.org/abs/2606.12918v2) | Raw Meta = [`2606.12918_meta.json`](../../raw_data/2026-06-11/2606.12918_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MAStrike: Shapley-Guided Collusive Red-Teaming on Multi-Agent Systems（セキュリティ分析論文）」（原題: MAStrike: Shapley-Guided Collusive Red-Teaming on Multi-Agent Systems / arXiv: 2606.12918v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.12918v2`
- **論文URL**: [https://arxiv.org/abs/2606.12918v2](https://arxiv.org/abs/2606.12918v2)
- **PDFリンク**: [https://arxiv.org/pdf/2606.12918v2.pdf](https://arxiv.org/pdf/2606.12918v2.pdf)
- **著者**: Chejian Xu, Zhaorun Chen, Jingyang Zhang, Freddy Lecue, Avni Kothari, Sarah Tan, Wenbo Guo, Bo Li
- **公開日時**: `2026-06-11T05:21:39Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-11/2606.12918_meta.json) | [`PDF`](../../raw_data/2026-06-11/2606.12918.pdf) | [`TXT`](../../raw_data/2026-06-11/2606.12918.txt)
