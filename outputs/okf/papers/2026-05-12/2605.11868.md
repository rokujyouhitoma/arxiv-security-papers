...
title_ja: "IPI-proxy: An Intercepting Proxy for Red-Teaming Web-Browsing AI Agents Against Indirect Prompt Injection（セキュリティ分析論文）"
description: "IPI-proxy: An Intercepting Proxy for Red-Teaming Web-Browsing AI Agents Against Indirect Prompt Injection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.11868v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-12/2605.11868_meta.json"
  published_date: "2026-05-12T09:48:53Z"
  authors:
    - "Chia-Pei"
    - "Chen"
    - "Kentaroh Toyoda"
...
### (日本語題名: IPI-proxy: An Intercepting Proxy for Red-Teaming Web-Browsing AI Agents Against Indirect Prompt Injection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.11868v1`](https://arxiv.org/abs/2605.11868v1) | Raw Meta = [`2605.11868_meta.json`](../../raw_data/2026-05-12/2605.11868_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「IPI-proxy: An Intercepting Proxy for Red-Teaming Web-Browsing AI Agents Against Indirect Prompt Injection（セキュリティ分析論文）」（原題: IPI-proxy: An Intercepting Proxy for Red-Teaming Web-Browsing AI Agents Against Indirect Prompt Injection / arXiv: 2605.11868v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.11868v1`
- **論文URL**: [https://arxiv.org/abs/2605.11868v1](https://arxiv.org/abs/2605.11868v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.11868v1.pdf](https://arxiv.org/pdf/2605.11868v1.pdf)
- **著者**: Chia-Pei, Chen, Kentaroh Toyoda, Anita Lai, Alex Leung
- **公開日時**: `2026-05-12T09:48:53Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-12/2605.11868_meta.json) | [`PDF`](../../raw_data/2026-05-12/2605.11868.pdf) | [`TXT`](../../raw_data/2026-05-12/2605.11868.txt)
