...
title_ja: "A Kolmogorov-Arnold Network for Interpretable Cyberattack Detection in AGC Systems（セキュリティ分析論文）"
description: "A Kolmogorov-Arnold Network for Interpretable Cyberattack Detection in AGC Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.05259v1"
tags:
  - "executive-summary"
  - "eess.SY"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-05/2509.05259_meta.json"
  published_date: "2025-09-05T17:18:17Z"
  authors:
    - "Jehad Jilan"
...
### (日本語題名: A Kolmogorov-Arnold Network for Interpretable Cyberattack Detection in AGC Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.05259v1`](https://arxiv.org/abs/2509.05259v1) | Raw Meta = [`2509.05259_meta.json`](../../raw_data/2025-09-05/2509.05259_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Kolmogorov-Arnold Network for Interpretable Cyberattack Detection in AGC Systems（セキュリティ分析論文）」（原題: A Kolmogorov-Arnold Network for Interpretable Cyberattack Detection in AGC Systems / arXiv: 2509.05259v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.05259v1`
- **論文URL**: [https://arxiv.org/abs/2509.05259v1](https://arxiv.org/abs/2509.05259v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.05259v1.pdf](https://arxiv.org/pdf/2509.05259v1.pdf)
- **著者**: Jehad Jilan, Niranjana Naveen Nambiar, Ahmad Mohammad Saber, Alok Paranjape, Amr Youssef, Deepa Kundur
- **公開日時**: `2025-09-05T17:18:17Z`
- **カテゴリ**: `cs.LG, cs.CR, eess.SY`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-05/2509.05259_meta.json) | [`PDF`](../../raw_data/2025-09-05/2509.05259.pdf) | [`TXT`](../../raw_data/2025-09-05/2509.05259.txt)
