...
title_ja: "FuzzRDUCC: Fuzzing with Reconstructed Def-Use Chain Coverage（セキュリティ分析論文）"
description: "FuzzRDUCC: Fuzzing with Reconstructed Def-Use Chain Coverage（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.04967v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-05/2509.04967_meta.json"
  published_date: "2025-09-05T09:47:34Z"
  authors:
    - "Kai Feng"
    - "Jeremy Singer"
...
### (日本語題名: FuzzRDUCC: Fuzzing with Reconstructed Def-Use Chain Coverage（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.04967v1`](https://arxiv.org/abs/2509.04967v1) | Raw Meta = [`2509.04967_meta.json`](../../raw_data/2025-09-05/2509.04967_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「FuzzRDUCC: Fuzzing with Reconstructed Def-Use Chain Coverage（セキュリティ分析論文）」（原題: FuzzRDUCC: Fuzzing with Reconstructed Def-Use Chain Coverage / arXiv: 2509.04967v1）は、cs.SE 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.04967v1`
- **論文URL**: [https://arxiv.org/abs/2509.04967v1](https://arxiv.org/abs/2509.04967v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.04967v1.pdf](https://arxiv.org/pdf/2509.04967v1.pdf)
- **著者**: Kai Feng, Jeremy Singer, Angelos K Marnerides
- **公開日時**: `2025-09-05T09:47:34Z`
- **カテゴリ**: `cs.SE, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-05/2509.04967_meta.json) | [`PDF`](../../raw_data/2025-09-05/2509.04967.pdf) | [`TXT`](../../raw_data/2025-09-05/2509.04967.txt)
