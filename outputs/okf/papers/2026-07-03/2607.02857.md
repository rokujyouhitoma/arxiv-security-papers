...
title_ja: "MOSAIC: Knowledge-Guided CLI Command Composition Attack in LLM Coding Agents（セキュリティ分析論文）"
description: "MOSAIC: Knowledge-Guided CLI Command Composition Attack in LLM Coding Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.02857v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-03/2607.02857_meta.json"
  published_date: "2026-07-03T01:41:17Z"
  authors:
    - "Jiangrong Wu"
    - "Huaijin Wang"
    - "Yihao Zhang"
...
### (日本語題名: MOSAIC: Knowledge-Guided CLI Command Composition Attack in LLM Coding Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.02857v1`](https://arxiv.org/abs/2607.02857v1) | Raw Meta = [`2607.02857_meta.json`](../../raw_data/2026-07-03/2607.02857_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MOSAIC: Knowledge-Guided CLI Command Composition Attack in LLM Coding Agents（セキュリティ分析論文）」（原題: MOSAIC: Knowledge-Guided CLI Command Composition Attack in LLM Coding Agents / arXiv: 2607.02857v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.02857v1`
- **論文URL**: [https://arxiv.org/abs/2607.02857v1](https://arxiv.org/abs/2607.02857v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.02857v1.pdf](https://arxiv.org/pdf/2607.02857v1.pdf)
- **著者**: Jiangrong Wu, Huaijin Wang, Yihao Zhang, Yuhong Nan, Shuai Wang
- **公開日時**: `2026-07-03T01:41:17Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-03/2607.02857_meta.json) | [`PDF`](../../raw_data/2026-07-03/2607.02857.pdf) | [`TXT`](../../raw_data/2026-07-03/2607.02857.txt)
