...
resource: "https://arxiv.org/abs/2601.17178v3"
tags:
  - "AI/ML Security"
  - "arXiv"
  - "cs.AI"
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.17178v3`](https://arxiv.org/abs/2601.17178v3) | Raw Meta = [`2601.17178_meta.json`](../../raw_data/2026-01-23/2601.17178_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「TrojanGYM: A Detector-in-the-Loop LLM for Adaptive RTL Hardware Trojan Insertion（セキュリティ分析論文）」（原題: TrojanGYM: A Detector-in-the-Loop LLM for Adaptive RTL Hardware Trojan Insertion / arXiv: 2601.17178v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.17178v3`
- **論文URL**: [https://arxiv.org/abs/2601.17178v3](https://arxiv.org/abs/2601.17178v3)
- **PDFリンク**: [https://arxiv.org/pdf/2601.17178v3.pdf](https://arxiv.org/pdf/2601.17178v3.pdf)
