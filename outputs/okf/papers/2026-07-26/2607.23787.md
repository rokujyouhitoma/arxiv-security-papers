...
resource: "https://arxiv.org/abs/2607.23787v2"
tags:
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.23787v2`](https://arxiv.org/abs/2607.23787v2) | Raw Meta = [`2607.23787_meta.json`](../../raw_data/2026-07-26/2607.23787_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Bitcoin Mempool Linearization（セキュリティ分析論文）」（原題: Bitcoin Mempool Linearization / arXiv: 2607.23787v2）は、cs.DS 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.23787v2`
- **論文URL**: [https://arxiv.org/abs/2607.23787v2](https://arxiv.org/abs/2607.23787v2)
- **PDFリンク**: [https://arxiv.org/pdf/2607.23787v2.pdf](https://arxiv.org/pdf/2607.23787v2.pdf)
