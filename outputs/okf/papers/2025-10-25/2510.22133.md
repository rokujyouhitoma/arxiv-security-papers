...
title_ja: "HandPass: A Wi-Fi CSI Palm Authentication Approach for Access Control（セキュリティ分析論文）"
description: "HandPass: A Wi-Fi CSI Palm Authentication Approach for Access Control（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.22133v1"
tags:
  - "cs.NI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-10-25/2510.22133_meta.json"
  published_date: "2025-10-25T03:13:45Z"
  authors:
...
### (日本語題名: HandPass: A Wi-Fi CSI Palm Authentication Approach for Access Control（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.22133v1`](https://arxiv.org/abs/2510.22133v1) | Raw Meta = [`2510.22133_meta.json`](../../raw_data/2025-10-25/2510.22133_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「HandPass: A Wi-Fi CSI Palm Authentication Approach for Access Control（セキュリティ分析論文）」（原題: HandPass: A Wi-Fi CSI Palm Authentication Approach for Access Control / arXiv: 2510.22133v1）は、cs.NI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2510.22133v1`
- **論文URL**: [https://arxiv.org/abs/2510.22133v1](https://arxiv.org/abs/2510.22133v1)
- **PDFリンク**: [https://arxiv.org/pdf/2510.22133v1.pdf](https://arxiv.org/pdf/2510.22133v1.pdf)
- **著者**: Eduardo Fabricio Gomes Trindade, Felipe Silveira de Almeida, Gioliano de Oliveira Braga, Rafael Pimenta de Mattos Paixão, Pedro Henrique dos Santos Rocha, Lourenco Alves Pereira
- **公開日時**: `2025-10-25T03:13:45Z`
- **カテゴリ**: `cs.NI, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-10-25/2510.22133_meta.json) | [`PDF`](../../raw_data/2025-10-25/2510.22133.pdf) | [`TXT`](../../raw_data/2025-10-25/2510.22133.txt)
