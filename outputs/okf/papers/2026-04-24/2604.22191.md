...
title_ja: "Behavioral Canaries: Auditing Private Retrieved Context Usage in RL Fine-Tuning（セキュリティ分析論文）"
description: "Behavioral Canaries: Auditing Private Retrieved Context Usage in RL Fine-Tuning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.22191v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-24/2604.22191_meta.json"
  published_date: "2026-04-24T03:38:52Z"
  authors:
    - "Chaoran Chen"
    - "Dayu Yuan"
    - "Peter Kairouz"
...
### (日本語題名: Behavioral Canaries: Auditing Private Retrieved Context Usage in RL Fine-Tuning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.22191v2`](https://arxiv.org/abs/2604.22191v2) | Raw Meta = [`2604.22191_meta.json`](../../raw_data/2026-04-24/2604.22191_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Behavioral Canaries: Auditing Private Retrieved Context Usage in RL Fine-Tuning（セキュリティ分析論文）」（原題: Behavioral Canaries: Auditing Private Retrieved Context Usage in RL Fine-Tuning / arXiv: 2604.22191v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.22191v2`
- **論文URL**: [https://arxiv.org/abs/2604.22191v2](https://arxiv.org/abs/2604.22191v2)
- **PDFリンク**: [https://arxiv.org/pdf/2604.22191v2.pdf](https://arxiv.org/pdf/2604.22191v2.pdf)
- **著者**: Chaoran Chen, Dayu Yuan, Peter Kairouz
- **公開日時**: `2026-04-24T03:38:52Z`
- **カテゴリ**: `cs.CR, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-24/2604.22191_meta.json) | [`PDF`](../../raw_data/2026-04-24/2604.22191.pdf) | [`TXT`](../../raw_data/2026-04-24/2604.22191.txt)
