...
title_ja: "Trivial Trojans: How Minimal MCP Servers Enable Cross-Tool Exfiltration of Sensitive Data（セキュリティ分析論文）"
description: "Trivial Trojans: How Minimal MCP Servers Enable Cross-Tool Exfiltration of Sensitive Data（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.19880v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-26/2507.19880_meta.json"
  published_date: "2025-07-26T09:22:40Z"
  authors:
    - "Nicola Croce"
    - "Tobin South"
trust:
...
### (日本語題名: Trivial Trojans: How Minimal MCP Servers Enable Cross-Tool Exfiltration of Sensitive Data（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.19880v1`](https://arxiv.org/abs/2507.19880v1) | Raw Meta = [`2507.19880_meta.json`](../../raw_data/2025-07-26/2507.19880_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Trivial Trojans: How Minimal MCP Servers Enable Cross-Tool Exfiltration of Sensitive Data（セキュリティ分析論文）」（原題: Trivial Trojans: How Minimal MCP Servers Enable Cross-Tool Exfiltration of Sensitive Data / arXiv: 2507.19880v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.19880v1`
- **論文URL**: [https://arxiv.org/abs/2507.19880v1](https://arxiv.org/abs/2507.19880v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.19880v1.pdf](https://arxiv.org/pdf/2507.19880v1.pdf)
- **著者**: Nicola Croce, Tobin South
- **公開日時**: `2025-07-26T09:22:40Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-26/2507.19880_meta.json) | [`PDF`](../../raw_data/2025-07-26/2507.19880.pdf) | [`TXT`](../../raw_data/2025-07-26/2507.19880.txt)
