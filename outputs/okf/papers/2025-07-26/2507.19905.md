...
title_ja: "ConSeg: Contextual Backdoor Attack Against Semantic Segmentation（セキュリティ分析論文）"
description: "ConSeg: Contextual Backdoor Attack Against Semantic Segmentation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.19905v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CV"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-26/2507.19905_meta.json"
  published_date: "2025-07-26T10:30:27Z"
  authors:
...
### (日本語題名: ConSeg: Contextual Backdoor Attack Against Semantic Segmentation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.19905v1`](https://arxiv.org/abs/2507.19905v1) | Raw Meta = [`2507.19905_meta.json`](../../raw_data/2025-07-26/2507.19905_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ConSeg: Contextual Backdoor Attack Against Semantic Segmentation（セキュリティ分析論文）」（原題: ConSeg: Contextual Backdoor Attack Against Semantic Segmentation / arXiv: 2507.19905v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.19905v1`
- **論文URL**: [https://arxiv.org/abs/2507.19905v1](https://arxiv.org/abs/2507.19905v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.19905v1.pdf](https://arxiv.org/pdf/2507.19905v1.pdf)
- **著者**: Bilal Hussain Abbasi, Zirui Gong, Yanjun Zhang, Shang Gao, Antonio Robles-Kelly, Leo Zhang
- **公開日時**: `2025-07-26T10:30:27Z`
- **カテゴリ**: `cs.CR, cs.CV`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-26/2507.19905_meta.json) | [`PDF`](../../raw_data/2025-07-26/2507.19905.pdf) | [`TXT`](../../raw_data/2025-07-26/2507.19905.txt)
