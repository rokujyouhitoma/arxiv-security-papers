...
resource: "https://arxiv.org/abs/2603.18245v2"
tags:
  - "AI/ML Security"
  - "arXiv"
  - "cs.CR"
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.18245v2`](https://arxiv.org/abs/2603.18245v2) | Raw Meta = [`2603.18245_meta.json`](../../raw_data/2026-03-18/2603.18245_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Who Tests the Testers? Systematic Enumeration and Coverage Audit of LLM Agent Tool Call Safety（セキュリティ分析論文）」（原題: Who Tests the Testers? Systematic Enumeration and Coverage Audit of LLM Agent Tool Call Safety / arXiv: 2603.18245v2）は、cs.SE 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.18245v2`
- **論文URL**: [https://arxiv.org/abs/2603.18245v2](https://arxiv.org/abs/2603.18245v2)
- **PDFリンク**: [https://arxiv.org/pdf/2603.18245v2.pdf](https://arxiv.org/pdf/2603.18245v2.pdf)
