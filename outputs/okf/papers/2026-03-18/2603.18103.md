...
title_ja: "STEP: Detecting Audio Backdoor Attacks via Stability-based Trigger Exposure Profiling（セキュリティ分析論文）"
description: "STEP: Detecting Audio Backdoor Attacks via Stability-based Trigger Exposure Profiling（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.18103v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-18/2603.18103_meta.json"
  published_date: "2026-03-18T12:14:14Z"
  authors:
    - "Kun Wang"
    - "Meng Chen"
    - "Junhao Wang"
...
### (日本語題名: STEP: Detecting Audio Backdoor Attacks via Stability-based Trigger Exposure Profiling（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.18103v1`](https://arxiv.org/abs/2603.18103v1) | Raw Meta = [`2603.18103_meta.json`](../../raw_data/2026-03-18/2603.18103_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「STEP: Detecting Audio Backdoor Attacks via Stability-based Trigger Exposure Profiling（セキュリティ分析論文）」（原題: STEP: Detecting Audio Backdoor Attacks via Stability-based Trigger Exposure Profiling / arXiv: 2603.18103v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.18103v1`
- **論文URL**: [https://arxiv.org/abs/2603.18103v1](https://arxiv.org/abs/2603.18103v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.18103v1.pdf](https://arxiv.org/pdf/2603.18103v1.pdf)
- **著者**: Kun Wang, Meng Chen, Junhao Wang, Yuli Wu, Li Lu, Chong Zhang, Peng Cheng, Jiaheng Zhang, Kui Ren
- **公開日時**: `2026-03-18T12:14:14Z`
- **カテゴリ**: `cs.CR, cs.LG, cs.SD`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-18/2603.18103_meta.json) | [`PDF`](../../raw_data/2026-03-18/2603.18103.pdf) | [`TXT`](../../raw_data/2026-03-18/2603.18103.txt)
