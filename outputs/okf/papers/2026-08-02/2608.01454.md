...
resource: "https://arxiv.org/abs/2608.01454v2"
tags:
  - "Privacy & Provenance"
  - "arXiv"
  - "cs.CR"
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.01454v2`](https://arxiv.org/abs/2608.01454v2) | Raw Meta = [`2608.01454_meta.json`](../../raw_data/2026-08-02/2608.01454_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「How Benchmarks and Evaluation Protocols Shape Conclusions in Provenance-Based Intrusion Detection（セキュリティ分析論文）」（原題: How Benchmarks and Evaluation Protocols Shape Conclusions in Provenance-Based Intrusion Detection / arXiv: 2608.01454v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.01454v2`
- **論文URL**: [https://arxiv.org/abs/2608.01454v2](https://arxiv.org/abs/2608.01454v2)
- **PDFリンク**: [https://arxiv.org/pdf/2608.01454v2.pdf](https://arxiv.org/pdf/2608.01454v2.pdf)
