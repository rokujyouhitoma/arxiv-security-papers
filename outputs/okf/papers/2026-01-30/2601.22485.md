...
title_ja: "FraudShield: Knowledge Graph Empowered Defense for LLMs against Fraud Attacks（セキュリティ分析論文）"
description: "FraudShield: Knowledge Graph Empowered Defense for LLMs against Fraud Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.22485v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-30/2601.22485_meta.json"
  published_date: "2026-01-30T02:48:52Z"
  authors:
    - "Naen Xu"
    - "Jinghuai Zhang"
    - "Ping He"
...
### (日本語題名: FraudShield: Knowledge Graph Empowered Defense for LLMs against Fraud Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.22485v1`](https://arxiv.org/abs/2601.22485v1) | Raw Meta = [`2601.22485_meta.json`](../../raw_data/2026-01-30/2601.22485_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「FraudShield: Knowledge Graph Empowered Defense for LLMs against Fraud Attacks（セキュリティ分析論文）」（原題: FraudShield: Knowledge Graph Empowered Defense for LLMs against Fraud Attacks / arXiv: 2601.22485v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2601.22485v1](https://arxiv.org/abs/2601.22485v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.22485v1.pdf](https://arxiv.org/pdf/2601.22485v1.pdf)
- **著者**: Naen Xu, Jinghuai Zhang, Ping He, Chunyi Zhou, Jun Wang, Zhihui Fu, Tianyu Du, Zhaoxiang Wang, Shouling Ji
- **公開日時**: `2026-01-30T02:48:52Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-30/2601.22485_meta.json) | [`PDF`](../../raw_data/2026-01-30/2601.22485.pdf) | [`TXT`](../../raw_data/2026-01-30/2601.22485.txt)
