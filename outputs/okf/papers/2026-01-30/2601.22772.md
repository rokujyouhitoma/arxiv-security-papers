...
title_ja: "Rust and Go directed fuzzing with LibAFL-DiFuzz（セキュリティ分析論文）"
description: "Rust and Go directed fuzzing with LibAFL-DiFuzz（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.22772v2"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-30/2601.22772_meta.json"
  published_date: "2026-01-30T09:52:50Z"
  authors:
    - "Timofey Mezhuev"
    - "Darya Parygina"
    - "Daniil Kuts"
...
### (日本語題名: Rust and Go directed fuzzing with LibAFL-DiFuzz（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.22772v2`](https://arxiv.org/abs/2601.22772v2) | Raw Meta = [`2601.22772_meta.json`](../../raw_data/2026-01-30/2601.22772_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Rust and Go directed fuzzing with LibAFL-DiFuzz（セキュリティ分析論文）」（原題: Rust and Go directed fuzzing with LibAFL-DiFuzz / arXiv: 2601.22772v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.22772v2`
- **論文URL**: [https://arxiv.org/abs/2601.22772v2](https://arxiv.org/abs/2601.22772v2)
- **PDFリンク**: [https://arxiv.org/pdf/2601.22772v2.pdf](https://arxiv.org/pdf/2601.22772v2.pdf)
- **著者**: Timofey Mezhuev, Darya Parygina, Daniil Kuts
- **公開日時**: `2026-01-30T09:52:50Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-30/2601.22772_meta.json) | [`PDF`](../../raw_data/2026-01-30/2601.22772.pdf) | [`TXT`](../../raw_data/2026-01-30/2601.22772.txt)
