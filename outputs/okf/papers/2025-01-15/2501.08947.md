...
title_ja: "Taint Analysis for Graph APIs Focusing on Broken Access Control（セキュリティ分析論文）"
description: "Taint Analysis for Graph APIs Focusing on Broken Access Control（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.08947v5"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-15/2501.08947_meta.json"
  published_date: "2025-01-15T16:49:32Z"
  authors:
    - "Leen Lambers"
    - "Lucas Sakizloglou"
    - "Taisiya Khakharova"
...
### (日本語題名: Taint Analysis for Graph APIs Focusing on Broken Access Control（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.08947v5`](https://arxiv.org/abs/2501.08947v5) | Raw Meta = [`2501.08947_meta.json`](../../raw_data/2025-01-15/2501.08947_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Taint Analysis for Graph APIs Focusing on Broken Access Control（セキュリティ分析論文）」（原題: Taint Analysis for Graph APIs Focusing on Broken Access Control / arXiv: 2501.08947v5）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.08947v5`
- **論文URL**: [https://arxiv.org/abs/2501.08947v5](https://arxiv.org/abs/2501.08947v5)
- **PDFリンク**: [https://arxiv.org/pdf/2501.08947v5.pdf](https://arxiv.org/pdf/2501.08947v5.pdf)
- **著者**: Leen Lambers, Lucas Sakizloglou, Taisiya Khakharova, Fernando Orejas
- **公開日時**: `2025-01-15T16:49:32Z`
- **カテゴリ**: `cs.CR, cs.LO, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-15/2501.08947_meta.json) | [`PDF`](../../raw_data/2025-01-15/2501.08947.pdf) | [`TXT`](../../raw_data/2025-01-15/2501.08947.txt)
