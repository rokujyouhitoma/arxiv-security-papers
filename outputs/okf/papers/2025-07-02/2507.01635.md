...
title_ja: "EGNInfoLeaker: Unveiling the Risks of Public Key Reuse and User Identity Leakage in Blockchain（セキュリティ分析論文）"
description: "EGNInfoLeaker: Unveiling the Risks of Public Key Reuse and User Identity Leakage in Blockchain（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.01635v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-02/2507.01635_meta.json"
  published_date: "2025-07-02T12:07:03Z"
  authors:
    - "Chenyu Li"
    - "Xueping Liang"
    - "Xiaorui Gong"
...
### (日本語題名: EGNInfoLeaker: Unveiling the Risks of Public Key Reuse and User Identity Leakage in Blockchain（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.01635v1`](https://arxiv.org/abs/2507.01635v1) | Raw Meta = [`2507.01635_meta.json`](../../raw_data/2025-07-02/2507.01635_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「EGNInfoLeaker: Unveiling the Risks of Public Key Reuse and User Identity Leakage in Blockchain（セキュリティ分析論文）」（原題: EGNInfoLeaker: Unveiling the Risks of Public Key Reuse and User Identity Leakage in Blockchain / arXiv: 2507.01635v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.01635v1`
- **論文URL**: [https://arxiv.org/abs/2507.01635v1](https://arxiv.org/abs/2507.01635v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.01635v1.pdf](https://arxiv.org/pdf/2507.01635v1.pdf)
- **著者**: Chenyu Li, Xueping Liang, Xiaorui Gong, Xiu Zhang
- **公開日時**: `2025-07-02T12:07:03Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-02/2507.01635_meta.json) | [`PDF`](../../raw_data/2025-07-02/2507.01635.pdf) | [`TXT`](../../raw_data/2025-07-02/2507.01635.txt)
