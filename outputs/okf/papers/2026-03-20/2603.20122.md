...
title_ja: "Evolving Jailbreaks: Automated Multi-Objective Long-Tail Attacks on 大規模言語モデル"
description: "Evolving Jailbreaks: Automated Multi-Objective Long-Tail Attacks on 大規模言語モデル — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.20122v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-20/2603.20122_meta.json"
  published_date: "2026-03-20T16:45:04Z"
  authors:
    - "Wenjing Hong"
    - "Zhonghua Rong"
    - "Li Wang"
...
### (日本語題名: Evolving Jailbreaks: Automated Multi-Objective Long-Tail Attacks on 大規模言語モデル)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.20122v1`](https://arxiv.org/abs/2603.20122v1) | Raw Meta = [`2603.20122_meta.json`](../../raw_data/2026-03-20/2603.20122_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Evolving Jailbreaks: Automated Multi-Objective Long-Tail Attacks on 大規模言語モデル」（原題: Evolving Jailbreaks: Automated Multi-Objective Long-Tail Attacks on Large Language Models / arXiv: 2603.20122v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2603.20122v1](https://arxiv.org/abs/2603.20122v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.20122v1.pdf](https://arxiv.org/pdf/2603.20122v1.pdf)
- **著者**: Wenjing Hong, Zhonghua Rong, Li Wang, Feng Chang, Jian Zhu, Ke Tang, Zexuan Zhu, Yew-Soon Ong
- **公開日時**: `2026-03-20T16:45:04Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-20/2603.20122_meta.json) | [`PDF`](../../raw_data/2026-03-20/2603.20122.pdf) | [`TXT`](../../raw_data/2026-03-20/2603.20122.txt)
