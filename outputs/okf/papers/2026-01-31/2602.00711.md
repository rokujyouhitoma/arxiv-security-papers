...
title_ja: "From Detection to Prevention: Explaining Security-Critical Code to Avoid Vulnerabilities（セキュリティ分析論文）"
description: "From Detection to Prevention: Explaining Security-Critical Code to Avoid Vulnerabilities（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.00711v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-31/2602.00711_meta.json"
  published_date: "2026-01-31T13:16:01Z"
  authors:
...
### (日本語題名: From Detection to Prevention: Explaining Security-Critical Code to Avoid Vulnerabilities（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.00711v1`](https://arxiv.org/abs/2602.00711v1) | Raw Meta = [`2602.00711_meta.json`](../../raw_data/2026-01-31/2602.00711_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「From Detection to Prevention: Explaining Security-Critical Code to Avoid Vulnerabilities（セキュリティ分析論文）」（原題: From Detection to Prevention: Explaining Security-Critical Code to Avoid Vulnerabilities / arXiv: 2602.00711v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.00711v1`
- **論文URL**: [https://arxiv.org/abs/2602.00711v1](https://arxiv.org/abs/2602.00711v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.00711v1.pdf](https://arxiv.org/pdf/2602.00711v1.pdf)
- **著者**: Ranjith Krishnamurthy, Oshando Johnson, Goran Piskachev, Eric Bodden
- **公開日時**: `2026-01-31T13:16:01Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-31/2602.00711_meta.json) | [`PDF`](../../raw_data/2026-01-31/2602.00711.pdf) | [`TXT`](../../raw_data/2026-01-31/2602.00711.txt)
