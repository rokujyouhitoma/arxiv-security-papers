...
title_ja: "When Embedding-Based Defenses Fail: Rethinking Safety in LLM-Based Multi-Agent Systems（セキュリティ分析論文）"
description: "When Embedding-Based Defenses Fail: Rethinking Safety in LLM-Based Multi-Agent Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.01133v3"
tags:
  - "arXiv"
  - "cs.MA"
  - "executive-summary"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-01/2605.01133_meta.json"
  published_date: "2026-05-01T22:15:11Z"
  authors:
    - "Lingxi Zhang"
    - "Guangtao Zheng"
    - "Hanjie Chen"
...
### (日本語題名: When Embedding-Based Defenses Fail: Rethinking Safety in LLM-Based Multi-Agent Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.01133v3`](https://arxiv.org/abs/2605.01133v3) | Raw Meta = [`2605.01133_meta.json`](../../raw_data/2026-05-01/2605.01133_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「When Embedding-Based Defenses Fail: Rethinking Safety in LLM-Based Multi-Agent Systems（セキュリティ分析論文）」（原題: When Embedding-Based Defenses Fail: Rethinking Safety in LLM-Based Multi-Agent Systems / arXiv: 2605.01133v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.01133v3`
- **論文URL**: [https://arxiv.org/abs/2605.01133v3](https://arxiv.org/abs/2605.01133v3)
- **PDFリンク**: [https://arxiv.org/pdf/2605.01133v3.pdf](https://arxiv.org/pdf/2605.01133v3.pdf)
- **著者**: Lingxi Zhang, Guangtao Zheng, Hanjie Chen
- **公開日時**: `2026-05-01T22:15:11Z`
- **カテゴリ**: `cs.CR, cs.LG, cs.MA`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-01/2605.01133_meta.json) | [`PDF`](../../raw_data/2026-05-01/2605.01133.pdf) | [`TXT`](../../raw_data/2026-05-01/2605.01133.txt)
