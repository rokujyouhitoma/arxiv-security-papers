...
title_ja: "A Multi-Scale Graph Learning Framework with Temporal Consistency Constraints for Financial Fraud Detection in Transaction Networks under Non-Stationary Conditions（セキュリティ分析論文）"
description: "A Multi-Scale Graph Learning Framework with Temporal Consistency Constraints for Financial Fraud Detection in Transaction Networks under Non-Stationary Conditions（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.14592v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-15/2603.14592_meta.json"
  published_date: "2026-03-15T20:30:02Z"
  authors:
    - "Yiming Lei"
    - "Qiannan Shen"
    - "Junhao Song"
...
### (日本語題名: A Multi-Scale Graph Learning Framework with Temporal Consistency Constraints for Financial Fraud Detection in Transaction Networks under Non-Stationary Conditions（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.14592v1`](https://arxiv.org/abs/2603.14592v1) | Raw Meta = [`2603.14592_meta.json`](../../raw_data/2026-03-15/2603.14592_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Multi-Scale Graph Learning Framework with Temporal Consistency Constraints for Financial Fraud Detection in Transaction Networks under Non-Stationary Conditions（セキュリティ分析論文）」（原題: A Multi-Scale Graph Learning Framework with Temporal Consistency Constraints for Financial Fraud Detection in Transaction Networks under Non-Stationary Conditions / arXiv: 2603.14592v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2603.14592v1](https://arxiv.org/abs/2603.14592v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.14592v1.pdf](https://arxiv.org/pdf/2603.14592v1.pdf)
- **著者**: Yiming Lei, Qiannan Shen, Junhao Song
- **公開日時**: `2026-03-15T20:30:02Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-15/2603.14592_meta.json) | [`PDF`](../../raw_data/2026-03-15/2603.14592.pdf) | [`TXT`](../../raw_data/2026-03-15/2603.14592.txt)
