...
title_ja: "SoK: Measuring Blockchain Decentralization（セキュリティ分析論文）"
description: "SoK: Measuring Blockchain Decentralization（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.18279v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-30/2501.18279_meta.json"
  published_date: "2025-01-30T11:37:34Z"
  authors:
    - "Christina Ovezik"
    - "Dimitris Karakostas"
    - "Mary Milad"
...
### (日本語題名: SoK: Measuring Blockchain Decentralization（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.18279v2`](https://arxiv.org/abs/2501.18279v2) | Raw Meta = [`2501.18279_meta.json`](../../raw_data/2025-01-30/2501.18279_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SoK: Measuring Blockchain Decentralization（セキュリティ分析論文）」（原題: SoK: Measuring Blockchain Decentralization / arXiv: 2501.18279v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.18279v2`
- **論文URL**: [https://arxiv.org/abs/2501.18279v2](https://arxiv.org/abs/2501.18279v2)
- **PDFリンク**: [https://arxiv.org/pdf/2501.18279v2.pdf](https://arxiv.org/pdf/2501.18279v2.pdf)
- **著者**: Christina Ovezik, Dimitris Karakostas, Mary Milad, Aggelos Kiayias, Daniel W. Woods
- **公開日時**: `2025-01-30T11:37:34Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-30/2501.18279_meta.json) | [`PDF`](../../raw_data/2025-01-30/2501.18279.pdf) | [`TXT`](../../raw_data/2025-01-30/2501.18279.txt)
