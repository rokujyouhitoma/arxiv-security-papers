...
title_ja: "VEXAIoT: Autonomous IoT Vulnerability EXploitation using AI Agents（セキュリティ分析論文）"
description: "VEXAIoT: Autonomous IoT Vulnerability EXploitation using AI Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.09653v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-10/2607.09653_meta.json"
  published_date: "2026-07-10T17:52:29Z"
  authors:
    - "Katherine Swinea"
    - "Kshitiz Aryal"
    - "Lopamudra Praharaj"
...
### (日本語題名: VEXAIoT: Autonomous IoT Vulnerability EXploitation using AI Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.09653v1`](https://arxiv.org/abs/2607.09653v1) | Raw Meta = [`2607.09653_meta.json`](../../raw_data/2026-07-10/2607.09653_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「VEXAIoT: Autonomous IoT Vulnerability EXploitation using AI Agents（セキュリティ分析論文）」（原題: VEXAIoT: Autonomous IoT Vulnerability EXploitation using AI Agents / arXiv: 2607.09653v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.09653v1`
- **論文URL**: [https://arxiv.org/abs/2607.09653v1](https://arxiv.org/abs/2607.09653v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.09653v1.pdf](https://arxiv.org/pdf/2607.09653v1.pdf)
- **著者**: Katherine Swinea, Kshitiz Aryal, Lopamudra Praharaj, Maanak Gupta
- **公開日時**: `2026-07-10T17:52:29Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-10/2607.09653_meta.json) | [`PDF`](../../raw_data/2026-07-10/2607.09653.pdf) | [`TXT`](../../raw_data/2026-07-10/2607.09653.txt)
