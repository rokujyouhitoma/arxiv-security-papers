...
title_ja: "Efficient and Adaptable Malicious LLM Prompts via Bootstrap Aggregationの検出"
description: "Efficient and Adaptable Malicious LLM Prompts via Bootstrap Aggregationの検出 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.08062v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-08/2602.08062_meta.json"
  published_date: "2026-02-08T17:11:33Z"
  authors:
    - "Shayan Ali Hassan"
    - "Tao Ni"
    - "Zafar Ayyub Qazi"
...
### (日本語題名: Efficient and Adaptable Malicious LLM Prompts via Bootstrap Aggregationの検出)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.08062v1`](https://arxiv.org/abs/2602.08062v1) | Raw Meta = [`2602.08062_meta.json`](../../raw_data/2026-02-08/2602.08062_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Efficient and Adaptable Malicious LLM Prompts via Bootstrap Aggregationの検出」（原題: Efficient and Adaptable Detection of Malicious LLM Prompts via Bootstrap Aggregation / arXiv: 2602.08062v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2602.08062v1](https://arxiv.org/abs/2602.08062v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.08062v1.pdf](https://arxiv.org/pdf/2602.08062v1.pdf)
- **著者**: Shayan Ali Hassan, Tao Ni, Zafar Ayyub Qazi, Marco Canini
- **公開日時**: `2026-02-08T17:11:33Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-08/2602.08062_meta.json) | [`PDF`](../../raw_data/2026-02-08/2602.08062.pdf) | [`TXT`](../../raw_data/2026-02-08/2602.08062.txt)
