...
title_ja: "AgentSecBench: Measuring Prompt Injection, Privacy Leakage, and Tool-Use Integrity in LLMエージェント"
description: "AgentSecBench: Measuring Prompt Injection, Privacy Leakage, and Tool-Use Integrity in LLMエージェント — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.26269v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-25/2605.26269_meta.json"
  published_date: "2026-05-25T18:53:22Z"
  authors:
    - "Faruk Alpay"
    - "Taylan Alpay"
trust:
...
### (日本語題名: AgentSecBench: Measuring Prompt Injection, Privacy Leakage, and Tool-Use Integrity in LLMエージェント)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.26269v1`](https://arxiv.org/abs/2605.26269v1) | Raw Meta = [`2605.26269_meta.json`](../../raw_data/2026-05-25/2605.26269_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「AgentSecBench: Measuring Prompt Injection, Privacy Leakage, and Tool-Use Integrity in LLMエージェント」（原題: AgentSecBench: Measuring Prompt Injection, Privacy Leakage, and Tool-Use Integrity in LLM Agents / arXiv: 2605.26269v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.26269v1`
- **論文URL**: [https://arxiv.org/abs/2605.26269v1](https://arxiv.org/abs/2605.26269v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.26269v1.pdf](https://arxiv.org/pdf/2605.26269v1.pdf)
- **著者**: Faruk Alpay, Taylan Alpay
- **公開日時**: `2026-05-25T18:53:22Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-25/2605.26269_meta.json) | [`PDF`](../../raw_data/2026-05-25/2605.26269.pdf) | [`TXT`](../../raw_data/2026-05-25/2605.26269.txt)
