...
title_ja: "Privacy-Preserving and Personalized Smart Homes via Tailored Small Language Modelsに向けて"
description: "Privacy-Preserving and Personalized Smart Homes via Tailored Small Language Modelsに向けて — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.08878v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-10/2507.08878_meta.json"
  published_date: "2025-07-10T05:36:32Z"
  authors:
    - "Xinyu Huang"
    - "Leming Shen"
    - "Zijing Ma"
...
### (日本語題名: Privacy-Preserving and Personalized Smart Homes via Tailored Small Language Modelsに向けて)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.08878v1`](https://arxiv.org/abs/2507.08878v1) | Raw Meta = [`2507.08878_meta.json`](../../raw_data/2025-07-10/2507.08878_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Privacy-Preserving and Personalized Smart Homes via Tailored Small Language Modelsに向けて」（原題: Towards Privacy-Preserving and Personalized Smart Homes via Tailored Small Language Models / arXiv: 2507.08878v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.08878v1`
- **論文URL**: [https://arxiv.org/abs/2507.08878v1](https://arxiv.org/abs/2507.08878v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.08878v1.pdf](https://arxiv.org/pdf/2507.08878v1.pdf)
- **著者**: Xinyu Huang, Leming Shen, Zijing Ma, Yuanqing Zheng
- **公開日時**: `2025-07-10T05:36:32Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-10/2507.08878_meta.json) | [`PDF`](../../raw_data/2025-07-10/2507.08878.pdf) | [`TXT`](../../raw_data/2025-07-10/2507.08878.txt)
