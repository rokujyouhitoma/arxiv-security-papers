...
title_ja: "zkSTAR: A zero knowledge system for time series attack detection enforcing regulatory compliance in critical infrastructure networks（セキュリティ分析論文）"
description: "zkSTAR: A zero knowledge system for time series attack detection enforcing regulatory compliance in critical infrastructure networks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.23060v4"
tags:
  - "executive-summary"
  - "eess.SY"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-10-27/2510.23060_meta.json"
  published_date: "2025-10-27T06:45:11Z"
  authors:
    - "Paritosh Ramanan"
    - "Sathwik Yamana"
...
### (日本語題名: zkSTAR: A zero knowledge system for time series attack detection enforcing regulatory compliance in critical infrastructure networks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.23060v4`](https://arxiv.org/abs/2510.23060v4) | Raw Meta = [`2510.23060_meta.json`](../../raw_data/2025-10-27/2510.23060_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「zkSTAR: A zero knowledge system for time series attack detection enforcing regulatory compliance in critical infrastructure networks（セキュリティ分析論文）」（原題: zkSTAR: A zero knowledge system for time series attack detection enforcing regulatory compliance in critical infrastructure networks / arXiv: 2510.23060v4）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2510.23060v4`
- **論文URL**: [https://arxiv.org/abs/2510.23060v4](https://arxiv.org/abs/2510.23060v4)
- **PDFリンク**: [https://arxiv.org/pdf/2510.23060v4.pdf](https://arxiv.org/pdf/2510.23060v4.pdf)
- **著者**: Paritosh Ramanan, Sathwik Yamana, H. M. Mohaimanul Islam, Abhiram Reddy Alugula
- **公開日時**: `2025-10-27T06:45:11Z`
- **カテゴリ**: `cs.CR, eess.SY`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-10-27/2510.23060_meta.json) | [`PDF`](../../raw_data/2025-10-27/2510.23060.pdf) | [`TXT`](../../raw_data/2025-10-27/2510.23060.txt)
