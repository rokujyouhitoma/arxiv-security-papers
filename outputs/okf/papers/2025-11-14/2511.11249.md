...
title_ja: "Bridging Local and Federated Data Normalization in 連合学習: A Privacy-Preserving Approach"
description: "Bridging Local and Federated Data Normalization in 連合学習: A Privacy-Preserving Approach — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.11249v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-14/2511.11249_meta.json"
  published_date: "2025-11-14T12:48:58Z"
  authors:
    - "Melih Coşğun"
    - "Mert Gençtürk"
    - "Sinem Sav"
...
### (日本語題名: Bridging Local and Federated Data Normalization in 連合学習: A Privacy-Preserving Approach)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.11249v1`](https://arxiv.org/abs/2511.11249v1) | Raw Meta = [`2511.11249_meta.json`](../../raw_data/2025-11-14/2511.11249_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Bridging Local and Federated Data Normalization in 連合学習: A Privacy-Preserving Approach」（原題: Bridging Local and Federated Data Normalization in Federated Learning: A Privacy-Preserving Approach / arXiv: 2511.11249v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.11249v1`
- **論文URL**: [https://arxiv.org/abs/2511.11249v1](https://arxiv.org/abs/2511.11249v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.11249v1.pdf](https://arxiv.org/pdf/2511.11249v1.pdf)
- **著者**: Melih Coşğun, Mert Gençtürk, Sinem Sav
- **公開日時**: `2025-11-14T12:48:58Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-14/2511.11249_meta.json) | [`PDF`](../../raw_data/2025-11-14/2511.11249.pdf) | [`TXT`](../../raw_data/2025-11-14/2511.11249.txt)
