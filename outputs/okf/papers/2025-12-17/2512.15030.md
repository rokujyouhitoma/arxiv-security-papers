...
title_ja: "ScamSweeper: Detecting Illegal Accounts in Web3 Scams via Transactions Analysis（セキュリティ分析論文）"
description: "ScamSweeper: Detecting Illegal Accounts in Web3 Scams via Transactions Analysis（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.15030v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-17/2512.15030_meta.json"
  published_date: "2025-12-17T02:43:35Z"
  authors:
    - "Xiaoqi Li"
    - "Wenkai Li"
    - "Zhijie Liu"
...
### (日本語題名: ScamSweeper: Detecting Illegal Accounts in Web3 Scams via Transactions Analysis（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.15030v1`](https://arxiv.org/abs/2512.15030v1) | Raw Meta = [`2512.15030_meta.json`](../../raw_data/2025-12-17/2512.15030_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ScamSweeper: Detecting Illegal Accounts in Web3 Scams via Transactions Analysis（セキュリティ分析論文）」（原題: ScamSweeper: Detecting Illegal Accounts in Web3 Scams via Transactions Analysis / arXiv: 2512.15030v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.15030v1`
- **論文URL**: [https://arxiv.org/abs/2512.15030v1](https://arxiv.org/abs/2512.15030v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.15030v1.pdf](https://arxiv.org/pdf/2512.15030v1.pdf)
- **著者**: Xiaoqi Li, Wenkai Li, Zhijie Liu, Meikang Qiu, Zhiquan Liu, Sen Nie, Zongwei Li, Shi Wu, Yuqing Zhang
- **公開日時**: `2025-12-17T02:43:35Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-17/2512.15030_meta.json) | [`PDF`](../../raw_data/2025-12-17/2512.15030.pdf) | [`TXT`](../../raw_data/2025-12-17/2512.15030.txt)
