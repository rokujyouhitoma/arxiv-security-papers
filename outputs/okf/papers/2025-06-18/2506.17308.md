...
title_ja: "A Nested Watermark for 大規模言語モデル"
description: "A Nested Watermark for 大規模言語モデル — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.17308v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-18/2506.17308_meta.json"
  published_date: "2025-06-18T05:49:05Z"
  authors:
    - "Koichi Nagatsuka"
    - "Terufumi Morishita"
    - "Yasuhiro Sogawa"
...
### (日本語題名: A Nested Watermark for 大規模言語モデル)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.17308v1`](https://arxiv.org/abs/2506.17308v1) | Raw Meta = [`2506.17308_meta.json`](../../raw_data/2025-06-18/2506.17308_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Nested Watermark for 大規模言語モデル」（原題: A Nested Watermark for Large Language Models / arXiv: 2506.17308v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.17308v1`
- **論文URL**: [https://arxiv.org/abs/2506.17308v1](https://arxiv.org/abs/2506.17308v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.17308v1.pdf](https://arxiv.org/pdf/2506.17308v1.pdf)
- **著者**: Koichi Nagatsuka, Terufumi Morishita, Yasuhiro Sogawa
- **公開日時**: `2025-06-18T05:49:05Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-18/2506.17308_meta.json) | [`PDF`](../../raw_data/2025-06-18/2506.17308.pdf) | [`TXT`](../../raw_data/2025-06-18/2506.17308.txt)
