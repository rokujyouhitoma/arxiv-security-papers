...
title_ja: "PEB Separation and State Migration: Unmasking the New Frontiers of DeFi AML Evasion（セキュリティ分析論文）"
description: "PEB Separation and State Migration: Unmasking the New Frontiers of DeFi AML Evasion（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.26290v1"
tags:
  - "q-fin.TR"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-27/2603.26290_meta.json"
  published_date: "2026-03-27T10:58:54Z"
  authors:
    - "Yixin Cao"
    - "Xianfeng Cheng"
    - "Yijie Liu"
...
### (日本語題名: PEB Separation and State Migration: Unmasking the New Frontiers of DeFi AML Evasion（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.26290v1`](https://arxiv.org/abs/2603.26290v1) | Raw Meta = [`2603.26290_meta.json`](../../raw_data/2026-03-27/2603.26290_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「PEB Separation and State Migration: Unmasking the New Frontiers of DeFi AML Evasion（セキュリティ分析論文）」（原題: PEB Separation and State Migration: Unmasking the New Frontiers of DeFi AML Evasion / arXiv: 2603.26290v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2603.26290v1](https://arxiv.org/abs/2603.26290v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.26290v1.pdf](https://arxiv.org/pdf/2603.26290v1.pdf)
- **著者**: Yixin Cao, Xianfeng Cheng, Yijie Liu
- **公開日時**: `2026-03-27T10:58:54Z`
- **カテゴリ**: `cs.CR, q-fin.TR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-27/2603.26290_meta.json) | [`PDF`](../../raw_data/2026-03-27/2603.26290.pdf) | [`TXT`](../../raw_data/2026-03-27/2603.26290.txt)
