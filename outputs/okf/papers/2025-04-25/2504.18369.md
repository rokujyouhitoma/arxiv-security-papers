...
title_ja: "ThreMoLIA: Threat Modeling of Large Language Model-Integrated Applications（セキュリティ分析論文）"
description: "ThreMoLIA: Threat Modeling of Large Language Model-Integrated Applications（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.18369v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-25/2504.18369_meta.json"
  published_date: "2025-04-25T14:11:42Z"
  authors:
...
### (日本語題名: ThreMoLIA: Threat Modeling of Large Language Model-Integrated Applications（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.18369v1`](https://arxiv.org/abs/2504.18369v1) | Raw Meta = [`2504.18369_meta.json`](../../raw_data/2025-04-25/2504.18369_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ThreMoLIA: Threat Modeling of Large Language Model-Integrated Applications（セキュリティ分析論文）」（原題: ThreMoLIA: Threat Modeling of Large Language Model-Integrated Applications / arXiv: 2504.18369v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.18369v1`
- **論文URL**: [https://arxiv.org/abs/2504.18369v1](https://arxiv.org/abs/2504.18369v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.18369v1.pdf](https://arxiv.org/pdf/2504.18369v1.pdf)
- **著者**: Felix Viktor Jedrzejewski, Davide Fucci, Oleksandr Adamov
- **公開日時**: `2025-04-25T14:11:42Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-25/2504.18369_meta.json) | [`PDF`](../../raw_data/2025-04-25/2504.18369.pdf) | [`TXT`](../../raw_data/2025-04-25/2504.18369.txt)
