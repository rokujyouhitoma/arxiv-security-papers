...
title_ja: "Empirical Assessment of the Code Comprehension Effort Needed to Attack Programs Protected with Obfuscation（セキュリティ分析論文）"
description: "Empirical Assessment of the Code Comprehension Effort Needed to Attack Programs Protected with Obfuscation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.21301v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-26/2511.21301_meta.json"
  published_date: "2025-11-26T11:48:21Z"
  authors:
    - "Leonardo Regano"
    - "Daniele Canavese"
    - "Cataldo Basile"
...
### (日本語題名: Empirical Assessment of the Code Comprehension Effort Needed to Attack Programs Protected with Obfuscation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.21301v1`](https://arxiv.org/abs/2511.21301v1) | Raw Meta = [`2511.21301_meta.json`](../../raw_data/2025-11-26/2511.21301_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Empirical Assessment of the Code Comprehension Effort Needed to Attack Programs Protected with Obfuscation（セキュリティ分析論文）」（原題: Empirical Assessment of the Code Comprehension Effort Needed to Attack Programs Protected with Obfuscation / arXiv: 2511.21301v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.21301v1`
- **論文URL**: [https://arxiv.org/abs/2511.21301v1](https://arxiv.org/abs/2511.21301v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.21301v1.pdf](https://arxiv.org/pdf/2511.21301v1.pdf)
- **著者**: Leonardo Regano, Daniele Canavese, Cataldo Basile, Marco Torchiano
- **公開日時**: `2025-11-26T11:48:21Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-26/2511.21301_meta.json) | [`PDF`](../../raw_data/2025-11-26/2511.21301.pdf) | [`TXT`](../../raw_data/2025-11-26/2511.21301.txt)
