...
title_ja: "A Channel-Triggered Backdoor Attack on Wireless Semantic Image Reconstruction（セキュリティ分析論文）"
description: "A Channel-Triggered Backdoor Attack on Wireless Semantic Image Reconstruction（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.23866v3"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-31/2503.23866_meta.json"
  published_date: "2025-03-31T09:17:10Z"
  authors:
    - "Jialin Wan"
    - "Jinglong Shen"
    - "Nan Cheng"
...
### (日本語題名: A Channel-Triggered Backdoor Attack on Wireless Semantic Image Reconstruction（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.23866v3`](https://arxiv.org/abs/2503.23866v3) | Raw Meta = [`2503.23866_meta.json`](../../raw_data/2025-03-31/2503.23866_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Channel-Triggered Backdoor Attack on Wireless Semantic Image Reconstruction（セキュリティ分析論文）」（原題: A Channel-Triggered Backdoor Attack on Wireless Semantic Image Reconstruction / arXiv: 2503.23866v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.23866v3`
- **論文URL**: [https://arxiv.org/abs/2503.23866v3](https://arxiv.org/abs/2503.23866v3)
- **PDFリンク**: [https://arxiv.org/pdf/2503.23866v3.pdf](https://arxiv.org/pdf/2503.23866v3.pdf)
- **著者**: Jialin Wan, Jinglong Shen, Nan Cheng, Zhisheng Yin, Yiliang Liu, Wenchao Xu, Xuemin, Shen
- **公開日時**: `2025-03-31T09:17:10Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-31/2503.23866_meta.json) | [`PDF`](../../raw_data/2025-03-31/2503.23866.pdf) | [`TXT`](../../raw_data/2025-03-31/2503.23866.txt)
