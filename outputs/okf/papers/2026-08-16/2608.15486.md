---
type: "security-paper"
title: "Beyond Single-Vulnerability Evaluation: Closing the Engineering Decision Gap Between C Retrofits and Native Safety"
title_ja: "Beyond Single-Vulnerability Evaluation: Closing the Engineering Decision Gap Between C Retrofits and Native Safety（セキュリティ分析論文）"
description: "Beyond Single-Vulnerability Evaluation: Closing the Engineering Decision Gap Between C Retrofits and Native Safety（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.15486v1"
tags:
  - "Software Security"
  - "arXiv"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-16/2608.15486_meta.json"
  published_date: "2026-08-16T02:29:15Z"
  authors:
    - "Andrew Laramore"
    - "Joseph Spracklen"
    - "Murtuza Jadliwala"
...
### (日本語題名: Beyond Single-Vulnerability Evaluation: Closing the Engineering Decision Gap Between C Retrofits and Native Safety（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.15486v1`](https://arxiv.org/abs/2608.15486v1) | Raw Meta = [`2608.15486_meta.json`](../../raw_data/2026-08-16/2608.15486_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Beyond Single-Vulnerability Evaluation: Closing the Engineering Decision Gap Between C Retrofits and Native Safety（セキュリティ分析論文）」（原題: Beyond Single-Vulnerability Evaluation: Closing the Engineering Decision Gap Between C Retrofits and Native Safety / arXiv: 2608.15486v1）は、cs.PL 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.15486v1`
- **論文URL**: [https://arxiv.org/abs/2608.15486v1](https://arxiv.org/abs/2608.15486v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.15486v1.pdf](https://arxiv.org/pdf/2608.15486v1.pdf)
- **著者**: Andrew Laramore, Joseph Spracklen, Murtuza Jadliwala
- **公開日時**: `2026-08-16T02:29:15Z`
- **カテゴリ**: `cs.PL, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-16/2608.15486_meta.json) | [`PDF`](../../raw_data/2026-08-16/2608.15486.pdf) | [`TXT`](../../raw_data/2026-08-16/2608.15486.txt)
