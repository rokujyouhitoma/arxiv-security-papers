...
title_ja: "ICL-EVADER: Zero-Query Black-Box Evasion Attacks on In-Context Learning and Their Defenses（セキュリティ分析論文）"
description: "ICL-EVADER: Zero-Query Black-Box Evasion Attacks on In-Context Learning and Their Defenses（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.21586v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-29/2601.21586_meta.json"
  published_date: "2026-01-29T11:50:50Z"
  authors:
    - "Ningyuan He"
    - "Ronghong Huang"
    - "Qianqian Tang"
...
### (日本語題名: ICL-EVADER: Zero-Query Black-Box Evasion Attacks on In-Context Learning and Their Defenses（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.21586v1`](https://arxiv.org/abs/2601.21586v1) | Raw Meta = [`2601.21586_meta.json`](../../raw_data/2026-01-29/2601.21586_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ICL-EVADER: Zero-Query Black-Box Evasion Attacks on In-Context Learning and Their Defenses（セキュリティ分析論文）」（原題: ICL-EVADER: Zero-Query Black-Box Evasion Attacks on In-Context Learning and Their Defenses / arXiv: 2601.21586v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.21586v1`
- **論文URL**: [https://arxiv.org/abs/2601.21586v1](https://arxiv.org/abs/2601.21586v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.21586v1.pdf](https://arxiv.org/pdf/2601.21586v1.pdf)
- **著者**: Ningyuan He, Ronghong Huang, Qianqian Tang, Hongyu Wang, Xianghang Mi, Shanqing Guo
- **公開日時**: `2026-01-29T11:50:50Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-29/2601.21586_meta.json) | [`PDF`](../../raw_data/2026-01-29/2601.21586.pdf) | [`TXT`](../../raw_data/2026-01-29/2601.21586.txt)
