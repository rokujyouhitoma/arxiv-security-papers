...
title_ja: "BadPatches: Routing-aware Backdoor Attacks on Vision Mixture of Experts（セキュリティ分析論文）"
description: "BadPatches: Routing-aware Backdoor Attacks on Vision Mixture of Experts（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.01811v3"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-03/2505.01811_meta.json"
  published_date: "2025-05-03T12:48:04Z"
  authors:
    - "Cedric Chan"
    - "Jona te Lintelo"
    - "Stjepan Picek"
...
### (日本語題名: BadPatches: Routing-aware Backdoor Attacks on Vision Mixture of Experts（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.01811v3`](https://arxiv.org/abs/2505.01811v3) | Raw Meta = [`2505.01811_meta.json`](../../raw_data/2025-05-03/2505.01811_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「BadPatches: Routing-aware Backdoor Attacks on Vision Mixture of Experts（セキュリティ分析論文）」（原題: BadPatches: Routing-aware Backdoor Attacks on Vision Mixture of Experts / arXiv: 2505.01811v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.01811v3`
- **論文URL**: [https://arxiv.org/abs/2505.01811v3](https://arxiv.org/abs/2505.01811v3)
- **PDFリンク**: [https://arxiv.org/pdf/2505.01811v3.pdf](https://arxiv.org/pdf/2505.01811v3.pdf)
- **著者**: Cedric Chan, Jona te Lintelo, Stjepan Picek
- **公開日時**: `2025-05-03T12:48:04Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-03/2505.01811_meta.json) | [`PDF`](../../raw_data/2025-05-03/2505.01811.pdf) | [`TXT`](../../raw_data/2025-05-03/2505.01811.txt)
