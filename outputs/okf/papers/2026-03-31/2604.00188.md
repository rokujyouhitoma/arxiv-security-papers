...
title_ja: "On the Necessity of Pre-agreed Secrets for Thwarting Last-minute Coercion: Vulnerabilities and Lessons From the Loki E-voting Protocol（セキュリティ分析論文）"
description: "On the Necessity of Pre-agreed Secrets for Thwarting Last-minute Coercion: Vulnerabilities and Lessons From the Loki E-voting Protocol（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.00188v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-31/2604.00188_meta.json"
  published_date: "2026-03-31T19:40:55Z"
  authors:
    - "Jingxin Qiao"
    - "Myrto Arapinis"
    - "Thomas Zacharias"
...
### (日本語題名: On the Necessity of Pre-agreed Secrets for Thwarting Last-minute Coercion: Vulnerabilities and Lessons From the Loki E-voting Protocol（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.00188v1`](https://arxiv.org/abs/2604.00188v1) | Raw Meta = [`2604.00188_meta.json`](../../raw_data/2026-03-31/2604.00188_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「On the Necessity of Pre-agreed Secrets for Thwarting Last-minute Coercion: Vulnerabilities and Lessons From the Loki E-voting Protocol（セキュリティ分析論文）」（原題: On the Necessity of Pre-agreed Secrets for Thwarting Last-minute Coercion: Vulnerabilities and Lessons From the Loki E-voting Protocol / arXiv: 2604.00188v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.00188v1`
- **論文URL**: [https://arxiv.org/abs/2604.00188v1](https://arxiv.org/abs/2604.00188v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.00188v1.pdf](https://arxiv.org/pdf/2604.00188v1.pdf)
- **著者**: Jingxin Qiao, Myrto Arapinis, Thomas Zacharias
- **公開日時**: `2026-03-31T19:40:55Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-31/2604.00188_meta.json) | [`PDF`](../../raw_data/2026-03-31/2604.00188.pdf) | [`TXT`](../../raw_data/2026-03-31/2604.00188.txt)
