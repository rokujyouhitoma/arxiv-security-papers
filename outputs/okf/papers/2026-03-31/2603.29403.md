...
title_ja: "Security in LLM-as-a-Judge: A Comprehensive SoK（セキュリティ分析論文）"
description: "Security in LLM-as-a-Judge: A Comprehensive SoK（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.29403v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-31/2603.29403_meta.json"
  published_date: "2026-03-31T08:05:54Z"
  authors:
    - "Aiman Al Masoud"
    - "Antony Anju"
    - "Marco Arazzi"
...
### (日本語題名: Security in LLM-as-a-Judge: A Comprehensive SoK（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.29403v2`](https://arxiv.org/abs/2603.29403v2) | Raw Meta = [`2603.29403_meta.json`](../../raw_data/2026-03-31/2603.29403_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Security in LLM-as-a-Judge: A Comprehensive SoK（セキュリティ分析論文）」（原題: Security in LLM-as-a-Judge: A Comprehensive SoK / arXiv: 2603.29403v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.29403v2`
- **論文URL**: [https://arxiv.org/abs/2603.29403v2](https://arxiv.org/abs/2603.29403v2)
- **PDFリンク**: [https://arxiv.org/pdf/2603.29403v2.pdf](https://arxiv.org/pdf/2603.29403v2.pdf)
- **著者**: Aiman Al Masoud, Antony Anju, Marco Arazzi, Mert Cihangiroglu, Vignesh Kumar Kembu, Serena Nicolazzo, Antonino Nocera, Vinod P., Saraga Sakthidharan
- **公開日時**: `2026-03-31T08:05:54Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-31/2603.29403_meta.json) | [`PDF`](../../raw_data/2026-03-31/2603.29403.pdf) | [`TXT`](../../raw_data/2026-03-31/2603.29403.txt)
