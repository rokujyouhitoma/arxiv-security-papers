...
title_ja: "Architecting Secure AI Agents: Perspectives on System-Level Defenses Against Indirect Prompt Injection Attacks（セキュリティ分析論文）"
description: "Architecting Secure AI Agents: Perspectives on System-Level Defenses Against Indirect Prompt Injection Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-31/2603.30016_meta.json"
  published_date: "2026-03-31T17:15:46Z"
  authors:
    - "Chong Xiang"
    - "Drew Zagieboylo"
    - "Shaona Ghosh"
...
### (日本語題名: Architecting Secure AI Agents: Perspectives on System-Level Defenses Against Indirect Prompt Injection Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.30016v1`](https://arxiv.org/abs/2603.30016v1) | Raw Meta = [`2603.30016_meta.json`](../../raw_data/2026-03-31/2603.30016_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Architecting Secure AI Agents: Perspectives on System-Level Defenses Against Indirect Prompt Injection Attacks（セキュリティ分析論文）」（原題: Architecting Secure AI Agents: Perspectives on System-Level Defenses Against Indirect Prompt Injection Attacks / arXiv: 2603.30016v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2603.30016v1](https://arxiv.org/abs/2603.30016v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.30016v1.pdf](https://arxiv.org/pdf/2603.30016v1.pdf)
- **著者**: Chong Xiang, Drew Zagieboylo, Shaona Ghosh, Sanjay Kariyappa, Kai Greshake, Hanshen Xiao, Chaowei Xiao, G. Edward Suh
- **公開日時**: `2026-03-31T17:15:46Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-31/2603.30016_meta.json) | [`PDF`](../../raw_data/2026-03-31/2603.30016.pdf) | [`TXT`](../../raw_data/2026-03-31/2603.30016.txt)
