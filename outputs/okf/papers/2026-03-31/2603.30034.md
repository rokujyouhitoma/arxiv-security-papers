...
title_ja: "EnsembleSHAP: Faithful and Certifiably Robust Attribution for Random Subspace Method（セキュリティ分析論文）"
description: "EnsembleSHAP: Faithful and Certifiably Robust Attribution for Random Subspace Method（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.30034v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-31/2603.30034_meta.json"
  published_date: "2026-03-31T17:30:52Z"
  authors:
    - "Yanting Wang"
    - "Jinyuan Jia"
trust:
...
### (日本語題名: EnsembleSHAP: Faithful and Certifiably Robust Attribution for Random Subspace Method（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.30034v1`](https://arxiv.org/abs/2603.30034v1) | Raw Meta = [`2603.30034_meta.json`](../../raw_data/2026-03-31/2603.30034_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「EnsembleSHAP: Faithful and Certifiably Robust Attribution for Random Subspace Method（セキュリティ分析論文）」（原題: EnsembleSHAP: Faithful and Certifiably Robust Attribution for Random Subspace Method / arXiv: 2603.30034v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.30034v1`
- **論文URL**: [https://arxiv.org/abs/2603.30034v1](https://arxiv.org/abs/2603.30034v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.30034v1.pdf](https://arxiv.org/pdf/2603.30034v1.pdf)
- **著者**: Yanting Wang, Jinyuan Jia
- **公開日時**: `2026-03-31T17:30:52Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-31/2603.30034_meta.json) | [`PDF`](../../raw_data/2026-03-31/2603.30034.pdf) | [`TXT`](../../raw_data/2026-03-31/2603.30034.txt)
