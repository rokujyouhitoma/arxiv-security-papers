...
title_ja: "Beyond Crash: Hijacking Your Autonomous Vehicle for Fun and Profit（セキュリティ分析論文）"
description: "Beyond Crash: Hijacking Your Autonomous Vehicle for Fun and Profit（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.07249v2"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-06/2602.07249_meta.json"
  published_date: "2026-02-06T22:57:16Z"
  authors:
    - "Qi Sun"
    - "Ahmed Abdo"
    - "Luis Burbano"
...
### (日本語題名: Beyond Crash: Hijacking Your Autonomous Vehicle for Fun and Profit（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.07249v2`](https://arxiv.org/abs/2602.07249v2) | Raw Meta = [`2602.07249_meta.json`](../../raw_data/2026-02-06/2602.07249_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Beyond Crash: Hijacking Your Autonomous Vehicle for Fun and Profit（セキュリティ分析論文）」（原題: Beyond Crash: Hijacking Your Autonomous Vehicle for Fun and Profit / arXiv: 2602.07249v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.07249v2`
- **論文URL**: [https://arxiv.org/abs/2602.07249v2](https://arxiv.org/abs/2602.07249v2)
- **PDFリンク**: [https://arxiv.org/pdf/2602.07249v2.pdf](https://arxiv.org/pdf/2602.07249v2.pdf)
- **著者**: Qi Sun, Ahmed Abdo, Luis Burbano, Ziyang Li, Yaxing Yao, Alvaro Cardenas, Yinzhi Cao
- **公開日時**: `2026-02-06T22:57:16Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-06/2602.07249_meta.json) | [`PDF`](../../raw_data/2026-02-06/2602.07249.pdf) | [`TXT`](../../raw_data/2026-02-06/2602.07249.txt)
