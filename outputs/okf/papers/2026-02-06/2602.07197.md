...
title_ja: "Lite-BD: A Lightweight Black-box Backdoor Defense via Reviving Multi-Stage Image Transformations（セキュリティ分析論文）"
description: "Lite-BD: A Lightweight Black-box Backdoor Defense via Reviving Multi-Stage Image Transformations（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.07197v3"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-06/2602.07197_meta.json"
  published_date: "2026-02-06T21:11:49Z"
  authors:
...
### (日本語題名: Lite-BD: A Lightweight Black-box Backdoor Defense via Reviving Multi-Stage Image Transformations（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.07197v3`](https://arxiv.org/abs/2602.07197v3) | Raw Meta = [`2602.07197_meta.json`](../../raw_data/2026-02-06/2602.07197_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Lite-BD: A Lightweight Black-box Backdoor Defense via Reviving Multi-Stage Image Transformations（セキュリティ分析論文）」（原題: Lite-BD: A Lightweight Black-box Backdoor Defense via Reviving Multi-Stage Image Transformations / arXiv: 2602.07197v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.07197v3`
- **論文URL**: [https://arxiv.org/abs/2602.07197v3](https://arxiv.org/abs/2602.07197v3)
- **PDFリンク**: [https://arxiv.org/pdf/2602.07197v3.pdf](https://arxiv.org/pdf/2602.07197v3.pdf)
- **著者**: Abdullah Arafat Miah, Yu Bi
- **公開日時**: `2026-02-06T21:11:49Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-06/2602.07197_meta.json) | [`PDF`](../../raw_data/2026-02-06/2602.07197.pdf) | [`TXT`](../../raw_data/2026-02-06/2602.07197.txt)
