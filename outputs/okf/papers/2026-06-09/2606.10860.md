...
title_ja: "Training LLMs to Enforce Multi-Level Instruction Hierarchies via Gravity-Weighted Direct Preference Optimization（セキュリティ分析論文）"
description: "Training LLMs to Enforce Multi-Level Instruction Hierarchies via Gravity-Weighted Direct Preference Optimization（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.10860v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-09/2606.10860_meta.json"
  published_date: "2026-06-09T13:39:17Z"
  authors:
    - "Lena S. Bolliger"
    - "Lena A. Jäger"
trust:
...
### (日本語題名: Training LLMs to Enforce Multi-Level Instruction Hierarchies via Gravity-Weighted Direct Preference Optimization（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.10860v1`](https://arxiv.org/abs/2606.10860v1) | Raw Meta = [`2606.10860_meta.json`](../../raw_data/2026-06-09/2606.10860_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Training LLMs to Enforce Multi-Level Instruction Hierarchies via Gravity-Weighted Direct Preference Optimization（セキュリティ分析論文）」（原題: Training LLMs to Enforce Multi-Level Instruction Hierarchies via Gravity-Weighted Direct Preference Optimization / arXiv: 2606.10860v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2606.10860v1](https://arxiv.org/abs/2606.10860v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.10860v1.pdf](https://arxiv.org/pdf/2606.10860v1.pdf)
- **著者**: Lena S. Bolliger, Lena A. Jäger
- **公開日時**: `2026-06-09T13:39:17Z`
- **カテゴリ**: `cs.CR, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-09/2606.10860_meta.json) | [`PDF`](../../raw_data/2026-06-09/2606.10860.pdf) | [`TXT`](../../raw_data/2026-06-09/2606.10860.txt)
