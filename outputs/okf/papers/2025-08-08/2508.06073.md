...
title_ja: "ProvX: Generating Counterfactual-Driven Attack Explanations for Provenance-Based Detection（セキュリティ分析論文）"
description: "ProvX: Generating Counterfactual-Driven Attack Explanations for Provenance-Based Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.06073v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-08/2508.06073_meta.json"
  published_date: "2025-08-08T07:12:10Z"
  authors:
    - "Weiheng Wu"
    - "Wei Qiao"
    - "Teng Li"
...
### (日本語題名: ProvX: Generating Counterfactual-Driven Attack Explanations for Provenance-Based Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.06073v1`](https://arxiv.org/abs/2508.06073v1) | Raw Meta = [`2508.06073_meta.json`](../../raw_data/2025-08-08/2508.06073_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ProvX: Generating Counterfactual-Driven Attack Explanations for Provenance-Based Detection（セキュリティ分析論文）」（原題: ProvX: Generating Counterfactual-Driven Attack Explanations for Provenance-Based Detection / arXiv: 2508.06073v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.06073v1`
- **論文URL**: [https://arxiv.org/abs/2508.06073v1](https://arxiv.org/abs/2508.06073v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.06073v1.pdf](https://arxiv.org/pdf/2508.06073v1.pdf)
- **著者**: Weiheng Wu, Wei Qiao, Teng Li, Yebo Feng, Zhuo Ma, Jianfeng Ma, Yang Liu
- **公開日時**: `2025-08-08T07:12:10Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-08/2508.06073_meta.json) | [`PDF`](../../raw_data/2025-08-08/2508.06073.pdf) | [`TXT`](../../raw_data/2025-08-08/2508.06073.txt)
