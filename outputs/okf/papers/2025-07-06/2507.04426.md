...
title_ja: "Enhancing Phishing Detection in Financial Systems through NLP（セキュリティ分析論文）"
description: "Enhancing Phishing Detection in Financial Systems through NLP（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.04426v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-06/2507.04426_meta.json"
  published_date: "2025-07-06T15:20:25Z"
  authors:
    - "Novruz Amirov"
    - "Leminur Celik"
    - "Egemen Ali Caner"
...
### (日本語題名: Enhancing Phishing Detection in Financial Systems through NLP（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.04426v1`](https://arxiv.org/abs/2507.04426v1) | Raw Meta = [`2507.04426_meta.json`](../../raw_data/2025-07-06/2507.04426_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Enhancing Phishing Detection in Financial Systems through NLP（セキュリティ分析論文）」（原題: Enhancing Phishing Detection in Financial Systems through NLP / arXiv: 2507.04426v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.04426v1`
- **論文URL**: [https://arxiv.org/abs/2507.04426v1](https://arxiv.org/abs/2507.04426v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.04426v1.pdf](https://arxiv.org/pdf/2507.04426v1.pdf)
- **著者**: Novruz Amirov, Leminur Celik, Egemen Ali Caner, Emre Yurdakul, Fahri Anil Yerlikaya, Serif Bahtiyar
- **公開日時**: `2025-07-06T15:20:25Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-06/2507.04426_meta.json) | [`PDF`](../../raw_data/2025-07-06/2507.04426.pdf) | [`TXT`](../../raw_data/2025-07-06/2507.04426.txt)
