...
title_ja: "PatchDEMUX: A Certifiably Robust Framework for Multi-label Classifiers Against Adversarial Patches（セキュリティ分析論文）"
description: "PatchDEMUX: A Certifiably Robust Framework for Multi-label Classifiers Against Adversarial Patches（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.24703v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-30/2505.24703_meta.json"
  published_date: "2025-05-30T15:25:51Z"
  authors:
    - "Dennis Jacob"
    - "Chong Xiang"
    - "Prateek Mittal"
...
### (日本語題名: PatchDEMUX: A Certifiably Robust Framework for Multi-label Classifiers Against Adversarial Patches（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.24703v1`](https://arxiv.org/abs/2505.24703v1) | Raw Meta = [`2505.24703_meta.json`](../../raw_data/2025-05-30/2505.24703_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「PatchDEMUX: A Certifiably Robust Framework for Multi-label Classifiers Against Adversarial Patches（セキュリティ分析論文）」（原題: PatchDEMUX: A Certifiably Robust Framework for Multi-label Classifiers Against Adversarial Patches / arXiv: 2505.24703v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.24703v1`
- **論文URL**: [https://arxiv.org/abs/2505.24703v1](https://arxiv.org/abs/2505.24703v1)
- **PDFリンク**: [https://arxiv.org/pdf/2505.24703v1.pdf](https://arxiv.org/pdf/2505.24703v1.pdf)
- **著者**: Dennis Jacob, Chong Xiang, Prateek Mittal
- **公開日時**: `2025-05-30T15:25:51Z`
- **カテゴリ**: `cs.CR, cs.CV, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-30/2505.24703_meta.json) | [`PDF`](../../raw_data/2025-05-30/2505.24703.pdf) | [`TXT`](../../raw_data/2025-05-30/2505.24703.txt)
