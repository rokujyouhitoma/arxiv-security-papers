...
title_ja: "PARSE: Provenance-Aware Retrieval Sanitization for Professional Domain LLMエージェント"
description: "PARSE: Provenance-Aware Retrieval Sanitization for Professional Domain LLMエージェント — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.17467v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-16/2606.17467_meta.json"
  published_date: "2026-06-16T03:29:23Z"
  authors:
    - "Aaditya Pai"
trust:
...
### (日本語題名: PARSE: Provenance-Aware Retrieval Sanitization for Professional Domain LLMエージェント)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.17467v2`](https://arxiv.org/abs/2606.17467v2) | Raw Meta = [`2606.17467_meta.json`](../../raw_data/2026-06-16/2606.17467_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「PARSE: Provenance-Aware Retrieval Sanitization for Professional Domain LLMエージェント」（原題: PARSE: Provenance-Aware Retrieval Sanitization for Professional Domain LLM Agents / arXiv: 2606.17467v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.17467v2`
- **論文URL**: [https://arxiv.org/abs/2606.17467v2](https://arxiv.org/abs/2606.17467v2)
- **PDFリンク**: [https://arxiv.org/pdf/2606.17467v2.pdf](https://arxiv.org/pdf/2606.17467v2.pdf)
- **著者**: Aaditya Pai
- **公開日時**: `2026-06-16T03:29:23Z`
- **カテゴリ**: `cs.CR, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-16/2606.17467_meta.json) | [`PDF`](../../raw_data/2026-06-16/2606.17467.pdf) | [`TXT`](../../raw_data/2026-06-16/2606.17467.txt)
