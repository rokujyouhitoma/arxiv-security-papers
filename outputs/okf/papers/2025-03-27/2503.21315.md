...
title_ja: "Tricking Retrievers with Influential Tokens: An Efficient Black-Box Corpus Poisoning Attack（セキュリティ分析論文）"
description: "Tricking Retrievers with Influential Tokens: An Efficient Black-Box Corpus Poisoning Attack（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.21315v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-27/2503.21315_meta.json"
  published_date: "2025-03-27T09:54:37Z"
  authors:
    - "Cheng Wang"
    - "Yiwei Wang"
    - "Yujun Cai"
...
### (日本語題名: Tricking Retrievers with Influential Tokens: An Efficient Black-Box Corpus Poisoning Attack（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.21315v1`](https://arxiv.org/abs/2503.21315v1) | Raw Meta = [`2503.21315_meta.json`](../../raw_data/2025-03-27/2503.21315_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Tricking Retrievers with Influential Tokens: An Efficient Black-Box Corpus Poisoning Attack（セキュリティ分析論文）」（原題: Tricking Retrievers with Influential Tokens: An Efficient Black-Box Corpus Poisoning Attack / arXiv: 2503.21315v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.21315v1`
- **論文URL**: [https://arxiv.org/abs/2503.21315v1](https://arxiv.org/abs/2503.21315v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.21315v1.pdf](https://arxiv.org/pdf/2503.21315v1.pdf)
- **著者**: Cheng Wang, Yiwei Wang, Yujun Cai, Bryan Hooi
- **公開日時**: `2025-03-27T09:54:37Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-27/2503.21315_meta.json) | [`PDF`](../../raw_data/2025-03-27/2503.21315.pdf) | [`TXT`](../../raw_data/2025-03-27/2503.21315.txt)
