...
title_ja: "Your Space is My Zone: Demystifying the Security Risks of AI-Powered Applications on Pre-Trained Model Hubs（セキュリティ分析論文）"
description: "Your Space is My Zone: Demystifying the Security Risks of AI-Powered Applications on Pre-Trained Model Hubs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.30373v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-29/2606.30373_meta.json"
  published_date: "2026-06-29T14:34:43Z"
  authors:
    - "Yacong Gu"
    - "Lingyun Ying"
    - "Zidong Zhang"
...
### (日本語題名: Your Space is My Zone: Demystifying the Security Risks of AI-Powered Applications on Pre-Trained Model Hubs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.30373v1`](https://arxiv.org/abs/2606.30373v1) | Raw Meta = [`2606.30373_meta.json`](../../raw_data/2026-06-29/2606.30373_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Your Space is My Zone: Demystifying the Security Risks of AI-Powered Applications on Pre-Trained Model Hubs（セキュリティ分析論文）」（原題: Your Space is My Zone: Demystifying the Security Risks of AI-Powered Applications on Pre-Trained Model Hubs / arXiv: 2606.30373v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.30373v1`
- **論文URL**: [https://arxiv.org/abs/2606.30373v1](https://arxiv.org/abs/2606.30373v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.30373v1.pdf](https://arxiv.org/pdf/2606.30373v1.pdf)
- **著者**: Yacong Gu, Lingyun Ying, Zidong Zhang, Yingyuan Pu, Xiaoxue Huang, Jiawei Zhou, Wenjie Zhu, Donghong Sun, Haixin Duan
- **公開日時**: `2026-06-29T14:34:43Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-29/2606.30373_meta.json) | [`PDF`](../../raw_data/2026-06-29/2606.30373.pdf) | [`TXT`](../../raw_data/2026-06-29/2606.30373.txt)
