...
title_ja: "Feedback-Driven Execution for LLM-Based Binary Analysis（セキュリティ分析論文）"
description: "Feedback-Driven Execution for LLM-Based Binary Analysis（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.15136v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-16/2604.15136_meta.json"
  published_date: "2026-04-16T15:15:58Z"
  authors:
    - "XiangRui Zhang"
    - "Qiang Li"
    - "Haining Wang"
...
### (日本語題名: Feedback-Driven Execution for LLM-Based Binary Analysis（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.15136v1`](https://arxiv.org/abs/2604.15136v1) | Raw Meta = [`2604.15136_meta.json`](../../raw_data/2026-04-16/2604.15136_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Feedback-Driven Execution for LLM-Based Binary Analysis（セキュリティ分析論文）」（原題: Feedback-Driven Execution for LLM-Based Binary Analysis / arXiv: 2604.15136v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.15136v1`
- **論文URL**: [https://arxiv.org/abs/2604.15136v1](https://arxiv.org/abs/2604.15136v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.15136v1.pdf](https://arxiv.org/pdf/2604.15136v1.pdf)
- **著者**: XiangRui Zhang, Qiang Li, Haining Wang
- **公開日時**: `2026-04-16T15:15:58Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-16/2604.15136_meta.json) | [`PDF`](../../raw_data/2026-04-16/2604.15136.pdf) | [`TXT`](../../raw_data/2026-04-16/2604.15136.txt)
