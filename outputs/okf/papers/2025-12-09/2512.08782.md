...
title_ja: "An Explainable AI Model for the Detecting Malicious Smart Contracts Based on EVM Opcode Based Features（セキュリティ分析論文）"
description: "An Explainable AI Model for the Detecting Malicious Smart Contracts Based on EVM Opcode Based Features（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.08782v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-09/2512.08782_meta.json"
  published_date: "2025-12-09T16:34:23Z"
  authors:
    - "Roopak Surendran"
trust:
...
### (日本語題名: An Explainable AI Model for the Detecting Malicious Smart Contracts Based on EVM Opcode Based Features（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.08782v1`](https://arxiv.org/abs/2512.08782v1) | Raw Meta = [`2512.08782_meta.json`](../../raw_data/2025-12-09/2512.08782_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「An Explainable AI Model for the Detecting Malicious Smart Contracts Based on EVM Opcode Based Features（セキュリティ分析論文）」（原題: An Explainable AI Model for the Detecting Malicious Smart Contracts Based on EVM Opcode Based Features / arXiv: 2512.08782v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.08782v1`
- **論文URL**: [https://arxiv.org/abs/2512.08782v1](https://arxiv.org/abs/2512.08782v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.08782v1.pdf](https://arxiv.org/pdf/2512.08782v1.pdf)
- **著者**: Roopak Surendran
- **公開日時**: `2025-12-09T16:34:23Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-09/2512.08782_meta.json) | [`PDF`](../../raw_data/2025-12-09/2512.08782.pdf) | [`TXT`](../../raw_data/2025-12-09/2512.08782.txt)
