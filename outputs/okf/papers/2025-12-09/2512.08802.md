...
title_ja: "Democratizing ML for Enterprise Security: A Self-Sustained Attack Detection Framework（セキュリティ分析論文）"
description: "Democratizing ML for Enterprise Security: A Self-Sustained Attack Detection Framework（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.08802v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-09/2512.08802_meta.json"
  published_date: "2025-12-09T16:58:08Z"
  authors:
    - "Sadegh Momeni"
    - "Ge Zhang"
    - "Birkett Huber"
...
### (日本語題名: Democratizing ML for Enterprise Security: A Self-Sustained Attack Detection Framework（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.08802v1`](https://arxiv.org/abs/2512.08802v1) | Raw Meta = [`2512.08802_meta.json`](../../raw_data/2025-12-09/2512.08802_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Democratizing ML for Enterprise Security: A Self-Sustained Attack Detection Framework（セキュリティ分析論文）」（原題: Democratizing ML for Enterprise Security: A Self-Sustained Attack Detection Framework / arXiv: 2512.08802v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2512.08802v1](https://arxiv.org/abs/2512.08802v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.08802v1.pdf](https://arxiv.org/pdf/2512.08802v1.pdf)
- **著者**: Sadegh Momeni, Ge Zhang, Birkett Huber, Hamza Harkous, Sam Lipton, Benoit Seguin, Yanis Pavlidis
- **公開日時**: `2025-12-09T16:58:08Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-09/2512.08802_meta.json) | [`PDF`](../../raw_data/2025-12-09/2512.08802.pdf) | [`TXT`](../../raw_data/2025-12-09/2512.08802.txt)
