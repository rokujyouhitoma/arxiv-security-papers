...
title_ja: "Efficient Adversarial Malware Defense via Trust-Based Raw Override and Confidence-Adaptive Bit-Depth Reduction（セキュリティ分析論文）"
description: "Efficient Adversarial Malware Defense via Trust-Based Raw Override and Confidence-Adaptive Bit-Depth Reduction（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.12827v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-16/2511.12827_meta.json"
  published_date: "2025-11-16T23:21:44Z"
  authors:
    - "Ayush Chaudhary"
    - "Sisir Doppalpudi"
trust:
...
### (日本語題名: Efficient Adversarial Malware Defense via Trust-Based Raw Override and Confidence-Adaptive Bit-Depth Reduction（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.12827v1`](https://arxiv.org/abs/2511.12827v1) | Raw Meta = [`2511.12827_meta.json`](../../raw_data/2025-11-16/2511.12827_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Efficient Adversarial Malware Defense via Trust-Based Raw Override and Confidence-Adaptive Bit-Depth Reduction（セキュリティ分析論文）」（原題: Efficient Adversarial Malware Defense via Trust-Based Raw Override and Confidence-Adaptive Bit-Depth Reduction / arXiv: 2511.12827v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2511.12827v1](https://arxiv.org/abs/2511.12827v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.12827v1.pdf](https://arxiv.org/pdf/2511.12827v1.pdf)
- **著者**: Ayush Chaudhary, Sisir Doppalpudi
- **公開日時**: `2025-11-16T23:21:44Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-16/2511.12827_meta.json) | [`PDF`](../../raw_data/2025-11-16/2511.12827.pdf) | [`TXT`](../../raw_data/2025-11-16/2511.12827.txt)
