...
title_ja: "RoguePrompt: Dual-Layer Ciphering for Self-Reconstruction to Circumvent LLM Moderation（セキュリティ分析論文）"
description: "RoguePrompt: Dual-Layer Ciphering for Self-Reconstruction to Circumvent LLM Moderation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.18790v3"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-24/2511.18790_meta.json"
  published_date: "2025-11-24T05:42:54Z"
  authors:
    - "Benyamin Tafreshian"
trust:
...
### (日本語題名: RoguePrompt: Dual-Layer Ciphering for Self-Reconstruction to Circumvent LLM Moderation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.18790v3`](https://arxiv.org/abs/2511.18790v3) | Raw Meta = [`2511.18790_meta.json`](../../raw_data/2025-11-24/2511.18790_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「RoguePrompt: Dual-Layer Ciphering for Self-Reconstruction to Circumvent LLM Moderation（セキュリティ分析論文）」（原題: RoguePrompt: Dual-Layer Ciphering for Self-Reconstruction to Circumvent LLM Moderation / arXiv: 2511.18790v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.18790v3`
- **論文URL**: [https://arxiv.org/abs/2511.18790v3](https://arxiv.org/abs/2511.18790v3)
- **PDFリンク**: [https://arxiv.org/pdf/2511.18790v3.pdf](https://arxiv.org/pdf/2511.18790v3.pdf)
- **著者**: Benyamin Tafreshian
- **公開日時**: `2025-11-24T05:42:54Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-24/2511.18790_meta.json) | [`PDF (arXiv)`](https://arxiv.org/pdf/2511.18790v3.pdf) | [`TXT`](../../raw_data/2025-11-24/2511.18790_raw_abstract.txt)
