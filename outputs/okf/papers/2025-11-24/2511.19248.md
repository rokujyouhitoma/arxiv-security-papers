...
title_ja: "FedPoisonTTP: A Threat Model and Poisoning Attack for Federated Test-Time Personalization（セキュリティ分析論文）"
description: "FedPoisonTTP: A Threat Model and Poisoning Attack for Federated Test-Time Personalization（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.19248v1"
tags:
  - "cs.CV"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-24/2511.19248_meta.json"
  published_date: "2025-11-24T16:02:01Z"
  authors:
...
### (日本語題名: FedPoisonTTP: A Threat Model and Poisoning Attack for Federated Test-Time Personalization（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.19248v1`](https://arxiv.org/abs/2511.19248v1) | Raw Meta = [`2511.19248_meta.json`](../../raw_data/2025-11-24/2511.19248_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「FedPoisonTTP: A Threat Model and Poisoning Attack for Federated Test-Time Personalization（セキュリティ分析論文）」（原題: FedPoisonTTP: A Threat Model and Poisoning Attack for Federated Test-Time Personalization / arXiv: 2511.19248v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.19248v1`
- **論文URL**: [https://arxiv.org/abs/2511.19248v1](https://arxiv.org/abs/2511.19248v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.19248v1.pdf](https://arxiv.org/pdf/2511.19248v1.pdf)
- **著者**: Md Akil Raihan Iftee, Syed Md. Ahnaf Hasan, Amin Ahsan Ali, AKM Mahbubur Rahman, Sajib Mistry, Aneesh Krishna
- **公開日時**: `2025-11-24T16:02:01Z`
- **カテゴリ**: `cs.CR, cs.CV`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-24/2511.19248_meta.json) | [`PDF`](../../raw_data/2025-11-24/2511.19248.pdf) | [`TXT`](../../raw_data/2025-11-24/2511.19248.txt)
