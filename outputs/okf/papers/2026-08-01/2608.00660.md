...
title_ja: "Improving the Security of Containerized Workloads using Transparency and Traceability Services（セキュリティ分析論文）"
description: "Improving the Security of Containerized Workloads using Transparency and Traceability Services（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.00660v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-01/2608.00660_meta.json"
  published_date: "2026-08-01T13:25:44Z"
  authors:
    - "Nikos Fotiou"
    - "Lefteris Georgiadis"
    - "Ignacio Lacalle"
...
### (日本語題名: Improving the Security of Containerized Workloads using Transparency and Traceability Services（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.00660v1`](https://arxiv.org/abs/2608.00660v1) | Raw Meta = [`2608.00660_meta.json`](../../raw_data/2026-08-01/2608.00660_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Improving the Security of Containerized Workloads using Transparency and Traceability Services（セキュリティ分析論文）」（原題: Improving the Security of Containerized Workloads using Transparency and Traceability Services / arXiv: 2608.00660v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.00660v1`
- **論文URL**: [https://arxiv.org/abs/2608.00660v1](https://arxiv.org/abs/2608.00660v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.00660v1.pdf](https://arxiv.org/pdf/2608.00660v1.pdf)
- **著者**: Nikos Fotiou, Lefteris Georgiadis, Ignacio Lacalle, George C. Polyzos, Vasilios A. Siris
- **公開日時**: `2026-08-01T13:25:44Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-01/2608.00660_meta.json) | [`PDF`](../../raw_data/2026-08-01/2608.00660.pdf) | [`TXT`](../../raw_data/2026-08-01/2608.00660.txt)
