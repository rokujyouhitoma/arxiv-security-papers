...
description: "【提案】This paper presents the first machine-checked proof of EUF-CMA security for the FS-FS h...。実証評価によりThe proof is parametrised..."
...
本論文「A Machine-Checked EUF-CMA Proof for the Hybrid Fiat-Shamir Signature Scheme（セキュリティ分析論文）」（原題: A Machine-Checked EUF-CMA Proof for the Hybrid Fiat-Shamir Signature Scheme / IACR: 2026-1086）は、cryptography 分野における最新セキュリティ研究成果を取り扱っています。

**概要**: 【提案】This paper presents the first machine-checked proof of EUF-CMA security for the FS-FS h...。実証評価によりThe proof is parametrised...

### 2. 背景とセキュリティ上の課題 (Background & Problem)
【課題・脅威】Hybrid signatures are a practical approach to post-量子 migration, but their security ana...
(主要キーワード: FS-FS hybrid, Shamir Signature Scheme Hybrid, Hybrid Fiat, Machine-Checked EUF)

### 3. 提案アプローチ・技術革新 (Technical Innovation)
【提案技術】This paper presents the first machine-checked proof of EUF-CMA security for the FS-FS h...

### 4. セキュリティ影響と実験結果 (Results & Impact)
【実証・影響】The proof is parametrised over abstract component interfaces and establishes the intend...
...
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-09-02/iacr-2026-1086_meta.json) | [`PDF (arXiv)`](https://eprint.iacr.org/2026/1086.pdf) | [`TXT`](../../raw_data/2026-09-02/iacr-2026-1086_meta.json)
