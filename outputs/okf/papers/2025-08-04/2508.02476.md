...
title_ja: "PoseGuard: Pose-Guided Generation with Safety Guardrails（セキュリティ分析論文）"
description: "PoseGuard: Pose-Guided Generation with Safety Guardrails（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.02476v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-04/2508.02476_meta.json"
  published_date: "2025-08-04T14:42:20Z"
  authors:
    - "Kongxin Wang"
    - "Jie Zhang"
    - "Peigui Qi"
...
### (日本語題名: PoseGuard: Pose-Guided Generation with Safety Guardrails（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.02476v1`](https://arxiv.org/abs/2508.02476v1) | Raw Meta = [`2508.02476_meta.json`](../../raw_data/2025-08-04/2508.02476_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「PoseGuard: Pose-Guided Generation with Safety Guardrails（セキュリティ分析論文）」（原題: PoseGuard: Pose-Guided Generation with Safety Guardrails / arXiv: 2508.02476v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.02476v1`
- **論文URL**: [https://arxiv.org/abs/2508.02476v1](https://arxiv.org/abs/2508.02476v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.02476v1.pdf](https://arxiv.org/pdf/2508.02476v1.pdf)
- **著者**: Kongxin Wang, Jie Zhang, Peigui Qi, Kunsheng Tang, Tianwei Zhang, Wenbo Zhou
- **公開日時**: `2025-08-04T14:42:20Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-04/2508.02476_meta.json) | [`PDF`](../../raw_data/2025-08-04/2508.02476.pdf) | [`TXT`](../../raw_data/2025-08-04/2508.02476.txt)
