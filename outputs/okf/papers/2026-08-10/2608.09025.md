...
resource: "https://arxiv.org/abs/2608.09025v2"
tags:
  - "AI/ML Security"
  - "arXiv"
  - "cs.AI"
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.09025v2`](https://arxiv.org/abs/2608.09025v2) | Raw Meta = [`2608.09025_meta.json`](../../raw_data/2026-08-10/2608.09025_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Context Is Not Authority: Structured Runtime Governance for Financial Market Agents（セキュリティ分析論文）」（原題: Context Is Not Authority: Structured Runtime Governance for Financial Market Agents / arXiv: 2608.09025v2）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.09025v2`
- **論文URL**: [https://arxiv.org/abs/2608.09025v2](https://arxiv.org/abs/2608.09025v2)
- **PDFリンク**: [https://arxiv.org/pdf/2608.09025v2.pdf](https://arxiv.org/pdf/2608.09025v2.pdf)
- **著者**: Rui Tang, Qiangqiang Liu, Yichi Zhang, Youwei Yang, Xi Chen, Chen Dong
