...
title_ja: "Decompiling Smart Contracts with a Large Language Model（セキュリティ分析論文）"
description: "Decompiling Smart Contracts with a Large Language Model（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.19624v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-24/2506.19624_meta.json"
  published_date: "2025-06-24T13:42:59Z"
  authors:
    - "Isaac David"
    - "Liyi Zhou"
    - "Dawn Song"
...
### (日本語題名: Decompiling Smart Contracts with a Large Language Model（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.19624v1`](https://arxiv.org/abs/2506.19624v1) | Raw Meta = [`2506.19624_meta.json`](../../raw_data/2025-06-24/2506.19624_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Decompiling Smart Contracts with a Large Language Model（セキュリティ分析論文）」（原題: Decompiling Smart Contracts with a Large Language Model / arXiv: 2506.19624v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.19624v1`
- **論文URL**: [https://arxiv.org/abs/2506.19624v1](https://arxiv.org/abs/2506.19624v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.19624v1.pdf](https://arxiv.org/pdf/2506.19624v1.pdf)
- **著者**: Isaac David, Liyi Zhou, Dawn Song, Arthur Gervais, Kaihua Qin
- **公開日時**: `2025-06-24T13:42:59Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-24/2506.19624_meta.json) | [`PDF`](../../raw_data/2025-06-24/2506.19624.pdf) | [`TXT`](../../raw_data/2025-06-24/2506.19624.txt)
