...
title_ja: "SafeGenes: Evaluating the Adversarial Robustness of Genomic Foundation Models（セキュリティ分析論文）"
description: "SafeGenes: Evaluating the Adversarial Robustness of Genomic Foundation Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.00821v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-01/2506.00821_meta.json"
  published_date: "2025-06-01T03:54:03Z"
  authors:
    - "Huixin Zhan"
    - "Clovis Barbour"
    - "Jason H. Moore"
...
### (日本語題名: SafeGenes: Evaluating the Adversarial Robustness of Genomic Foundation Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.00821v2`](https://arxiv.org/abs/2506.00821v2) | Raw Meta = [`2506.00821_meta.json`](../../raw_data/2025-06-01/2506.00821_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SafeGenes: Evaluating the Adversarial Robustness of Genomic Foundation Models（セキュリティ分析論文）」（原題: SafeGenes: Evaluating the Adversarial Robustness of Genomic Foundation Models / arXiv: 2506.00821v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.00821v2`
- **論文URL**: [https://arxiv.org/abs/2506.00821v2](https://arxiv.org/abs/2506.00821v2)
- **PDFリンク**: [https://arxiv.org/pdf/2506.00821v2.pdf](https://arxiv.org/pdf/2506.00821v2.pdf)
- **著者**: Huixin Zhan, Clovis Barbour, Jason H. Moore
- **公開日時**: `2025-06-01T03:54:03Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-01/2506.00821_meta.json) | [`PDF`](../../raw_data/2025-06-01/2506.00821.pdf) | [`TXT`](../../raw_data/2025-06-01/2506.00821.txt)
