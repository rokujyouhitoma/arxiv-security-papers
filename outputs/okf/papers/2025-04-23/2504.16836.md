...
title_ja: "Snorkeling in dark waters: A longitudinal surface exploration of unique Tor Hidden Services (Extended Version)（セキュリティ分析論文）"
description: "Snorkeling in dark waters: A longitudinal surface exploration of unique Tor Hidden Services (Extended Version)（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.16836v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-23/2504.16836_meta.json"
  published_date: "2025-04-23T15:59:16Z"
  authors:
...
### (日本語題名: Snorkeling in dark waters: A longitudinal surface exploration of unique Tor Hidden Services (Extended Version)（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.16836v1`](https://arxiv.org/abs/2504.16836v1) | Raw Meta = [`2504.16836_meta.json`](../../raw_data/2025-04-23/2504.16836_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Snorkeling in dark waters: A longitudinal surface exploration of unique Tor Hidden Services (Extended Version)（セキュリティ分析論文）」（原題: Snorkeling in dark waters: A longitudinal surface exploration of unique Tor Hidden Services (Extended Version) / arXiv: 2504.16836v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.16836v1`
- **論文URL**: [https://arxiv.org/abs/2504.16836v1](https://arxiv.org/abs/2504.16836v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.16836v1.pdf](https://arxiv.org/pdf/2504.16836v1.pdf)
- **著者**: Alfonso Rodriguez Barredo-Valenzuela, Sergio Pastrana Portillo, Guillermo Suarez-Tangil
- **公開日時**: `2025-04-23T15:59:16Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-23/2504.16836_meta.json) | [`PDF`](../../raw_data/2025-04-23/2504.16836.pdf) | [`TXT`](../../raw_data/2025-04-23/2504.16836.txt)
