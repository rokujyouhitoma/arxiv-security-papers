...
title_ja: "Cloud Security Leveraging AI: A Fusion-Based AISOC for Malware and Log Behaviour Detection（セキュリティ分析論文）"
description: "Cloud Security Leveraging AI: A Fusion-Based AISOC for Malware and Log Behaviour Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.14935v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-16/2512.14935_meta.json"
  published_date: "2025-12-16T21:56:11Z"
  authors:
...
### (日本語題名: Cloud Security Leveraging AI: A Fusion-Based AISOC for Malware and Log Behaviour Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.14935v1`](https://arxiv.org/abs/2512.14935v1) | Raw Meta = [`2512.14935_meta.json`](../../raw_data/2025-12-16/2512.14935_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Cloud Security Leveraging AI: A Fusion-Based AISOC for Malware and Log Behaviour Detection（セキュリティ分析論文）」（原題: Cloud Security Leveraging AI: A Fusion-Based AISOC for Malware and Log Behaviour Detection / arXiv: 2512.14935v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.14935v1`
- **論文URL**: [https://arxiv.org/abs/2512.14935v1](https://arxiv.org/abs/2512.14935v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.14935v1.pdf](https://arxiv.org/pdf/2512.14935v1.pdf)
- **著者**: Nnamdi Philip Okonkwo, Lubna Luxmi Dhirani
- **公開日時**: `2025-12-16T21:56:11Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-16/2512.14935_meta.json) | [`PDF`](../../raw_data/2025-12-16/2512.14935.pdf) | [`TXT`](../../raw_data/2025-12-16/2512.14935.txt)
