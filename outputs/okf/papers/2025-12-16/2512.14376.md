...
title_ja: "Lost in the Pages: WebAssembly Code Recovery through SEV-SNP's Exposed Address Space（セキュリティ分析論文）"
description: "Lost in the Pages: WebAssembly Code Recovery through SEV-SNP's Exposed Address Space（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.14376v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-16/2512.14376_meta.json"
  published_date: "2025-12-16T13:05:15Z"
  authors:
    - "Markus Berthilsson"
    - "Christian Gehrmann"
trust:
...
### (日本語題名: Lost in the Pages: WebAssembly Code Recovery through SEV-SNP's Exposed Address Space（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.14376v1`](https://arxiv.org/abs/2512.14376v1) | Raw Meta = [`2512.14376_meta.json`](../../raw_data/2025-12-16/2512.14376_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Lost in the Pages: WebAssembly Code Recovery through SEV-SNP's Exposed Address Space（セキュリティ分析論文）」（原題: Lost in the Pages: WebAssembly Code Recovery through SEV-SNP's Exposed Address Space / arXiv: 2512.14376v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.14376v1`
- **論文URL**: [https://arxiv.org/abs/2512.14376v1](https://arxiv.org/abs/2512.14376v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.14376v1.pdf](https://arxiv.org/pdf/2512.14376v1.pdf)
- **著者**: Markus Berthilsson, Christian Gehrmann
- **公開日時**: `2025-12-16T13:05:15Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-16/2512.14376_meta.json) | [`PDF`](../../raw_data/2025-12-16/2512.14376.pdf) | [`TXT`](../../raw_data/2025-12-16/2512.14376.txt)
