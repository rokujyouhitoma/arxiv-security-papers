...
title_ja: "GTI-mSEMP Framework : A Proposed Framework to Simulate Malware Propagation with Inclusion of Attacker-Defender Strategy（セキュリティ分析論文）"
description: "GTI-mSEMP Framework : A Proposed Framework to Simulate Malware Propagation with Inclusion of Attacker-Defender Strategy（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.28079v3"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.GT"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-26/2606.28079_meta.json"
  published_date: "2026-06-26T13:44:12Z"
  authors:
    - "Shadeeb Hossain"
    - "Kristopher Wilson"
trust:
...
### (日本語題名: GTI-mSEMP Framework : A Proposed Framework to Simulate Malware Propagation with Inclusion of Attacker-Defender Strategy（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.28079v3`](https://arxiv.org/abs/2606.28079v3) | Raw Meta = [`2606.28079_meta.json`](../../raw_data/2026-06-26/2606.28079_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「GTI-mSEMP Framework : A Proposed Framework to Simulate Malware Propagation with Inclusion of Attacker-Defender Strategy（セキュリティ分析論文）」（原題: GTI-mSEMP Framework : A Proposed Framework to Simulate Malware Propagation with Inclusion of Attacker-Defender Strategy / arXiv: 2606.28079v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.28079v3`
- **論文URL**: [https://arxiv.org/abs/2606.28079v3](https://arxiv.org/abs/2606.28079v3)
- **PDFリンク**: [https://arxiv.org/pdf/2606.28079v3.pdf](https://arxiv.org/pdf/2606.28079v3.pdf)
- **著者**: Shadeeb Hossain, Kristopher Wilson
- **公開日時**: `2026-06-26T13:44:12Z`
- **カテゴリ**: `cs.CR, cs.GT, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-26/2606.28079_meta.json) | [`PDF`](../../raw_data/2026-06-26/2606.28079.pdf) | [`TXT`](../../raw_data/2026-06-26/2606.28079.txt)
