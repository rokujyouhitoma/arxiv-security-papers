...
title_ja: "Inference-Time Safety For Code LLMs Via Retrieval-Augmented Revision（セキュリティ分析論文）"
description: "Inference-Time Safety For Code LLMs Via Retrieval-Augmented Revision（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.01494v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-02/2603.01494_meta.json"
  published_date: "2026-03-02T06:06:34Z"
  authors:
    - "Manisha Mukherjee"
...
### (日本語題名: Inference-Time Safety For Code LLMs Via Retrieval-Augmented Revision（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.01494v1`](https://arxiv.org/abs/2603.01494v1) | Raw Meta = [`2603.01494_meta.json`](../../raw_data/2026-03-02/2603.01494_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Inference-Time Safety For Code LLMs Via Retrieval-Augmented Revision（セキュリティ分析論文）」（原題: Inference-Time Safety For Code LLMs Via Retrieval-Augmented Revision / arXiv: 2603.01494v1）は、cs.SE 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2603.01494v1](https://arxiv.org/abs/2603.01494v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.01494v1.pdf](https://arxiv.org/pdf/2603.01494v1.pdf)
- **著者**: Manisha Mukherjee, Vincent J. Hellendoorn
- **公開日時**: `2026-03-02T06:06:34Z`
- **カテゴリ**: `cs.SE, cs.AI, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-02/2603.01494_meta.json) | [`PDF`](../../raw_data/2026-03-02/2603.01494.pdf) | [`TXT`](../../raw_data/2026-03-02/2603.01494.txt)
