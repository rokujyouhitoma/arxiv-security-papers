...
title_ja: "SubstratumGraphEnv: Reinforcement Learning Environment (RLE) for Modeling System Attack Paths（セキュリティ分析論文）"
description: "SubstratumGraphEnv: Reinforcement Learning Environment (RLE) for Modeling System Attack Paths（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.01340v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-02/2603.01340_meta.json"
  published_date: "2026-03-02T00:48:24Z"
  authors:
    - "Bahirah Adewunmi"
    - "Edward Raff"
    - "Sanjay Purushotham"
...
### (日本語題名: SubstratumGraphEnv: Reinforcement Learning Environment (RLE) for Modeling System Attack Paths（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.01340v1`](https://arxiv.org/abs/2603.01340v1) | Raw Meta = [`2603.01340_meta.json`](../../raw_data/2026-03-02/2603.01340_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SubstratumGraphEnv: Reinforcement Learning Environment (RLE) for Modeling System Attack Paths（セキュリティ分析論文）」（原題: SubstratumGraphEnv: Reinforcement Learning Environment (RLE) for Modeling System Attack Paths / arXiv: 2603.01340v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.01340v1`
- **論文URL**: [https://arxiv.org/abs/2603.01340v1](https://arxiv.org/abs/2603.01340v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.01340v1.pdf](https://arxiv.org/pdf/2603.01340v1.pdf)
- **著者**: Bahirah Adewunmi, Edward Raff, Sanjay Purushotham
- **公開日時**: `2026-03-02T00:48:24Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-02/2603.01340_meta.json) | [`PDF`](../../raw_data/2026-03-02/2603.01340.pdf) | [`TXT`](../../raw_data/2026-03-02/2603.01340.txt)
