...
title_ja: "When Routine Chats Turn Toxic: Unintended Long-Term State Poisoning in Personalized Agents（セキュリティ分析論文）"
description: "When Routine Chats Turn Toxic: Unintended Long-Term State Poisoning in Personalized Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.06731v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-07/2605.06731_meta.json"
  published_date: "2026-05-07T12:25:16Z"
  authors:
    - "Xiaoyu Xu"
    - "Minxin Du"
    - "Qipeng Xie"
...
### (日本語題名: When Routine Chats Turn Toxic: Unintended Long-Term State Poisoning in Personalized Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.06731v1`](https://arxiv.org/abs/2605.06731v1) | Raw Meta = [`2605.06731_meta.json`](../../raw_data/2026-05-07/2605.06731_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「When Routine Chats Turn Toxic: Unintended Long-Term State Poisoning in Personalized Agents（セキュリティ分析論文）」（原題: When Routine Chats Turn Toxic: Unintended Long-Term State Poisoning in Personalized Agents / arXiv: 2605.06731v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.06731v1`
- **論文URL**: [https://arxiv.org/abs/2605.06731v1](https://arxiv.org/abs/2605.06731v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.06731v1.pdf](https://arxiv.org/pdf/2605.06731v1.pdf)
- **著者**: Xiaoyu Xu, Minxin Du, Qipeng Xie, Haobin Ke, Qingqing Ye, Haibo Hu
- **公開日時**: `2026-05-07T12:25:16Z`
- **カテゴリ**: `cs.CR, cs.CL, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-07/2605.06731_meta.json) | [`PDF`](../../raw_data/2026-05-07/2605.06731.pdf) | [`TXT`](../../raw_data/2026-05-07/2605.06731.txt)
