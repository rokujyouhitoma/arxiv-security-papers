...
title_ja: "Stateful Agent Backdoor（セキュリティ分析論文）"
description: "Stateful Agent Backdoor（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.06158v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-07/2605.06158_meta.json"
  published_date: "2026-05-07T12:48:40Z"
  authors:
    - "Zhengchunmin Dai"
    - "Jiaxiong Tang"
    - "Liantao Wu"
...
### (日本語題名: Stateful Agent Backdoor（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.06158v1`](https://arxiv.org/abs/2605.06158v1) | Raw Meta = [`2605.06158_meta.json`](../../raw_data/2026-05-07/2605.06158_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Stateful Agent Backdoor（セキュリティ分析論文）」（原題: Stateful Agent Backdoor / arXiv: 2605.06158v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.06158v1`
- **論文URL**: [https://arxiv.org/abs/2605.06158v1](https://arxiv.org/abs/2605.06158v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.06158v1.pdf](https://arxiv.org/pdf/2605.06158v1.pdf)
- **著者**: Zhengchunmin Dai, Jiaxiong Tang, Liantao Wu, Peng Sun, Honglong Chen
- **公開日時**: `2026-05-07T12:48:40Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-07/2605.06158_meta.json) | [`PDF`](../../raw_data/2026-05-07/2605.06158.pdf) | [`TXT`](../../raw_data/2026-05-07/2605.06158.txt)
