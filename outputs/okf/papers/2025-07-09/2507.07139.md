...
title_ja: "Image Can Bring Your Memory Back: A Novel Multi-Modal Guided Attack against Image Generation Model Unlearning（セキュリティ分析論文）"
description: "Image Can Bring Your Memory Back: A Novel Multi-Modal Guided Attack against Image Generation Model Unlearning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.07139v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-09/2507.07139_meta.json"
  published_date: "2025-07-09T02:59:01Z"
  authors:
    - "Renyang Liu"
    - "Guanlin Li"
    - "Tianwei Zhang"
...
### (日本語題名: Image Can Bring Your Memory Back: A Novel Multi-Modal Guided Attack against Image Generation Model Unlearning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.07139v2`](https://arxiv.org/abs/2507.07139v2) | Raw Meta = [`2507.07139_meta.json`](../../raw_data/2025-07-09/2507.07139_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Image Can Bring Your Memory Back: A Novel Multi-Modal Guided Attack against Image Generation Model Unlearning（セキュリティ分析論文）」（原題: Image Can Bring Your Memory Back: A Novel Multi-Modal Guided Attack against Image Generation Model Unlearning / arXiv: 2507.07139v2）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.07139v2`
- **論文URL**: [https://arxiv.org/abs/2507.07139v2](https://arxiv.org/abs/2507.07139v2)
- **PDFリンク**: [https://arxiv.org/pdf/2507.07139v2.pdf](https://arxiv.org/pdf/2507.07139v2.pdf)
- **著者**: Renyang Liu, Guanlin Li, Tianwei Zhang, See-Kiong Ng
- **公開日時**: `2025-07-09T02:59:01Z`
- **カテゴリ**: `cs.CV, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-09/2507.07139_meta.json) | [`PDF`](../../raw_data/2025-07-09/2507.07139.pdf) | [`TXT`](../../raw_data/2025-07-09/2507.07139.txt)
