...
title_ja: "No Prompt, No Leaks: A Robust Generative Steganography Framework via Prompt-Free Diffusion（セキュリティ分析論文）"
description: "No Prompt, No Leaks: A Robust Generative Steganography Framework via Prompt-Free Diffusion（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.31427v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-30/2606.31427_meta.json"
  published_date: "2026-06-30T09:51:34Z"
  authors:
    - "Jingwen Cai"
    - "Fen Xiao"
    - "Shuhua Deng"
...
### (日本語題名: No Prompt, No Leaks: A Robust Generative Steganography Framework via Prompt-Free Diffusion（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.31427v1`](https://arxiv.org/abs/2606.31427v1) | Raw Meta = [`2606.31427_meta.json`](../../raw_data/2026-06-30/2606.31427_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「No Prompt, No Leaks: A Robust Generative Steganography Framework via Prompt-Free Diffusion（セキュリティ分析論文）」（原題: No Prompt, No Leaks: A Robust Generative Steganography Framework via Prompt-Free Diffusion / arXiv: 2606.31427v1）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.31427v1`
- **論文URL**: [https://arxiv.org/abs/2606.31427v1](https://arxiv.org/abs/2606.31427v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.31427v1.pdf](https://arxiv.org/pdf/2606.31427v1.pdf)
- **著者**: Jingwen Cai, Fen Xiao, Shuhua Deng, Xieping Gao
- **公開日時**: `2026-06-30T09:51:34Z`
- **カテゴリ**: `cs.CV, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-30/2606.31427_meta.json) | [`PDF`](../../raw_data/2026-06-30/2606.31427.pdf) | [`TXT`](../../raw_data/2026-06-30/2606.31427.txt)
