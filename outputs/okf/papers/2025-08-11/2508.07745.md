...
title_ja: "Chimera: Harnessing Multi-Agent LLMs for Automatic Insider Threat Simulation（セキュリティ分析論文）"
description: "Chimera: Harnessing Multi-Agent LLMs for Automatic Insider Threat Simulation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.07745v4"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-11/2508.07745_meta.json"
  published_date: "2025-08-11T08:24:48Z"
  authors:
    - "Jiongchi Yu"
    - "Xiaofei Xie"
    - "Qiang Hu"
...
### (日本語題名: Chimera: Harnessing Multi-Agent LLMs for Automatic Insider Threat Simulation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.07745v4`](https://arxiv.org/abs/2508.07745v4) | Raw Meta = [`2508.07745_meta.json`](../../raw_data/2025-08-11/2508.07745_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Chimera: Harnessing Multi-Agent LLMs for Automatic Insider Threat Simulation（セキュリティ分析論文）」（原題: Chimera: Harnessing Multi-Agent LLMs for Automatic Insider Threat Simulation / arXiv: 2508.07745v4）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.07745v4`
- **論文URL**: [https://arxiv.org/abs/2508.07745v4](https://arxiv.org/abs/2508.07745v4)
- **PDFリンク**: [https://arxiv.org/pdf/2508.07745v4.pdf](https://arxiv.org/pdf/2508.07745v4.pdf)
- **著者**: Jiongchi Yu, Xiaofei Xie, Qiang Hu, Yuhan Ma, Ziming Zhao
- **公開日時**: `2025-08-11T08:24:48Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-11/2508.07745_meta.json) | [`PDF`](../../raw_data/2025-08-11/2508.07745.pdf) | [`TXT`](../../raw_data/2025-08-11/2508.07745.txt)
