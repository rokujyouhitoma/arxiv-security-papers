...
title_ja: "SPIDER: Two Server Functionality for the Cost of Zero（セキュリティ分析論文）"
description: "SPIDER: Two Server Functionality for the Cost of Zero（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.21857v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-21/2605.21857_meta.json"
  published_date: "2026-05-21T01:08:55Z"
  authors:
    - "Ofir Dvir"
    - "Kali Hale"
    - "Javin Zipkin"
...
### (日本語題名: SPIDER: Two Server Functionality for the Cost of Zero（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.21857v1`](https://arxiv.org/abs/2605.21857v1) | Raw Meta = [`2605.21857_meta.json`](../../raw_data/2026-05-21/2605.21857_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SPIDER: Two Server Functionality for the Cost of Zero（セキュリティ分析論文）」（原題: SPIDER: Two Server Functionality for the Cost of Zero / arXiv: 2605.21857v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.21857v1`
- **論文URL**: [https://arxiv.org/abs/2605.21857v1](https://arxiv.org/abs/2605.21857v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.21857v1.pdf](https://arxiv.org/pdf/2605.21857v1.pdf)
- **著者**: Ofir Dvir, Kali Hale, Javin Zipkin, Divyakant Agrawal, Dahlia Malkhi
- **公開日時**: `2026-05-21T01:08:55Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-21/2605.21857_meta.json) | [`PDF`](../../raw_data/2026-05-21/2605.21857.pdf) | [`TXT`](../../raw_data/2026-05-21/2605.21857.txt)
