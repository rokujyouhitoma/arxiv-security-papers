...
title_ja: "Mechanistic origins of catastrophic forgetting: why RL preserves circuits better than SFT?（セキュリティ分析論文）"
description: "Mechanistic origins of catastrophic forgetting: why RL preserves circuits better than SFT?（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.28860v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-21/2605.28860_meta.json"
  published_date: "2026-05-21T19:03:57Z"
  authors:
...
### (日本語題名: Mechanistic origins of catastrophic forgetting: why RL preserves circuits better than SFT?（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.28860v2`](https://arxiv.org/abs/2605.28860v2) | Raw Meta = [`2605.28860_meta.json`](../../raw_data/2026-05-21/2605.28860_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Mechanistic origins of catastrophic forgetting: why RL preserves circuits better than SFT?（セキュリティ分析論文）」（原題: Mechanistic origins of catastrophic forgetting: why RL preserves circuits better than SFT? / arXiv: 2605.28860v2）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.28860v2`
- **論文URL**: [https://arxiv.org/abs/2605.28860v2](https://arxiv.org/abs/2605.28860v2)
- **PDFリンク**: [https://arxiv.org/pdf/2605.28860v2.pdf](https://arxiv.org/pdf/2605.28860v2.pdf)
- **著者**: Jeanmely Rojas Nunez, Viraj Sawant, Nathan Allen, Nomgondalai Amgalanbaatar, Yannis Zongo, Vasu Sharma, Maheep Chaudhary
- **公開日時**: `2026-05-21T19:03:57Z`
- **カテゴリ**: `cs.LG, cs.AI, cs.CL, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-21/2605.28860_meta.json) | [`PDF`](../../raw_data/2026-05-21/2605.28860.pdf) | [`TXT`](../../raw_data/2026-05-21/2605.28860.txt)
