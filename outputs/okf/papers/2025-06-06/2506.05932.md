...
title_ja: "Combating Reentrancy Bugs on Sharded Blockchains（セキュリティ分析論文）"
description: "Combating Reentrancy Bugs on Sharded Blockchains（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.05932v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-06/2506.05932_meta.json"
  published_date: "2025-06-06T09:57:03Z"
  authors:
    - "Roman Kashitsyn"
    - "Robin Künzler"
    - "Ognjen Marić"
...
### (日本語題名: Combating Reentrancy Bugs on Sharded Blockchains（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.05932v1`](https://arxiv.org/abs/2506.05932v1) | Raw Meta = [`2506.05932_meta.json`](../../raw_data/2025-06-06/2506.05932_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Combating Reentrancy Bugs on Sharded Blockchains（セキュリティ分析論文）」（原題: Combating Reentrancy Bugs on Sharded Blockchains / arXiv: 2506.05932v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.05932v1`
- **論文URL**: [https://arxiv.org/abs/2506.05932v1](https://arxiv.org/abs/2506.05932v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.05932v1.pdf](https://arxiv.org/pdf/2506.05932v1.pdf)
- **著者**: Roman Kashitsyn, Robin Künzler, Ognjen Marić, Lara Schmid
- **公開日時**: `2025-06-06T09:57:03Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-06/2506.05932_meta.json) | [`PDF`](../../raw_data/2025-06-06/2506.05932.pdf) | [`TXT`](../../raw_data/2025-06-06/2506.05932.txt)
