...
title_ja: "T2T: Captioning Smartphone Activities Using Mobile Traffic（セキュリティ分析論文）"
description: "T2T: Captioning Smartphone Activities Using Mobile Traffic（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.05642v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-07/2604.05642_meta.json"
  published_date: "2026-04-07T09:44:27Z"
  authors:
    - "Jiyu Liu"
    - "Yong Huang"
    - "Yanzhao Lu"
...
### (日本語題名: T2T: Captioning Smartphone Activities Using Mobile Traffic（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.05642v1`](https://arxiv.org/abs/2604.05642v1) | Raw Meta = [`2604.05642_meta.json`](../../raw_data/2026-04-07/2604.05642_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「T2T: Captioning Smartphone Activities Using Mobile Traffic（セキュリティ分析論文）」（原題: T2T: Captioning Smartphone Activities Using Mobile Traffic / arXiv: 2604.05642v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.05642v1`
- **論文URL**: [https://arxiv.org/abs/2604.05642v1](https://arxiv.org/abs/2604.05642v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.05642v1.pdf](https://arxiv.org/pdf/2604.05642v1.pdf)
- **著者**: Jiyu Liu, Yong Huang, Yanzhao Lu, Yun Tie, Wanqing Tu
- **公開日時**: `2026-04-07T09:44:27Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-07/2604.05642_meta.json) | [`PDF`](../../raw_data/2026-04-07/2604.05642.pdf) | [`TXT`](../../raw_data/2026-04-07/2604.05642.txt)
