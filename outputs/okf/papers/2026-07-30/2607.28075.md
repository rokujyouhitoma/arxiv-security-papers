...
title_ja: "Temporal Poisoning: Clean-Label Backdoors via Event Redistribution in SNNs（セキュリティ分析論文）"
description: "Temporal Poisoning: Clean-Label Backdoors via Event Redistribution in SNNs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.28075v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-30/2607.28075_meta.json"
  published_date: "2026-07-30T11:49:28Z"
  authors:
    - "Roberto Riaño"
    - "Gorka Abad"
    - "Stjepan Picek"
...
### (日本語題名: Temporal Poisoning: Clean-Label Backdoors via Event Redistribution in SNNs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.28075v1`](https://arxiv.org/abs/2607.28075v1) | Raw Meta = [`2607.28075_meta.json`](../../raw_data/2026-07-30/2607.28075_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Temporal Poisoning: Clean-Label Backdoors via Event Redistribution in SNNs（セキュリティ分析論文）」（原題: Temporal Poisoning: Clean-Label Backdoors via Event Redistribution in SNNs / arXiv: 2607.28075v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2607.28075v1](https://arxiv.org/abs/2607.28075v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.28075v1.pdf](https://arxiv.org/pdf/2607.28075v1.pdf)
- **著者**: Roberto Riaño, Gorka Abad, Stjepan Picek, Aitor Urbieta
- **公開日時**: `2026-07-30T11:49:28Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-30/2607.28075_meta.json) | [`PDF`](../../raw_data/2026-07-30/2607.28075.pdf) | [`TXT`](../../raw_data/2026-07-30/2607.28075.txt)
