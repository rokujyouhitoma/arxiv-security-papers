...
title_ja: "Benign on Label, Malicious by Design: Clean-Label Dormant-to-Activated Backdoor via Machine Unlearning with Removable Camouflage（セキュリティ分析論文）"
description: "Benign on Label, Malicious by Design: Clean-Label Dormant-to-Activated Backdoor via Machine Unlearning with Removable Camouflage（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.27936v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-30/2607.27936_meta.json"
  published_date: "2026-07-30T09:46:02Z"
  authors:
    - "Dongdong Zhao"
    - "Can Li"
    - "Xiang Yao"
...
### (日本語題名: Benign on Label, Malicious by Design: Clean-Label Dormant-to-Activated Backdoor via Machine Unlearning with Removable Camouflage（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.27936v1`](https://arxiv.org/abs/2607.27936v1) | Raw Meta = [`2607.27936_meta.json`](../../raw_data/2026-07-30/2607.27936_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Benign on Label, Malicious by Design: Clean-Label Dormant-to-Activated Backdoor via Machine Unlearning with Removable Camouflage（セキュリティ分析論文）」（原題: Benign on Label, Malicious by Design: Clean-Label Dormant-to-Activated Backdoor via Machine Unlearning with Removable Camouflage / arXiv: 2607.27936v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.27936v1`
- **論文URL**: [https://arxiv.org/abs/2607.27936v1](https://arxiv.org/abs/2607.27936v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.27936v1.pdf](https://arxiv.org/pdf/2607.27936v1.pdf)
- **著者**: Dongdong Zhao, Can Li, Xiang Yao, Fan He, Qihang Ge, Baogang Song
- **公開日時**: `2026-07-30T09:46:02Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-30/2607.27936_meta.json) | [`PDF`](../../raw_data/2026-07-30/2607.27936.pdf) | [`TXT`](../../raw_data/2026-07-30/2607.27936.txt)
