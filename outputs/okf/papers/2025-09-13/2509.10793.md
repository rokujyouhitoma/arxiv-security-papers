...
title_ja: "ORQ: Complex Analytics on Private Data with Strong Security Guarantees（セキュリティ分析論文）"
description: "ORQ: Complex Analytics on Private Data with Strong Security Guarantees（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.10793v2"
tags:
  - "cs.DB"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-13/2509.10793_meta.json"
  published_date: "2025-09-13T03:19:01Z"
  authors:
    - "Eli Baum"
    - "Sam Buxbaum"
    - "Nitin Mathai"
...
### (日本語題名: ORQ: Complex Analytics on Private Data with Strong Security Guarantees（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.10793v2`](https://arxiv.org/abs/2509.10793v2) | Raw Meta = [`2509.10793_meta.json`](../../raw_data/2025-09-13/2509.10793_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ORQ: Complex Analytics on Private Data with Strong Security Guarantees（セキュリティ分析論文）」（原題: ORQ: Complex Analytics on Private Data with Strong Security Guarantees / arXiv: 2509.10793v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.10793v2`
- **論文URL**: [https://arxiv.org/abs/2509.10793v2](https://arxiv.org/abs/2509.10793v2)
- **PDFリンク**: [https://arxiv.org/pdf/2509.10793v2.pdf](https://arxiv.org/pdf/2509.10793v2.pdf)
- **著者**: Eli Baum, Sam Buxbaum, Nitin Mathai, Muhammad Faisal, Vasiliki Kalavri, Mayank Varia, John Liagouris
- **公開日時**: `2025-09-13T03:19:01Z`
- **カテゴリ**: `cs.CR, cs.DB`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-13/2509.10793_meta.json) | [`PDF`](../../raw_data/2025-09-13/2509.10793.pdf) | [`TXT`](../../raw_data/2025-09-13/2509.10793.txt)
