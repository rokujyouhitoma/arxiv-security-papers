...
title_ja: "Following Dragons: Code Review-Guided Fuzzing（セキュリティ分析論文）"
description: "Following Dragons: Code Review-Guided Fuzzing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.10487v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-11/2602.10487_meta.json"
  published_date: "2026-02-11T03:46:57Z"
  authors:
    - "Viet Hoang Luu"
    - "Amirmohammad Pasdar"
...
### (日本語題名: Following Dragons: Code Review-Guided Fuzzing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.10487v1`](https://arxiv.org/abs/2602.10487v1) | Raw Meta = [`2602.10487_meta.json`](../../raw_data/2026-02-11/2602.10487_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Following Dragons: Code Review-Guided Fuzzing（セキュリティ分析論文）」（原題: Following Dragons: Code Review-Guided Fuzzing / arXiv: 2602.10487v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.10487v1`
- **論文URL**: [https://arxiv.org/abs/2602.10487v1](https://arxiv.org/abs/2602.10487v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.10487v1.pdf](https://arxiv.org/pdf/2602.10487v1.pdf)
- **著者**: Viet Hoang Luu, Amirmohammad Pasdar, Wachiraphan Charoenwet, Toby Murray, Shaanan Cohney, Van-Thuan Pham
- **公開日時**: `2026-02-11T03:46:57Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-11/2602.10487_meta.json) | [`PDF`](../../raw_data/2026-02-11/2602.10487.pdf) | [`TXT`](../../raw_data/2026-02-11/2602.10487.txt)
