---
type: "security-paper"
title: "$\mathsf{CRATE}$: Cross-Rollup Atomic Transaction Execution"
title_ja: "$\mathsf{CRATE}$: Cross-Rollup Atomic Transaction Execution（セキュリティ分析論文）"
description: "$\mathsf{CRATE}$: Cross-Rollup Atomic Transaction Execution（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.04659v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-07/2502.04659_meta.json"
  published_date: "2025-02-07T04:58:59Z"
  authors:
    - "Ioannis Kaklamanis"
    - "Fan Zhang"
trust:
...
### (日本語題名: $\mathsf{CRATE}$: Cross-Rollup Atomic Transaction Execution（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.04659v1`](https://arxiv.org/abs/2502.04659v1) | Raw Meta = [`2502.04659_meta.json`](../../raw_data/2025-02-07/2502.04659_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「$\mathsf{CRATE}$: Cross-Rollup Atomic Transaction Execution（セキュリティ分析論文）」（原題: $\mathsf{CRATE}$: Cross-Rollup Atomic Transaction Execution / arXiv: 2502.04659v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.04659v1`
- **論文URL**: [https://arxiv.org/abs/2502.04659v1](https://arxiv.org/abs/2502.04659v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.04659v1.pdf](https://arxiv.org/pdf/2502.04659v1.pdf)
- **著者**: Ioannis Kaklamanis, Fan Zhang
- **公開日時**: `2025-02-07T04:58:59Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-07/2502.04659_meta.json) | [`PDF`](../../raw_data/2025-02-07/2502.04659.pdf) | [`TXT`](../../raw_data/2025-02-07/2502.04659.txt)
