...
title_ja: "CyberThreat-Eval: Can 大規模言語モデル Automate Real-World Threat Research?"
description: "CyberThreat-Eval: Can 大規模言語モデル Automate Real-World Threat Research? — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.09452v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-10/2603.09452_meta.json"
  published_date: "2026-03-10T10:04:12Z"
  authors:
    - "Xiangsen Chen"
    - "Xuan Feng"
    - "Shuo Chen"
...
### (日本語題名: CyberThreat-Eval: Can 大規模言語モデル Automate Real-World Threat Research?)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.09452v1`](https://arxiv.org/abs/2603.09452v1) | Raw Meta = [`2603.09452_meta.json`](../../raw_data/2026-03-10/2603.09452_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「CyberThreat-Eval: Can 大規模言語モデル Automate Real-World Threat Research?」（原題: CyberThreat-Eval: Can Large Language Models Automate Real-World Threat Research? / arXiv: 2603.09452v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2603.09452v1](https://arxiv.org/abs/2603.09452v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.09452v1.pdf](https://arxiv.org/pdf/2603.09452v1.pdf)
- **著者**: Xiangsen Chen, Xuan Feng, Shuo Chen, Matthieu Maitre, Sudipto Rakshit, Diana Duvieilh, Ashley Picone, Nan Tang
- **公開日時**: `2026-03-10T10:04:12Z`
- **カテゴリ**: `cs.CR, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-10/2603.09452_meta.json) | [`PDF`](../../raw_data/2026-03-10/2603.09452.pdf) | [`TXT`](../../raw_data/2026-03-10/2603.09452.txt)
