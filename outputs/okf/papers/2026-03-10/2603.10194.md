...
title_ja: "MCP-in-SoS: Risk assessment framework for open-source MCP servers（セキュリティ分析論文）"
description: "MCP-in-SoS: Risk assessment framework for open-source MCP servers（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.10194v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-10/2603.10194_meta.json"
  published_date: "2026-03-10T19:38:17Z"
  authors:
    - "Pratyay Kumar"
...
### (日本語題名: MCP-in-SoS: Risk assessment framework for open-source MCP servers（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.10194v1`](https://arxiv.org/abs/2603.10194v1) | Raw Meta = [`2603.10194_meta.json`](../../raw_data/2026-03-10/2603.10194_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MCP-in-SoS: Risk assessment framework for open-source MCP servers（セキュリティ分析論文）」（原題: MCP-in-SoS: Risk assessment framework for open-source MCP servers / arXiv: 2603.10194v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.10194v1`
- **論文URL**: [https://arxiv.org/abs/2603.10194v1](https://arxiv.org/abs/2603.10194v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.10194v1.pdf](https://arxiv.org/pdf/2603.10194v1.pdf)
- **著者**: Pratyay Kumar, Miguel Antonio Guirao Aguilera, Srikathyayani Srikanteswara, Satyajayant Misra, Abu Saleh Md Tayeen
- **公開日時**: `2026-03-10T19:38:17Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-10/2603.10194_meta.json) | [`PDF`](../../raw_data/2026-03-10/2603.10194.pdf) | [`TXT`](../../raw_data/2026-03-10/2603.10194.txt)
