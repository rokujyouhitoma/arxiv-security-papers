...
title_ja: "MM-FusionNet: Context-Aware Dynamic Fusion for Multi-modal Fake News Detection with Large Vision-Language Models（セキュリティ分析論文）"
description: "MM-FusionNet: Context-Aware Dynamic Fusion for Multi-modal Fake News Detection with Large Vision-Language Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.05684v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-05/2508.05684_meta.json"
  published_date: "2025-08-05T21:27:13Z"
  authors:
    - "Junhao He"
    - "Tianyu Liu"
    - "Jingyuan Zhao"
...
### (日本語題名: MM-FusionNet: Context-Aware Dynamic Fusion for Multi-modal Fake News Detection with Large Vision-Language Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.05684v1`](https://arxiv.org/abs/2508.05684v1) | Raw Meta = [`2508.05684_meta.json`](../../raw_data/2025-08-05/2508.05684_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MM-FusionNet: Context-Aware Dynamic Fusion for Multi-modal Fake News Detection with Large Vision-Language Models（セキュリティ分析論文）」（原題: MM-FusionNet: Context-Aware Dynamic Fusion for Multi-modal Fake News Detection with Large Vision-Language Models / arXiv: 2508.05684v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.05684v1`
- **論文URL**: [https://arxiv.org/abs/2508.05684v1](https://arxiv.org/abs/2508.05684v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.05684v1.pdf](https://arxiv.org/pdf/2508.05684v1.pdf)
- **著者**: Junhao He, Tianyu Liu, Jingyuan Zhao, Benjamin Turner
- **公開日時**: `2025-08-05T21:27:13Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-05/2508.05684_meta.json) | [`PDF`](../../raw_data/2025-08-05/2508.05684.pdf) | [`TXT`](../../raw_data/2025-08-05/2508.05684.txt)
