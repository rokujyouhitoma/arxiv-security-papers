...
title_ja: "When Friction Helps: Transaction Confirmation Improves Decision Quality in Blockchain Interactions（セキュリティ分析論文）"
description: "When Friction Helps: Transaction Confirmation Improves Decision Quality in Blockchain Interactions（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.18834v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-21/2602.18834_meta.json"
  published_date: "2026-02-21T13:32:14Z"
  authors:
    - "Eason Chen"
    - "Xinyi Tang"
    - "George Digkas"
...
### (日本語題名: When Friction Helps: Transaction Confirmation Improves Decision Quality in Blockchain Interactions（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.18834v1`](https://arxiv.org/abs/2602.18834v1) | Raw Meta = [`2602.18834_meta.json`](../../raw_data/2026-02-21/2602.18834_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「When Friction Helps: Transaction Confirmation Improves Decision Quality in Blockchain Interactions（セキュリティ分析論文）」（原題: When Friction Helps: Transaction Confirmation Improves Decision Quality in Blockchain Interactions / arXiv: 2602.18834v1）は、cs.HC 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.18834v1`
- **論文URL**: [https://arxiv.org/abs/2602.18834v1](https://arxiv.org/abs/2602.18834v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.18834v1.pdf](https://arxiv.org/pdf/2602.18834v1.pdf)
- **著者**: Eason Chen, Xinyi Tang, George Digkas, Dionysios Lougaris, John E. Naulty, Kostas Chalkias
- **公開日時**: `2026-02-21T13:32:14Z`
- **カテゴリ**: `cs.HC, cs.CR, cs.CY`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-21/2602.18834_meta.json) | [`PDF`](../../raw_data/2026-02-21/2602.18834.pdf) | [`TXT`](../../raw_data/2026-02-21/2602.18834.txt)
