...
title_ja: "AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing（セキュリティ分析論文）"
description: "AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.04760v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-06/2605.04760_meta.json"
  published_date: "2026-05-06T11:07:24Z"
  authors:
    - "Jiaying Meng"
    - "Xuewei Feng"
    - "Qi Li"
...
### (日本語題名: AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.04760v1`](https://arxiv.org/abs/2605.04760v1) | Raw Meta = [`2605.04760_meta.json`](../../raw_data/2026-05-06/2605.04760_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing（セキュリティ分析論文）」（原題: AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing / arXiv: 2605.04760v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2605.04760v1](https://arxiv.org/abs/2605.04760v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.04760v1.pdf](https://arxiv.org/pdf/2605.04760v1.pdf)
- **著者**: Jiaying Meng, Xuewei Feng, Qi Li, Min Liu, Ke Xu
- **公開日時**: `2026-05-06T11:07:24Z`
- **カテゴリ**: `cs.CR, cs.NI, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-06/2605.04760_meta.json) | [`PDF`](../../raw_data/2026-05-06/2605.04760.pdf) | [`TXT`](../../raw_data/2026-05-06/2605.04760.txt)
