...
title_ja: "Unveiling Malicious Logic: a Statement-Level Taxonomy and Dataset for Securing Python Packagesに向けて"
description: "Unveiling Malicious Logic: a Statement-Level Taxonomy and Dataset for Securing Python Packagesに向けて — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.12559v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-14/2512.12559_meta.json"
  published_date: "2025-12-14T05:28:30Z"
  authors:
    - "Ahmed Ryan"
    - "Junaid Mansur Ifti"
    - "Md Erfan"
...
### (日本語題名: Unveiling Malicious Logic: a Statement-Level Taxonomy and Dataset for Securing Python Packagesに向けて)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.12559v1`](https://arxiv.org/abs/2512.12559v1) | Raw Meta = [`2512.12559_meta.json`](../../raw_data/2025-12-14/2512.12559_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Unveiling Malicious Logic: a Statement-Level Taxonomy and Dataset for Securing Python Packagesに向けて」（原題: Unveiling Malicious Logic: Towards a Statement-Level Taxonomy and Dataset for Securing Python Packages / arXiv: 2512.12559v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.12559v1`
- **論文URL**: [https://arxiv.org/abs/2512.12559v1](https://arxiv.org/abs/2512.12559v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.12559v1.pdf](https://arxiv.org/pdf/2512.12559v1.pdf)
- **著者**: Ahmed Ryan, Junaid Mansur Ifti, Md Erfan, Akond Ashfaque Ur Rahman, Md Rayhanur Rahman
- **公開日時**: `2025-12-14T05:28:30Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-14/2512.12559_meta.json) | [`PDF`](../../raw_data/2025-12-14/2512.12559.pdf) | [`TXT`](../../raw_data/2025-12-14/2512.12559.txt)
