...
title_ja: "CODE ACROSTIC: Robust Watermarking for Code Generation（セキュリティ分析論文）"
description: "CODE ACROSTIC: Robust Watermarking for Code Generation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.14753v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-14/2512.14753_meta.json"
  published_date: "2025-12-14T19:14:54Z"
  authors:
    - "Li Lin"
    - "Siyuan Xin"
    - "Yang Cao"
...
### (日本語題名: CODE ACROSTIC: Robust Watermarking for Code Generation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.14753v1`](https://arxiv.org/abs/2512.14753v1) | Raw Meta = [`2512.14753_meta.json`](../../raw_data/2025-12-14/2512.14753_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「CODE ACROSTIC: Robust Watermarking for Code Generation（セキュリティ分析論文）」（原題: CODE ACROSTIC: Robust Watermarking for Code Generation / arXiv: 2512.14753v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.14753v1`
- **論文URL**: [https://arxiv.org/abs/2512.14753v1](https://arxiv.org/abs/2512.14753v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.14753v1.pdf](https://arxiv.org/pdf/2512.14753v1.pdf)
- **著者**: Li Lin, Siyuan Xin, Yang Cao, Xiaochun Cao
- **公開日時**: `2025-12-14T19:14:54Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-14/2512.14753_meta.json) | [`PDF`](../../raw_data/2025-12-14/2512.14753.pdf) | [`TXT`](../../raw_data/2025-12-14/2512.14753.txt)
