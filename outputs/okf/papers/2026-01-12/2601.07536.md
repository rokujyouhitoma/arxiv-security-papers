...
title_ja: "A Protocol-Aware P4 Pipeline for MQTT Security and Anomaly Mitigation in Edge IoT Systems（セキュリティ分析論文）"
description: "A Protocol-Aware P4 Pipeline for MQTT Security and Anomaly Mitigation in Edge IoT Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.07536v1"
tags:
  - "cs.NI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-12/2601.07536_meta.json"
  published_date: "2026-01-12T13:38:59Z"
  authors:
    - "Bui Ngoc Thanh Binh"
    - "Pham Hoai Luan"
    - "Le Vu Trung Duong"
...
### (日本語題名: A Protocol-Aware P4 Pipeline for MQTT Security and Anomaly Mitigation in Edge IoT Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.07536v1`](https://arxiv.org/abs/2601.07536v1) | Raw Meta = [`2601.07536_meta.json`](../../raw_data/2026-01-12/2601.07536_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Protocol-Aware P4 Pipeline for MQTT Security and Anomaly Mitigation in Edge IoT Systems（セキュリティ分析論文）」（原題: A Protocol-Aware P4 Pipeline for MQTT Security and Anomaly Mitigation in Edge IoT Systems / arXiv: 2601.07536v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.07536v1`
- **論文URL**: [https://arxiv.org/abs/2601.07536v1](https://arxiv.org/abs/2601.07536v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.07536v1.pdf](https://arxiv.org/pdf/2601.07536v1.pdf)
- **著者**: Bui Ngoc Thanh Binh, Pham Hoai Luan, Le Vu Trung Duong, Vu Tuan Hai, Yasuhiko Nakashima
- **公開日時**: `2026-01-12T13:38:59Z`
- **カテゴリ**: `cs.CR, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-12/2601.07536_meta.json) | [`PDF`](../../raw_data/2026-01-12/2601.07536.pdf) | [`TXT`](../../raw_data/2026-01-12/2601.07536.txt)
