...
title_ja: "Dual-Guard: Dual-Channel Latent Watermarking for Provenance and Tamper Localization in Diffusion Images（セキュリティ分析論文）"
description: "Dual-Guard: Dual-Channel Latent Watermarking for Provenance and Tamper Localization in Diffusion Images（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.19090v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-21/2604.19090_meta.json"
  published_date: "2026-04-21T05:03:42Z"
  authors:
    - "JinFeng Xie"
    - "Chengfu Ou"
    - "Peipeng Yu"
...
### (日本語題名: Dual-Guard: Dual-Channel Latent Watermarking for Provenance and Tamper Localization in Diffusion Images（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.19090v1`](https://arxiv.org/abs/2604.19090v1) | Raw Meta = [`2604.19090_meta.json`](../../raw_data/2026-04-21/2604.19090_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Dual-Guard: Dual-Channel Latent Watermarking for Provenance and Tamper Localization in Diffusion Images（セキュリティ分析論文）」（原題: Dual-Guard: Dual-Channel Latent Watermarking for Provenance and Tamper Localization in Diffusion Images / arXiv: 2604.19090v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.19090v1`
- **論文URL**: [https://arxiv.org/abs/2604.19090v1](https://arxiv.org/abs/2604.19090v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.19090v1.pdf](https://arxiv.org/pdf/2604.19090v1.pdf)
- **著者**: JinFeng Xie, Chengfu Ou, Peipeng Yu, Xiaoyu Zhou, Dingding Huang, Jianwei Fei, Zixuan Shen, Zhihua Xia
- **公開日時**: `2026-04-21T05:03:42Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-21/2604.19090_meta.json) | [`PDF`](../../raw_data/2026-04-21/2604.19090.pdf) | [`TXT`](../../raw_data/2026-04-21/2604.19090.txt)
