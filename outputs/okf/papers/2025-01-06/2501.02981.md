...
title_ja: "CONTINUUM: Detecting APT Attacks through Spatial-Temporal Graph Neural Networks（セキュリティ分析論文）"
description: "CONTINUUM: Detecting APT Attacks through Spatial-Temporal Graph Neural Networks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.02981v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-06/2501.02981_meta.json"
  published_date: "2025-01-06T12:43:59Z"
  authors:
...
### (日本語題名: CONTINUUM: Detecting APT Attacks through Spatial-Temporal Graph Neural Networks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.02981v2`](https://arxiv.org/abs/2501.02981v2) | Raw Meta = [`2501.02981_meta.json`](../../raw_data/2025-01-06/2501.02981_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「CONTINUUM: Detecting APT Attacks through Spatial-Temporal Graph Neural Networks（セキュリティ分析論文）」（原題: CONTINUUM: Detecting APT Attacks through Spatial-Temporal Graph Neural Networks / arXiv: 2501.02981v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.02981v2`
- **論文URL**: [https://arxiv.org/abs/2501.02981v2](https://arxiv.org/abs/2501.02981v2)
- **PDFリンク**: [https://arxiv.org/pdf/2501.02981v2.pdf](https://arxiv.org/pdf/2501.02981v2.pdf)
- **著者**: Atmane Ayoub Mansour Bahar, Kamel Soaid Ferrahi, Mohamed-Lamine Messai, Hamida Seba, Karima Amrouche
- **公開日時**: `2025-01-06T12:43:59Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-06/2501.02981_meta.json) | [`PDF`](../../raw_data/2025-01-06/2501.02981.pdf) | [`TXT`](../../raw_data/2025-01-06/2501.02981.txt)
