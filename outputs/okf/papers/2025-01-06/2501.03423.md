...
title_ja: "SoK: A Review of Cross-Chain Bridge Hacks in 2023（セキュリティ分析論文）"
description: "SoK: A Review of Cross-Chain Bridge Hacks in 2023（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.03423v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-06/2501.03423_meta.json"
  published_date: "2025-01-06T23:05:14Z"
  authors:
    - "Nikita Belenkov"
    - "Valerian Callens"
    - "Alexandr Murashkin"
...
### (日本語題名: SoK: A Review of Cross-Chain Bridge Hacks in 2023（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.03423v1`](https://arxiv.org/abs/2501.03423v1) | Raw Meta = [`2501.03423_meta.json`](../../raw_data/2025-01-06/2501.03423_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SoK: A Review of Cross-Chain Bridge Hacks in 2023（セキュリティ分析論文）」（原題: SoK: A Review of Cross-Chain Bridge Hacks in 2023 / arXiv: 2501.03423v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.03423v1`
- **論文URL**: [https://arxiv.org/abs/2501.03423v1](https://arxiv.org/abs/2501.03423v1)
- **PDFリンク**: [https://arxiv.org/pdf/2501.03423v1.pdf](https://arxiv.org/pdf/2501.03423v1.pdf)
- **著者**: Nikita Belenkov, Valerian Callens, Alexandr Murashkin, Kacper Bak, Martin Derka, Jan Gorzny, Sung-Shine Lee
- **公開日時**: `2025-01-06T23:05:14Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-06/2501.03423_meta.json) | [`PDF`](../../raw_data/2025-01-06/2501.03423.pdf) | [`TXT`](../../raw_data/2025-01-06/2501.03423.txt)
