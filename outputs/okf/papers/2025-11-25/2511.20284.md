...
title_ja: "Can LLMs Make (Personalized) Access Control Decisions?（セキュリティ分析論文）"
description: "Can LLMs Make (Personalized) Access Control Decisions?（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.20284v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-25/2511.20284_meta.json"
  published_date: "2025-11-25T13:11:23Z"
  authors:
...
### (日本語題名: Can LLMs Make (Personalized) Access Control Decisions?（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.20284v2`](https://arxiv.org/abs/2511.20284v2) | Raw Meta = [`2511.20284_meta.json`](../../raw_data/2025-11-25/2511.20284_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Can LLMs Make (Personalized) Access Control Decisions?（セキュリティ分析論文）」（原題: Can LLMs Make (Personalized) Access Control Decisions? / arXiv: 2511.20284v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.20284v2`
- **論文URL**: [https://arxiv.org/abs/2511.20284v2](https://arxiv.org/abs/2511.20284v2)
- **PDFリンク**: [https://arxiv.org/pdf/2511.20284v2.pdf](https://arxiv.org/pdf/2511.20284v2.pdf)
- **著者**: Friederike Groschupp, Daniele Lain, Aritra Dhar, Lara Magdalena Lazier, Srdjan Čapkun
- **公開日時**: `2025-11-25T13:11:23Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-25/2511.20284_meta.json) | [`PDF`](../../raw_data/2025-11-25/2511.20284.pdf) | [`TXT`](../../raw_data/2025-11-25/2511.20284.txt)
