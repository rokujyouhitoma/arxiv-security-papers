...
title_ja: "Beyond DNS: Unlocking the Internet of AI Agents via the NANDA Index and Verified AgentFacts（セキュリティ分析論文）"
description: "Beyond DNS: Unlocking the Internet of AI Agents via the NANDA Index and Verified AgentFacts（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.14263v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-18/2507.14263_meta.json"
  published_date: "2025-07-18T13:40:46Z"
  authors:
    - "Ramesh Raskar"
    - "Pradyumna Chari"
    - "John Zinky"
...
### (日本語題名: Beyond DNS: Unlocking the Internet of AI Agents via the NANDA Index and Verified AgentFacts（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.14263v1`](https://arxiv.org/abs/2507.14263v1) | Raw Meta = [`2507.14263_meta.json`](../../raw_data/2025-07-18/2507.14263_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Beyond DNS: Unlocking the Internet of AI Agents via the NANDA Index and Verified AgentFacts（セキュリティ分析論文）」（原題: Beyond DNS: Unlocking the Internet of AI Agents via the NANDA Index and Verified AgentFacts / arXiv: 2507.14263v1）は、cs.NI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.14263v1`
- **論文URL**: [https://arxiv.org/abs/2507.14263v1](https://arxiv.org/abs/2507.14263v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.14263v1.pdf](https://arxiv.org/pdf/2507.14263v1.pdf)
- **著者**: Ramesh Raskar, Pradyumna Chari, John Zinky, Mahesh Lambe, Jared James Grogan, Sichao Wang, Rajesh Ranjan, Rekha Singhal, Shailja Gupta, Robert Lincourt, Raghu Bala, Aditi Joshi, Abhishek Singh, Ayush Chopra, Dimitris Stripelis, Bhuwan B, Sumit Kumar, Maria Gorskikh
- **公開日時**: `2025-07-18T13:40:46Z`
- **カテゴリ**: `cs.NI, cs.AI, cs.CR, cs.MA`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-18/2507.14263_meta.json) | [`PDF`](../../raw_data/2025-07-18/2507.14263.pdf) | [`TXT`](../../raw_data/2025-07-18/2507.14263.txt)
