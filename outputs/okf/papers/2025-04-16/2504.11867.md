...
title_ja: "MDHP-Net: Detecting an Emerging Time-exciting Threat in IVN（セキュリティ分析論文）"
description: "MDHP-Net: Detecting an Emerging Time-exciting Threat in IVN（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.11867v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-16/2504.11867_meta.json"
  published_date: "2025-04-16T08:41:24Z"
  authors:
    - "Qi Liu"
    - "Yanchen Liu"
    - "Ruifeng Li"
...
### (日本語題名: MDHP-Net: Detecting an Emerging Time-exciting Threat in IVN（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.11867v2`](https://arxiv.org/abs/2504.11867v2) | Raw Meta = [`2504.11867_meta.json`](../../raw_data/2025-04-16/2504.11867_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MDHP-Net: Detecting an Emerging Time-exciting Threat in IVN（セキュリティ分析論文）」（原題: MDHP-Net: Detecting an Emerging Time-exciting Threat in IVN / arXiv: 2504.11867v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.11867v2`
- **論文URL**: [https://arxiv.org/abs/2504.11867v2](https://arxiv.org/abs/2504.11867v2)
- **PDFリンク**: [https://arxiv.org/pdf/2504.11867v2.pdf](https://arxiv.org/pdf/2504.11867v2.pdf)
- **著者**: Qi Liu, Yanchen Liu, Ruifeng Li, Chenhong Cao, Yufeng Li, Xingyu Li, Peng Wang, Runhan Feng, Shiyang Bu
- **公開日時**: `2025-04-16T08:41:24Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-16/2504.11867_meta.json) | [`PDF (arXiv)`](https://arxiv.org/pdf/2504.11867v2.pdf) | [`TXT`](../../raw_data/2025-04-16/2504.11867_raw_abstract.txt)
