...
title_ja: "Solving the Post-Quantum Control Plane Bottleneck: Energy-Aware Cryptographic Scheduling in Open RAN（セキュリティ分析論文）"
description: "Solving the Post-Quantum Control Plane Bottleneck: Energy-Aware Cryptographic Scheduling in Open RAN（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.11820v1"
tags:
  - "executive-summary"
  - "eess.SY"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-12/2602.11820_meta.json"
  published_date: "2026-02-12T10:58:54Z"
  authors:
    - "Neha Gupta"
    - "Hamed Alimohammadi"
    - "Mohammad Shojafar"
...
### (日本語題名: Solving the Post-Quantum Control Plane Bottleneck: Energy-Aware Cryptographic Scheduling in Open RAN（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.11820v1`](https://arxiv.org/abs/2602.11820v1) | Raw Meta = [`2602.11820_meta.json`](../../raw_data/2026-02-12/2602.11820_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Solving the Post-Quantum Control Plane Bottleneck: Energy-Aware Cryptographic Scheduling in Open RAN（セキュリティ分析論文）」（原題: Solving the Post-Quantum Control Plane Bottleneck: Energy-Aware Cryptographic Scheduling in Open RAN / arXiv: 2602.11820v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.11820v1`
- **論文URL**: [https://arxiv.org/abs/2602.11820v1](https://arxiv.org/abs/2602.11820v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.11820v1.pdf](https://arxiv.org/pdf/2602.11820v1.pdf)
- **著者**: Neha Gupta, Hamed Alimohammadi, Mohammad Shojafar, De Mi, Muhammad N. M. Bhutta
- **公開日時**: `2026-02-12T10:58:54Z`
- **カテゴリ**: `cs.CR, eess.SY`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-12/2602.11820_meta.json) | [`PDF`](../../raw_data/2026-02-12/2602.11820.pdf) | [`TXT`](../../raw_data/2026-02-12/2602.11820.txt)
