...
title_ja: "Knowledge Base Poisoning Attacks and Defense for Policy-Aware LLM-RAG Framework（セキュリティ分析論文）"
description: "Knowledge Base Poisoning Attacks and Defense for Policy-Aware LLM-RAG Framework（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.04379v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-05/2607.04379_meta.json"
  published_date: "2026-07-05T16:12:16Z"
  authors:
    - "Om Solanki"
    - "Lopamudra Praharaj"
    - "Deepti Gupta"
...
### (日本語題名: Knowledge Base Poisoning Attacks and Defense for Policy-Aware LLM-RAG Framework（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.04379v1`](https://arxiv.org/abs/2607.04379v1) | Raw Meta = [`2607.04379_meta.json`](../../raw_data/2026-07-05/2607.04379_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Knowledge Base Poisoning Attacks and Defense for Policy-Aware LLM-RAG Framework（セキュリティ分析論文）」（原題: Knowledge Base Poisoning Attacks and Defense for Policy-Aware LLM-RAG Framework / arXiv: 2607.04379v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.04379v1`
- **論文URL**: [https://arxiv.org/abs/2607.04379v1](https://arxiv.org/abs/2607.04379v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.04379v1.pdf](https://arxiv.org/pdf/2607.04379v1.pdf)
- **著者**: Om Solanki, Lopamudra Praharaj, Deepti Gupta, Maanak Gupta
- **公開日時**: `2026-07-05T16:12:16Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-05/2607.04379_meta.json) | [`PDF`](../../raw_data/2026-07-05/2607.04379.pdf) | [`TXT`](../../raw_data/2026-07-05/2607.04379.txt)
