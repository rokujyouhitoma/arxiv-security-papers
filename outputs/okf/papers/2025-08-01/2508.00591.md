...
title_ja: "Wukong Framework for Not Safe For Work Detection in Text-to-Image systems（セキュリティ分析論文）"
description: "Wukong Framework for Not Safe For Work Detection in Text-to-Image systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.00591v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CV"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-01/2508.00591_meta.json"
  published_date: "2025-08-01T12:45:30Z"
  authors:
    - "Mingrui Liu"
    - "Sixiao Zhang"
    - "Cheng Long"
...
### (日本語題名: Wukong Framework for Not Safe For Work Detection in Text-to-Image systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.00591v2`](https://arxiv.org/abs/2508.00591v2) | Raw Meta = [`2508.00591_meta.json`](../../raw_data/2025-08-01/2508.00591_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Wukong Framework for Not Safe For Work Detection in Text-to-Image systems（セキュリティ分析論文）」（原題: Wukong Framework for Not Safe For Work Detection in Text-to-Image systems / arXiv: 2508.00591v2）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.00591v2`
- **論文URL**: [https://arxiv.org/abs/2508.00591v2](https://arxiv.org/abs/2508.00591v2)
- **PDFリンク**: [https://arxiv.org/pdf/2508.00591v2.pdf](https://arxiv.org/pdf/2508.00591v2.pdf)
- **著者**: Mingrui Liu, Sixiao Zhang, Cheng Long
- **公開日時**: `2025-08-01T12:45:30Z`
- **カテゴリ**: `cs.CV, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-01/2508.00591_meta.json) | [`PDF`](../../raw_data/2025-08-01/2508.00591.pdf) | [`TXT`](../../raw_data/2025-08-01/2508.00591.txt)
