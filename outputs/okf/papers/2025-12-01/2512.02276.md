...
title_ja: "Adversarial Robustness of Traffic Classification under Resource Constraints: Input Structure Matters（セキュリティ分析論文）"
description: "Adversarial Robustness of Traffic Classification under Resource Constraints: Input Structure Matters（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.02276v1"
tags:
  - "cs.NI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-01/2512.02276_meta.json"
  published_date: "2025-12-01T23:47:22Z"
  authors:
    - "Adel Chehade"
    - "Edoardo Ragusa"
    - "Paolo Gastaldo"
...
### (日本語題名: Adversarial Robustness of Traffic Classification under Resource Constraints: Input Structure Matters（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.02276v1`](https://arxiv.org/abs/2512.02276v1) | Raw Meta = [`2512.02276_meta.json`](../../raw_data/2025-12-01/2512.02276_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Adversarial Robustness of Traffic Classification under Resource Constraints: Input Structure Matters（セキュリティ分析論文）」（原題: Adversarial Robustness of Traffic Classification under Resource Constraints: Input Structure Matters / arXiv: 2512.02276v1）は、cs.NI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.02276v1`
- **論文URL**: [https://arxiv.org/abs/2512.02276v1](https://arxiv.org/abs/2512.02276v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.02276v1.pdf](https://arxiv.org/pdf/2512.02276v1.pdf)
- **著者**: Adel Chehade, Edoardo Ragusa, Paolo Gastaldo, Rodolfo Zunino
- **公開日時**: `2025-12-01T23:47:22Z`
- **カテゴリ**: `cs.NI, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-01/2512.02276_meta.json) | [`PDF`](../../raw_data/2025-12-01/2512.02276.pdf) | [`TXT`](../../raw_data/2025-12-01/2512.02276.txt)
