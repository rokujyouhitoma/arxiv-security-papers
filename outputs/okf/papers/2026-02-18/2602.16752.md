...
title_ja: "The Vulnerability of LLM Rankers to Prompt Injection Attacks（セキュリティ分析論文）"
description: "The Vulnerability of LLM Rankers to Prompt Injection Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.16752v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-18/2602.16752_meta.json"
  published_date: "2026-02-18T06:19:08Z"
  authors:
    - "Yu Yin"
    - "Shuai Wang"
    - "Bevan Koopman"
...
### (日本語題名: The Vulnerability of LLM Rankers to Prompt Injection Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.16752v1`](https://arxiv.org/abs/2602.16752v1) | Raw Meta = [`2602.16752_meta.json`](../../raw_data/2026-02-18/2602.16752_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「The Vulnerability of LLM Rankers to Prompt Injection Attacks（セキュリティ分析論文）」（原題: The Vulnerability of LLM Rankers to Prompt Injection Attacks / arXiv: 2602.16752v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.16752v1`
- **論文URL**: [https://arxiv.org/abs/2602.16752v1](https://arxiv.org/abs/2602.16752v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.16752v1.pdf](https://arxiv.org/pdf/2602.16752v1.pdf)
- **著者**: Yu Yin, Shuai Wang, Bevan Koopman, Guido Zuccon
- **公開日時**: `2026-02-18T06:19:08Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-18/2602.16752_meta.json) | [`PDF`](../../raw_data/2026-02-18/2602.16752.pdf) | [`TXT`](../../raw_data/2026-02-18/2602.16752.txt)
