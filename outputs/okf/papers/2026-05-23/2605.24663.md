...
title_ja: "CyBOKClaw: Human-in-the-Loop CyBOK Mapping for サイバーセキュリティ Curriculum"
description: "CyBOKClaw: Human-in-the-Loop CyBOK Mapping for サイバーセキュリティ Curriculum — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.24663v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-23/2605.24663_meta.json"
  published_date: "2026-05-23T17:04:31Z"
  authors:
    - "Yan Lin Aung"
    - "Kevin Togbe"
trust:
...
### (日本語題名: CyBOKClaw: Human-in-the-Loop CyBOK Mapping for サイバーセキュリティ Curriculum)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.24663v1`](https://arxiv.org/abs/2605.24663v1) | Raw Meta = [`2605.24663_meta.json`](../../raw_data/2026-05-23/2605.24663_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「CyBOKClaw: Human-in-the-Loop CyBOK Mapping for サイバーセキュリティ Curriculum」（原題: CyBOKClaw: Human-in-the-Loop CyBOK Mapping for Cybersecurity Curriculum / arXiv: 2605.24663v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.24663v1`
- **論文URL**: [https://arxiv.org/abs/2605.24663v1](https://arxiv.org/abs/2605.24663v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.24663v1.pdf](https://arxiv.org/pdf/2605.24663v1.pdf)
- **著者**: Yan Lin Aung, Kevin Togbe
- **公開日時**: `2026-05-23T17:04:31Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-23/2605.24663_meta.json) | [`PDF`](../../raw_data/2026-05-23/2605.24663.pdf) | [`TXT`](../../raw_data/2026-05-23/2605.24663.txt)
