...
title_ja: "A Hard-Label Black-Box Evasion Attack against ML-based Malicious Traffic Detection Systems（セキュリティ分析論文）"
description: "A Hard-Label Black-Box Evasion Attack against ML-based Malicious Traffic Detection Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.14906v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-10-16/2510.14906_meta.json"
  published_date: "2025-10-16T17:24:18Z"
  authors:
    - "Zixuan Liu"
    - "Yi Zhao"
    - "Zhuotao Liu"
...
### (日本語題名: A Hard-Label Black-Box Evasion Attack against ML-based Malicious Traffic Detection Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.14906v1`](https://arxiv.org/abs/2510.14906v1) | Raw Meta = [`2510.14906_meta.json`](../../raw_data/2025-10-16/2510.14906_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Hard-Label Black-Box Evasion Attack against ML-based Malicious Traffic Detection Systems（セキュリティ分析論文）」（原題: A Hard-Label Black-Box Evasion Attack against ML-based Malicious Traffic Detection Systems / arXiv: 2510.14906v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2510.14906v1`
- **論文URL**: [https://arxiv.org/abs/2510.14906v1](https://arxiv.org/abs/2510.14906v1)
- **PDFリンク**: [https://arxiv.org/pdf/2510.14906v1.pdf](https://arxiv.org/pdf/2510.14906v1.pdf)
- **著者**: Zixuan Liu, Yi Zhao, Zhuotao Liu, Qi Li, Chuanpu Fu, Guangmeng Zhou, Ke Xu
- **公開日時**: `2025-10-16T17:24:18Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-10-16/2510.14906_meta.json) | [`PDF`](../../raw_data/2025-10-16/2510.14906.pdf) | [`TXT`](../../raw_data/2025-10-16/2510.14906.txt)
