...
title_ja: "Structural Representations for Cross-Attack Generalization in AI Agent Threat Detection（セキュリティ分析論文）"
description: "Structural Representations for Cross-Attack Generalization in AI Agent Threat Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.01723v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-05/2601.01723_meta.json"
  published_date: "2026-01-05T01:51:40Z"
  authors:
    - "Vignesh Iyer"
trust:
...
### (日本語題名: Structural Representations for Cross-Attack Generalization in AI Agent Threat Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.01723v1`](https://arxiv.org/abs/2601.01723v1) | Raw Meta = [`2601.01723_meta.json`](../../raw_data/2026-01-05/2601.01723_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Structural Representations for Cross-Attack Generalization in AI Agent Threat Detection（セキュリティ分析論文）」（原題: Structural Representations for Cross-Attack Generalization in AI Agent Threat Detection / arXiv: 2601.01723v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.01723v1`
- **論文URL**: [https://arxiv.org/abs/2601.01723v1](https://arxiv.org/abs/2601.01723v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.01723v1.pdf](https://arxiv.org/pdf/2601.01723v1.pdf)
- **著者**: Vignesh Iyer
- **公開日時**: `2026-01-05T01:51:40Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-05/2601.01723_meta.json) | [`PDF`](../../raw_data/2026-01-05/2601.01723.pdf) | [`TXT`](../../raw_data/2026-01-05/2601.01723.txt)
