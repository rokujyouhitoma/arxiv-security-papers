...
title_ja: "When Words Are Safe But Actions Kill: Probing Physical Danger Beyond Text Safety in Hidden-State Risk Space（セキュリティ分析論文）"
description: "When Words Are Safe But Actions Kill: Probing Physical Danger Beyond Text Safety in Hidden-State Risk Space（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.15218v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-16/2607.15218_meta.json"
  published_date: "2026-07-16T17:20:38Z"
  authors:
    - "Weimeng Wang"
    - "Ziqiang Wang"
    - "Zihang Zhan"
...
### (日本語題名: When Words Are Safe But Actions Kill: Probing Physical Danger Beyond Text Safety in Hidden-State Risk Space（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.15218v1`](https://arxiv.org/abs/2607.15218v1) | Raw Meta = [`2607.15218_meta.json`](../../raw_data/2026-07-16/2607.15218_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「When Words Are Safe But Actions Kill: Probing Physical Danger Beyond Text Safety in Hidden-State Risk Space（セキュリティ分析論文）」（原題: When Words Are Safe But Actions Kill: Probing Physical Danger Beyond Text Safety in Hidden-State Risk Space / arXiv: 2607.15218v1）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2607.15218v1](https://arxiv.org/abs/2607.15218v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.15218v1.pdf](https://arxiv.org/pdf/2607.15218v1.pdf)
- **著者**: Weimeng Wang, Ziqiang Wang, Zihang Zhan, Chuanpu Fu, Qi Li, Ke Xu
- **公開日時**: `2026-07-16T17:20:38Z`
- **カテゴリ**: `cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-16/2607.15218_meta.json) | [`PDF`](../../raw_data/2026-07-16/2607.15218.pdf) | [`TXT`](../../raw_data/2026-07-16/2607.15218.txt)
