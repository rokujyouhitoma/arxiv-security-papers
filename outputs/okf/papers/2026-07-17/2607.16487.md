...
title_ja: "Fuzz'EMup: Leveraging EM Side-Channel Emanation to Guide Black-Box Embedded Firmware Fuzzing（セキュリティ分析論文）"
description: "Fuzz'EMup: Leveraging EM Side-Channel Emanation to Guide Black-Box Embedded Firmware Fuzzing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.16487v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-17/2607.16487_meta.json"
  published_date: "2026-07-17T20:25:03Z"
  authors:
...
### (日本語題名: Fuzz'EMup: Leveraging EM Side-Channel Emanation to Guide Black-Box Embedded Firmware Fuzzing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.16487v1`](https://arxiv.org/abs/2607.16487v1) | Raw Meta = [`2607.16487_meta.json`](../../raw_data/2026-07-17/2607.16487_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Fuzz'EMup: Leveraging EM Side-Channel Emanation to Guide Black-Box Embedded Firmware Fuzzing（セキュリティ分析論文）」（原題: Fuzz'EMup: Leveraging EM Side-Channel Emanation to Guide Black-Box Embedded Firmware Fuzzing / arXiv: 2607.16487v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.16487v1`
- **論文URL**: [https://arxiv.org/abs/2607.16487v1](https://arxiv.org/abs/2607.16487v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.16487v1.pdf](https://arxiv.org/pdf/2607.16487v1.pdf)
- **著者**: Fatemeh Moradihaghighi, Zihao Zhan, Yanan Guo, Ziming Zhao, Mashrur Chowdhury, Zhenkai Zhang
- **公開日時**: `2026-07-17T20:25:03Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-17/2607.16487_meta.json) | [`PDF`](../../raw_data/2026-07-17/2607.16487.pdf) | [`TXT`](../../raw_data/2026-07-17/2607.16487.txt)
