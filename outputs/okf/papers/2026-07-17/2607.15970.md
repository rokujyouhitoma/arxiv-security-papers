...
title_ja: "Code-Poisoning Property Inference Attacks（セキュリティ分析論文）"
description: "Code-Poisoning Property Inference Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.15970v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-17/2607.15970_meta.json"
  published_date: "2026-07-17T14:04:59Z"
  authors:
    - "Xukun Luan"
    - "Yuhui Gong"
    - "Gang Zhang"
...
### (日本語題名: Code-Poisoning Property Inference Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.15970v1`](https://arxiv.org/abs/2607.15970v1) | Raw Meta = [`2607.15970_meta.json`](../../raw_data/2026-07-17/2607.15970_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Code-Poisoning Property Inference Attacks（セキュリティ分析論文）」（原題: Code-Poisoning Property Inference Attacks / arXiv: 2607.15970v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.15970v1`
- **論文URL**: [https://arxiv.org/abs/2607.15970v1](https://arxiv.org/abs/2607.15970v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.15970v1.pdf](https://arxiv.org/pdf/2607.15970v1.pdf)
- **著者**: Xukun Luan, Yuhui Gong, Gang Zhang, Zixuan Huang, Yuanguo Bi, Xuesong Li, Jinyan Liu
- **公開日時**: `2026-07-17T14:04:59Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-17/2607.15970_meta.json) | [`PDF`](../../raw_data/2026-07-17/2607.15970.pdf) | [`TXT`](../../raw_data/2026-07-17/2607.15970.txt)
