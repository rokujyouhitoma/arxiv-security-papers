...
title_ja: "Multi-target Coverage-based Greybox Fuzzing（セキュリティ分析論文）"
description: "Multi-target Coverage-based Greybox Fuzzing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.25354v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-26/2603.25354_meta.json"
  published_date: "2026-03-26T11:59:21Z"
  authors:
    - "Masami Ichikawa"
trust:
...
### (日本語題名: Multi-target Coverage-based Greybox Fuzzing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.25354v1`](https://arxiv.org/abs/2603.25354v1) | Raw Meta = [`2603.25354_meta.json`](../../raw_data/2026-03-26/2603.25354_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Multi-target Coverage-based Greybox Fuzzing（セキュリティ分析論文）」（原題: Multi-target Coverage-based Greybox Fuzzing / arXiv: 2603.25354v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.25354v1`
- **論文URL**: [https://arxiv.org/abs/2603.25354v1](https://arxiv.org/abs/2603.25354v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.25354v1.pdf](https://arxiv.org/pdf/2603.25354v1.pdf)
- **著者**: Masami Ichikawa
- **公開日時**: `2026-03-26T11:59:21Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-26/2603.25354_meta.json) | [`PDF`](../../raw_data/2026-03-26/2603.25354.pdf) | [`TXT`](../../raw_data/2026-03-26/2603.25354.txt)
