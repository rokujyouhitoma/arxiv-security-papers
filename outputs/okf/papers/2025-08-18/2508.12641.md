...
title_ja: "MPOCryptoML: Multi-Pattern based Off-Chain Crypto Money Laundering Detection（セキュリティ分析論文）"
description: "MPOCryptoML: Multi-Pattern based Off-Chain Crypto Money Laundering Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.12641v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-18/2508.12641_meta.json"
  published_date: "2025-08-18T06:06:32Z"
  authors:
    - "Yasaman Samadi"
    - "Hai Dong"
    - "Xiaoyu Xia"
...
### (日本語題名: MPOCryptoML: Multi-Pattern based Off-Chain Crypto Money Laundering Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.12641v1`](https://arxiv.org/abs/2508.12641v1) | Raw Meta = [`2508.12641_meta.json`](../../raw_data/2025-08-18/2508.12641_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MPOCryptoML: Multi-Pattern based Off-Chain Crypto Money Laundering Detection（セキュリティ分析論文）」（原題: MPOCryptoML: Multi-Pattern based Off-Chain Crypto Money Laundering Detection / arXiv: 2508.12641v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.12641v1`
- **論文URL**: [https://arxiv.org/abs/2508.12641v1](https://arxiv.org/abs/2508.12641v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.12641v1.pdf](https://arxiv.org/pdf/2508.12641v1.pdf)
- **著者**: Yasaman Samadi, Hai Dong, Xiaoyu Xia
- **公開日時**: `2025-08-18T06:06:32Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-18/2508.12641_meta.json) | [`PDF`](../../raw_data/2025-08-18/2508.12641.pdf) | [`TXT`](../../raw_data/2025-08-18/2508.12641.txt)
