...
title_ja: "KEENHash: Hashing Programs into Function-Aware Embeddings for Large-Scale Binary Code Similarity Analysis（セキュリティ分析論文）"
description: "KEENHash: Hashing Programs into Function-Aware Embeddings for Large-Scale Binary Code Similarity Analysis（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.11612v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-13/2506.11612_meta.json"
  published_date: "2025-06-13T09:33:58Z"
  authors:
    - "Zhijie Liu"
    - "Qiyi Tang"
    - "Sen Nie"
...
### (日本語題名: KEENHash: Hashing Programs into Function-Aware Embeddings for Large-Scale Binary Code Similarity Analysis（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.11612v1`](https://arxiv.org/abs/2506.11612v1) | Raw Meta = [`2506.11612_meta.json`](../../raw_data/2025-06-13/2506.11612_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「KEENHash: Hashing Programs into Function-Aware Embeddings for Large-Scale Binary Code Similarity Analysis（セキュリティ分析論文）」（原題: KEENHash: Hashing Programs into Function-Aware Embeddings for Large-Scale Binary Code Similarity Analysis / arXiv: 2506.11612v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.11612v1`
- **論文URL**: [https://arxiv.org/abs/2506.11612v1](https://arxiv.org/abs/2506.11612v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.11612v1.pdf](https://arxiv.org/pdf/2506.11612v1.pdf)
- **著者**: Zhijie Liu, Qiyi Tang, Sen Nie, Shi Wu, Liang Feng Zhang, Yutian Tang
- **公開日時**: `2025-06-13T09:33:58Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-13/2506.11612_meta.json) | [`PDF`](../../raw_data/2025-06-13/2506.11612.pdf) | [`TXT`](../../raw_data/2025-06-13/2506.11612.txt)
