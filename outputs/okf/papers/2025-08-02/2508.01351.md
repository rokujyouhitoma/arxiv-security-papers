...
title_ja: "NATLM: Detecting Defects in NFT Smart Contracts Leveraging LLM（セキュリティ分析論文）"
description: "NATLM: Detecting Defects in NFT Smart Contracts Leveraging LLM（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.01351v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-02/2508.01351_meta.json"
  published_date: "2025-08-02T12:56:27Z"
  authors:
    - "Yuanzheng Niu"
    - "Xiaoqi Li"
    - "Wenkai Li"
...
### (日本語題名: NATLM: Detecting Defects in NFT Smart Contracts Leveraging LLM（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.01351v2`](https://arxiv.org/abs/2508.01351v2) | Raw Meta = [`2508.01351_meta.json`](../../raw_data/2025-08-02/2508.01351_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「NATLM: Detecting Defects in NFT Smart Contracts Leveraging LLM（セキュリティ分析論文）」（原題: NATLM: Detecting Defects in NFT Smart Contracts Leveraging LLM / arXiv: 2508.01351v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.01351v2`
- **論文URL**: [https://arxiv.org/abs/2508.01351v2](https://arxiv.org/abs/2508.01351v2)
- **PDFリンク**: [https://arxiv.org/pdf/2508.01351v2.pdf](https://arxiv.org/pdf/2508.01351v2.pdf)
- **著者**: Yuanzheng Niu, Xiaoqi Li, Wenkai Li
- **公開日時**: `2025-08-02T12:56:27Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-02/2508.01351_meta.json) | [`PDF`](../../raw_data/2025-08-02/2508.01351.pdf) | [`TXT`](../../raw_data/2025-08-02/2508.01351.txt)
