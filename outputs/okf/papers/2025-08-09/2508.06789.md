...
title_ja: "Label Inference Attacks against Federated Unlearning（セキュリティ分析論文）"
description: "Label Inference Attacks against Federated Unlearning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.06789v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-09/2508.06789_meta.json"
  published_date: "2025-08-09T02:38:24Z"
  authors:
    - "Wei Wang"
    - "Xiangyun Tang"
    - "Yajie Wang"
...
### (日本語題名: Label Inference Attacks against Federated Unlearning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.06789v1`](https://arxiv.org/abs/2508.06789v1) | Raw Meta = [`2508.06789_meta.json`](../../raw_data/2025-08-09/2508.06789_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Label Inference Attacks against Federated Unlearning（セキュリティ分析論文）」（原題: Label Inference Attacks against Federated Unlearning / arXiv: 2508.06789v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.06789v1`
- **論文URL**: [https://arxiv.org/abs/2508.06789v1](https://arxiv.org/abs/2508.06789v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.06789v1.pdf](https://arxiv.org/pdf/2508.06789v1.pdf)
- **著者**: Wei Wang, Xiangyun Tang, Yajie Wang, Yijing Lin, Tao Zhang, Meng Shen, Dusit Niyato, Liehuang Zhu
- **公開日時**: `2025-08-09T02:38:24Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-09/2508.06789_meta.json) | [`PDF`](../../raw_data/2025-08-09/2508.06789.pdf) | [`TXT`](../../raw_data/2025-08-09/2508.06789.txt)
