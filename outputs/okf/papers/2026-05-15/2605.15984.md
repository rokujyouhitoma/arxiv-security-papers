...
title_ja: "Beyond Content: A Comprehensive Speech Toxicity Dataset and Detection Framework Incorporating Paralinguistic Cues（セキュリティ分析論文）"
description: "Beyond Content: A Comprehensive Speech Toxicity Dataset and Detection Framework Incorporating Paralinguistic Cues（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.15984v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-15/2605.15984_meta.json"
  published_date: "2026-05-15T14:17:19Z"
  authors:
    - "Zhongjie Ba"
    - "Liang Yi"
    - "Peng Cheng"
...
### (日本語題名: Beyond Content: A Comprehensive Speech Toxicity Dataset and Detection Framework Incorporating Paralinguistic Cues（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.15984v1`](https://arxiv.org/abs/2605.15984v1) | Raw Meta = [`2605.15984_meta.json`](../../raw_data/2026-05-15/2605.15984_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Beyond Content: A Comprehensive Speech Toxicity Dataset and Detection Framework Incorporating Paralinguistic Cues（セキュリティ分析論文）」（原題: Beyond Content: A Comprehensive Speech Toxicity Dataset and Detection Framework Incorporating Paralinguistic Cues / arXiv: 2605.15984v1）は、cs.SD 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.15984v1`
- **論文URL**: [https://arxiv.org/abs/2605.15984v1](https://arxiv.org/abs/2605.15984v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.15984v1.pdf](https://arxiv.org/pdf/2605.15984v1.pdf)
- **著者**: Zhongjie Ba, Liang Yi, Peng Cheng, Qingcao Li, Qinglong Wang, Li Lu
- **公開日時**: `2026-05-15T14:17:19Z`
- **カテゴリ**: `cs.SD, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-15/2605.15984_meta.json) | [`PDF`](../../raw_data/2026-05-15/2605.15984.pdf) | [`TXT`](../../raw_data/2026-05-15/2605.15984.txt)
