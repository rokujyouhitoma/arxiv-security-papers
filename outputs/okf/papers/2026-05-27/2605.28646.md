...
title_ja: "MaskClaw: Edge-Side Personalized Privacy Arbitration for GUI Agents with Behavior-Driven Skill Evolution（セキュリティ分析論文）"
description: "MaskClaw: Edge-Side Personalized Privacy Arbitration for GUI Agents with Behavior-Driven Skill Evolution（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.28646v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-27/2605.28646_meta.json"
  published_date: "2026-05-27T15:51:22Z"
  authors:
    - "Yanqiu Zhao"
    - "Dongying Zheng"
    - "Kaibo Huang"
...
### (日本語題名: MaskClaw: Edge-Side Personalized Privacy Arbitration for GUI Agents with Behavior-Driven Skill Evolution（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.28646v2`](https://arxiv.org/abs/2605.28646v2) | Raw Meta = [`2605.28646_meta.json`](../../raw_data/2026-05-27/2605.28646_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MaskClaw: Edge-Side Personalized Privacy Arbitration for GUI Agents with Behavior-Driven Skill Evolution（セキュリティ分析論文）」（原題: MaskClaw: Edge-Side Personalized Privacy Arbitration for GUI Agents with Behavior-Driven Skill Evolution / arXiv: 2605.28646v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.28646v2`
- **論文URL**: [https://arxiv.org/abs/2605.28646v2](https://arxiv.org/abs/2605.28646v2)
- **PDFリンク**: [https://arxiv.org/pdf/2605.28646v2.pdf](https://arxiv.org/pdf/2605.28646v2.pdf)
- **著者**: Yanqiu Zhao, Dongying Zheng, Kaibo Huang, Yukun Wei, Zhongliang Yang, Linna Zhou
- **公開日時**: `2026-05-27T15:51:22Z`
- **カテゴリ**: `cs.CR, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-27/2605.28646_meta.json) | [`PDF`](../../raw_data/2026-05-27/2605.28646.pdf) | [`TXT`](../../raw_data/2026-05-27/2605.28646.txt)
