...
title_ja: "SAP-DIFF: Semantic Adversarial Patch Generation for Black-Box Face Recognition Models via Diffusion Models（セキュリティ分析論文）"
description: "SAP-DIFF: Semantic Adversarial Patch Generation for Black-Box Face Recognition Models via Diffusion Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.19710v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CV"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-27/2502.19710_meta.json"
  published_date: "2025-02-27T02:57:29Z"
  authors:
    - "Mingsi Wang"
    - "Shuaiyin Yao"
    - "Chang Yue"
...
### (日本語題名: SAP-DIFF: Semantic Adversarial Patch Generation for Black-Box Face Recognition Models via Diffusion Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.19710v1`](https://arxiv.org/abs/2502.19710v1) | Raw Meta = [`2502.19710_meta.json`](../../raw_data/2025-02-27/2502.19710_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SAP-DIFF: Semantic Adversarial Patch Generation for Black-Box Face Recognition Models via Diffusion Models（セキュリティ分析論文）」（原題: SAP-DIFF: Semantic Adversarial Patch Generation for Black-Box Face Recognition Models via Diffusion Models / arXiv: 2502.19710v1）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.19710v1`
- **論文URL**: [https://arxiv.org/abs/2502.19710v1](https://arxiv.org/abs/2502.19710v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.19710v1.pdf](https://arxiv.org/pdf/2502.19710v1.pdf)
- **著者**: Mingsi Wang, Shuaiyin Yao, Chang Yue, Lijie Zhang, Guozhu Meng
- **公開日時**: `2025-02-27T02:57:29Z`
- **カテゴリ**: `cs.CV, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-27/2502.19710_meta.json) | [`PDF`](../../raw_data/2025-02-27/2502.19710.pdf) | [`TXT`](../../raw_data/2025-02-27/2502.19710.txt)
