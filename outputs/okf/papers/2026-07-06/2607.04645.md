...
title_ja: "Retroactive Chain-of-Thought (RetroCoT): Forensic Reconstruction Prompts as a Safety Diagnostic Across Model Generations（セキュリティ分析論文）"
description: "Retroactive Chain-of-Thought (RetroCoT): Forensic Reconstruction Prompts as a Safety Diagnostic Across Model Generations（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.04645v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-06/2607.04645_meta.json"
  published_date: "2026-07-06T03:59:06Z"
  authors:
    - "Samira Hajizadeh"
trust:
...
### (日本語題名: Retroactive Chain-of-Thought (RetroCoT): Forensic Reconstruction Prompts as a Safety Diagnostic Across Model Generations（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.04645v1`](https://arxiv.org/abs/2607.04645v1) | Raw Meta = [`2607.04645_meta.json`](../../raw_data/2026-07-06/2607.04645_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Retroactive Chain-of-Thought (RetroCoT): Forensic Reconstruction Prompts as a Safety Diagnostic Across Model Generations（セキュリティ分析論文）」（原題: Retroactive Chain-of-Thought (RetroCoT): Forensic Reconstruction Prompts as a Safety Diagnostic Across Model Generations / arXiv: 2607.04645v1）は、cs.CL 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.04645v1`
- **論文URL**: [https://arxiv.org/abs/2607.04645v1](https://arxiv.org/abs/2607.04645v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.04645v1.pdf](https://arxiv.org/pdf/2607.04645v1.pdf)
- **著者**: Samira Hajizadeh
- **公開日時**: `2026-07-06T03:59:06Z`
- **カテゴリ**: `cs.CL, cs.AI, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-06/2607.04645_meta.json) | [`PDF`](../../raw_data/2026-07-06/2607.04645.pdf) | [`TXT`](../../raw_data/2026-07-06/2607.04645.txt)
