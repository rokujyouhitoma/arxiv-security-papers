...
title_ja: "正当性とガバナンスの分離: エージェント型ワークフローにおける出所完全性の検証"
description: "正当性とガバナンスの分離: エージェント型ワークフローにおける出所完全性の検証 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.12761v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-13/2608.12761_meta.json"
  published_date: "2026-08-13T03:12:13Z"
  authors:
    - "Jesus Salas"
trust:
...
### (日本語題名: 正当性とガバナンスの分離: エージェント型ワークフローにおける出所完全性の検証)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.12761v1`](https://arxiv.org/abs/2608.12761v1) | Raw Meta = [`2608.12761_meta.json`](../../raw_data/2026-08-13/2608.12761_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「正当性とガバナンスの分離: エージェント型ワークフローにおける出所完全性の検証」（原題: Correct Is Not Governed: Provenance Integrity in Agentic Workflows / arXiv: 2608.12761v1）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.12761v1`
- **論文URL**: [https://arxiv.org/abs/2608.12761v1](https://arxiv.org/abs/2608.12761v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.12761v1.pdf](https://arxiv.org/pdf/2608.12761v1.pdf)
- **著者**: Jesus Salas
- **公開日時**: `2026-08-13T03:12:13Z`
- **カテゴリ**: `cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-13/2608.12761_meta.json) | [`PDF`](../../raw_data/2026-08-13/2608.12761.pdf) | [`TXT`](../../raw_data/2026-08-13/2608.12761.txt)
