...
title_ja: "垂直型連合学習におけるバックドア脆弱性の理解: 研究と実務の乖離分析"
description: "垂直型連合学習におけるバックドア脆弱性の理解: 研究と実務の乖離分析 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.12962v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-13/2608.12962_meta.json"
  published_date: "2026-08-13T08:46:06Z"
  authors:
    - "Ziqi Zhao"
    - "Jialin Lu"
    - "Junjie Shan"
...
### (日本語題名: 垂直型連合学習におけるバックドア脆弱性の理解: 研究と実務の乖離分析)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.12962v1`](https://arxiv.org/abs/2608.12962v1) | Raw Meta = [`2608.12962_meta.json`](../../raw_data/2026-08-13/2608.12962_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「垂直型連合学習におけるバックドア脆弱性の理解: 研究と実務の乖離分析」（原題: Understanding Backdoor Vulnerabilities in Vertical Federated Learning: The Gap Between Research and Practice / arXiv: 2608.12962v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.12962v1`
- **論文URL**: [https://arxiv.org/abs/2608.12962v1](https://arxiv.org/abs/2608.12962v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.12962v1.pdf](https://arxiv.org/pdf/2608.12962v1.pdf)
- **著者**: Ziqi Zhao, Jialin Lu, Junjie Shan, Junyuan Zhang, Shuya Yang, Ka-Ho Chow
- **公開日時**: `2026-08-13T08:46:06Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-13/2608.12962_meta.json) | [`PDF`](../../raw_data/2026-08-13/2608.12962.pdf) | [`TXT`](../../raw_data/2026-08-13/2608.12962.txt)
