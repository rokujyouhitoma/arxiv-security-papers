...
title_ja: "OptiLeak: Efficient Prompt Reconstruction via Reinforcement Learning in Multi-tenant LLM Services（セキュリティ分析論文）"
description: "OptiLeak: Efficient Prompt Reconstruction via Reinforcement Learning in Multi-tenant LLM Services（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.20595v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-24/2602.20595_meta.json"
  published_date: "2026-02-24T06:35:22Z"
  authors:
    - "Longxiang Wang"
    - "Xiang Zheng"
    - "Xuhao Zhang"
...
### (日本語題名: OptiLeak: Efficient Prompt Reconstruction via Reinforcement Learning in Multi-tenant LLM Services（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.20595v1`](https://arxiv.org/abs/2602.20595v1) | Raw Meta = [`2602.20595_meta.json`](../../raw_data/2026-02-24/2602.20595_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「OptiLeak: Efficient Prompt Reconstruction via Reinforcement Learning in Multi-tenant LLM Services（セキュリティ分析論文）」（原題: OptiLeak: Efficient Prompt Reconstruction via Reinforcement Learning in Multi-tenant LLM Services / arXiv: 2602.20595v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.20595v1`
- **論文URL**: [https://arxiv.org/abs/2602.20595v1](https://arxiv.org/abs/2602.20595v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.20595v1.pdf](https://arxiv.org/pdf/2602.20595v1.pdf)
- **著者**: Longxiang Wang, Xiang Zheng, Xuhao Zhang, Yao Zhang, Ye Wu, Cong Wang
- **公開日時**: `2026-02-24T06:35:22Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-24/2602.20595_meta.json) | [`PDF`](../../raw_data/2026-02-24/2602.20595.pdf) | [`TXT`](../../raw_data/2026-02-24/2602.20595.txt)
