...
title_ja: "Human-AI Collaborative Bot Detection in MMORPGs（セキュリティ分析論文）"
description: "Human-AI Collaborative Bot Detection in MMORPGs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.20578v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-28/2508.20578_meta.json"
  published_date: "2025-08-28T09:17:35Z"
  authors:
    - "Jaeman Son"
    - "Hyunsoo Kim"
trust:
...
### (日本語題名: Human-AI Collaborative Bot Detection in MMORPGs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.20578v1`](https://arxiv.org/abs/2508.20578v1) | Raw Meta = [`2508.20578_meta.json`](../../raw_data/2025-08-28/2508.20578_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Human-AI Collaborative Bot Detection in MMORPGs（セキュリティ分析論文）」（原題: Human-AI Collaborative Bot Detection in MMORPGs / arXiv: 2508.20578v1）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.20578v1`
- **論文URL**: [https://arxiv.org/abs/2508.20578v1](https://arxiv.org/abs/2508.20578v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.20578v1.pdf](https://arxiv.org/pdf/2508.20578v1.pdf)
- **著者**: Jaeman Son, Hyunsoo Kim
- **公開日時**: `2025-08-28T09:17:35Z`
- **カテゴリ**: `cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-28/2508.20578_meta.json) | [`PDF`](../../raw_data/2025-08-28/2508.20578.pdf) | [`TXT`](../../raw_data/2025-08-28/2508.20578.txt)
