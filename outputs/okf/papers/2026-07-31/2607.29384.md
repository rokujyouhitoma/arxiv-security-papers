...
title_ja: "On the Resilience of 5G NR Against Jamming（セキュリティ分析論文）"
description: "On the Resilience of 5G NR Against Jamming（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.29384v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-31/2607.29384_meta.json"
  published_date: "2026-07-31T13:05:06Z"
  authors:
    - "Sotiris Michaelides"
    - "Fidelius Lula"
...
### (日本語題名: On the Resilience of 5G NR Against Jamming（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.29384v1`](https://arxiv.org/abs/2607.29384v1) | Raw Meta = [`2607.29384_meta.json`](../../raw_data/2026-07-31/2607.29384_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「On the Resilience of 5G NR Against Jamming（セキュリティ分析論文）」（原題: On the Resilience of 5G NR Against Jamming / arXiv: 2607.29384v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.29384v1`
- **論文URL**: [https://arxiv.org/abs/2607.29384v1](https://arxiv.org/abs/2607.29384v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.29384v1.pdf](https://arxiv.org/pdf/2607.29384v1.pdf)
- **著者**: Sotiris Michaelides, Fidelius Lula, Daniel Eguiguren Chavez, Michael Rademacher, Martin Henze
- **公開日時**: `2026-07-31T13:05:06Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-31/2607.29384_meta.json) | [`PDF`](../../raw_data/2026-07-31/2607.29384.pdf) | [`TXT`](../../raw_data/2026-07-31/2607.29384.txt)
