...
title_ja: "Alignment Is Local: A Paired Diagnostic for GUI Agents under User-Side Persuasion（セキュリティ分析論文）"
description: "Alignment Is Local: A Paired Diagnostic for GUI Agents under User-Side Persuasion（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.29199v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-31/2607.29199_meta.json"
  published_date: "2026-07-31T09:18:55Z"
  authors:
    - "Haoxin An"
    - "Yunpeng Song"
    - "Zihao Bai"
...
### (日本語題名: Alignment Is Local: A Paired Diagnostic for GUI Agents under User-Side Persuasion（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.29199v1`](https://arxiv.org/abs/2607.29199v1) | Raw Meta = [`2607.29199_meta.json`](../../raw_data/2026-07-31/2607.29199_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Alignment Is Local: A Paired Diagnostic for GUI Agents under User-Side Persuasion（セキュリティ分析論文）」（原題: Alignment Is Local: A Paired Diagnostic for GUI Agents under User-Side Persuasion / arXiv: 2607.29199v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.29199v1`
- **論文URL**: [https://arxiv.org/abs/2607.29199v1](https://arxiv.org/abs/2607.29199v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.29199v1.pdf](https://arxiv.org/pdf/2607.29199v1.pdf)
- **著者**: Haoxin An, Yunpeng Song, Zihao Bai, Zhongmin Cai, Guojun Xiong, Chenhao Lin, Wentao Chen, Feng Wei, Chao Shen
- **公開日時**: `2026-07-31T09:18:55Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-31/2607.29199_meta.json) | [`PDF`](../../raw_data/2026-07-31/2607.29199.pdf) | [`TXT`](../../raw_data/2026-07-31/2607.29199.txt)
