...
title_ja: "Beyond Detection Accuracy: Measuring Explanation Cost, Stability, and Utility for Resource-Aware IoT Intrusion Detection（セキュリティ分析論文）"
description: "Beyond Detection Accuracy: Measuring Explanation Cost, Stability, and Utility for Resource-Aware IoT Intrusion Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.10349v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-11/2608.10349_meta.json"
  published_date: "2026-08-11T01:18:07Z"
  authors:
    - "Abdurrahman Tolay"
trust:
...
### (日本語題名: Beyond Detection Accuracy: Measuring Explanation Cost, Stability, and Utility for Resource-Aware IoT Intrusion Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.10349v1`](https://arxiv.org/abs/2608.10349v1) | Raw Meta = [`2608.10349_meta.json`](../../raw_data/2026-08-11/2608.10349_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Beyond Detection Accuracy: Measuring Explanation Cost, Stability, and Utility for Resource-Aware IoT Intrusion Detection（セキュリティ分析論文）」（原題: Beyond Detection Accuracy: Measuring Explanation Cost, Stability, and Utility for Resource-Aware IoT Intrusion Detection / arXiv: 2608.10349v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。

**概要**: 本研究はサイバー脅威環境におけるセキュリティ構造・脆弱性の検証を目的としています。(主要検出項目: attack, leak, drift)

### 2. 背景とセキュリティ上の課題 (Background & Problem)
本研究はサイバー脅威環境におけるセキュリティ構造・脆弱性の検証を目的としています。(主要検出項目: attack, leak, drift)
...
- **arXiv ID**: `2608.10349v1`
- **論文URL**: [https://arxiv.org/abs/2608.10349v1](https://arxiv.org/abs/2608.10349v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.10349v1.pdf](https://arxiv.org/pdf/2608.10349v1.pdf)
- **著者**: Abdurrahman Tolay
- **公開日時**: `2026-08-11T01:18:07Z`
- **カテゴリ**: `cs.CR, cs.LG, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-11/2608.10349_meta.json) | [`PDF`](../../raw_data/2026-08-11/2608.10349.pdf) | [`TXT`](../../raw_data/2026-08-11/2608.10349.txt)
