...
title_ja: "Anti-Backdoor Coreset Selection via Cumulative Entropy（セキュリティ分析論文）"
description: "Anti-Backdoor Coreset Selection via Cumulative Entropy（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.25502v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-28/2607.25502_meta.json"
  published_date: "2026-07-28T09:37:11Z"
  authors:
    - "Qi Zhao"
...
### (日本語題名: Anti-Backdoor Coreset Selection via Cumulative Entropy（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.25502v1`](https://arxiv.org/abs/2607.25502v1) | Raw Meta = [`2607.25502_meta.json`](../../raw_data/2026-07-28/2607.25502_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Anti-Backdoor Coreset Selection via Cumulative Entropy（セキュリティ分析論文）」（原題: Anti-Backdoor Coreset Selection via Cumulative Entropy / arXiv: 2607.25502v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.25502v1`
- **論文URL**: [https://arxiv.org/abs/2607.25502v1](https://arxiv.org/abs/2607.25502v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.25502v1.pdf](https://arxiv.org/pdf/2607.25502v1.pdf)
- **著者**: Qi Zhao, Christian Wressnegger
- **公開日時**: `2026-07-28T09:37:11Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-28/2607.25502_meta.json) | [`PDF`](../../raw_data/2026-07-28/2607.25502.pdf) | [`TXT`](../../raw_data/2026-07-28/2607.25502.txt)
