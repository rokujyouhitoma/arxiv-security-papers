...
title_ja: "Lilith: Backdoor Generalization under Training-Inference Trigger Shift（セキュリティ分析論文）"
description: "Lilith: Backdoor Generalization under Training-Inference Trigger Shift（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.26099v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-28/2607.26099_meta.json"
  published_date: "2026-07-28T06:23:48Z"
  authors:
    - "Zhou Feng"
    - "Jiahao Chen"
    - "Chunyi Zhou"
...
### (日本語題名: Lilith: Backdoor Generalization under Training-Inference Trigger Shift（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.26099v1`](https://arxiv.org/abs/2607.26099v1) | Raw Meta = [`2607.26099_meta.json`](../../raw_data/2026-07-28/2607.26099_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Lilith: Backdoor Generalization under Training-Inference Trigger Shift（セキュリティ分析論文）」（原題: Lilith: Backdoor Generalization under Training-Inference Trigger Shift / arXiv: 2607.26099v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.26099v1`
- **論文URL**: [https://arxiv.org/abs/2607.26099v1](https://arxiv.org/abs/2607.26099v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.26099v1.pdf](https://arxiv.org/pdf/2607.26099v1.pdf)
- **著者**: Zhou Feng, Jiahao Chen, Chunyi Zhou, Yuan Su, Tianyu Du, Yuwen Pu, Jianhai Chen, Jinbao Li, Shouling Ji
- **公開日時**: `2026-07-28T06:23:48Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-28/2607.26099_meta.json) | [`PDF`](../../raw_data/2026-07-28/2607.26099.pdf) | [`TXT`](../../raw_data/2026-07-28/2607.26099.txt)
