...
title_ja: "Rotation-Invariant Spherical Watermarking via Third-Order SO(3) Representation Coupling（セキュリティ分析論文）"
description: "Rotation-Invariant Spherical Watermarking via Third-Order SO(3) Representation Coupling（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.26702v3"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-26/2605.26702_meta.json"
  published_date: "2026-05-26T08:43:40Z"
  authors:
    - "Pengzhen Chen"
    - "Yanwei Liu"
    - "Xiaoyan Gu"
...
### (日本語題名: Rotation-Invariant Spherical Watermarking via Third-Order SO(3) Representation Coupling（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.26702v3`](https://arxiv.org/abs/2605.26702v3) | Raw Meta = [`2605.26702_meta.json`](../../raw_data/2026-05-26/2605.26702_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Rotation-Invariant Spherical Watermarking via Third-Order SO(3) Representation Coupling（セキュリティ分析論文）」（原題: Rotation-Invariant Spherical Watermarking via Third-Order SO(3) Representation Coupling / arXiv: 2605.26702v3）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.26702v3`
- **論文URL**: [https://arxiv.org/abs/2605.26702v3](https://arxiv.org/abs/2605.26702v3)
- **PDFリンク**: [https://arxiv.org/pdf/2605.26702v3.pdf](https://arxiv.org/pdf/2605.26702v3.pdf)
- **著者**: Pengzhen Chen, Yanwei Liu, Xiaoyan Gu, Antonios Argyriou, Wu Liu, Weiping Wang
- **公開日時**: `2026-05-26T08:43:40Z`
- **カテゴリ**: `cs.CV, cs.AI, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-26/2605.26702_meta.json) | [`PDF`](../../raw_data/2026-05-26/2605.26702.pdf) | [`TXT`](../../raw_data/2026-05-26/2605.26702.txt)
