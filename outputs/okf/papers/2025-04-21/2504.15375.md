...
title_ja: "FLARE: Feature-based Lightweight Aggregation for Robust Evaluation of IoT Intrusion Detection（セキュリティ分析論文）"
description: "FLARE: Feature-based Lightweight Aggregation for Robust Evaluation of IoT Intrusion Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.15375v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-21/2504.15375_meta.json"
  published_date: "2025-04-21T18:33:53Z"
  authors:
    - "Bradley Boswell"
    - "Seth Barrett"
...
### (日本語題名: FLARE: Feature-based Lightweight Aggregation for Robust Evaluation of IoT Intrusion Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.15375v1`](https://arxiv.org/abs/2504.15375v1) | Raw Meta = [`2504.15375_meta.json`](../../raw_data/2025-04-21/2504.15375_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「FLARE: Feature-based Lightweight Aggregation for Robust Evaluation of IoT Intrusion Detection（セキュリティ分析論文）」（原題: FLARE: Feature-based Lightweight Aggregation for Robust Evaluation of IoT Intrusion Detection / arXiv: 2504.15375v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.15375v1`
- **論文URL**: [https://arxiv.org/abs/2504.15375v1](https://arxiv.org/abs/2504.15375v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.15375v1.pdf](https://arxiv.org/pdf/2504.15375v1.pdf)
- **著者**: Bradley Boswell, Seth Barrett, Swarnamugi Rajaganapathy, Gokila Dorai
- **公開日時**: `2025-04-21T18:33:53Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-21/2504.15375_meta.json) | [`PDF`](../../raw_data/2025-04-21/2504.15375.pdf) | [`TXT`](../../raw_data/2025-04-21/2504.15375.txt)
