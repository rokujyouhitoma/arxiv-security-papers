...
title_ja: "CSI2Dig: Recovering Digit Content from Smartphone Loudspeakers Using Channel State Information（セキュリティ分析論文）"
description: "CSI2Dig: Recovering Digit Content from Smartphone Loudspeakers Using Channel State Information（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.14812v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-21/2504.14812_meta.json"
  published_date: "2025-04-21T02:31:19Z"
  authors:
    - "Yangyang Gu"
    - "Xianglong Li"
    - "Haolin Wu"
...
### (日本語題名: CSI2Dig: Recovering Digit Content from Smartphone Loudspeakers Using Channel State Information（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.14812v1`](https://arxiv.org/abs/2504.14812v1) | Raw Meta = [`2504.14812_meta.json`](../../raw_data/2025-04-21/2504.14812_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「CSI2Dig: Recovering Digit Content from Smartphone Loudspeakers Using Channel State Information（セキュリティ分析論文）」（原題: CSI2Dig: Recovering Digit Content from Smartphone Loudspeakers Using Channel State Information / arXiv: 2504.14812v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.14812v1`
- **論文URL**: [https://arxiv.org/abs/2504.14812v1](https://arxiv.org/abs/2504.14812v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.14812v1.pdf](https://arxiv.org/pdf/2504.14812v1.pdf)
- **著者**: Yangyang Gu, Xianglong Li, Haolin Wu, Jing Chen, Kun He, Ruiying Du, Cong Wu
- **公開日時**: `2025-04-21T02:31:19Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-21/2504.14812_meta.json) | [`PDF`](../../raw_data/2025-04-21/2504.14812.pdf) | [`TXT`](../../raw_data/2025-04-21/2504.14812.txt)
