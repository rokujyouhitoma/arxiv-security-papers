...
title_ja: "DARTIC: Decentralized Anonymous Reputation at Scale for Trustworthy Crowdsourcing（セキュリティ分析論文）"
description: "DARTIC: Decentralized Anonymous Reputation at Scale for Trustworthy Crowdsourcing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.18146v3"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-18/2605.18146_meta.json"
  published_date: "2026-05-18T09:52:11Z"
  authors:
...
### (日本語題名: DARTIC: Decentralized Anonymous Reputation at Scale for Trustworthy Crowdsourcing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.18146v3`](https://arxiv.org/abs/2605.18146v3) | Raw Meta = [`2605.18146_meta.json`](../../raw_data/2026-05-18/2605.18146_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「DARTIC: Decentralized Anonymous Reputation at Scale for Trustworthy Crowdsourcing（セキュリティ分析論文）」（原題: DARTIC: Decentralized Anonymous Reputation at Scale for Trustworthy Crowdsourcing / arXiv: 2605.18146v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.18146v3`
- **論文URL**: [https://arxiv.org/abs/2605.18146v3](https://arxiv.org/abs/2605.18146v3)
- **PDFリンク**: [https://arxiv.org/pdf/2605.18146v3.pdf](https://arxiv.org/pdf/2605.18146v3.pdf)
- **著者**: Mouhamed Amine Bouchiha, Mourad Rabah, Ronan Champagnat, Abdelaziz Amara Korba, Yacine Ghamri-Doudane
- **公開日時**: `2026-05-18T09:52:11Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-18/2605.18146_meta.json) | [`PDF`](../../raw_data/2026-05-18/2605.18146.pdf) | [`TXT`](../../raw_data/2026-05-18/2605.18146.txt)
