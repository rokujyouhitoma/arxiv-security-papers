...
title_ja: "MOLM: Mixture of LoRA Markers（セキュリティ分析論文）"
description: "MOLM: Mixture of LoRA Markers（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.00293v2"
tags:
  - "cs.CV"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-30/2510.00293_meta.json"
  published_date: "2025-09-30T21:27:14Z"
  authors:
    - "Samar Fares"
    - "Nurbek Tastan"
    - "Noor Hussein"
...
### (日本語題名: MOLM: Mixture of LoRA Markers（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.00293v2`](https://arxiv.org/abs/2510.00293v2) | Raw Meta = [`2510.00293_meta.json`](../../raw_data/2025-09-30/2510.00293_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MOLM: Mixture of LoRA Markers（セキュリティ分析論文）」（原題: MOLM: Mixture of LoRA Markers / arXiv: 2510.00293v2）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2510.00293v2`
- **論文URL**: [https://arxiv.org/abs/2510.00293v2](https://arxiv.org/abs/2510.00293v2)
- **PDFリンク**: [https://arxiv.org/pdf/2510.00293v2.pdf](https://arxiv.org/pdf/2510.00293v2.pdf)
- **著者**: Samar Fares, Nurbek Tastan, Noor Hussein, Karthik Nandakumar
- **公開日時**: `2025-09-30T21:27:14Z`
- **カテゴリ**: `cs.CV, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-30/2510.00293_meta.json) | [`PDF`](../../raw_data/2025-09-30/2510.00293.pdf) | [`TXT`](../../raw_data/2025-09-30/2510.00293.txt)
