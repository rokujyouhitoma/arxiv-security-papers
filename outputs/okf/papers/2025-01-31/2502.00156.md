...
title_ja: "ALBAR: Adversarial Learning approach to mitigate Biases in Action Recognition（セキュリティ分析論文）"
description: "ALBAR: Adversarial Learning approach to mitigate Biases in Action Recognition（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.00156v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CV"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-31/2502.00156_meta.json"
  published_date: "2025-01-31T20:47:06Z"
  authors:
    - "Joseph Fioresi"
...
### (日本語題名: ALBAR: Adversarial Learning approach to mitigate Biases in Action Recognition（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.00156v2`](https://arxiv.org/abs/2502.00156v2) | Raw Meta = [`2502.00156_meta.json`](../../raw_data/2025-01-31/2502.00156_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ALBAR: Adversarial Learning approach to mitigate Biases in Action Recognition（セキュリティ分析論文）」（原題: ALBAR: Adversarial Learning approach to mitigate Biases in Action Recognition / arXiv: 2502.00156v2）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.00156v2`
- **論文URL**: [https://arxiv.org/abs/2502.00156v2](https://arxiv.org/abs/2502.00156v2)
- **PDFリンク**: [https://arxiv.org/pdf/2502.00156v2.pdf](https://arxiv.org/pdf/2502.00156v2.pdf)
- **著者**: Joseph Fioresi, Ishan Rajendrakumar Dave, Mubarak Shah
- **公開日時**: `2025-01-31T20:47:06Z`
- **カテゴリ**: `cs.CV, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-31/2502.00156_meta.json) | [`PDF`](../../raw_data/2025-01-31/2502.00156.pdf) | [`TXT`](../../raw_data/2025-01-31/2502.00156.txt)
