...
resource: "https://arxiv.org/abs/2607.07436v2"
tags:
  - "AI/ML Security"
  - "arXiv"
  - "cs.AI"
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.07436v2`](https://arxiv.org/abs/2607.07436v2) | Raw Meta = [`2607.07436_meta.json`](../../raw_data/2026-07-08/2607.07436_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「The Blind Curator: How a Biased Judge Silently Disables Skill Retirement in Self-Evolving Agents（セキュリティ分析論文）」（原題: The Blind Curator: How a Biased Judge Silently Disables Skill Retirement in Self-Evolving Agents / arXiv: 2607.07436v2）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.07436v2`
- **論文URL**: [https://arxiv.org/abs/2607.07436v2](https://arxiv.org/abs/2607.07436v2)
- **PDFリンク**: [https://arxiv.org/pdf/2607.07436v2.pdf](https://arxiv.org/pdf/2607.07436v2.pdf)
