...
title_ja: "zk-ScalHard: Scalable and Hardware-Rooted Privacy-Preserving Authentication for Secure OTA Updates in Zonal SDVs（セキュリティ分析論文）"
description: "zk-ScalHard: Scalable and Hardware-Rooted Privacy-Preserving Authentication for Secure OTA Updates in Zonal SDVs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.07371v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-08/2607.07371_meta.json"
  published_date: "2026-07-08T13:05:19Z"
  authors:
    - "Shrikant Tangade"
    - "Bansi Pambhar"
    - "Valeria Loscri"
...
### (日本語題名: zk-ScalHard: Scalable and Hardware-Rooted Privacy-Preserving Authentication for Secure OTA Updates in Zonal SDVs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.07371v2`](https://arxiv.org/abs/2607.07371v2) | Raw Meta = [`2607.07371_meta.json`](../../raw_data/2026-07-08/2607.07371_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「zk-ScalHard: Scalable and Hardware-Rooted Privacy-Preserving Authentication for Secure OTA Updates in Zonal SDVs（セキュリティ分析論文）」（原題: zk-ScalHard: Scalable and Hardware-Rooted Privacy-Preserving Authentication for Secure OTA Updates in Zonal SDVs / arXiv: 2607.07371v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.07371v2`
- **論文URL**: [https://arxiv.org/abs/2607.07371v2](https://arxiv.org/abs/2607.07371v2)
- **PDFリンク**: [https://arxiv.org/pdf/2607.07371v2.pdf](https://arxiv.org/pdf/2607.07371v2.pdf)
- **著者**: Shrikant Tangade, Bansi Pambhar, Valeria Loscri, Mauro Conti
- **公開日時**: `2026-07-08T13:05:19Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-08/2607.07371_meta.json) | [`PDF`](../../raw_data/2026-07-08/2607.07371.pdf) | [`TXT`](../../raw_data/2026-07-08/2607.07371.txt)
