...
title_ja: "Forensic Schema for Psychological Manipulation in Cyber Fraud: LLM-Driven Victim Reports Analysis（セキュリティ分析論文）"
description: "Forensic Schema for Psychological Manipulation in Cyber Fraud: LLM-Driven Victim Reports Analysis（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.07751v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-08/2607.07751_meta.json"
  published_date: "2026-07-08T11:37:56Z"
  authors:
    - "Zikai Alex Wen"
    - "Corrazon Ogot"
    - "Juan Li"
...
### (日本語題名: Forensic Schema for Psychological Manipulation in Cyber Fraud: LLM-Driven Victim Reports Analysis（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.07751v1`](https://arxiv.org/abs/2607.07751v1) | Raw Meta = [`2607.07751_meta.json`](../../raw_data/2026-07-08/2607.07751_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Forensic Schema for Psychological Manipulation in Cyber Fraud: LLM-Driven Victim Reports Analysis（セキュリティ分析論文）」（原題: Forensic Schema for Psychological Manipulation in Cyber Fraud: LLM-Driven Victim Reports Analysis / arXiv: 2607.07751v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.07751v1`
- **論文URL**: [https://arxiv.org/abs/2607.07751v1](https://arxiv.org/abs/2607.07751v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.07751v1.pdf](https://arxiv.org/pdf/2607.07751v1.pdf)
- **著者**: Zikai Alex Wen, Corrazon Ogot, Juan Li, Yan Bai
- **公開日時**: `2026-07-08T11:37:56Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-08/2607.07751_meta.json) | [`PDF`](../../raw_data/2026-07-08/2607.07751.pdf) | [`TXT`](../../raw_data/2026-07-08/2607.07751.txt)
