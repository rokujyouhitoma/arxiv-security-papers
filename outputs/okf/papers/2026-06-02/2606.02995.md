...
title_ja: "Patcher: Post-Hoc Patching of Backdoored 大規模言語モデル"
description: "Patcher: Post-Hoc Patching of Backdoored 大規模言語モデル — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.02995v2"
tags:
  - "arXiv"
  - "cs.IR"
  - "executive-summary"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-02/2606.02995_meta.json"
  published_date: "2026-06-02T01:11:58Z"
  authors:
    - "Anjun Gao"
    - "Yueyang Quan"
    - "Yufei Xia"
...
### (日本語題名: Patcher: Post-Hoc Patching of Backdoored 大規模言語モデル)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.02995v2`](https://arxiv.org/abs/2606.02995v2) | Raw Meta = [`2606.02995_meta.json`](../../raw_data/2026-06-02/2606.02995_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Patcher: Post-Hoc Patching of Backdoored 大規模言語モデル」（原題: Patcher: Post-Hoc Patching of Backdoored Large Language Models / arXiv: 2606.02995v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.02995v2`
- **論文URL**: [https://arxiv.org/abs/2606.02995v2](https://arxiv.org/abs/2606.02995v2)
- **PDFリンク**: [https://arxiv.org/pdf/2606.02995v2.pdf](https://arxiv.org/pdf/2606.02995v2.pdf)
- **著者**: Anjun Gao, Yueyang Quan, Yufei Xia, Zhuqing Liu, Minghong Fang
- **公開日時**: `2026-06-02T01:11:58Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.IR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-02/2606.02995_meta.json) | [`PDF`](../../raw_data/2026-06-02/2606.02995.pdf) | [`TXT`](../../raw_data/2026-06-02/2606.02995.txt)
