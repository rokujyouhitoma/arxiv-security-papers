---
type: "security-paper"
title: "From Hype to Collapse: Investigating Rug Pull Scams on Solana"
title_ja: "From Hype to Collapse: Investigating Rug Pull Scams on Solana（セキュリティ分析論文）"
description: "From Hype to Collapse: Investigating Rug Pull Scams on Solana（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.24625v2"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-25/2603.24625_meta.json"
  published_date: "2026-03-25T02:31:31Z"
  authors:
    - "Jiaxin Chen"
    - "Ziwei Li"
    - "Zigui Jiang"
...
### (日本語題名: From Hype to Collapse: Investigating Rug Pull Scams on Solana（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.24625v2`](https://arxiv.org/abs/2603.24625v2) | Raw Meta = [`2603.24625_meta.json`](../../raw_data/2026-03-25/2603.24625_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「From Hype to Collapse: Investigating Rug Pull Scams on Solana（セキュリティ分析論文）」（原題: From Hype to Collapse: Investigating Rug Pull Scams on Solana / arXiv: 2603.24625v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.24625v2`
- **論文URL**: [https://arxiv.org/abs/2603.24625v2](https://arxiv.org/abs/2603.24625v2)
- **PDFリンク**: [https://arxiv.org/pdf/2603.24625v2.pdf](https://arxiv.org/pdf/2603.24625v2.pdf)
- **著者**: Jiaxin Chen, Ziwei Li, Zigui Jiang, Ruihong He, Yantong Zhou, Jiajing Wu, Zibin Zheng
- **公開日時**: `2026-03-25T02:31:31Z`
- **カテゴリ**: `cs.CR, cs.CY`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-25/2603.24625_meta.json) | [`PDF`](../../raw_data/2026-03-25/2603.24625.pdf) | [`TXT`](../../raw_data/2026-03-25/2603.24625.txt)
