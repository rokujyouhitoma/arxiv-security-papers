...
title_ja: "Bridging Code Property Graphs and Language Models for Program Analysis（セキュリティ分析論文）"
description: "Bridging Code Property Graphs and Language Models for Program Analysis（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.24837v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-25/2603.24837_meta.json"
  published_date: "2026-03-25T22:08:04Z"
  authors:
    - "Ahmed Lekssays"
trust:
...
### (日本語題名: Bridging Code Property Graphs and Language Models for Program Analysis（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.24837v1`](https://arxiv.org/abs/2603.24837v1) | Raw Meta = [`2603.24837_meta.json`](../../raw_data/2026-03-25/2603.24837_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Bridging Code Property Graphs and Language Models for Program Analysis（セキュリティ分析論文）」（原題: Bridging Code Property Graphs and Language Models for Program Analysis / arXiv: 2603.24837v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.24837v1`
- **論文URL**: [https://arxiv.org/abs/2603.24837v1](https://arxiv.org/abs/2603.24837v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.24837v1.pdf](https://arxiv.org/pdf/2603.24837v1.pdf)
- **著者**: Ahmed Lekssays
- **公開日時**: `2026-03-25T22:08:04Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-25/2603.24837_meta.json) | [`PDF`](../../raw_data/2026-03-25/2603.24837.pdf) | [`TXT`](../../raw_data/2026-03-25/2603.24837.txt)
