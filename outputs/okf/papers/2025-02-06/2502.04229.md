...
title_ja: "Dark Distillation: Backdooring Distilled Datasets without Accessing Raw Data（セキュリティ分析論文）"
description: "Dark Distillation: Backdooring Distilled Datasets without Accessing Raw Data（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.04229v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-06/2502.04229_meta.json"
  published_date: "2025-02-06T17:14:17Z"
  authors:
    - "Ziyuan Yang"
    - "Ming Yan"
    - "Yi Zhang"
...
### (日本語題名: Dark Distillation: Backdooring Distilled Datasets without Accessing Raw Data（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.04229v1`](https://arxiv.org/abs/2502.04229v1) | Raw Meta = [`2502.04229_meta.json`](../../raw_data/2025-02-06/2502.04229_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Dark Distillation: Backdooring Distilled Datasets without Accessing Raw Data（セキュリティ分析論文）」（原題: Dark Distillation: Backdooring Distilled Datasets without Accessing Raw Data / arXiv: 2502.04229v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.04229v1`
- **論文URL**: [https://arxiv.org/abs/2502.04229v1](https://arxiv.org/abs/2502.04229v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.04229v1.pdf](https://arxiv.org/pdf/2502.04229v1.pdf)
- **著者**: Ziyuan Yang, Ming Yan, Yi Zhang, Joey Tianyi Zhou
- **公開日時**: `2025-02-06T17:14:17Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-06/2502.04229_meta.json) | [`PDF`](../../raw_data/2025-02-06/2502.04229.pdf) | [`TXT`](../../raw_data/2025-02-06/2502.04229.txt)
