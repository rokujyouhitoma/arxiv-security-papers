...
title_ja: "PatchSeeker: Mapping NVD Records to their Vulnerability-fixing Commits with LLM Generated Commits and Embeddings（セキュリティ分析論文）"
description: "PatchSeeker: Mapping NVD Records to their Vulnerability-fixing Commits with LLM Generated Commits and Embeddings（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.07540v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-09/2509.07540_meta.json"
  published_date: "2025-09-09T09:16:45Z"
  authors:
    - "Huu Hung Nguyen"
    - "Anh Tuan Nguyen"
    - "Thanh Le-Cong"
...
### (日本語題名: PatchSeeker: Mapping NVD Records to their Vulnerability-fixing Commits with LLM Generated Commits and Embeddings（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.07540v1`](https://arxiv.org/abs/2509.07540v1) | Raw Meta = [`2509.07540_meta.json`](../../raw_data/2025-09-09/2509.07540_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「PatchSeeker: Mapping NVD Records to their Vulnerability-fixing Commits with LLM Generated Commits and Embeddings（セキュリティ分析論文）」（原題: PatchSeeker: Mapping NVD Records to their Vulnerability-fixing Commits with LLM Generated Commits and Embeddings / arXiv: 2509.07540v1）は、cs.SE 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.07540v1`
- **論文URL**: [https://arxiv.org/abs/2509.07540v1](https://arxiv.org/abs/2509.07540v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.07540v1.pdf](https://arxiv.org/pdf/2509.07540v1.pdf)
- **著者**: Huu Hung Nguyen, Anh Tuan Nguyen, Thanh Le-Cong, Yikun Li, Han Wei Ang, Yide Yin, Frank Liauw, Shar Lwin Khin, Ouh Eng Lieh, Ting Zhang, David Lo
- **公開日時**: `2025-09-09T09:16:45Z`
- **カテゴリ**: `cs.SE, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-09/2509.07540_meta.json) | [`PDF`](../../raw_data/2025-09-09/2509.07540.pdf) | [`TXT`](../../raw_data/2025-09-09/2509.07540.txt)
