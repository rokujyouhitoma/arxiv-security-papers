...
title_ja: "Detecting Stealthy Data Poisoning Attacks in AI Code Generators（セキュリティ分析論文）"
description: "Detecting Stealthy Data Poisoning Attacks in AI Code Generators（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.21636v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-29/2508.21636_meta.json"
  published_date: "2025-08-29T14:00:06Z"
  authors:
    - "Cristina Improta"
trust:
...
### (日本語題名: Detecting Stealthy Data Poisoning Attacks in AI Code Generators（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.21636v1`](https://arxiv.org/abs/2508.21636v1) | Raw Meta = [`2508.21636_meta.json`](../../raw_data/2025-08-29/2508.21636_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Detecting Stealthy Data Poisoning Attacks in AI Code Generators（セキュリティ分析論文）」（原題: Detecting Stealthy Data Poisoning Attacks in AI Code Generators / arXiv: 2508.21636v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.21636v1`
- **論文URL**: [https://arxiv.org/abs/2508.21636v1](https://arxiv.org/abs/2508.21636v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.21636v1.pdf](https://arxiv.org/pdf/2508.21636v1.pdf)
- **著者**: Cristina Improta
- **公開日時**: `2025-08-29T14:00:06Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-29/2508.21636_meta.json) | [`PDF`](../../raw_data/2025-08-29/2508.21636.pdf) | [`TXT`](../../raw_data/2025-08-29/2508.21636.txt)
