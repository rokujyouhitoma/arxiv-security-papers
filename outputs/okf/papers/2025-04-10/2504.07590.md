...
title_ja: "DWFS-Obfuscation: Dynamic Weighted Feature Selection for Robust Malware Familial Classification under Obfuscation（セキュリティ分析論文）"
description: "DWFS-Obfuscation: Dynamic Weighted Feature Selection for Robust Malware Familial Classification under Obfuscation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.07590v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-10/2504.07590_meta.json"
  published_date: "2025-04-10T09:37:43Z"
  authors:
    - "Xingyuan Wei"
    - "Zijun Cheng"
    - "Ning Li"
...
### (日本語題名: DWFS-Obfuscation: Dynamic Weighted Feature Selection for Robust Malware Familial Classification under Obfuscation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.07590v1`](https://arxiv.org/abs/2504.07590v1) | Raw Meta = [`2504.07590_meta.json`](../../raw_data/2025-04-10/2504.07590_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「DWFS-Obfuscation: Dynamic Weighted Feature Selection for Robust Malware Familial Classification under Obfuscation（セキュリティ分析論文）」（原題: DWFS-Obfuscation: Dynamic Weighted Feature Selection for Robust Malware Familial Classification under Obfuscation / arXiv: 2504.07590v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.07590v1`
- **論文URL**: [https://arxiv.org/abs/2504.07590v1](https://arxiv.org/abs/2504.07590v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.07590v1.pdf](https://arxiv.org/pdf/2504.07590v1.pdf)
- **著者**: Xingyuan Wei, Zijun Cheng, Ning Li, Qiujian Lv, Ziyang Yu, Degang Sun
- **公開日時**: `2025-04-10T09:37:43Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-10/2504.07590_meta.json) | [`PDF`](../../raw_data/2025-04-10/2504.07590.pdf) | [`TXT`](../../raw_data/2025-04-10/2504.07590.txt)
