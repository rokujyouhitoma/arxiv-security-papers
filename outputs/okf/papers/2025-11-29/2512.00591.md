...
title_ja: "TrojanLoC: LLM-based Framework for RTL Trojan Localization（セキュリティ分析論文）"
description: "TrojanLoC: LLM-based Framework for RTL Trojan Localization（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.00591v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-29/2512.00591_meta.json"
  published_date: "2025-11-29T18:45:00Z"
  authors:
    - "Weihua Xiao"
    - "Zeng Wang"
    - "Minghao Shao"
...
### (日本語題名: TrojanLoC: LLM-based Framework for RTL Trojan Localization（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.00591v1`](https://arxiv.org/abs/2512.00591v1) | Raw Meta = [`2512.00591_meta.json`](../../raw_data/2025-11-29/2512.00591_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「TrojanLoC: LLM-based Framework for RTL Trojan Localization（セキュリティ分析論文）」（原題: TrojanLoC: LLM-based Framework for RTL Trojan Localization / arXiv: 2512.00591v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.00591v1`
- **論文URL**: [https://arxiv.org/abs/2512.00591v1](https://arxiv.org/abs/2512.00591v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.00591v1.pdf](https://arxiv.org/pdf/2512.00591v1.pdf)
- **著者**: Weihua Xiao, Zeng Wang, Minghao Shao, Raghu Vamshi Hemadri, Ozgur Sinanoglu, Muhammad Shafique, Johann Knechtel, Siddharth Garg, Ramesh Karri
- **公開日時**: `2025-11-29T18:45:00Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-29/2512.00591_meta.json) | [`PDF`](../../raw_data/2025-11-29/2512.00591.pdf) | [`TXT`](../../raw_data/2025-11-29/2512.00591.txt)
