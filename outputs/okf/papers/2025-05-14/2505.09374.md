...
title_ja: "DNS Query Forgery: A Client-Side Defense Against Mobile App Traffic Profiling（セキュリティ分析論文）"
description: "DNS Query Forgery: A Client-Side Defense Against Mobile App Traffic Profiling（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.09374v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-14/2505.09374_meta.json"
  published_date: "2025-05-14T13:25:19Z"
  authors:
...
### (日本語題名: DNS Query Forgery: A Client-Side Defense Against Mobile App Traffic Profiling（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.09374v1`](https://arxiv.org/abs/2505.09374v1) | Raw Meta = [`2505.09374_meta.json`](../../raw_data/2025-05-14/2505.09374_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「DNS Query Forgery: A Client-Side Defense Against Mobile App Traffic Profiling（セキュリティ分析論文）」（原題: DNS Query Forgery: A Client-Side Defense Against Mobile App Traffic Profiling / arXiv: 2505.09374v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.09374v1`
- **論文URL**: [https://arxiv.org/abs/2505.09374v1](https://arxiv.org/abs/2505.09374v1)
- **PDFリンク**: [https://arxiv.org/pdf/2505.09374v1.pdf](https://arxiv.org/pdf/2505.09374v1.pdf)
- **著者**: Andrea Jimenez-Berenguel, César Gil, Carlos Garcia-Rubio, Jordi Forné, Celeste Campo
- **公開日時**: `2025-05-14T13:25:19Z`
- **カテゴリ**: `cs.CR, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-14/2505.09374_meta.json) | [`PDF`](../../raw_data/2025-05-14/2505.09374.pdf) | [`TXT`](../../raw_data/2025-05-14/2505.09374.txt)
