...
title_ja: "A Compact Post-quantum Strong Designated Verifier Signature Scheme from Isogenies（セキュリティ分析論文）"
description: "A Compact Post-quantum Strong Designated Verifier Signature Scheme from Isogenies（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.14893v3"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-20/2507.14893_meta.json"
  published_date: "2025-07-20T10:15:38Z"
  authors:
    - "Farzin Renan"
trust:
...
### (日本語題名: A Compact Post-quantum Strong Designated Verifier Signature Scheme from Isogenies（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.14893v3`](https://arxiv.org/abs/2507.14893v3) | Raw Meta = [`2507.14893_meta.json`](../../raw_data/2025-07-20/2507.14893_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Compact Post-quantum Strong Designated Verifier Signature Scheme from Isogenies（セキュリティ分析論文）」（原題: A Compact Post-quantum Strong Designated Verifier Signature Scheme from Isogenies / arXiv: 2507.14893v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.14893v3`
- **論文URL**: [https://arxiv.org/abs/2507.14893v3](https://arxiv.org/abs/2507.14893v3)
- **PDFリンク**: [https://arxiv.org/pdf/2507.14893v3.pdf](https://arxiv.org/pdf/2507.14893v3.pdf)
- **著者**: Farzin Renan
- **公開日時**: `2025-07-20T10:15:38Z`
- **カテゴリ**: `cs.CR, math.NT`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-20/2507.14893_meta.json) | [`PDF`](../../raw_data/2025-07-20/2507.14893.pdf) | [`TXT`](../../raw_data/2025-07-20/2507.14893.txt)
