...
title_ja: "Sequential Data Poisoning in LLM Post-Training（セキュリティ分析論文）"
description: "Sequential Data Poisoning in LLM Post-Training（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.04929v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-03/2606.04929_meta.json"
  published_date: "2026-06-03T14:22:50Z"
  authors:
    - "Jack Sanderson"
    - "Yihan Wang"
    - "Xiaoqian Lu"
...
### (日本語題名: Sequential Data Poisoning in LLM Post-Training（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.04929v1`](https://arxiv.org/abs/2606.04929v1) | Raw Meta = [`2606.04929_meta.json`](../../raw_data/2026-06-03/2606.04929_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Sequential Data Poisoning in LLM Post-Training（セキュリティ分析論文）」（原題: Sequential Data Poisoning in LLM Post-Training / arXiv: 2606.04929v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2606.04929v1](https://arxiv.org/abs/2606.04929v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.04929v1.pdf](https://arxiv.org/pdf/2606.04929v1.pdf)
- **著者**: Jack Sanderson, Yihan Wang, Xiaoqian Lu, Gautam Kamath, Yiwei Lu
- **公開日時**: `2026-06-03T14:22:50Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-03/2606.04929_meta.json) | [`PDF`](../../raw_data/2026-06-03/2606.04929.pdf) | [`TXT`](../../raw_data/2026-06-03/2606.04929.txt)
