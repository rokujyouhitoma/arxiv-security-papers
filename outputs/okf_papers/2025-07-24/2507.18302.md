...
title_ja: "LoRA-Leak: Membership Inference Attacks Against LoRA Fine-tuned Language Models（セキュリティ分析論文）"
description: "LoRA-Leak: Membership Inference Attacks Against LoRA Fine-tuned Language Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.18302v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CL"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-24/2507.18302_meta.json"
  published_date: "2025-07-24T11:18:27Z"
  authors:
    - "Delong Ran"
    - "Xinlei He"
    - "Tianshuo Cong"
...
### (日本語題名: LoRA-Leak: Membership Inference Attacks Against LoRA Fine-tuned Language Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.18302v1`](https://arxiv.org/abs/2507.18302v1) | Raw Meta = [`2507.18302_meta.json`](../../raw_data/2025-07-24/2507.18302_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「LoRA-Leak: Membership Inference Attacks Against LoRA Fine-tuned Language Models（セキュリティ分析論文）」（原題: LoRA-Leak: Membership Inference Attacks Against LoRA Fine-tuned Language Models / arXiv: 2507.18302v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.18302v1`
- **論文URL**: [https://arxiv.org/abs/2507.18302v1](https://arxiv.org/abs/2507.18302v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.18302v1.pdf](https://arxiv.org/pdf/2507.18302v1.pdf)
- **著者**: Delong Ran, Xinlei He, Tianshuo Cong, Anyu Wang, Qi Li, Xiaoyun Wang
- **公開日時**: `2025-07-24T11:18:27Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-24/2507.18302_meta.json) | [`PDF`](../../raw_data/2025-07-24/2507.18302.pdf) | [`TXT`](../../raw_data/2025-07-24/2507.18302.txt)
