...
title_ja: "Defense Against Model Stealing Based on Account-Aware Distribution Discrepancy（セキュリティ分析論文）"
description: "Defense Against Model Stealing Based on Account-Aware Distribution Discrepancy（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.12497v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-16/2503.12497_meta.json"
  published_date: "2025-03-16T13:22:53Z"
  authors:
    - "Jian-Ping Mei"
    - "Weibin Zhang"
    - "Jie Chen"
...
### (日本語題名: Defense Against Model Stealing Based on Account-Aware Distribution Discrepancy（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.12497v1`](https://arxiv.org/abs/2503.12497v1) | Raw Meta = [`2503.12497_meta.json`](../../raw_data/2025-03-16/2503.12497_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Defense Against Model Stealing Based on Account-Aware Distribution Discrepancy（セキュリティ分析論文）」（原題: Defense Against Model Stealing Based on Account-Aware Distribution Discrepancy / arXiv: 2503.12497v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.12497v1`
- **論文URL**: [https://arxiv.org/abs/2503.12497v1](https://arxiv.org/abs/2503.12497v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.12497v1.pdf](https://arxiv.org/pdf/2503.12497v1.pdf)
- **著者**: Jian-Ping Mei, Weibin Zhang, Jie Chen, Xuyun Zhang, Tiantian Zhu
- **公開日時**: `2025-03-16T13:22:53Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-16/2503.12497_meta.json) | [`PDF`](../../raw_data/2025-03-16/2503.12497.pdf) | [`TXT`](../../raw_data/2025-03-16/2503.12497.txt)
