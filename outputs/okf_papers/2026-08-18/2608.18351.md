...
title_ja: "Task-Conditioned Least-Privilege Learning for Executable Terminal and MCP Agents（セキュリティ分析論文）"
description: "Task-Conditioned Least-Privilege Learning for Executable Terminal and MCP Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.18351v1"
tags:
  - "AI/ML Security"
  - "arXiv"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-18/2608.18351_meta.json"
  published_date: "2026-08-18T22:07:23Z"
  authors:
    - "Alexander Tu"
    - "Michael Tu"
trust:
...
### (日本語題名: Task-Conditioned Least-Privilege Learning for Executable Terminal and MCP Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.18351v1`](https://arxiv.org/abs/2608.18351v1) | Raw Meta = [`2608.18351_meta.json`](../../raw_data/2026-08-18/2608.18351_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Task-Conditioned Least-Privilege Learning for Executable Terminal and MCP Agents（セキュリティ分析論文）」（原題: Task-Conditioned Least-Privilege Learning for Executable Terminal and MCP Agents / arXiv: 2608.18351v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.18351v1`
- **論文URL**: [https://arxiv.org/abs/2608.18351v1](https://arxiv.org/abs/2608.18351v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.18351v1.pdf](https://arxiv.org/pdf/2608.18351v1.pdf)
- **著者**: Alexander Tu, Michael Tu
- **公開日時**: `2026-08-18T22:07:23Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG, eess.SY`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-18/2608.18351_meta.json) | [`PDF`](../../raw_data/2026-08-18/2608.18351.pdf) | [`TXT`](../../raw_data/2026-08-18/2608.18351.txt)
