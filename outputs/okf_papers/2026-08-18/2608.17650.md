...
title_ja: "An Emulation Anchored Digital Twin Testbed for Cyberattack and Defense Analysis in Hospital IT OT Environments（セキュリティ分析論文）"
description: "An Emulation Anchored Digital Twin Testbed for Cyberattack and Defense Analysis in Hospital IT OT Environments（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.17650v1"
tags:
  - "AI/ML Security"
  - "arXiv"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-18/2608.17650_meta.json"
  published_date: "2026-08-18T11:10:11Z"
  authors:
    - "Prashant Rawat"
    - "Ravi Kumar Bairagi"
    - "Arunima"
...
### (日本語題名: An Emulation Anchored Digital Twin Testbed for Cyberattack and Defense Analysis in Hospital IT OT Environments（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.17650v1`](https://arxiv.org/abs/2608.17650v1) | Raw Meta = [`2608.17650_meta.json`](../../raw_data/2026-08-18/2608.17650_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「An Emulation Anchored Digital Twin Testbed for Cyberattack and Defense Analysis in Hospital IT OT Environments（セキュリティ分析論文）」（原題: An Emulation Anchored Digital Twin Testbed for Cyberattack and Defense Analysis in Hospital IT OT Environments / arXiv: 2608.17650v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.17650v1`
- **論文URL**: [https://arxiv.org/abs/2608.17650v1](https://arxiv.org/abs/2608.17650v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.17650v1.pdf](https://arxiv.org/pdf/2608.17650v1.pdf)
- **著者**: Prashant Rawat, Ravi Kumar Bairagi, Arunima, Geeta Yadav
- **公開日時**: `2026-08-18T11:10:11Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-18/2608.17650_meta.json) | [`PDF`](../../raw_data/2026-08-18/2608.17650.pdf) | [`TXT`](../../raw_data/2026-08-18/2608.17650.txt)
