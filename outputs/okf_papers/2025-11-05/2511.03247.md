...
title_ja: "Death by a Thousand Prompts: Open Model Vulnerability Analysis（セキュリティ分析論文）"
description: "Death by a Thousand Prompts: Open Model Vulnerability Analysis（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.03247v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-05/2511.03247_meta.json"
  published_date: "2025-11-05T07:22:24Z"
  authors:
    - "Amy Chang"
    - "Nicholas Conley"
...
### (日本語題名: Death by a Thousand Prompts: Open Model Vulnerability Analysis（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.03247v1`](https://arxiv.org/abs/2511.03247v1) | Raw Meta = [`2511.03247_meta.json`](../../raw_data/2025-11-05/2511.03247_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Death by a Thousand Prompts: Open Model Vulnerability Analysis（セキュリティ分析論文）」（原題: Death by a Thousand Prompts: Open Model Vulnerability Analysis / arXiv: 2511.03247v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2511.03247v1](https://arxiv.org/abs/2511.03247v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.03247v1.pdf](https://arxiv.org/pdf/2511.03247v1.pdf)
- **著者**: Amy Chang, Nicholas Conley, Harish Santhanalakshmi Ganesan, Adam Swanda
- **公開日時**: `2025-11-05T07:22:24Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-05/2511.03247_meta.json) | [`PDF`](../../raw_data/2025-11-05/2511.03247.pdf) | [`TXT`](../../raw_data/2025-11-05/2511.03247.txt)
