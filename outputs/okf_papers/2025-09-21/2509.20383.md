...
title_ja: "MARS: A Malignity-Aware Backdoor Defense in 連合学習"
description: "MARS: A Malignity-Aware Backdoor Defense in 連合学習 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.20383v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-21/2509.20383_meta.json"
  published_date: "2025-09-21T14:50:02Z"
  authors:
    - "Wei Wan"
    - "Yuxuan Ning"
    - "Zhicong Huang"
...
### (日本語題名: MARS: A Malignity-Aware Backdoor Defense in 連合学習)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.20383v1`](https://arxiv.org/abs/2509.20383v1) | Raw Meta = [`2509.20383_meta.json`](../../raw_data/2025-09-21/2509.20383_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MARS: A Malignity-Aware Backdoor Defense in 連合学習」（原題: MARS: A Malignity-Aware Backdoor Defense in Federated Learning / arXiv: 2509.20383v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.20383v1`
- **論文URL**: [https://arxiv.org/abs/2509.20383v1](https://arxiv.org/abs/2509.20383v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.20383v1.pdf](https://arxiv.org/pdf/2509.20383v1.pdf)
- **著者**: Wei Wan, Yuxuan Ning, Zhicong Huang, Cheng Hong, Shengshan Hu, Ziqi Zhou, Yechao Zhang, Tianqing Zhu, Wanlei Zhou, Leo Yu Zhang
- **公開日時**: `2025-09-21T14:50:02Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-21/2509.20383_meta.json) | [`PDF`](../../raw_data/2025-09-21/2509.20383.pdf) | [`TXT`](../../raw_data/2025-09-21/2509.20383.txt)
