...
title_ja: "Secure Data Bridging in Industry 4.0: An OPC UA Aggregation Approach for Including Insecure Legacy Systems（セキュリティ分析論文）"
description: "Secure Data Bridging in Industry 4.0: An OPC UA Aggregation Approach for Including Insecure Legacy Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.10929v1"
tags:
  - "executive-summary"
  - "eess.SY"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-16/2601.10929_meta.json"
  published_date: "2026-01-16T01:18:31Z"
  authors:
    - "Dalibor Sain"
    - "Thomas Rosenstatter"
    - "Olaf Saßnick"
...
### (日本語題名: Secure Data Bridging in Industry 4.0: An OPC UA Aggregation Approach for Including Insecure Legacy Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.10929v1`](https://arxiv.org/abs/2601.10929v1) | Raw Meta = [`2601.10929_meta.json`](../../raw_data/2026-01-16/2601.10929_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Secure Data Bridging in Industry 4.0: An OPC UA Aggregation Approach for Including Insecure Legacy Systems（セキュリティ分析論文）」（原題: Secure Data Bridging in Industry 4.0: An OPC UA Aggregation Approach for Including Insecure Legacy Systems / arXiv: 2601.10929v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.10929v1`
- **論文URL**: [https://arxiv.org/abs/2601.10929v1](https://arxiv.org/abs/2601.10929v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.10929v1.pdf](https://arxiv.org/pdf/2601.10929v1.pdf)
- **著者**: Dalibor Sain, Thomas Rosenstatter, Olaf Saßnick, Christian Schäfer, Stefan Huber
- **公開日時**: `2026-01-16T01:18:31Z`
- **カテゴリ**: `cs.CR, eess.SY`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-16/2601.10929_meta.json) | [`PDF`](../../raw_data/2026-01-16/2601.10929.pdf) | [`TXT`](../../raw_data/2026-01-16/2601.10929.txt)
