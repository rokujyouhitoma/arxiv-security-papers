...
title_ja: "A Novel and Practical Universal Adversarial Perturbations against Deep Reinforcement Learning based Intrusion Detection Systems（セキュリティ分析論文）"
description: "A Novel and Practical Universal Adversarial Perturbations against Deep Reinforcement Learning based Intrusion Detection Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.18223v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-22/2511.18223_meta.json"
  published_date: "2025-11-22T23:52:01Z"
  authors:
    - "H. Zhang"
    - "L. Zhang"
    - "G. Epiphaniou"
...
### (日本語題名: A Novel and Practical Universal Adversarial Perturbations against Deep Reinforcement Learning based Intrusion Detection Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.18223v1`](https://arxiv.org/abs/2511.18223v1) | Raw Meta = [`2511.18223_meta.json`](../../raw_data/2025-11-22/2511.18223_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Novel and Practical Universal Adversarial Perturbations against Deep Reinforcement Learning based Intrusion Detection Systems（セキュリティ分析論文）」（原題: A Novel and Practical Universal Adversarial Perturbations against Deep Reinforcement Learning based Intrusion Detection Systems / arXiv: 2511.18223v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2511.18223v1](https://arxiv.org/abs/2511.18223v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.18223v1.pdf](https://arxiv.org/pdf/2511.18223v1.pdf)
- **著者**: H. Zhang, L. Zhang, G. Epiphaniou, C. Maple
- **公開日時**: `2025-11-22T23:52:01Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-22/2511.18223_meta.json) | [`PDF`](../../raw_data/2025-11-22/2511.18223.pdf) | [`TXT`](../../raw_data/2025-11-22/2511.18223.txt)
