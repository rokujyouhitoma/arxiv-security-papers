...
title_ja: "GAS-Leak-LLM: Genetic Algorithm-Based Suffix Optimization for Black-Box LLM Jailbreaking（セキュリティ分析論文）"
description: "GAS-Leak-LLM: Genetic Algorithm-Based Suffix Optimization for Black-Box LLM Jailbreaking（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.15788v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-14/2606.15788_meta.json"
  published_date: "2026-06-14T12:41:21Z"
  authors:
    - "Aman Anifer"
    - "Vignesh Kumar Kembu"
    - "Vishnu M"
...
### (日本語題名: GAS-Leak-LLM: Genetic Algorithm-Based Suffix Optimization for Black-Box LLM Jailbreaking（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.15788v1`](https://arxiv.org/abs/2606.15788v1) | Raw Meta = [`2606.15788_meta.json`](../../raw_data/2026-06-14/2606.15788_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「GAS-Leak-LLM: Genetic Algorithm-Based Suffix Optimization for Black-Box LLM Jailbreaking（セキュリティ分析論文）」（原題: GAS-Leak-LLM: Genetic Algorithm-Based Suffix Optimization for Black-Box LLM Jailbreaking / arXiv: 2606.15788v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.15788v1`
- **論文URL**: [https://arxiv.org/abs/2606.15788v1](https://arxiv.org/abs/2606.15788v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.15788v1.pdf](https://arxiv.org/pdf/2606.15788v1.pdf)
- **著者**: Aman Anifer, Vignesh Kumar Kembu, Vishnu M, Antonino Nocera, Vinod P., Amal Murali PK, Akshay S Rajan
- **公開日時**: `2026-06-14T12:41:21Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-14/2606.15788_meta.json) | [`PDF`](../../raw_data/2026-06-14/2606.15788.pdf) | [`TXT`](../../raw_data/2026-06-14/2606.15788.txt)
