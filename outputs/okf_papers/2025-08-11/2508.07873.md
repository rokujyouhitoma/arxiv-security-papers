...
title_ja: "EFU: Enforcing Federated Unlearning via Functional Encryption（セキュリティ分析論文）"
description: "EFU: Enforcing Federated Unlearning via Functional Encryption（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.07873v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-11/2508.07873_meta.json"
  published_date: "2025-08-11T11:44:21Z"
  authors:
    - "Samaneh Mohammadi"
    - "Vasileios Tsouvalas"
    - "Iraklis Symeonidis"
...
### (日本語題名: EFU: Enforcing Federated Unlearning via Functional Encryption（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.07873v1`](https://arxiv.org/abs/2508.07873v1) | Raw Meta = [`2508.07873_meta.json`](../../raw_data/2025-08-11/2508.07873_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「EFU: Enforcing Federated Unlearning via Functional Encryption（セキュリティ分析論文）」（原題: EFU: Enforcing Federated Unlearning via Functional Encryption / arXiv: 2508.07873v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.07873v1`
- **論文URL**: [https://arxiv.org/abs/2508.07873v1](https://arxiv.org/abs/2508.07873v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.07873v1.pdf](https://arxiv.org/pdf/2508.07873v1.pdf)
- **著者**: Samaneh Mohammadi, Vasileios Tsouvalas, Iraklis Symeonidis, Ali Balador, Tanir Ozcelebi, Francesco Flammini, Nirvana Meratnia
- **公開日時**: `2025-08-11T11:44:21Z`
- **カテゴリ**: `cs.CR, cs.DC, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-11/2508.07873_meta.json) | [`PDF`](../../raw_data/2025-08-11/2508.07873.pdf) | [`TXT`](../../raw_data/2025-08-11/2508.07873.txt)
