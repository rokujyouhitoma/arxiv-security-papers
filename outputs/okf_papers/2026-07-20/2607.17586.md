...
title_ja: "Detection, Attribution, Narration: An End-to-End Pipeline for Explainable Money Mule Identification（セキュリティ分析論文）"
description: "Detection, Attribution, Narration: An End-to-End Pipeline for Explainable Money Mule Identification（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.17586v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-20/2607.17586_meta.json"
  published_date: "2026-07-20T06:05:57Z"
  authors:
    - "Yuge Zhang"
    - "Yuanxing Zhang"
    - "Yichao Jin"
...
### (日本語題名: Detection, Attribution, Narration: An End-to-End Pipeline for Explainable Money Mule Identification（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.17586v1`](https://arxiv.org/abs/2607.17586v1) | Raw Meta = [`2607.17586_meta.json`](../../raw_data/2026-07-20/2607.17586_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Detection, Attribution, Narration: An End-to-End Pipeline for Explainable Money Mule Identification（セキュリティ分析論文）」（原題: Detection, Attribution, Narration: An End-to-End Pipeline for Explainable Money Mule Identification / arXiv: 2607.17586v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.17586v1`
- **論文URL**: [https://arxiv.org/abs/2607.17586v1](https://arxiv.org/abs/2607.17586v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.17586v1.pdf](https://arxiv.org/pdf/2607.17586v1.pdf)
- **著者**: Yuge Zhang, Yuanxing Zhang, Yichao Jin, Khairul Amsyar Mohd Razis, Nicholas Qi An Choo, Kai Yin Anders Wong, Xinyan Tang, Kenneth Zhu Ke, Wee Keong Dennis Lee, Jingyuan Zhao
- **公開日時**: `2026-07-20T06:05:57Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-20/2607.17586_meta.json) | [`PDF`](../../raw_data/2026-07-20/2607.17586.pdf) | [`TXT`](../../raw_data/2026-07-20/2607.17586.txt)
