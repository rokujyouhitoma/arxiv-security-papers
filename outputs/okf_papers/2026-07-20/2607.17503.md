...
title_ja: "ShadowPickle: Evading Machine Learning Model Scanners via Stealthy Pickle Deserialization Attacks（セキュリティ分析論文）"
description: "ShadowPickle: Evading Machine Learning Model Scanners via Stealthy Pickle Deserialization Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.17503v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-20/2607.17503_meta.json"
  published_date: "2026-07-20T03:18:15Z"
  authors:
    - "Dhruv Pradhan"
    - "Sarang Nambiar"
    - "Ezekiel Soremekun"
...
### (日本語題名: ShadowPickle: Evading Machine Learning Model Scanners via Stealthy Pickle Deserialization Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.17503v1`](https://arxiv.org/abs/2607.17503v1) | Raw Meta = [`2607.17503_meta.json`](../../raw_data/2026-07-20/2607.17503_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ShadowPickle: Evading Machine Learning Model Scanners via Stealthy Pickle Deserialization Attacks（セキュリティ分析論文）」（原題: ShadowPickle: Evading Machine Learning Model Scanners via Stealthy Pickle Deserialization Attacks / arXiv: 2607.17503v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.17503v1`
- **論文URL**: [https://arxiv.org/abs/2607.17503v1](https://arxiv.org/abs/2607.17503v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.17503v1.pdf](https://arxiv.org/pdf/2607.17503v1.pdf)
- **著者**: Dhruv Pradhan, Sarang Nambiar, Ezekiel Soremekun
- **公開日時**: `2026-07-20T03:18:15Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-20/2607.17503_meta.json) | [`PDF`](../../raw_data/2026-07-20/2607.17503.pdf) | [`TXT`](../../raw_data/2026-07-20/2607.17503.txt)
