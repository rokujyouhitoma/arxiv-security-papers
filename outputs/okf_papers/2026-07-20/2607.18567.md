...
title_ja: "Attacking Graph Foundation Models Through Their Shared Representation（セキュリティ分析論文）"
description: "Attacking Graph Foundation Models Through Their Shared Representation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.18567v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-20/2607.18567_meta.json"
  published_date: "2026-07-20T23:03:26Z"
  authors:
    - "Pankaj Kumar"
    - "Subhankar Mishra"
trust:
...
### (日本語題名: Attacking Graph Foundation Models Through Their Shared Representation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.18567v1`](https://arxiv.org/abs/2607.18567v1) | Raw Meta = [`2607.18567_meta.json`](../../raw_data/2026-07-20/2607.18567_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Attacking Graph Foundation Models Through Their Shared Representation（セキュリティ分析論文）」（原題: Attacking Graph Foundation Models Through Their Shared Representation / arXiv: 2607.18567v1）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2607.18567v1](https://arxiv.org/abs/2607.18567v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.18567v1.pdf](https://arxiv.org/pdf/2607.18567v1.pdf)
- **著者**: Pankaj Kumar, Subhankar Mishra
- **公開日時**: `2026-07-20T23:03:26Z`
- **カテゴリ**: `cs.AI, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-20/2607.18567_meta.json) | [`PDF`](../../raw_data/2026-07-20/2607.18567.pdf) | [`TXT`](../../raw_data/2026-07-20/2607.18567.txt)
