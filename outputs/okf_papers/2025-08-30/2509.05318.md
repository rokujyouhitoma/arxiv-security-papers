...
title_ja: "Backdoor Samples Detection Based on Perturbation Discrepancy Consistency in Pre-trained Language Models（セキュリティ分析論文）"
description: "Backdoor Samples Detection Based on Perturbation Discrepancy Consistency in Pre-trained Language Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.05318v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-30/2509.05318_meta.json"
  published_date: "2025-08-30T06:35:32Z"
  authors:
    - "Zuquan Peng"
    - "Jianming Fu"
    - "Lixin Zou"
...
### (日本語題名: Backdoor Samples Detection Based on Perturbation Discrepancy Consistency in Pre-trained Language Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.05318v1`](https://arxiv.org/abs/2509.05318v1) | Raw Meta = [`2509.05318_meta.json`](../../raw_data/2025-08-30/2509.05318_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Backdoor Samples Detection Based on Perturbation Discrepancy Consistency in Pre-trained Language Models（セキュリティ分析論文）」（原題: Backdoor Samples Detection Based on Perturbation Discrepancy Consistency in Pre-trained Language Models / arXiv: 2509.05318v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.05318v1`
- **論文URL**: [https://arxiv.org/abs/2509.05318v1](https://arxiv.org/abs/2509.05318v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.05318v1.pdf](https://arxiv.org/pdf/2509.05318v1.pdf)
- **著者**: Zuquan Peng, Jianming Fu, Lixin Zou, Li Zheng, Yanzhen Ren, Guojun Peng
- **公開日時**: `2025-08-30T06:35:32Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-30/2509.05318_meta.json) | [`PDF`](../../raw_data/2025-08-30/2509.05318.pdf) | [`TXT`](../../raw_data/2025-08-30/2509.05318.txt)
