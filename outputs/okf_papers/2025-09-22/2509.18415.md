...
title_ja: "Context Lineage Assurance for Non-Human Identities in Critical Multi-Agent Systems（セキュリティ分析論文）"
description: "Context Lineage Assurance for Non-Human Identities in Critical Multi-Agent Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.18415v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-22/2509.18415_meta.json"
  published_date: "2025-09-22T20:59:51Z"
  authors:
    - "Sumana Malkapuram"
    - "Sameera Gangavarapu"
...
### (日本語題名: Context Lineage Assurance for Non-Human Identities in Critical Multi-Agent Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.18415v1`](https://arxiv.org/abs/2509.18415v1) | Raw Meta = [`2509.18415_meta.json`](../../raw_data/2025-09-22/2509.18415_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Context Lineage Assurance for Non-Human Identities in Critical Multi-Agent Systems（セキュリティ分析論文）」（原題: Context Lineage Assurance for Non-Human Identities in Critical Multi-Agent Systems / arXiv: 2509.18415v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2509.18415v1](https://arxiv.org/abs/2509.18415v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.18415v1.pdf](https://arxiv.org/pdf/2509.18415v1.pdf)
- **著者**: Sumana Malkapuram, Sameera Gangavarapu, Kailashnath Reddy Kavalakuntla, Ananya Gangavarapu
- **公開日時**: `2025-09-22T20:59:51Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-22/2509.18415_meta.json) | [`PDF`](../../raw_data/2025-09-22/2509.18415.pdf) | [`TXT`](../../raw_data/2025-09-22/2509.18415.txt)
