...
resource: "https://arxiv.org/abs/2607.01854v2"
tags:
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.01854v2`](https://arxiv.org/abs/2607.01854v2) | Raw Meta = [`2607.01854_meta.json`](../../raw_data/2026-07-02/2607.01854_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Has This Checkpoint Been Abliterated? A Two-Signal Audit and Its Failure Map（セキュリティ分析論文）」（原題: Has This Checkpoint Been Abliterated? A Two-Signal Audit and Its Failure Map / arXiv: 2607.01854v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.01854v2`
- **論文URL**: [https://arxiv.org/abs/2607.01854v2](https://arxiv.org/abs/2607.01854v2)
- **PDFリンク**: [https://arxiv.org/pdf/2607.01854v2.pdf](https://arxiv.org/pdf/2607.01854v2.pdf)
- **著者**: Gabriel Hurtado
