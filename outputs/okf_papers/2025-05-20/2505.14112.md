...
title_ja: "Invisible Entropy: Safe and Efficient Low-Entropy LLM Watermarkingに向けて"
description: "Invisible Entropy: Safe and Efficient Low-Entropy LLM Watermarkingに向けて — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.14112v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CL"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-20/2505.14112_meta.json"
  published_date: "2025-05-20T09:19:06Z"
  authors:
    - "Tianle Gu"
    - "Zongqi Wang"
    - "Kexin Huang"
...
### (日本語題名: Invisible Entropy: Safe and Efficient Low-Entropy LLM Watermarkingに向けて)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.14112v1`](https://arxiv.org/abs/2505.14112v1) | Raw Meta = [`2505.14112_meta.json`](../../raw_data/2025-05-20/2505.14112_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Invisible Entropy: Safe and Efficient Low-Entropy LLM Watermarkingに向けて」（原題: Invisible Entropy: Towards Safe and Efficient Low-Entropy LLM Watermarking / arXiv: 2505.14112v1）は、cs.CL 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.14112v1`
- **論文URL**: [https://arxiv.org/abs/2505.14112v1](https://arxiv.org/abs/2505.14112v1)
- **PDFリンク**: [https://arxiv.org/pdf/2505.14112v1.pdf](https://arxiv.org/pdf/2505.14112v1.pdf)
- **著者**: Tianle Gu, Zongqi Wang, Kexin Huang, Yuanqi Yao, Xiangliang Zhang, Yujiu Yang, Xiuying Chen
- **公開日時**: `2025-05-20T09:19:06Z`
- **カテゴリ**: `cs.CL, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-20/2505.14112_meta.json) | [`PDF`](../../raw_data/2025-05-20/2505.14112.pdf) | [`TXT`](../../raw_data/2025-05-20/2505.14112.txt)
