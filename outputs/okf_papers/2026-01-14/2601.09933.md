...
title_ja: "Malware Classification using Diluted Convolutional Neural Network with Fast Gradient Sign Method（セキュリティ分析論文）"
description: "Malware Classification using Diluted Convolutional Neural Network with Fast Gradient Sign Method（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.09933v1"
tags:
  - "cs.CE"
  - "cs.AI"
  - "executive-summary"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-14/2601.09933_meta.json"
  published_date: "2026-01-14T23:35:08Z"
  authors:
    - "Ashish Anand"
    - "Bhupendra Singh"
    - "Sunil Khemka"
...
### (日本語題名: Malware Classification using Diluted Convolutional Neural Network with Fast Gradient Sign Method（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.09933v1`](https://arxiv.org/abs/2601.09933v1) | Raw Meta = [`2601.09933_meta.json`](../../raw_data/2026-01-14/2601.09933_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Malware Classification using Diluted Convolutional Neural Network with Fast Gradient Sign Method（セキュリティ分析論文）」（原題: Malware Classification using Diluted Convolutional Neural Network with Fast Gradient Sign Method / arXiv: 2601.09933v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.09933v1`
- **論文URL**: [https://arxiv.org/abs/2601.09933v1](https://arxiv.org/abs/2601.09933v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.09933v1.pdf](https://arxiv.org/pdf/2601.09933v1.pdf)
- **著者**: Ashish Anand, Bhupendra Singh, Sunil Khemka, Bireswar Banerjee, Vishi Singh Bhatia, Piyush Ranjan
- **公開日時**: `2026-01-14T23:35:08Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CE, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-14/2601.09933_meta.json) | [`PDF`](../../raw_data/2026-01-14/2601.09933.pdf) | [`TXT`](../../raw_data/2026-01-14/2601.09933.txt)
