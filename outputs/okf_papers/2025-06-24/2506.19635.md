...
title_ja: "On the efficacy of old features for the new botsの検出"
description: "On the efficacy of old features for the new botsの検出 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.19635v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-24/2506.19635_meta.json"
  published_date: "2025-06-24T13:56:09Z"
  authors:
    - "Rocco De Nicola"
    - "Marinella Petrocchi"
    - "Manuel Pratelli"
...
### (日本語題名: On the efficacy of old features for the new botsの検出)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.19635v1`](https://arxiv.org/abs/2506.19635v1) | Raw Meta = [`2506.19635_meta.json`](../../raw_data/2025-06-24/2506.19635_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「On the efficacy of old features for the new botsの検出」（原題: On the efficacy of old features for the detection of new bots / arXiv: 2506.19635v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.19635v1`
- **論文URL**: [https://arxiv.org/abs/2506.19635v1](https://arxiv.org/abs/2506.19635v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.19635v1.pdf](https://arxiv.org/pdf/2506.19635v1.pdf)
- **著者**: Rocco De Nicola, Marinella Petrocchi, Manuel Pratelli
- **公開日時**: `2025-06-24T13:56:09Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.SI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-24/2506.19635_meta.json) | [`PDF`](../../raw_data/2025-06-24/2506.19635.pdf) | [`TXT`](../../raw_data/2025-06-24/2506.19635.txt)
