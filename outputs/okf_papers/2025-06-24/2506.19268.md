...
title_ja: "Health App Reviews for Privacy & Trust (HARPT): A Corpus for Analyzing Patient Privacy Concerns, Trust in Providers and Trust in Applications（セキュリティ分析論文）"
description: "Health App Reviews for Privacy & Trust (HARPT): A Corpus for Analyzing Patient Privacy Concerns, Trust in Providers and Trust in Applications（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.19268v4"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.HC"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-24/2506.19268_meta.json"
  published_date: "2025-06-24T02:59:14Z"
  authors:
    - "Timoteo Kelly"
    - "Abdulkadir Korkmaz"
    - "Samuel Mallet"
...
### (日本語題名: Health App Reviews for Privacy & Trust (HARPT): A Corpus for Analyzing Patient Privacy Concerns, Trust in Providers and Trust in Applications（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.19268v4`](https://arxiv.org/abs/2506.19268v4) | Raw Meta = [`2506.19268_meta.json`](../../raw_data/2025-06-24/2506.19268_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Health App Reviews for Privacy & Trust (HARPT): A Corpus for Analyzing Patient Privacy Concerns, Trust in Providers and Trust in Applications（セキュリティ分析論文）」（原題: Health App Reviews for Privacy & Trust (HARPT): A Corpus for Analyzing Patient Privacy Concerns, Trust in Providers and Trust in Applications / arXiv: 2506.19268v4）は、cs.HC 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.19268v4`
- **論文URL**: [https://arxiv.org/abs/2506.19268v4](https://arxiv.org/abs/2506.19268v4)
- **PDFリンク**: [https://arxiv.org/pdf/2506.19268v4.pdf](https://arxiv.org/pdf/2506.19268v4.pdf)
- **著者**: Timoteo Kelly, Abdulkadir Korkmaz, Samuel Mallet, Connor Souders, Sadra Aliakbarpour, Praveen Rao
- **公開日時**: `2025-06-24T02:59:14Z`
- **カテゴリ**: `cs.HC, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-24/2506.19268_meta.json) | [`PDF`](../../raw_data/2025-06-24/2506.19268.pdf) | [`TXT`](../../raw_data/2025-06-24/2506.19268.txt)
