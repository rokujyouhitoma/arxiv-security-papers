...
title_ja: "Verifiable Unlearning on Edge（セキュリティ分析論文）"
description: "Verifiable Unlearning on Edge（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.20037v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-24/2506.20037_meta.json"
  published_date: "2025-06-24T22:24:47Z"
  authors:
    - "Mohammad M Maheri"
    - "Alex Davidson"
    - "Hamed Haddadi"
...
### (日本語題名: Verifiable Unlearning on Edge（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.20037v1`](https://arxiv.org/abs/2506.20037v1) | Raw Meta = [`2506.20037_meta.json`](../../raw_data/2025-06-24/2506.20037_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Verifiable Unlearning on Edge（セキュリティ分析論文）」（原題: Verifiable Unlearning on Edge / arXiv: 2506.20037v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.20037v1`
- **論文URL**: [https://arxiv.org/abs/2506.20037v1](https://arxiv.org/abs/2506.20037v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.20037v1.pdf](https://arxiv.org/pdf/2506.20037v1.pdf)
- **著者**: Mohammad M Maheri, Alex Davidson, Hamed Haddadi
- **公開日時**: `2025-06-24T22:24:47Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-24/2506.20037_meta.json) | [`PDF`](../../raw_data/2025-06-24/2506.20037.pdf) | [`TXT`](../../raw_data/2025-06-24/2506.20037.txt)
