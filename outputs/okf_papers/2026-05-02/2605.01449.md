...
title_ja: "VisInject: Disruption != Injection -- A Dual-Dimension Evaluation of Universal Vision-Language Modelsに対する敵対的攻撃"
description: "VisInject: Disruption != Injection -- A Dual-Dimension Evaluation of Universal Vision-Language Modelsに対する敵対的攻撃 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.01449v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-02/2605.01449_meta.json"
  published_date: "2026-05-02T13:56:50Z"
  authors:
    - "Pang Liu"
    - "Yingjie Lao"
trust:
...
### (日本語題名: VisInject: Disruption != Injection -- A Dual-Dimension Evaluation of Universal Vision-Language Modelsに対する敵対的攻撃)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.01449v1`](https://arxiv.org/abs/2605.01449v1) | Raw Meta = [`2605.01449_meta.json`](../../raw_data/2026-05-02/2605.01449_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「VisInject: Disruption != Injection -- A Dual-Dimension Evaluation of Universal Vision-Language Modelsに対する敵対的攻撃」（原題: VisInject: Disruption != Injection -- A Dual-Dimension Evaluation of Universal Adversarial Attacks on Vision-Language Models / arXiv: 2605.01449v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.01449v1`
- **論文URL**: [https://arxiv.org/abs/2605.01449v1](https://arxiv.org/abs/2605.01449v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.01449v1.pdf](https://arxiv.org/pdf/2605.01449v1.pdf)
- **著者**: Pang Liu, Yingjie Lao
- **公開日時**: `2026-05-02T13:56:50Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-02/2605.01449_meta.json) | [`PDF`](../../raw_data/2026-05-02/2605.01449.pdf) | [`TXT`](../../raw_data/2026-05-02/2605.01449.txt)
