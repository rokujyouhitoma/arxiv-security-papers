...
title_ja: "Multi-View Decompilation for LLM-Based Malware Classification（セキュリティ分析論文）"
description: "Multi-View Decompilation for LLM-Based Malware Classification（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.20436v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-18/2606.20436_meta.json"
  published_date: "2026-06-18T16:15:30Z"
  authors:
    - "Bercan Turkmen"
    - "Vyas Raina"
trust:
...
### (日本語題名: Multi-View Decompilation for LLM-Based Malware Classification（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.20436v1`](https://arxiv.org/abs/2606.20436v1) | Raw Meta = [`2606.20436_meta.json`](../../raw_data/2026-06-18/2606.20436_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Multi-View Decompilation for LLM-Based Malware Classification（セキュリティ分析論文）」（原題: Multi-View Decompilation for LLM-Based Malware Classification / arXiv: 2606.20436v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.20436v1`
- **論文URL**: [https://arxiv.org/abs/2606.20436v1](https://arxiv.org/abs/2606.20436v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.20436v1.pdf](https://arxiv.org/pdf/2606.20436v1.pdf)
- **著者**: Bercan Turkmen, Vyas Raina
- **公開日時**: `2026-06-18T16:15:30Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-18/2606.20436_meta.json) | [`PDF`](../../raw_data/2026-06-18/2606.20436.pdf) | [`TXT`](../../raw_data/2026-06-18/2606.20436.txt)
