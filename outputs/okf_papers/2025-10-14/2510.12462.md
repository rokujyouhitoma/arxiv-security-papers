...
title_ja: "Evaluating and Mitigating LLM-as-a-judge Bias in Communication Systems（セキュリティ分析論文）"
description: "Evaluating and Mitigating LLM-as-a-judge Bias in Communication Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.12462v3"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-10-14/2510.12462_meta.json"
  published_date: "2025-10-14T12:52:29Z"
  authors:
    - "Jiaxin Gao"
    - "Chen Chen"
    - "Yanwen Jia"
...
### (日本語題名: Evaluating and Mitigating LLM-as-a-judge Bias in Communication Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.12462v3`](https://arxiv.org/abs/2510.12462v3) | Raw Meta = [`2510.12462_meta.json`](../../raw_data/2025-10-14/2510.12462_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Evaluating and Mitigating LLM-as-a-judge Bias in Communication Systems（セキュリティ分析論文）」（原題: Evaluating and Mitigating LLM-as-a-judge Bias in Communication Systems / arXiv: 2510.12462v3）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2510.12462v3`
- **論文URL**: [https://arxiv.org/abs/2510.12462v3](https://arxiv.org/abs/2510.12462v3)
- **PDFリンク**: [https://arxiv.org/pdf/2510.12462v3.pdf](https://arxiv.org/pdf/2510.12462v3.pdf)
- **著者**: Jiaxin Gao, Chen Chen, Yanwen Jia, Xueluan Gong, Kwok-Yan Lam, Qian Wang
- **公開日時**: `2025-10-14T12:52:29Z`
- **カテゴリ**: `cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-10-14/2510.12462_meta.json) | [`PDF`](../../raw_data/2025-10-14/2510.12462.pdf) | [`TXT`](../../raw_data/2025-10-14/2510.12462.txt)
