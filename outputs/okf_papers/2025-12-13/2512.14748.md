...
title_ja: "Modeling the Interdependent Coupling of Safety and Security for Connected and Automated Vehicles: A Copula-Based Integrated Risk Analysis Approach（セキュリティ分析論文）"
description: "Modeling the Interdependent Coupling of Safety and Security for Connected and Automated Vehicles: A Copula-Based Integrated Risk Analysis Approach（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.14748v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-13/2512.14748_meta.json"
  published_date: "2025-12-13T06:29:52Z"
  authors:
    - "Xingyu Li"
    - "Qi Liu"
    - "Yufeng Li"
...
### (日本語題名: Modeling the Interdependent Coupling of Safety and Security for Connected and Automated Vehicles: A Copula-Based Integrated Risk Analysis Approach（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.14748v1`](https://arxiv.org/abs/2512.14748v1) | Raw Meta = [`2512.14748_meta.json`](../../raw_data/2025-12-13/2512.14748_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Modeling the Interdependent Coupling of Safety and Security for Connected and Automated Vehicles: A Copula-Based Integrated Risk Analysis Approach（セキュリティ分析論文）」（原題: Modeling the Interdependent Coupling of Safety and Security for Connected and Automated Vehicles: A Copula-Based Integrated Risk Analysis Approach / arXiv: 2512.14748v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.14748v1`
- **論文URL**: [https://arxiv.org/abs/2512.14748v1](https://arxiv.org/abs/2512.14748v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.14748v1.pdf](https://arxiv.org/pdf/2512.14748v1.pdf)
- **著者**: Xingyu Li, Qi Liu, Yufeng Li
- **公開日時**: `2025-12-13T06:29:52Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-13/2512.14748_meta.json) | [`PDF`](../../raw_data/2025-12-13/2512.14748.pdf) | [`TXT`](../../raw_data/2025-12-13/2512.14748.txt)
