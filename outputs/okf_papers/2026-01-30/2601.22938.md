...
title_ja: "A Real-Time Privacy-Preserving Behavior Recognition System via Edge-Cloud Collaboration（セキュリティ分析論文）"
description: "A Real-Time Privacy-Preserving Behavior Recognition System via Edge-Cloud Collaboration（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.22938v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "eess.IV"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-30/2601.22938_meta.json"
  published_date: "2026-01-30T12:55:36Z"
  authors:
    - "Huan Song"
    - "Shuyu Tian"
    - "Junyi Hao"
...
### (日本語題名: A Real-Time Privacy-Preserving Behavior Recognition System via Edge-Cloud Collaboration（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.22938v1`](https://arxiv.org/abs/2601.22938v1) | Raw Meta = [`2601.22938_meta.json`](../../raw_data/2026-01-30/2601.22938_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Real-Time Privacy-Preserving Behavior Recognition System via Edge-Cloud Collaboration（セキュリティ分析論文）」（原題: A Real-Time Privacy-Preserving Behavior Recognition System via Edge-Cloud Collaboration / arXiv: 2601.22938v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.22938v1`
- **論文URL**: [https://arxiv.org/abs/2601.22938v1](https://arxiv.org/abs/2601.22938v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.22938v1.pdf](https://arxiv.org/pdf/2601.22938v1.pdf)
- **著者**: Huan Song, Shuyu Tian, Junyi Hao, Cheng Yuan, Zhenyu Jia, Jiawei Shao, Xuelong Li
- **公開日時**: `2026-01-30T12:55:36Z`
- **カテゴリ**: `cs.CR, cs.AI, eess.IV, eess.SP`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-30/2601.22938_meta.json) | [`PDF`](../../raw_data/2026-01-30/2601.22938.pdf) | [`TXT`](../../raw_data/2026-01-30/2601.22938.txt)
