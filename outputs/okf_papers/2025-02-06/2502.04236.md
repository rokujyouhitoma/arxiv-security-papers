...
title_ja: "Saflo: eBPF-Based MPTCP Scheduler for Mitigating Traffic Analysis Attacks in Cellular Networks（セキュリティ分析論文）"
description: "Saflo: eBPF-Based MPTCP Scheduler for Mitigating Traffic Analysis Attacks in Cellular Networks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.04236v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-06/2502.04236_meta.json"
  published_date: "2025-02-06T17:20:07Z"
  authors:
    - "Sangwoo Lee"
    - "Liuyi Jin"
    - "Radu Stoleru"
...
### (日本語題名: Saflo: eBPF-Based MPTCP Scheduler for Mitigating Traffic Analysis Attacks in Cellular Networks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.04236v1`](https://arxiv.org/abs/2502.04236v1) | Raw Meta = [`2502.04236_meta.json`](../../raw_data/2025-02-06/2502.04236_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Saflo: eBPF-Based MPTCP Scheduler for Mitigating Traffic Analysis Attacks in Cellular Networks（セキュリティ分析論文）」（原題: Saflo: eBPF-Based MPTCP Scheduler for Mitigating Traffic Analysis Attacks in Cellular Networks / arXiv: 2502.04236v1）は、cs.NI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.04236v1`
- **論文URL**: [https://arxiv.org/abs/2502.04236v1](https://arxiv.org/abs/2502.04236v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.04236v1.pdf](https://arxiv.org/pdf/2502.04236v1.pdf)
- **著者**: Sangwoo Lee, Liuyi Jin, Radu Stoleru
- **公開日時**: `2025-02-06T17:20:07Z`
- **カテゴリ**: `cs.NI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-06/2502.04236_meta.json) | [`PDF`](../../raw_data/2025-02-06/2502.04236.pdf) | [`TXT`](../../raw_data/2025-02-06/2502.04236.txt)
