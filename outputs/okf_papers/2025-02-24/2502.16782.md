...
title_ja: "CipherPrune: Efficient and Scalable Private Transformer Inference（セキュリティ分析論文）"
description: "CipherPrune: Efficient and Scalable Private Transformer Inference（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.16782v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-24/2502.16782_meta.json"
  published_date: "2025-02-24T02:27:54Z"
  authors:
    - "Yancheng Zhang"
    - "Jiaqi Xue"
    - "Mengxin Zheng"
...
### (日本語題名: CipherPrune: Efficient and Scalable Private Transformer Inference（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.16782v2`](https://arxiv.org/abs/2502.16782v2) | Raw Meta = [`2502.16782_meta.json`](../../raw_data/2025-02-24/2502.16782_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「CipherPrune: Efficient and Scalable Private Transformer Inference（セキュリティ分析論文）」（原題: CipherPrune: Efficient and Scalable Private Transformer Inference / arXiv: 2502.16782v2）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.16782v2`
- **論文URL**: [https://arxiv.org/abs/2502.16782v2](https://arxiv.org/abs/2502.16782v2)
- **PDFリンク**: [https://arxiv.org/pdf/2502.16782v2.pdf](https://arxiv.org/pdf/2502.16782v2.pdf)
- **著者**: Yancheng Zhang, Jiaqi Xue, Mengxin Zheng, Mimi Xie, Mingzhe Zhang, Lei Jiang, Qian Lou
- **公開日時**: `2025-02-24T02:27:54Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-24/2502.16782_meta.json) | [`PDF`](../../raw_data/2025-02-24/2502.16782.pdf) | [`TXT`](../../raw_data/2025-02-24/2502.16782.txt)
