...
title_ja: "Runtime Adversarial Attacks in AI Accelerators Using Performance Countersの検出"
description: "Runtime Adversarial Attacks in AI Accelerators Using Performance Countersの検出 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.07568v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-10/2503.07568_meta.json"
  published_date: "2025-03-10T17:38:42Z"
  authors:
    - "Habibur Rahaman"
    - "Atri Chatterjee"
    - "Swarup Bhunia"
...
### (日本語題名: Runtime Adversarial Attacks in AI Accelerators Using Performance Countersの検出)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.07568v1`](https://arxiv.org/abs/2503.07568v1) | Raw Meta = [`2503.07568_meta.json`](../../raw_data/2025-03-10/2503.07568_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Runtime Adversarial Attacks in AI Accelerators Using Performance Countersの検出」（原題: Runtime Detection of Adversarial Attacks in AI Accelerators Using Performance Counters / arXiv: 2503.07568v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.07568v1`
- **論文URL**: [https://arxiv.org/abs/2503.07568v1](https://arxiv.org/abs/2503.07568v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.07568v1.pdf](https://arxiv.org/pdf/2503.07568v1.pdf)
- **著者**: Habibur Rahaman, Atri Chatterjee, Swarup Bhunia
- **公開日時**: `2025-03-10T17:38:42Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-10/2503.07568_meta.json) | [`PDF`](../../raw_data/2025-03-10/2503.07568.pdf) | [`TXT`](../../raw_data/2025-03-10/2503.07568.txt)
