...
title_ja: "CodableLLM: Automating Decompiled and Source Code Mapping for LLM Dataset Generation（セキュリティ分析論文）"
description: "CodableLLM: Automating Decompiled and Source Code Mapping for LLM Dataset Generation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.22066v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-02/2507.22066_meta.json"
  published_date: "2025-07-02T15:15:12Z"
  authors:
    - "Dylan Manuel"
    - "Paul Rad"
trust:
...
### (日本語題名: CodableLLM: Automating Decompiled and Source Code Mapping for LLM Dataset Generation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.22066v1`](https://arxiv.org/abs/2507.22066v1) | Raw Meta = [`2507.22066_meta.json`](../../raw_data/2025-07-02/2507.22066_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「CodableLLM: Automating Decompiled and Source Code Mapping for LLM Dataset Generation（セキュリティ分析論文）」（原題: CodableLLM: Automating Decompiled and Source Code Mapping for LLM Dataset Generation / arXiv: 2507.22066v1）は、cs.SE 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.22066v1`
- **論文URL**: [https://arxiv.org/abs/2507.22066v1](https://arxiv.org/abs/2507.22066v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.22066v1.pdf](https://arxiv.org/pdf/2507.22066v1.pdf)
- **著者**: Dylan Manuel, Paul Rad
- **公開日時**: `2025-07-02T15:15:12Z`
- **カテゴリ**: `cs.SE, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-02/2507.22066_meta.json) | [`PDF`](../../raw_data/2025-07-02/2507.22066.pdf) | [`TXT`](../../raw_data/2025-07-02/2507.22066.txt)
