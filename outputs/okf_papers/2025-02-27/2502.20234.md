...
title_ja: "URL Inspection Tasks: Helping Users Detect Phishing Links in Emails（セキュリティ分析論文）"
description: "URL Inspection Tasks: Helping Users Detect Phishing Links in Emails（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.20234v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-27/2502.20234_meta.json"
  published_date: "2025-02-27T16:20:21Z"
  authors:
    - "Daniele Lain"
...
### (日本語題名: URL Inspection Tasks: Helping Users Detect Phishing Links in Emails（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.20234v1`](https://arxiv.org/abs/2502.20234v1) | Raw Meta = [`2502.20234_meta.json`](../../raw_data/2025-02-27/2502.20234_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「URL Inspection Tasks: Helping Users Detect Phishing Links in Emails（セキュリティ分析論文）」（原題: URL Inspection Tasks: Helping Users Detect Phishing Links in Emails / arXiv: 2502.20234v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.20234v1`
- **論文URL**: [https://arxiv.org/abs/2502.20234v1](https://arxiv.org/abs/2502.20234v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.20234v1.pdf](https://arxiv.org/pdf/2502.20234v1.pdf)
- **著者**: Daniele Lain, Yoshimichi Nakatsuka, Kari Kostiainen, Gene Tsudik, Srdjan Capkun
- **公開日時**: `2025-02-27T16:20:21Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-27/2502.20234_meta.json) | [`PDF`](../../raw_data/2025-02-27/2502.20234.pdf) | [`TXT`](../../raw_data/2025-02-27/2502.20234.txt)
