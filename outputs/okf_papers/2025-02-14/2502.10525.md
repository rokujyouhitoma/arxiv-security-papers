...
title_ja: "Watermarking of Open-Source LLMsに向けて"
description: "Watermarking of Open-Source LLMsに向けて — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.10525v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-14/2502.10525_meta.json"
  published_date: "2025-02-14T19:41:23Z"
  authors:
    - "Thibaud Gloaguen"
    - "Nikola Jovanović"
    - "Robin Staab"
...
### (日本語題名: Watermarking of Open-Source LLMsに向けて)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.10525v1`](https://arxiv.org/abs/2502.10525v1) | Raw Meta = [`2502.10525_meta.json`](../../raw_data/2025-02-14/2502.10525_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Watermarking of Open-Source LLMsに向けて」（原題: Towards Watermarking of Open-Source LLMs / arXiv: 2502.10525v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.10525v1`
- **論文URL**: [https://arxiv.org/abs/2502.10525v1](https://arxiv.org/abs/2502.10525v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.10525v1.pdf](https://arxiv.org/pdf/2502.10525v1.pdf)
- **著者**: Thibaud Gloaguen, Nikola Jovanović, Robin Staab, Martin Vechev
- **公開日時**: `2025-02-14T19:41:23Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-14/2502.10525_meta.json) | [`PDF`](../../raw_data/2025-02-14/2502.10525.pdf) | [`TXT`](../../raw_data/2025-02-14/2502.10525.txt)
