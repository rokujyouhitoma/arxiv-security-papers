...
title_ja: "MemSecBench: Tracking Agent Memory Poisoning from Persistence to Consequence and Repair（セキュリティ分析論文）"
description: "MemSecBench: Tracking Agent Memory Poisoning from Persistence to Consequence and Repair（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.27080v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-29/2607.27080_meta.json"
  published_date: "2026-07-29T16:06:54Z"
  authors:
    - "Xuanze Chen"
    - "Xukang Xie"
    - "Wentao Fu"
...
### (日本語題名: MemSecBench: Tracking Agent Memory Poisoning from Persistence to Consequence and Repair（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.27080v1`](https://arxiv.org/abs/2607.27080v1) | Raw Meta = [`2607.27080_meta.json`](../../raw_data/2026-07-29/2607.27080_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MemSecBench: Tracking Agent Memory Poisoning from Persistence to Consequence and Repair（セキュリティ分析論文）」（原題: MemSecBench: Tracking Agent Memory Poisoning from Persistence to Consequence and Repair / arXiv: 2607.27080v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2607.27080v1](https://arxiv.org/abs/2607.27080v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.27080v1.pdf](https://arxiv.org/pdf/2607.27080v1.pdf)
- **著者**: Xuanze Chen, Xukang Xie, Wentao Fu, Jiajun Zhou, Shanqing Yu, Qi Xuan
- **公開日時**: `2026-07-29T16:06:54Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-29/2607.27080_meta.json) | [`PDF`](../../raw_data/2026-07-29/2607.27080.pdf) | [`TXT`](../../raw_data/2026-07-29/2607.27080.txt)
