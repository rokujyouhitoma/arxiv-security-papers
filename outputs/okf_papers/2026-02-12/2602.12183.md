...
title_ja: "Unknown Attack Detection in IoT Networks using 大規模言語モデル: A Robust, Data-efficient Approach"
description: "Unknown Attack Detection in IoT Networks using 大規模言語モデル: A Robust, Data-efficient Approach — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.12183v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-12/2602.12183_meta.json"
  published_date: "2026-02-12T17:15:39Z"
  authors:
    - "Shan Ali"
    - "Feifei Niu"
    - "Paria Shirani"
...
### (日本語題名: Unknown Attack Detection in IoT Networks using 大規模言語モデル: A Robust, Data-efficient Approach)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.12183v1`](https://arxiv.org/abs/2602.12183v1) | Raw Meta = [`2602.12183_meta.json`](../../raw_data/2026-02-12/2602.12183_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Unknown Attack Detection in IoT Networks using 大規模言語モデル: A Robust, Data-efficient Approach」（原題: Unknown Attack Detection in IoT Networks using Large Language Models: A Robust, Data-efficient Approach / arXiv: 2602.12183v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2602.12183v1](https://arxiv.org/abs/2602.12183v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.12183v1.pdf](https://arxiv.org/pdf/2602.12183v1.pdf)
- **著者**: Shan Ali, Feifei Niu, Paria Shirani, Lionel C. Briand
- **公開日時**: `2026-02-12T17:15:39Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-12/2602.12183_meta.json) | [`PDF`](../../raw_data/2026-02-12/2602.12183.pdf) | [`TXT`](../../raw_data/2026-02-12/2602.12183.txt)
