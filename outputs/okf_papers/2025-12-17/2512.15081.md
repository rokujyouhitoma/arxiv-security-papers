...
title_ja: "Quantifying Return on Security Controls in LLM Systems（セキュリティ分析論文）"
description: "Quantifying Return on Security Controls in LLM Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.15081v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-17/2512.15081_meta.json"
  published_date: "2025-12-17T04:58:09Z"
  authors:
...
### (日本語題名: Quantifying Return on Security Controls in LLM Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.15081v1`](https://arxiv.org/abs/2512.15081v1) | Raw Meta = [`2512.15081_meta.json`](../../raw_data/2025-12-17/2512.15081_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Quantifying Return on Security Controls in LLM Systems（セキュリティ分析論文）」（原題: Quantifying Return on Security Controls in LLM Systems / arXiv: 2512.15081v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2512.15081v1](https://arxiv.org/abs/2512.15081v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.15081v1.pdf](https://arxiv.org/pdf/2512.15081v1.pdf)
- **著者**: Richard Helder Moulton, Austin O'Brien, John D. Hastings
- **公開日時**: `2025-12-17T04:58:09Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-17/2512.15081_meta.json) | [`PDF`](../../raw_data/2025-12-17/2512.15081.pdf) | [`TXT`](../../raw_data/2025-12-17/2512.15081.txt)
