...
title_ja: "Assessing Attack Surfaces in Generative Search Engines through Publisher Attributes: A Case Study in Political Domains（セキュリティ分析論文）"
description: "Assessing Attack Surfaces in Generative Search Engines through Publisher Attributes: A Case Study in Political Domains（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.15814v1"
tags:
  - "AI/ML Security"
  - "arXiv"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-16/2608.15814_meta.json"
  published_date: "2026-08-16T15:43:02Z"
  authors:
    - "Riku Mochizuki"
    - "Shusuke Komatsu"
    - "Souta Noguchi"
...
### (日本語題名: Assessing Attack Surfaces in Generative Search Engines through Publisher Attributes: A Case Study in Political Domains（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.15814v1`](https://arxiv.org/abs/2608.15814v1) | Raw Meta = [`2608.15814_meta.json`](../../raw_data/2026-08-16/2608.15814_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Assessing Attack Surfaces in Generative Search Engines through Publisher Attributes: A Case Study in Political Domains（セキュリティ分析論文）」（原題: Assessing Attack Surfaces in Generative Search Engines through Publisher Attributes: A Case Study in Political Domains / arXiv: 2608.15814v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.15814v1`
- **論文URL**: [https://arxiv.org/abs/2608.15814v1](https://arxiv.org/abs/2608.15814v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.15814v1.pdf](https://arxiv.org/pdf/2608.15814v1.pdf)
- **著者**: Riku Mochizuki, Shusuke Komatsu, Souta Noguchi, Kazuto Ataka
- **公開日時**: `2026-08-16T15:43:02Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-16/2608.15814_meta.json) | [`PDF`](../../raw_data/2026-08-16/2608.15814.pdf) | [`TXT`](../../raw_data/2026-08-16/2608.15814.txt)
