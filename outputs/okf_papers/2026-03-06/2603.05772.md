...
title_ja: "Depth Charge: Jailbreak 大規模言語モデル from Deep Safety Attention Heads"
description: "Depth Charge: Jailbreak 大規模言語モデル from Deep Safety Attention Heads — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.05772v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-06/2603.05772_meta.json"
  published_date: "2026-03-06T00:13:48Z"
  authors:
    - "Jinman Wu"
    - "Yi Xie"
    - "Shiqian Zhao"
...
### (日本語題名: Depth Charge: Jailbreak 大規模言語モデル from Deep Safety Attention Heads)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.05772v2`](https://arxiv.org/abs/2603.05772v2) | Raw Meta = [`2603.05772_meta.json`](../../raw_data/2026-03-06/2603.05772_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Depth Charge: Jailbreak 大規模言語モデル from Deep Safety Attention Heads」（原題: Depth Charge: Jailbreak Large Language Models from Deep Safety Attention Heads / arXiv: 2603.05772v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.05772v2`
- **論文URL**: [https://arxiv.org/abs/2603.05772v2](https://arxiv.org/abs/2603.05772v2)
- **PDFリンク**: [https://arxiv.org/pdf/2603.05772v2.pdf](https://arxiv.org/pdf/2603.05772v2.pdf)
- **著者**: Jinman Wu, Yi Xie, Shiqian Zhao, Xiaofeng Chen
- **公開日時**: `2026-03-06T00:13:48Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-06/2603.05772_meta.json) | [`PDF`](../../raw_data/2026-03-06/2603.05772.pdf) | [`TXT`](../../raw_data/2026-03-06/2603.05772.txt)
