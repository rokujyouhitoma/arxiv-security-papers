...
title_ja: "Watermarking Graph Neural Networks via Explanations for Ownership Protection（セキュリティ分析論文）"
description: "Watermarking Graph Neural Networks via Explanations for Ownership Protection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.05614v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-09/2501.05614_meta.json"
  published_date: "2025-01-09T23:25:06Z"
  authors:
    - "Jane Downer"
    - "Yingdan Shi"
    - "Ziyan Liu"
...
### (日本語題名: Watermarking Graph Neural Networks via Explanations for Ownership Protection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.05614v2`](https://arxiv.org/abs/2501.05614v2) | Raw Meta = [`2501.05614_meta.json`](../../raw_data/2025-01-09/2501.05614_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Watermarking Graph Neural Networks via Explanations for Ownership Protection（セキュリティ分析論文）」（原題: Watermarking Graph Neural Networks via Explanations for Ownership Protection / arXiv: 2501.05614v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.05614v2`
- **論文URL**: [https://arxiv.org/abs/2501.05614v2](https://arxiv.org/abs/2501.05614v2)
- **PDFリンク**: [https://arxiv.org/pdf/2501.05614v2.pdf](https://arxiv.org/pdf/2501.05614v2.pdf)
- **著者**: Jane Downer, Yingdan Shi, Ziyan Liu, Ren Wang, Binghui Wang
- **公開日時**: `2025-01-09T23:25:06Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-09/2501.05614_meta.json) | [`PDF`](../../raw_data/2025-01-09/2501.05614.pdf) | [`TXT`](../../raw_data/2025-01-09/2501.05614.txt)
