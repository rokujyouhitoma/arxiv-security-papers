...
title_ja: "Is Your Autonomous Vehicle Safe? Understanding the Threat of Electromagnetic Signal Injection Attacks on Traffic Scene Perception（セキュリティ分析論文）"
description: "Is Your Autonomous Vehicle Safe? Understanding the Threat of Electromagnetic Signal Injection Attacks on Traffic Scene Perception（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.05239v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CV"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-09/2501.05239_meta.json"
  published_date: "2025-01-09T13:44:42Z"
  authors:
    - "Wenhao Liao"
    - "Sineng Yan"
    - "Youqian Zhang"
...
### (日本語題名: Is Your Autonomous Vehicle Safe? Understanding the Threat of Electromagnetic Signal Injection Attacks on Traffic Scene Perception（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.05239v1`](https://arxiv.org/abs/2501.05239v1) | Raw Meta = [`2501.05239_meta.json`](../../raw_data/2025-01-09/2501.05239_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Is Your Autonomous Vehicle Safe? Understanding the Threat of Electromagnetic Signal Injection Attacks on Traffic Scene Perception（セキュリティ分析論文）」（原題: Is Your Autonomous Vehicle Safe? Understanding the Threat of Electromagnetic Signal Injection Attacks on Traffic Scene Perception / arXiv: 2501.05239v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.05239v1`
- **論文URL**: [https://arxiv.org/abs/2501.05239v1](https://arxiv.org/abs/2501.05239v1)
- **PDFリンク**: [https://arxiv.org/pdf/2501.05239v1.pdf](https://arxiv.org/pdf/2501.05239v1.pdf)
- **著者**: Wenhao Liao, Sineng Yan, Youqian Zhang, Xinwei Zhai, Yuanyuan Wang, Eugene Yujun Fu
- **公開日時**: `2025-01-09T13:44:42Z`
- **カテゴリ**: `cs.CR, cs.CV, eess.SP`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-09/2501.05239_meta.json) | [`PDF`](../../raw_data/2025-01-09/2501.05239.pdf) | [`TXT`](../../raw_data/2025-01-09/2501.05239.txt)
