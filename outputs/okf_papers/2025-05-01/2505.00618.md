...
title_ja: "RevealNet: Distributed Traffic Correlation for Attack Attribution on Programmable Networks（セキュリティ分析論文）"
description: "RevealNet: Distributed Traffic Correlation for Attack Attribution on Programmable Networks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.00618v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-01/2505.00618_meta.json"
  published_date: "2025-05-01T15:48:35Z"
  authors:
    - "Gurjot Singh"
    - "Alim Dhanani"
    - "Diogo Barradas"
...
### (日本語題名: RevealNet: Distributed Traffic Correlation for Attack Attribution on Programmable Networks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.00618v2`](https://arxiv.org/abs/2505.00618v2) | Raw Meta = [`2505.00618_meta.json`](../../raw_data/2025-05-01/2505.00618_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「RevealNet: Distributed Traffic Correlation for Attack Attribution on Programmable Networks（セキュリティ分析論文）」（原題: RevealNet: Distributed Traffic Correlation for Attack Attribution on Programmable Networks / arXiv: 2505.00618v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.00618v2`
- **論文URL**: [https://arxiv.org/abs/2505.00618v2](https://arxiv.org/abs/2505.00618v2)
- **PDFリンク**: [https://arxiv.org/pdf/2505.00618v2.pdf](https://arxiv.org/pdf/2505.00618v2.pdf)
- **著者**: Gurjot Singh, Alim Dhanani, Diogo Barradas
- **公開日時**: `2025-05-01T15:48:35Z`
- **カテゴリ**: `cs.CR, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-01/2505.00618_meta.json) | [`PDF`](../../raw_data/2025-05-01/2505.00618.pdf) | [`TXT`](../../raw_data/2025-05-01/2505.00618.txt)
