...
title_ja: "VIMU: Effective Physics-based Realtime Detection and Recovery against Stealthy Attacks on UAVs（セキュリティ分析論文）"
description: "VIMU: Effective Physics-based Realtime Detection and Recovery against Stealthy Attacks on UAVs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.20569v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-29/2504.20569_meta.json"
  published_date: "2025-04-29T09:20:41Z"
  authors:
    - "Yunbo Wang"
    - "Cong Sun"
    - "Qiaosen Liu"
...
### (日本語題名: VIMU: Effective Physics-based Realtime Detection and Recovery against Stealthy Attacks on UAVs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.20569v1`](https://arxiv.org/abs/2504.20569v1) | Raw Meta = [`2504.20569_meta.json`](../../raw_data/2025-04-29/2504.20569_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「VIMU: Effective Physics-based Realtime Detection and Recovery against Stealthy Attacks on UAVs（セキュリティ分析論文）」（原題: VIMU: Effective Physics-based Realtime Detection and Recovery against Stealthy Attacks on UAVs / arXiv: 2504.20569v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.20569v1`
- **論文URL**: [https://arxiv.org/abs/2504.20569v1](https://arxiv.org/abs/2504.20569v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.20569v1.pdf](https://arxiv.org/pdf/2504.20569v1.pdf)
- **著者**: Yunbo Wang, Cong Sun, Qiaosen Liu, Bingnan Su, Zongxu Zhang, Michael Norris, Gang Tan, Jianfeng Ma
- **公開日時**: `2025-04-29T09:20:41Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-29/2504.20569_meta.json) | [`PDF`](../../raw_data/2025-04-29/2504.20569.pdf) | [`TXT`](../../raw_data/2025-04-29/2504.20569.txt)
