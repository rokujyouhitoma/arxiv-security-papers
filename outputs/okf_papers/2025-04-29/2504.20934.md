...
title_ja: "DejaVuzz: Disclosing Transient Execution Bugs with Dynamic Swappable Memory and Differential Information Flow Tracking assisted Processor Fuzzing（セキュリティ分析論文）"
description: "DejaVuzz: Disclosing Transient Execution Bugs with Dynamic Swappable Memory and Differential Information Flow Tracking assisted Processor Fuzzing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.20934v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.AR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-29/2504.20934_meta.json"
  published_date: "2025-04-29T16:51:55Z"
  authors:
    - "Jinyan Xu"
    - "Yangye Zhou"
    - "Xingzhi Zhang"
...
### (日本語題名: DejaVuzz: Disclosing Transient Execution Bugs with Dynamic Swappable Memory and Differential Information Flow Tracking assisted Processor Fuzzing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.20934v1`](https://arxiv.org/abs/2504.20934v1) | Raw Meta = [`2504.20934_meta.json`](../../raw_data/2025-04-29/2504.20934_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「DejaVuzz: Disclosing Transient Execution Bugs with Dynamic Swappable Memory and Differential Information Flow Tracking assisted Processor Fuzzing（セキュリティ分析論文）」（原題: DejaVuzz: Disclosing Transient Execution Bugs with Dynamic Swappable Memory and Differential Information Flow Tracking assisted Processor Fuzzing / arXiv: 2504.20934v1）は、cs.AR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.20934v1`
- **論文URL**: [https://arxiv.org/abs/2504.20934v1](https://arxiv.org/abs/2504.20934v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.20934v1.pdf](https://arxiv.org/pdf/2504.20934v1.pdf)
- **著者**: Jinyan Xu, Yangye Zhou, Xingzhi Zhang, Yinshuai Li, Qinhan Tan, Yinqian Zhang, Yajin Zhou, Rui Chang, Wenbo Shen
- **公開日時**: `2025-04-29T16:51:55Z`
- **カテゴリ**: `cs.AR, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-29/2504.20934_meta.json) | [`PDF`](../../raw_data/2025-04-29/2504.20934.pdf) | [`TXT`](../../raw_data/2025-04-29/2504.20934.txt)
