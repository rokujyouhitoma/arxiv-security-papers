...
title_ja: "Attack Graph Generation on HPC Clusters（セキュリティ分析論文）"
description: "Attack Graph Generation on HPC Clusters（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.12161v1"
tags:
  - "executive-summary"
  - "cs.DC"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-16/2508.12161_meta.json"
  published_date: "2025-08-16T20:57:36Z"
  authors:
    - "Ming Li"
    - "John Hale"
trust:
...
### (日本語題名: Attack Graph Generation on HPC Clusters（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.12161v1`](https://arxiv.org/abs/2508.12161v1) | Raw Meta = [`2508.12161_meta.json`](../../raw_data/2025-08-16/2508.12161_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Attack Graph Generation on HPC Clusters（セキュリティ分析論文）」（原題: Attack Graph Generation on HPC Clusters / arXiv: 2508.12161v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.12161v1`
- **論文URL**: [https://arxiv.org/abs/2508.12161v1](https://arxiv.org/abs/2508.12161v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.12161v1.pdf](https://arxiv.org/pdf/2508.12161v1.pdf)
- **著者**: Ming Li, John Hale
- **公開日時**: `2025-08-16T20:57:36Z`
- **カテゴリ**: `cs.CR, cs.DC`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-16/2508.12161_meta.json) | [`PDF`](../../raw_data/2025-08-16/2508.12161.pdf) | [`TXT`](../../raw_data/2025-08-16/2508.12161.txt)
