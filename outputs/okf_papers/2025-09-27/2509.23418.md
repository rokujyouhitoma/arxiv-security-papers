...
title_ja: "Beyond Metadata: Multimodal, Policy-Aware YouTube Scam Videosの検出"
description: "Beyond Metadata: Multimodal, Policy-Aware YouTube Scam Videosの検出 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.23418v2"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-27/2509.23418_meta.json"
  published_date: "2025-09-27T17:24:55Z"
  authors:
    - "Ummay Kulsum"
    - "Aafaq Sabir"
    - "Abhinaya S. B."
...
### (日本語題名: Beyond Metadata: Multimodal, Policy-Aware YouTube Scam Videosの検出)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.23418v2`](https://arxiv.org/abs/2509.23418v2) | Raw Meta = [`2509.23418_meta.json`](../../raw_data/2025-09-27/2509.23418_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Beyond Metadata: Multimodal, Policy-Aware YouTube Scam Videosの検出」（原題: Beyond Metadata: Multimodal, Policy-Aware Detection of YouTube Scam Videos / arXiv: 2509.23418v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.23418v2`
- **論文URL**: [https://arxiv.org/abs/2509.23418v2](https://arxiv.org/abs/2509.23418v2)
- **PDFリンク**: [https://arxiv.org/pdf/2509.23418v2.pdf](https://arxiv.org/pdf/2509.23418v2.pdf)
- **著者**: Ummay Kulsum, Aafaq Sabir, Abhinaya S. B., Anupam Das
- **公開日時**: `2025-09-27T17:24:55Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-27/2509.23418_meta.json) | [`PDF`](../../raw_data/2025-09-27/2509.23418.pdf) | [`TXT`](../../raw_data/2025-09-27/2509.23418.txt)
