...
title_ja: "Prompt Inject Detection with Generative Explanation as an Investigative Tool（セキュリティ分析論文）"
description: "Prompt Inject Detection with Generative Explanation as an Investigative Tool（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.11006v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-16/2502.11006_meta.json"
  published_date: "2025-02-16T06:16:00Z"
  authors:
    - "Jonathan Pan"
    - "Swee Liang Wong"
    - "Yidi Yuan"
...
### (日本語題名: Prompt Inject Detection with Generative Explanation as an Investigative Tool（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.11006v1`](https://arxiv.org/abs/2502.11006v1) | Raw Meta = [`2502.11006_meta.json`](../../raw_data/2025-02-16/2502.11006_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Prompt Inject Detection with Generative Explanation as an Investigative Tool（セキュリティ分析論文）」（原題: Prompt Inject Detection with Generative Explanation as an Investigative Tool / arXiv: 2502.11006v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.11006v1`
- **論文URL**: [https://arxiv.org/abs/2502.11006v1](https://arxiv.org/abs/2502.11006v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.11006v1.pdf](https://arxiv.org/pdf/2502.11006v1.pdf)
- **著者**: Jonathan Pan, Swee Liang Wong, Yidi Yuan, Xin Wei Chia
- **公開日時**: `2025-02-16T06:16:00Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-16/2502.11006_meta.json) | [`PDF`](../../raw_data/2025-02-16/2502.11006.pdf) | [`TXT`](../../raw_data/2025-02-16/2502.11006.txt)
