...
title_ja: "Test-Time Attention Purification for Backdoored Large Vision Language Models（セキュリティ分析論文）"
description: "Test-Time Attention Purification for Backdoored Large Vision Language Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.12989v1"
tags:
  - "cs.CV"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-13/2603.12989_meta.json"
  published_date: "2026-03-13T13:45:06Z"
  authors:
    - "Zhifang Zhang"
    - "Bojun Yang"
    - "Shuo He"
...
### (日本語題名: Test-Time Attention Purification for Backdoored Large Vision Language Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.12989v1`](https://arxiv.org/abs/2603.12989v1) | Raw Meta = [`2603.12989_meta.json`](../../raw_data/2026-03-13/2603.12989_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Test-Time Attention Purification for Backdoored Large Vision Language Models（セキュリティ分析論文）」（原題: Test-Time Attention Purification for Backdoored Large Vision Language Models / arXiv: 2603.12989v1）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.12989v1`
- **論文URL**: [https://arxiv.org/abs/2603.12989v1](https://arxiv.org/abs/2603.12989v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.12989v1.pdf](https://arxiv.org/pdf/2603.12989v1.pdf)
- **著者**: Zhifang Zhang, Bojun Yang, Shuo He, Weitong Chen, Wei Emma Zhang, Olaf Maennel, Lei Feng, Miao Xu
- **公開日時**: `2026-03-13T13:45:06Z`
- **カテゴリ**: `cs.CV, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-13/2603.12989_meta.json) | [`PDF`](../../raw_data/2026-03-13/2603.12989.pdf) | [`TXT`](../../raw_data/2026-03-13/2603.12989.txt)
