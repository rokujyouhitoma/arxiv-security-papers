...
title_ja: "SmartGraphical: A Human-in-the-Loop Framework for Detecting Smart Contract Logical Vulnerabilities via Pattern-Driven Static Analysis and Visual Abstraction（セキュリティ分析論文）"
description: "SmartGraphical: A Human-in-the-Loop Framework for Detecting Smart Contract Logical Vulnerabilities via Pattern-Driven Static Analysis and Visual Abstraction（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.08580v2"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-09/2603.08580_meta.json"
  published_date: "2026-03-09T16:35:17Z"
  authors:
    - "Ali Fattahdizaji"
    - "Mohammad Pishdar"
    - "Zarina Shukur"
...
### (日本語題名: SmartGraphical: A Human-in-the-Loop Framework for Detecting Smart Contract Logical Vulnerabilities via Pattern-Driven Static Analysis and Visual Abstraction（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.08580v2`](https://arxiv.org/abs/2603.08580v2) | Raw Meta = [`2603.08580_meta.json`](../../raw_data/2026-03-09/2603.08580_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SmartGraphical: A Human-in-the-Loop Framework for Detecting Smart Contract Logical Vulnerabilities via Pattern-Driven Static Analysis and Visual Abstraction（セキュリティ分析論文）」（原題: SmartGraphical: A Human-in-the-Loop Framework for Detecting Smart Contract Logical Vulnerabilities via Pattern-Driven Static Analysis and Visual Abstraction / arXiv: 2603.08580v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.08580v2`
- **論文URL**: [https://arxiv.org/abs/2603.08580v2](https://arxiv.org/abs/2603.08580v2)
- **PDFリンク**: [https://arxiv.org/pdf/2603.08580v2.pdf](https://arxiv.org/pdf/2603.08580v2.pdf)
- **著者**: Ali Fattahdizaji, Mohammad Pishdar, Zarina Shukur
- **公開日時**: `2026-03-09T16:35:17Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-09/2603.08580_meta.json) | [`PDF`](../../raw_data/2026-03-09/2603.08580.pdf) | [`TXT`](../../raw_data/2026-03-09/2603.08580.txt)
