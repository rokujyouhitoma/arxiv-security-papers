...
title_ja: "Harmful Terms and Where to Find Them: Measuring and Modeling Unfavorable Financial Terms and Conditions in Shopping Websites at Scale（セキュリティ分析論文）"
description: "Harmful Terms and Where to Find Them: Measuring and Modeling Unfavorable Financial Terms and Conditions in Shopping Websites at Scale（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.01798v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-03/2502.01798_meta.json"
  published_date: "2025-02-03T20:23:02Z"
  authors:
    - "Elisa Tsai"
    - "Neal Mangaokar"
    - "Boyuan Zheng"
...
### (日本語題名: Harmful Terms and Where to Find Them: Measuring and Modeling Unfavorable Financial Terms and Conditions in Shopping Websites at Scale（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.01798v1`](https://arxiv.org/abs/2502.01798v1) | Raw Meta = [`2502.01798_meta.json`](../../raw_data/2025-02-03/2502.01798_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Harmful Terms and Where to Find Them: Measuring and Modeling Unfavorable Financial Terms and Conditions in Shopping Websites at Scale（セキュリティ分析論文）」（原題: Harmful Terms and Where to Find Them: Measuring and Modeling Unfavorable Financial Terms and Conditions in Shopping Websites at Scale / arXiv: 2502.01798v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.01798v1`
- **論文URL**: [https://arxiv.org/abs/2502.01798v1](https://arxiv.org/abs/2502.01798v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.01798v1.pdf](https://arxiv.org/pdf/2502.01798v1.pdf)
- **著者**: Elisa Tsai, Neal Mangaokar, Boyuan Zheng, Haizhong Zheng, Atul Prakash
- **公開日時**: `2025-02-03T20:23:02Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-03/2502.01798_meta.json) | [`PDF`](../../raw_data/2025-02-03/2502.01798.pdf) | [`TXT`](../../raw_data/2025-02-03/2502.01798.txt)
