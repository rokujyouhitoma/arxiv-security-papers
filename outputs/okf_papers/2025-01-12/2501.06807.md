...
title_ja: "MPCache: MPC-Friendly KV Cache Eviction for Efficient Private LLM Inference（セキュリティ分析論文）"
description: "MPCache: MPC-Friendly KV Cache Eviction for Efficient Private LLM Inference（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.06807v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-12/2501.06807_meta.json"
  published_date: "2025-01-12T13:18:04Z"
  authors:
    - "Wenxuan Zeng"
    - "Ye Dong"
    - "Jinjin Zhou"
...
### (日本語題名: MPCache: MPC-Friendly KV Cache Eviction for Efficient Private LLM Inference（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.06807v2`](https://arxiv.org/abs/2501.06807v2) | Raw Meta = [`2501.06807_meta.json`](../../raw_data/2025-01-12/2501.06807_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MPCache: MPC-Friendly KV Cache Eviction for Efficient Private LLM Inference（セキュリティ分析論文）」（原題: MPCache: MPC-Friendly KV Cache Eviction for Efficient Private LLM Inference / arXiv: 2501.06807v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.06807v2`
- **論文URL**: [https://arxiv.org/abs/2501.06807v2](https://arxiv.org/abs/2501.06807v2)
- **PDFリンク**: [https://arxiv.org/pdf/2501.06807v2.pdf](https://arxiv.org/pdf/2501.06807v2.pdf)
- **著者**: Wenxuan Zeng, Ye Dong, Jinjin Zhou, Jin Tan, Lei Wang, Tao Wei, Runsheng Wang, Meng Li
- **公開日時**: `2025-01-12T13:18:04Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-12/2501.06807_meta.json) | [`PDF`](../../raw_data/2025-01-12/2501.06807.pdf) | [`TXT`](../../raw_data/2025-01-12/2501.06807.txt)
