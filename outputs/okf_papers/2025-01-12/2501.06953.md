...
title_ja: "ByzSFL: Achieving Byzantine-Robust Secure 連合学習 with Zero-Knowledge Proofs"
description: "ByzSFL: Achieving Byzantine-Robust Secure 連合学習 with Zero-Knowledge Proofs — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.06953v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-12/2501.06953_meta.json"
  published_date: "2025-01-12T22:14:45Z"
  authors:
    - "Yongming Fan"
    - "Rui Zhu"
    - "Zihao Wang"
...
### (日本語題名: ByzSFL: Achieving Byzantine-Robust Secure 連合学習 with Zero-Knowledge Proofs)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.06953v1`](https://arxiv.org/abs/2501.06953v1) | Raw Meta = [`2501.06953_meta.json`](../../raw_data/2025-01-12/2501.06953_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ByzSFL: Achieving Byzantine-Robust Secure 連合学習 with Zero-Knowledge Proofs」（原題: ByzSFL: Achieving Byzantine-Robust Secure Federated Learning with Zero-Knowledge Proofs / arXiv: 2501.06953v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.06953v1`
- **論文URL**: [https://arxiv.org/abs/2501.06953v1](https://arxiv.org/abs/2501.06953v1)
- **PDFリンク**: [https://arxiv.org/pdf/2501.06953v1.pdf](https://arxiv.org/pdf/2501.06953v1.pdf)
- **著者**: Yongming Fan, Rui Zhu, Zihao Wang, Chenghong Wang, Haixu Tang, Ye Dong, Hyunghoon Cho, Lucila Ohno-Machado
- **公開日時**: `2025-01-12T22:14:45Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-12/2501.06953_meta.json) | [`PDF`](../../raw_data/2025-01-12/2501.06953.pdf) | [`TXT`](../../raw_data/2025-01-12/2501.06953.txt)
