...
title_ja: "Efficient Phishing URL Detection Using Graph-based Machine Learning and Loopy Belief Propagation（セキュリティ分析論文）"
description: "Efficient Phishing URL Detection Using Graph-based Machine Learning and Loopy Belief Propagation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2501.06912v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-12/2501.06912_meta.json"
  published_date: "2025-01-12T19:49:00Z"
  authors:
    - "Wenye Guo"
    - "Qun Wang"
    - "Hao Yue"
...
### (日本語題名: Efficient Phishing URL Detection Using Graph-based Machine Learning and Loopy Belief Propagation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2501.06912v1`](https://arxiv.org/abs/2501.06912v1) | Raw Meta = [`2501.06912_meta.json`](../../raw_data/2025-01-12/2501.06912_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Efficient Phishing URL Detection Using Graph-based Machine Learning and Loopy Belief Propagation（セキュリティ分析論文）」（原題: Efficient Phishing URL Detection Using Graph-based Machine Learning and Loopy Belief Propagation / arXiv: 2501.06912v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2501.06912v1`
- **論文URL**: [https://arxiv.org/abs/2501.06912v1](https://arxiv.org/abs/2501.06912v1)
- **PDFリンク**: [https://arxiv.org/pdf/2501.06912v1.pdf](https://arxiv.org/pdf/2501.06912v1.pdf)
- **著者**: Wenye Guo, Qun Wang, Hao Yue, Haijian Sun, Rose Qingyang Hu
- **公開日時**: `2025-01-12T19:49:00Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-12/2501.06912_meta.json) | [`PDF`](../../raw_data/2025-01-12/2501.06912.pdf) | [`TXT`](../../raw_data/2025-01-12/2501.06912.txt)
