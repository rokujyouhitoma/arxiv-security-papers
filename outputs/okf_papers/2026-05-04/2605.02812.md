...
title_ja: "Autonomous LLM Agent Worms: Cross-Platform Propagation, Automated Discovery and Temporal Re-Entry Defense（セキュリティ分析論文）"
description: "Autonomous LLM Agent Worms: Cross-Platform Propagation, Automated Discovery and Temporal Re-Entry Defense（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.02812v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-04/2605.02812_meta.json"
  published_date: "2026-05-04T16:49:29Z"
  authors:
    - "Mingming Zha"
    - "Xiaofeng Wang"
trust:
...
### (日本語題名: Autonomous LLM Agent Worms: Cross-Platform Propagation, Automated Discovery and Temporal Re-Entry Defense（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.02812v1`](https://arxiv.org/abs/2605.02812v1) | Raw Meta = [`2605.02812_meta.json`](../../raw_data/2026-05-04/2605.02812_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Autonomous LLM Agent Worms: Cross-Platform Propagation, Automated Discovery and Temporal Re-Entry Defense（セキュリティ分析論文）」（原題: Autonomous LLM Agent Worms: Cross-Platform Propagation, Automated Discovery and Temporal Re-Entry Defense / arXiv: 2605.02812v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.02812v1`
- **論文URL**: [https://arxiv.org/abs/2605.02812v1](https://arxiv.org/abs/2605.02812v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.02812v1.pdf](https://arxiv.org/pdf/2605.02812v1.pdf)
- **著者**: Mingming Zha, Xiaofeng Wang
- **公開日時**: `2026-05-04T16:49:29Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-04/2605.02812_meta.json) | [`PDF`](../../raw_data/2026-05-04/2605.02812.pdf) | [`TXT`](../../raw_data/2026-05-04/2605.02812.txt)
