...
title_ja: "Buffer is All You Need: Defending 連合学習 against Backdoor Attacks under Non-iids via Buffering"
description: "Buffer is All You Need: Defending 連合学習 against Backdoor Attacks under Non-iids via Buffering — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.23511v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-30/2503.23511_meta.json"
  published_date: "2025-03-30T16:46:14Z"
  authors:
    - "Xingyu Lyu"
    - "Ning Wang"
    - "Yang Xiao"
...
### (日本語題名: Buffer is All You Need: Defending 連合学習 against Backdoor Attacks under Non-iids via Buffering)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.23511v1`](https://arxiv.org/abs/2503.23511v1) | Raw Meta = [`2503.23511_meta.json`](../../raw_data/2025-03-30/2503.23511_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Buffer is All You Need: Defending 連合学習 against Backdoor Attacks under Non-iids via Buffering」（原題: Buffer is All You Need: Defending Federated Learning against Backdoor Attacks under Non-iids via Buffering / arXiv: 2503.23511v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.23511v1`
- **論文URL**: [https://arxiv.org/abs/2503.23511v1](https://arxiv.org/abs/2503.23511v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.23511v1.pdf](https://arxiv.org/pdf/2503.23511v1.pdf)
- **著者**: Xingyu Lyu, Ning Wang, Yang Xiao, Shixiong Li, Tao Li, Danjue Chen, Yimin Chen
- **公開日時**: `2025-03-30T16:46:14Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-30/2503.23511_meta.json) | [`PDF`](../../raw_data/2025-03-30/2503.23511.pdf) | [`TXT`](../../raw_data/2025-03-30/2503.23511.txt)
