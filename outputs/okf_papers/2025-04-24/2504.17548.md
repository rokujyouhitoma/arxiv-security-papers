...
title_ja: "Quantum Autoencoder for Multivariate Time Series Anomaly Detection（セキュリティ分析論文）"
description: "Quantum Autoencoder for Multivariate Time Series Anomaly Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.17548v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-24/2504.17548_meta.json"
  published_date: "2025-04-24T13:40:06Z"
  authors:
    - "Kilian Tscharke"
...
### (日本語題名: Quantum Autoencoder for Multivariate Time Series Anomaly Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.17548v2`](https://arxiv.org/abs/2504.17548v2) | Raw Meta = [`2504.17548_meta.json`](../../raw_data/2025-04-24/2504.17548_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Quantum Autoencoder for Multivariate Time Series Anomaly Detection（セキュリティ分析論文）」（原題: Quantum Autoencoder for Multivariate Time Series Anomaly Detection / arXiv: 2504.17548v2）は、quant-ph 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.17548v2`
- **論文URL**: [https://arxiv.org/abs/2504.17548v2](https://arxiv.org/abs/2504.17548v2)
- **PDFリンク**: [https://arxiv.org/pdf/2504.17548v2.pdf](https://arxiv.org/pdf/2504.17548v2.pdf)
- **著者**: Kilian Tscharke, Maximilian Wendlinger, Afrae Ahouzi, Pallavi Bhardwaj, Kaweh Amoi-Taleghani, Michael Schrödl-Baumann, Pascal Debus
- **公開日時**: `2025-04-24T13:40:06Z`
- **カテゴリ**: `quant-ph, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-24/2504.17548_meta.json) | [`PDF`](../../raw_data/2025-04-24/2504.17548.pdf) | [`TXT`](../../raw_data/2025-04-24/2504.17548.txt)
