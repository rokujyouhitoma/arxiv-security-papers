...
title_ja: "Adversarial VR: An Open-Source Testbed for Evaluating Adversarial Robustness of VR Cybersickness Detection and Mitigation（セキュリティ分析論文）"
description: "Adversarial VR: An Open-Source Testbed for Evaluating Adversarial Robustness of VR Cybersickness Detection and Mitigation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.17029v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-18/2512.17029_meta.json"
  published_date: "2025-12-18T19:45:47Z"
  authors:
    - "Istiak Ahmed"
    - "Ripan Kumar Kundu"
    - "Khaza Anuarul Hoque"
...
### (日本語題名: Adversarial VR: An Open-Source Testbed for Evaluating Adversarial Robustness of VR Cybersickness Detection and Mitigation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.17029v1`](https://arxiv.org/abs/2512.17029v1) | Raw Meta = [`2512.17029_meta.json`](../../raw_data/2025-12-18/2512.17029_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Adversarial VR: An Open-Source Testbed for Evaluating Adversarial Robustness of VR Cybersickness Detection and Mitigation（セキュリティ分析論文）」（原題: Adversarial VR: An Open-Source Testbed for Evaluating Adversarial Robustness of VR Cybersickness Detection and Mitigation / arXiv: 2512.17029v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.17029v1`
- **論文URL**: [https://arxiv.org/abs/2512.17029v1](https://arxiv.org/abs/2512.17029v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.17029v1.pdf](https://arxiv.org/pdf/2512.17029v1.pdf)
- **著者**: Istiak Ahmed, Ripan Kumar Kundu, Khaza Anuarul Hoque
- **公開日時**: `2025-12-18T19:45:47Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.HC`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-18/2512.17029_meta.json) | [`PDF`](../../raw_data/2025-12-18/2512.17029.pdf) | [`TXT`](../../raw_data/2025-12-18/2512.17029.txt)
