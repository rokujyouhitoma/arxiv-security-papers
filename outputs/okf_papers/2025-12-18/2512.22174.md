...
title_ja: "BitFlipScope: Scalable Fault Localization and Recovery for Bit-Flip Corruptions in LLMs（セキュリティ分析論文）"
description: "BitFlipScope: Scalable Fault Localization and Recovery for Bit-Flip Corruptions in LLMs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.22174v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cs.DC"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-18/2512.22174_meta.json"
  published_date: "2025-12-18T20:35:29Z"
  authors:
...
### (日本語題名: BitFlipScope: Scalable Fault Localization and Recovery for Bit-Flip Corruptions in LLMs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.22174v2`](https://arxiv.org/abs/2512.22174v2) | Raw Meta = [`2512.22174_meta.json`](../../raw_data/2025-12-18/2512.22174_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「BitFlipScope: Scalable Fault Localization and Recovery for Bit-Flip Corruptions in LLMs（セキュリティ分析論文）」（原題: BitFlipScope: Scalable Fault Localization and Recovery for Bit-Flip Corruptions in LLMs / arXiv: 2512.22174v2）は、cs.DC 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.22174v2`
- **論文URL**: [https://arxiv.org/abs/2512.22174v2](https://arxiv.org/abs/2512.22174v2)
- **PDFリンク**: [https://arxiv.org/pdf/2512.22174v2.pdf](https://arxiv.org/pdf/2512.22174v2.pdf)
- **著者**: Muhammad Zeeshan Karamat, Sadman Saif, Christiana Chamon Garcia
- **公開日時**: `2025-12-18T20:35:29Z`
- **カテゴリ**: `cs.DC, cs.AI, cs.AR, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-18/2512.22174_meta.json) | [`PDF`](../../raw_data/2025-12-18/2512.22174.pdf) | [`TXT`](../../raw_data/2025-12-18/2512.22174.txt)
