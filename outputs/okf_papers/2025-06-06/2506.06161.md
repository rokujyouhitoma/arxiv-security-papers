...
title_ja: "ORCAS: Obfuscation-Resilient Binary Code Similarity Analysis using Dominance Enhanced Semantic Graph（セキュリティ分析論文）"
description: "ORCAS: Obfuscation-Resilient Binary Code Similarity Analysis using Dominance Enhanced Semantic Graph（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.06161v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-06/2506.06161_meta.json"
  published_date: "2025-06-06T15:26:53Z"
  authors:
    - "Yufeng Wang"
    - "Yuhong Feng"
    - "Yixuan Cao"
...
### (日本語題名: ORCAS: Obfuscation-Resilient Binary Code Similarity Analysis using Dominance Enhanced Semantic Graph（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.06161v2`](https://arxiv.org/abs/2506.06161v2) | Raw Meta = [`2506.06161_meta.json`](../../raw_data/2025-06-06/2506.06161_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ORCAS: Obfuscation-Resilient Binary Code Similarity Analysis using Dominance Enhanced Semantic Graph（セキュリティ分析論文）」（原題: ORCAS: Obfuscation-Resilient Binary Code Similarity Analysis using Dominance Enhanced Semantic Graph / arXiv: 2506.06161v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.06161v2`
- **論文URL**: [https://arxiv.org/abs/2506.06161v2](https://arxiv.org/abs/2506.06161v2)
- **PDFリンク**: [https://arxiv.org/pdf/2506.06161v2.pdf](https://arxiv.org/pdf/2506.06161v2.pdf)
- **著者**: Yufeng Wang, Yuhong Feng, Yixuan Cao, Haoran Li, Haiyue Feng, Yifeng Wang
- **公開日時**: `2025-06-06T15:26:53Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-06/2506.06161_meta.json) | [`PDF`](../../raw_data/2025-06-06/2506.06161.pdf) | [`TXT`](../../raw_data/2025-06-06/2506.06161.txt)
