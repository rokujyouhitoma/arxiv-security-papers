...
title_ja: "Stealix: Model Stealing via Prompt Evolution（セキュリティ分析論文）"
description: "Stealix: Model Stealing via Prompt Evolution（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.05867v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-06/2506.05867_meta.json"
  published_date: "2025-06-06T08:34:00Z"
  authors:
    - "Zhixiong Zhuang"
    - "Hui-Po Wang"
    - "Maria-Irina Nicolae"
...
### (日本語題名: Stealix: Model Stealing via Prompt Evolution（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.05867v1`](https://arxiv.org/abs/2506.05867v1) | Raw Meta = [`2506.05867_meta.json`](../../raw_data/2025-06-06/2506.05867_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Stealix: Model Stealing via Prompt Evolution（セキュリティ分析論文）」（原題: Stealix: Model Stealing via Prompt Evolution / arXiv: 2506.05867v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.05867v1`
- **論文URL**: [https://arxiv.org/abs/2506.05867v1](https://arxiv.org/abs/2506.05867v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.05867v1.pdf](https://arxiv.org/pdf/2506.05867v1.pdf)
- **著者**: Zhixiong Zhuang, Hui-Po Wang, Maria-Irina Nicolae, Mario Fritz
- **公開日時**: `2025-06-06T08:34:00Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-06/2506.05867_meta.json) | [`PDF`](../../raw_data/2025-06-06/2506.05867.pdf) | [`TXT`](../../raw_data/2025-06-06/2506.05867.txt)
