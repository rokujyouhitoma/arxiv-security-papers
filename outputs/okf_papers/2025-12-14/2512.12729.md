...
title_ja: "RunPBA -- Runtime attestation for microcontrollers with PACBTI（セキュリティ分析論文）"
description: "RunPBA -- Runtime attestation for microcontrollers with PACBTI（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.12729v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-14/2512.12729_meta.json"
  published_date: "2025-12-14T15:09:48Z"
  authors:
    - "André Cirne"
    - "Patrícia R. Sousa"
    - "João S. Resende"
...
### (日本語題名: RunPBA -- Runtime attestation for microcontrollers with PACBTI（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.12729v1`](https://arxiv.org/abs/2512.12729v1) | Raw Meta = [`2512.12729_meta.json`](../../raw_data/2025-12-14/2512.12729_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「RunPBA -- Runtime attestation for microcontrollers with PACBTI（セキュリティ分析論文）」（原題: RunPBA -- Runtime attestation for microcontrollers with PACBTI / arXiv: 2512.12729v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.12729v1`
- **論文URL**: [https://arxiv.org/abs/2512.12729v1](https://arxiv.org/abs/2512.12729v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.12729v1.pdf](https://arxiv.org/pdf/2512.12729v1.pdf)
- **著者**: André Cirne, Patrícia R. Sousa, João S. Resende, Luís Antunes
- **公開日時**: `2025-12-14T15:09:48Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-14/2512.12729_meta.json) | [`PDF`](../../raw_data/2025-12-14/2512.12729.pdf) | [`TXT`](../../raw_data/2025-12-14/2512.12729.txt)
