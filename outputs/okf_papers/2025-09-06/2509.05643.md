...
title_ja: "FuzzBox: Blending Fuzzing into Emulation for Binary-Only Embedded Targets（セキュリティ分析論文）"
description: "FuzzBox: Blending Fuzzing into Emulation for Binary-Only Embedded Targets（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.05643v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-06/2509.05643_meta.json"
  published_date: "2025-09-06T08:31:36Z"
  authors:
    - "Carmine Cesarano"
    - "Roberto Natella"
trust:
...
### (日本語題名: FuzzBox: Blending Fuzzing into Emulation for Binary-Only Embedded Targets（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.05643v1`](https://arxiv.org/abs/2509.05643v1) | Raw Meta = [`2509.05643_meta.json`](../../raw_data/2025-09-06/2509.05643_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「FuzzBox: Blending Fuzzing into Emulation for Binary-Only Embedded Targets（セキュリティ分析論文）」（原題: FuzzBox: Blending Fuzzing into Emulation for Binary-Only Embedded Targets / arXiv: 2509.05643v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.05643v1`
- **論文URL**: [https://arxiv.org/abs/2509.05643v1](https://arxiv.org/abs/2509.05643v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.05643v1.pdf](https://arxiv.org/pdf/2509.05643v1.pdf)
- **著者**: Carmine Cesarano, Roberto Natella
- **公開日時**: `2025-09-06T08:31:36Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-06/2509.05643_meta.json) | [`PDF`](../../raw_data/2025-09-06/2509.05643.pdf) | [`TXT`](../../raw_data/2025-09-06/2509.05643.txt)
