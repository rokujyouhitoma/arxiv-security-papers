...
title_ja: "Channel-Robust RFF for Low-Latency 5G Device Identification in SIMO Scenarios（セキュリティ分析論文）"
description: "Channel-Robust RFF for Low-Latency 5G Device Identification in SIMO Scenarios（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.08902v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-12/2511.08902_meta.json"
  published_date: "2025-11-12T02:25:06Z"
  authors:
    - "Yingjie Sun"
    - "Guyue Li"
    - "Hongfu Chou"
...
### (日本語題名: Channel-Robust RFF for Low-Latency 5G Device Identification in SIMO Scenarios（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.08902v1`](https://arxiv.org/abs/2511.08902v1) | Raw Meta = [`2511.08902_meta.json`](../../raw_data/2025-11-12/2511.08902_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Channel-Robust RFF for Low-Latency 5G Device Identification in SIMO Scenarios（セキュリティ分析論文）」（原題: Channel-Robust RFF for Low-Latency 5G Device Identification in SIMO Scenarios / arXiv: 2511.08902v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.08902v1`
- **論文URL**: [https://arxiv.org/abs/2511.08902v1](https://arxiv.org/abs/2511.08902v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.08902v1.pdf](https://arxiv.org/pdf/2511.08902v1.pdf)
- **著者**: Yingjie Sun, Guyue Li, Hongfu Chou, Aiqun Hu
- **公開日時**: `2025-11-12T02:25:06Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-12/2511.08902_meta.json) | [`PDF`](../../raw_data/2025-11-12/2511.08902.pdf) | [`TXT`](../../raw_data/2025-11-12/2511.08902.txt)
