...
title_ja: "SecTracer: A Framework for Uncovering the Root Causes of Network Intrusions via Security Provenance（セキュリティ分析論文）"
description: "SecTracer: A Framework for Uncovering the Root Causes of Network Intrusions via Security Provenance（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.09266v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-12/2511.09266_meta.json"
  published_date: "2025-11-12T12:25:36Z"
  authors:
    - "Seunghyeon Lee"
    - "Hyunmin Seo"
    - "Hwanjo Heo"
...
### (日本語題名: SecTracer: A Framework for Uncovering the Root Causes of Network Intrusions via Security Provenance（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.09266v1`](https://arxiv.org/abs/2511.09266v1) | Raw Meta = [`2511.09266_meta.json`](../../raw_data/2025-11-12/2511.09266_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SecTracer: A Framework for Uncovering the Root Causes of Network Intrusions via Security Provenance（セキュリティ分析論文）」（原題: SecTracer: A Framework for Uncovering the Root Causes of Network Intrusions via Security Provenance / arXiv: 2511.09266v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.09266v1`
- **論文URL**: [https://arxiv.org/abs/2511.09266v1](https://arxiv.org/abs/2511.09266v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.09266v1.pdf](https://arxiv.org/pdf/2511.09266v1.pdf)
- **著者**: Seunghyeon Lee, Hyunmin Seo, Hwanjo Heo, Anduo Wang, Seungwon Shin, Jinwoo Kim
- **公開日時**: `2025-11-12T12:25:36Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-12/2511.09266_meta.json) | [`PDF`](../../raw_data/2025-11-12/2511.09266.pdf) | [`TXT`](../../raw_data/2025-11-12/2511.09266.txt)
