...
title_ja: "Attacking interpretable NLP systems（セキュリティ分析論文）"
description: "Attacking interpretable NLP systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.16164v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-22/2507.16164_meta.json"
  published_date: "2025-07-22T02:20:00Z"
  authors:
    - "Eldor Abdukhamidov"
    - "Tamer Abuhmed"
    - "Joanna C. S. Santos"
...
### (日本語題名: Attacking interpretable NLP systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.16164v1`](https://arxiv.org/abs/2507.16164v1) | Raw Meta = [`2507.16164_meta.json`](../../raw_data/2025-07-22/2507.16164_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Attacking interpretable NLP systems（セキュリティ分析論文）」（原題: Attacking interpretable NLP systems / arXiv: 2507.16164v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.16164v1`
- **論文URL**: [https://arxiv.org/abs/2507.16164v1](https://arxiv.org/abs/2507.16164v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.16164v1.pdf](https://arxiv.org/pdf/2507.16164v1.pdf)
- **著者**: Eldor Abdukhamidov, Tamer Abuhmed, Joanna C. S. Santos, Mohammed Abuhamad
- **公開日時**: `2025-07-22T02:20:00Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-22/2507.16164_meta.json) | [`PDF`](../../raw_data/2025-07-22/2507.16164.pdf) | [`TXT`](../../raw_data/2025-07-22/2507.16164.txt)
