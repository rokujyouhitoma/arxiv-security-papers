...
title_ja: "Pay Attention to the Triggers: Constructing Backdoors That Survive Distillation（セキュリティ分析論文）"
description: "Pay Attention to the Triggers: Constructing Backdoors That Survive Distillation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.18541v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-10-21/2510.18541_meta.json"
  published_date: "2025-10-21T11:39:45Z"
  authors:
    - "Giovanni De Muri"
    - "Mark Vero"
    - "Robin Staab"
...
### (日本語題名: Pay Attention to the Triggers: Constructing Backdoors That Survive Distillation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.18541v1`](https://arxiv.org/abs/2510.18541v1) | Raw Meta = [`2510.18541_meta.json`](../../raw_data/2025-10-21/2510.18541_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Pay Attention to the Triggers: Constructing Backdoors That Survive Distillation（セキュリティ分析論文）」（原題: Pay Attention to the Triggers: Constructing Backdoors That Survive Distillation / arXiv: 2510.18541v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2510.18541v1](https://arxiv.org/abs/2510.18541v1)
- **PDFリンク**: [https://arxiv.org/pdf/2510.18541v1.pdf](https://arxiv.org/pdf/2510.18541v1.pdf)
- **著者**: Giovanni De Muri, Mark Vero, Robin Staab, Martin Vechev
- **公開日時**: `2025-10-21T11:39:45Z`
- **カテゴリ**: `cs.LG, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-10-21/2510.18541_meta.json) | [`PDF`](../../raw_data/2025-10-21/2510.18541.pdf) | [`TXT`](../../raw_data/2025-10-21/2510.18541.txt)
