...
title_ja: "Bithoven: Formal Safety for Expressive Bitcoin Smart Contracts（セキュリティ分析論文）"
description: "Bithoven: Formal Safety for Expressive Bitcoin Smart Contracts（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.01436v1"
tags:
  - "cs.PL"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-04/2601.01436_meta.json"
  published_date: "2026-01-04T08:48:34Z"
  authors:
    - "Hyunhum Cho"
    - "Ik Rae Jeong"
trust:
...
### (日本語題名: Bithoven: Formal Safety for Expressive Bitcoin Smart Contracts（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.01436v1`](https://arxiv.org/abs/2601.01436v1) | Raw Meta = [`2601.01436_meta.json`](../../raw_data/2026-01-04/2601.01436_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Bithoven: Formal Safety for Expressive Bitcoin Smart Contracts（セキュリティ分析論文）」（原題: Bithoven: Formal Safety for Expressive Bitcoin Smart Contracts / arXiv: 2601.01436v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.01436v1`
- **論文URL**: [https://arxiv.org/abs/2601.01436v1](https://arxiv.org/abs/2601.01436v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.01436v1.pdf](https://arxiv.org/pdf/2601.01436v1.pdf)
- **著者**: Hyunhum Cho, Ik Rae Jeong
- **公開日時**: `2026-01-04T08:48:34Z`
- **カテゴリ**: `cs.CR, cs.PL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-04/2601.01436_meta.json) | [`PDF`](../../raw_data/2026-01-04/2601.01436.pdf) | [`TXT`](../../raw_data/2026-01-04/2601.01436.txt)
