...
title_ja: "MAD-OOD: A Deep Learning Cluster-Driven Framework for an Out-of-Distribution マルウェア検出 and Classification"
description: "MAD-OOD: A Deep Learning Cluster-Driven Framework for an Out-of-Distribution マルウェア検出 and Classification — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.17594v1"
tags:
  - "cs.AI"
  - "cs.CV"
  - "executive-summary"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-19/2512.17594_meta.json"
  published_date: "2025-12-19T14:02:37Z"
  authors:
    - "Tosin Ige"
...
### (日本語題名: MAD-OOD: A Deep Learning Cluster-Driven Framework for an Out-of-Distribution マルウェア検出 and Classification)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.17594v1`](https://arxiv.org/abs/2512.17594v1) | Raw Meta = [`2512.17594_meta.json`](../../raw_data/2025-12-19/2512.17594_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MAD-OOD: A Deep Learning Cluster-Driven Framework for an Out-of-Distribution マルウェア検出 and Classification」（原題: MAD-OOD: A Deep Learning Cluster-Driven Framework for an Out-of-Distribution Malware Detection and Classification / arXiv: 2512.17594v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.17594v1`
- **論文URL**: [https://arxiv.org/abs/2512.17594v1](https://arxiv.org/abs/2512.17594v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.17594v1.pdf](https://arxiv.org/pdf/2512.17594v1.pdf)
- **著者**: Tosin Ige, Christopher Kiekintveld, Aritran Piplai, Asif Rahman, Olukunle Kolade, Sasidhar Kunapuli
- **公開日時**: `2025-12-19T14:02:37Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CV, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-19/2512.17594_meta.json) | [`PDF`](../../raw_data/2025-12-19/2512.17594.pdf) | [`TXT`](../../raw_data/2025-12-19/2512.17594.txt)
