...
title_ja: "GUIGuard-Bench: Toward a General Evaluation for Privacy-Preserving GUI Agents（セキュリティ分析論文）"
description: "GUIGuard-Bench: Toward a General Evaluation for Privacy-Preserving GUI Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.18842v3"
tags:
  - "cs.AI"
  - "cs.CV"
  - "executive-summary"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-26/2601.18842_meta.json"
  published_date: "2026-01-26T11:33:40Z"
  authors:
    - "Yanxi Wang"
    - "Zhiling Zhang"
    - "Wenbo Zhou"
...
### (日本語題名: GUIGuard-Bench: Toward a General Evaluation for Privacy-Preserving GUI Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.18842v3`](https://arxiv.org/abs/2601.18842v3) | Raw Meta = [`2601.18842_meta.json`](../../raw_data/2026-01-26/2601.18842_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「GUIGuard-Bench: Toward a General Evaluation for Privacy-Preserving GUI Agents（セキュリティ分析論文）」（原題: GUIGuard-Bench: Toward a General Evaluation for Privacy-Preserving GUI Agents / arXiv: 2601.18842v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.18842v3`
- **論文URL**: [https://arxiv.org/abs/2601.18842v3](https://arxiv.org/abs/2601.18842v3)
- **PDFリンク**: [https://arxiv.org/pdf/2601.18842v3.pdf](https://arxiv.org/pdf/2601.18842v3.pdf)
- **著者**: Yanxi Wang, Zhiling Zhang, Wenbo Zhou, Weiming Zhang, Jie Zhang, Qiannan Zhu, Yu Shi, Shuxin Zheng, Jiyan He
- **公開日時**: `2026-01-26T11:33:40Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CV`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-26/2601.18842_meta.json) | [`PDF`](../../raw_data/2026-01-26/2601.18842.pdf) | [`TXT`](../../raw_data/2026-01-26/2601.18842.txt)
