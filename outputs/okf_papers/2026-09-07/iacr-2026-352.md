...
description: "【提案】新規に提案し a migration design that separates revealed-key and hidden-key credentials.。実証評価によりThe design adds one-way migration-..."
...
本論文「Post-Quantum Migration for Bitcoin and Ethereum: Hidden-Key Proofs, Finalization, and Enforcement（セキュリティ分析論文）」（原題: Post-Quantum Migration for Bitcoin and Ethereum: Hidden-Key Proofs, Finalization, and Enforcement / IACR: 2026-352）は、cryptography 分野における最新セキュリティ研究成果を取り扱っています。

**概要**: 【提案】新規に提案し a migration design that separates revealed-key and hidden-key credentials.。実証評価によりThe design adds one-way migration-...

### 2. 背景とセキュリティ上の課題 (Background & Problem)
【課題・脅威】量子 computers threaten the elliptic-curve signatures used by Bitcoin and Ethereum once a...
(主要キーワード: Hidden-key credentials, Quantum Migration, Key Proofs, Enforcement Quantum)

### 3. 提案アプローチ・技術革新 (Technical Innovation)
【提案技術】新規に提案し a migration design that separates revealed-key and hidden-key credentials.

### 4. セキュリティ影響と実験結果 (Results & Impact)
【実証・影響】The design adds one-way migration-registry semantics, 量子 hash-security analysis, scenar...
...
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-09-02/iacr-2026-352_meta.json) | [`PDF (arXiv)`](https://eprint.iacr.org/2026/352.pdf) | [`TXT`](../../raw_data/2026-09-02/iacr-2026-352_meta.json)
