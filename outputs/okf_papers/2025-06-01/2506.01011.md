...
title_ja: "Autoregressive Images Watermarking through Lexical Biasing: An Approach Resistant to Regeneration Attack（セキュリティ分析論文）"
description: "Autoregressive Images Watermarking through Lexical Biasing: An Approach Resistant to Regeneration Attack（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.01011v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-01/2506.01011_meta.json"
  published_date: "2025-06-01T13:44:20Z"
  authors:
    - "Siqi Hui"
    - "Yiren Song"
    - "Sanping Zhou"
...
### (日本語題名: Autoregressive Images Watermarking through Lexical Biasing: An Approach Resistant to Regeneration Attack（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.01011v1`](https://arxiv.org/abs/2506.01011v1) | Raw Meta = [`2506.01011_meta.json`](../../raw_data/2025-06-01/2506.01011_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Autoregressive Images Watermarking through Lexical Biasing: An Approach Resistant to Regeneration Attack（セキュリティ分析論文）」（原題: Autoregressive Images Watermarking through Lexical Biasing: An Approach Resistant to Regeneration Attack / arXiv: 2506.01011v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.01011v1`
- **論文URL**: [https://arxiv.org/abs/2506.01011v1](https://arxiv.org/abs/2506.01011v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.01011v1.pdf](https://arxiv.org/pdf/2506.01011v1.pdf)
- **著者**: Siqi Hui, Yiren Song, Sanping Zhou, Ye Deng, Wenli Huang, Jinjun Wang
- **公開日時**: `2025-06-01T13:44:20Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-01/2506.01011_meta.json) | [`PDF`](../../raw_data/2025-06-01/2506.01011.pdf) | [`TXT`](../../raw_data/2025-06-01/2506.01011.txt)
