...
title_ja: "One Prompt Is Enough: Watermark Laundering Through Foundation Image Models（セキュリティ分析論文）"
description: "One Prompt Is Enough: Watermark Laundering Through Foundation Image Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2609.01249v1"
tags:
  - "Privacy & Provenance"
  - "arXiv"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-09-01/2609.01249_meta.json"
  published_date: "2026-09-01T13:46:31Z"
  authors:
    - "Jidong Yang"
    - "Qi Li"
    - "Wei Zong"
...
### (日本語題名: One Prompt Is Enough: Watermark Laundering Through Foundation Image Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2609.01249v1`](https://arxiv.org/abs/2609.01249v1) | Raw Meta = [`2609.01249_meta.json`](../../raw_data/2026-09-01/2609.01249_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「One Prompt Is Enough: Watermark Laundering Through Foundation Image Models（セキュリティ分析論文）」（原題: One Prompt Is Enough: Watermark Laundering Through Foundation Image Models / arXiv: 2609.01249v1）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2609.01249v1`
- **論文URL**: [https://arxiv.org/abs/2609.01249v1](https://arxiv.org/abs/2609.01249v1)
- **PDFリンク**: [https://arxiv.org/pdf/2609.01249v1.pdf](https://arxiv.org/pdf/2609.01249v1.pdf)
- **著者**: Jidong Yang, Qi Li, Wei Zong, Yang-Wai Chow, Willy Susilo, Huaike Yu, Chunpeng Wang, Suo Gao
- **公開日時**: `2026-09-01T13:46:31Z`
- **カテゴリ**: `cs.CV, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-09-01/2609.01249_meta.json) | [`PDF`](../../raw_data/2026-09-01/2609.01249.pdf) | [`TXT`](../../raw_data/2026-09-01/2609.01249.txt)
