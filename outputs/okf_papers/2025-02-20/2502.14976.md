...
title_ja: "EigenShield: Causal Subspace Filtering via Random Matrix Theory for Adversarially Robust Vision-Language Models（セキュリティ分析論文）"
description: "EigenShield: Causal Subspace Filtering via Random Matrix Theory for Adversarially Robust Vision-Language Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.14976v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-20/2502.14976_meta.json"
  published_date: "2025-02-20T19:10:51Z"
  authors:
    - "Nastaran Darabi"
    - "Devashri Naik"
    - "Sina Tayebati"
...
### (日本語題名: EigenShield: Causal Subspace Filtering via Random Matrix Theory for Adversarially Robust Vision-Language Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.14976v1`](https://arxiv.org/abs/2502.14976v1) | Raw Meta = [`2502.14976_meta.json`](../../raw_data/2025-02-20/2502.14976_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「EigenShield: Causal Subspace Filtering via Random Matrix Theory for Adversarially Robust Vision-Language Models（セキュリティ分析論文）」（原題: EigenShield: Causal Subspace Filtering via Random Matrix Theory for Adversarially Robust Vision-Language Models / arXiv: 2502.14976v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.14976v1`
- **論文URL**: [https://arxiv.org/abs/2502.14976v1](https://arxiv.org/abs/2502.14976v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.14976v1.pdf](https://arxiv.org/pdf/2502.14976v1.pdf)
- **著者**: Nastaran Darabi, Devashri Naik, Sina Tayebati, Dinithi Jayasuriya, Ranganath Krishnan, Amit Ranjan Trivedi
- **公開日時**: `2025-02-20T19:10:51Z`
- **カテゴリ**: `cs.LG, cs.CR, cs.CV`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-20/2502.14976_meta.json) | [`PDF`](../../raw_data/2025-02-20/2502.14976.pdf) | [`TXT`](../../raw_data/2025-02-20/2502.14976.txt)
