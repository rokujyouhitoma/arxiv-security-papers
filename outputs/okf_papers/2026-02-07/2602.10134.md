...
title_ja: "Reverse-Engineering Model Editing on Language Models（セキュリティ分析論文）"
description: "Reverse-Engineering Model Editing on Language Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.10134v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-07/2602.10134_meta.json"
  published_date: "2026-02-07T08:35:59Z"
  authors:
    - "Zhiyu Sun"
    - "Minrui Luo"
    - "Yu Wang"
...
### (日本語題名: Reverse-Engineering Model Editing on Language Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.10134v2`](https://arxiv.org/abs/2602.10134v2) | Raw Meta = [`2602.10134_meta.json`](../../raw_data/2026-02-07/2602.10134_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Reverse-Engineering Model Editing on Language Models（セキュリティ分析論文）」（原題: Reverse-Engineering Model Editing on Language Models / arXiv: 2602.10134v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.10134v2`
- **論文URL**: [https://arxiv.org/abs/2602.10134v2](https://arxiv.org/abs/2602.10134v2)
- **PDFリンク**: [https://arxiv.org/pdf/2602.10134v2.pdf](https://arxiv.org/pdf/2602.10134v2.pdf)
- **著者**: Zhiyu Sun, Minrui Luo, Yu Wang, Zhili Chen, Tianxing He
- **公開日時**: `2026-02-07T08:35:59Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-07/2602.10134_meta.json) | [`PDF`](../../raw_data/2026-02-07/2602.10134.pdf) | [`TXT`](../../raw_data/2026-02-07/2602.10134.txt)
