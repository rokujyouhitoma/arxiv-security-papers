...
title_ja: "Jailbreaking Generative AI: Multivector Phishing Threats and Transformer based Defenses（セキュリティ分析論文）"
description: "Jailbreaking Generative AI: Multivector Phishing Threats and Transformer based Defenses（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.12185v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-16/2507.12185_meta.json"
  published_date: "2025-07-16T12:32:46Z"
  authors:
    - "Rina Mishra"
    - "Gaurav Varshney"
trust:
...
### (日本語題名: Jailbreaking Generative AI: Multivector Phishing Threats and Transformer based Defenses（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.12185v2`](https://arxiv.org/abs/2507.12185v2) | Raw Meta = [`2507.12185_meta.json`](../../raw_data/2025-07-16/2507.12185_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Jailbreaking Generative AI: Multivector Phishing Threats and Transformer based Defenses（セキュリティ分析論文）」（原題: Jailbreaking Generative AI: Multivector Phishing Threats and Transformer based Defenses / arXiv: 2507.12185v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.12185v2`
- **論文URL**: [https://arxiv.org/abs/2507.12185v2](https://arxiv.org/abs/2507.12185v2)
- **PDFリンク**: [https://arxiv.org/pdf/2507.12185v2.pdf](https://arxiv.org/pdf/2507.12185v2.pdf)
- **著者**: Rina Mishra, Gaurav Varshney
- **公開日時**: `2025-07-16T12:32:46Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-16/2507.12185_meta.json) | [`PDF`](../../raw_data/2025-07-16/2507.12185.pdf) | [`TXT`](../../raw_data/2025-07-16/2507.12185.txt)
