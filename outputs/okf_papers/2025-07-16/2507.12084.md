...
title_ja: "LLAMA: Multi-Feedback Smart Contract Fuzzing Framework with LLM-Guided Seed Generation（セキュリティ分析論文）"
description: "LLAMA: Multi-Feedback Smart Contract Fuzzing Framework with LLM-Guided Seed Generation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.12084v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-16/2507.12084_meta.json"
  published_date: "2025-07-16T09:46:58Z"
  authors:
    - "Keke Gai"
    - "Haochen Liang"
    - "Jing Yu"
...
### (日本語題名: LLAMA: Multi-Feedback Smart Contract Fuzzing Framework with LLM-Guided Seed Generation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.12084v1`](https://arxiv.org/abs/2507.12084v1) | Raw Meta = [`2507.12084_meta.json`](../../raw_data/2025-07-16/2507.12084_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「LLAMA: Multi-Feedback Smart Contract Fuzzing Framework with LLM-Guided Seed Generation（セキュリティ分析論文）」（原題: LLAMA: Multi-Feedback Smart Contract Fuzzing Framework with LLM-Guided Seed Generation / arXiv: 2507.12084v1）は、cs.SE 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.12084v1`
- **論文URL**: [https://arxiv.org/abs/2507.12084v1](https://arxiv.org/abs/2507.12084v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.12084v1.pdf](https://arxiv.org/pdf/2507.12084v1.pdf)
- **著者**: Keke Gai, Haochen Liang, Jing Yu, Liehuang Zhu, Dusit Niyato
- **公開日時**: `2025-07-16T09:46:58Z`
- **カテゴリ**: `cs.SE, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-16/2507.12084_meta.json) | [`PDF`](../../raw_data/2025-07-16/2507.12084.pdf) | [`TXT`](../../raw_data/2025-07-16/2507.12084.txt)
