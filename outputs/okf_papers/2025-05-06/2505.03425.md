...
title_ja: "Directed Greybox Fuzzing via Large Language Model（セキュリティ分析論文）"
description: "Directed Greybox Fuzzing via Large Language Model（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.03425v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-06/2505.03425_meta.json"
  published_date: "2025-05-06T11:04:07Z"
  authors:
    - "Hanxiang Xu"
    - "Yanjie Zhao"
    - "Haoyu Wang"
...
### (日本語題名: Directed Greybox Fuzzing via Large Language Model（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.03425v1`](https://arxiv.org/abs/2505.03425v1) | Raw Meta = [`2505.03425_meta.json`](../../raw_data/2025-05-06/2505.03425_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Directed Greybox Fuzzing via Large Language Model（セキュリティ分析論文）」（原題: Directed Greybox Fuzzing via Large Language Model / arXiv: 2505.03425v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.03425v1`
- **論文URL**: [https://arxiv.org/abs/2505.03425v1](https://arxiv.org/abs/2505.03425v1)
- **PDFリンク**: [https://arxiv.org/pdf/2505.03425v1.pdf](https://arxiv.org/pdf/2505.03425v1.pdf)
- **著者**: Hanxiang Xu, Yanjie Zhao, Haoyu Wang
- **公開日時**: `2025-05-06T11:04:07Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-06/2505.03425_meta.json) | [`PDF`](../../raw_data/2025-05-06/2505.03425.pdf) | [`TXT`](../../raw_data/2025-05-06/2505.03425.txt)
