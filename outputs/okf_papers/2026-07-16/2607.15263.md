...
title_ja: "Beyond Success Rate: Cost-Aware Evaluation of Offensive and Defensive Security Agents（セキュリティ分析論文）"
description: "Beyond Success Rate: Cost-Aware Evaluation of Offensive and Defensive Security Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.15263v3"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-16/2607.15263_meta.json"
  published_date: "2026-07-16T17:54:47Z"
  authors:
    - "Paul Kassianik"
    - "Blaine Nelson"
    - "Yaron Singer"
...
### (日本語題名: Beyond Success Rate: Cost-Aware Evaluation of Offensive and Defensive Security Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.15263v3`](https://arxiv.org/abs/2607.15263v3) | Raw Meta = [`2607.15263_meta.json`](../../raw_data/2026-07-16/2607.15263_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Beyond Success Rate: Cost-Aware Evaluation of Offensive and Defensive Security Agents（セキュリティ分析論文）」（原題: Beyond Success Rate: Cost-Aware Evaluation of Offensive and Defensive Security Agents / arXiv: 2607.15263v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.15263v3`
- **論文URL**: [https://arxiv.org/abs/2607.15263v3](https://arxiv.org/abs/2607.15263v3)
- **PDFリンク**: [https://arxiv.org/pdf/2607.15263v3.pdf](https://arxiv.org/pdf/2607.15263v3.pdf)
- **著者**: Paul Kassianik, Blaine Nelson, Yaron Singer
- **公開日時**: `2026-07-16T17:54:47Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-16/2607.15263_meta.json) | [`PDF`](../../raw_data/2026-07-16/2607.15263.pdf) | [`TXT`](../../raw_data/2026-07-16/2607.15263.txt)
