...
title_ja: "Setup Complete, Now You Are Compromised: Weaponizing Setup Instructions Against AI Coding Agents（セキュリティ分析論文）"
description: "Setup Complete, Now You Are Compromised: Weaponizing Setup Instructions Against AI Coding Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.15143v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-16/2607.15143_meta.json"
  published_date: "2026-07-16T15:47:19Z"
  authors:
    - "Aadesh Bagmar"
    - "Pushkar Saraf"
trust:
...
### (日本語題名: Setup Complete, Now You Are Compromised: Weaponizing Setup Instructions Against AI Coding Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.15143v1`](https://arxiv.org/abs/2607.15143v1) | Raw Meta = [`2607.15143_meta.json`](../../raw_data/2026-07-16/2607.15143_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Setup Complete, Now You Are Compromised: Weaponizing Setup Instructions Against AI Coding Agents（セキュリティ分析論文）」（原題: Setup Complete, Now You Are Compromised: Weaponizing Setup Instructions Against AI Coding Agents / arXiv: 2607.15143v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.15143v1`
- **論文URL**: [https://arxiv.org/abs/2607.15143v1](https://arxiv.org/abs/2607.15143v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.15143v1.pdf](https://arxiv.org/pdf/2607.15143v1.pdf)
- **著者**: Aadesh Bagmar, Pushkar Saraf
- **公開日時**: `2026-07-16T15:47:19Z`
- **カテゴリ**: `cs.CR, cs.HC, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-16/2607.15143_meta.json) | [`PDF`](../../raw_data/2026-07-16/2607.15143.pdf) | [`TXT`](../../raw_data/2026-07-16/2607.15143.txt)
