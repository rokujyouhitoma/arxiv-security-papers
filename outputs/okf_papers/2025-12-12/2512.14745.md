...
title_ja: "Factor(U,T): Controlling Untrusted AI by Monitoring their Plans（セキュリティ分析論文）"
description: "Factor(U,T): Controlling Untrusted AI by Monitoring their Plans（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.14745v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-12/2512.14745_meta.json"
  published_date: "2025-12-12T19:11:34Z"
  authors:
    - "Edward Lue Chee Lip"
    - "Anthony Channg"
    - "Diana Kim"
...
### (日本語題名: Factor(U,T): Controlling Untrusted AI by Monitoring their Plans（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.14745v1`](https://arxiv.org/abs/2512.14745v1) | Raw Meta = [`2512.14745_meta.json`](../../raw_data/2025-12-12/2512.14745_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Factor(U,T): Controlling Untrusted AI by Monitoring their Plans（セキュリティ分析論文）」（原題: Factor(U,T): Controlling Untrusted AI by Monitoring their Plans / arXiv: 2512.14745v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.14745v1`
- **論文URL**: [https://arxiv.org/abs/2512.14745v1](https://arxiv.org/abs/2512.14745v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.14745v1.pdf](https://arxiv.org/pdf/2512.14745v1.pdf)
- **著者**: Edward Lue Chee Lip, Anthony Channg, Diana Kim, Aaron Sandoval, Kevin Zhu
- **公開日時**: `2025-12-12T19:11:34Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-12/2512.14745_meta.json) | [`PDF`](../../raw_data/2025-12-12/2512.14745.pdf) | [`TXT`](../../raw_data/2025-12-12/2512.14745.txt)
