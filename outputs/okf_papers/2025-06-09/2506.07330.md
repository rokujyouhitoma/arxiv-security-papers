...
title_ja: "JavelinGuard: Low-Cost Transformer Architectures for LLM Security（セキュリティ分析論文）"
description: "JavelinGuard: Low-Cost Transformer Architectures for LLM Security（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.07330v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-09/2506.07330_meta.json"
  published_date: "2025-06-09T00:11:06Z"
  authors:
    - "Yash Datta"
    - "Sharath Rajasekar"
trust:
...
### (日本語題名: JavelinGuard: Low-Cost Transformer Architectures for LLM Security（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.07330v1`](https://arxiv.org/abs/2506.07330v1) | Raw Meta = [`2506.07330_meta.json`](../../raw_data/2025-06-09/2506.07330_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「JavelinGuard: Low-Cost Transformer Architectures for LLM Security（セキュリティ分析論文）」（原題: JavelinGuard: Low-Cost Transformer Architectures for LLM Security / arXiv: 2506.07330v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.07330v1`
- **論文URL**: [https://arxiv.org/abs/2506.07330v1](https://arxiv.org/abs/2506.07330v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.07330v1.pdf](https://arxiv.org/pdf/2506.07330v1.pdf)
- **著者**: Yash Datta, Sharath Rajasekar
- **公開日時**: `2025-06-09T00:11:06Z`
- **カテゴリ**: `cs.LG, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-09/2506.07330_meta.json) | [`PDF`](../../raw_data/2025-06-09/2506.07330.pdf) | [`TXT`](../../raw_data/2025-06-09/2506.07330.txt)
