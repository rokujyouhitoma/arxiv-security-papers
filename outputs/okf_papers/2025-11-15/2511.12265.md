...
title_ja: "Stabilizing Multi-Attack Adversarial Training via Bandit Optimization（セキュリティ分析論文）"
description: "Stabilizing Multi-Attack Adversarial Training via Bandit Optimization（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.12265v2"
tags:
  - "cs.AI"
  - "cs.CV"
  - "executive-summary"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-15/2511.12265_meta.json"
  published_date: "2025-11-15T15:42:40Z"
  authors:
    - "Rui Wang"
    - "Zeming Wei"
    - "Xiyue Zhang"
...
### (日本語題名: Stabilizing Multi-Attack Adversarial Training via Bandit Optimization（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.12265v2`](https://arxiv.org/abs/2511.12265v2) | Raw Meta = [`2511.12265_meta.json`](../../raw_data/2025-11-15/2511.12265_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Stabilizing Multi-Attack Adversarial Training via Bandit Optimization（セキュリティ分析論文）」（原題: Stabilizing Multi-Attack Adversarial Training via Bandit Optimization / arXiv: 2511.12265v2）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。

**概要**: 本研究はサイバー脅威環境におけるセキュリティ構造・脆弱性の検証を目的としています。(主要検出項目: attack, exploit, drift)

### 2. 背景とセキュリティ上の課題 (Background & Problem)
本研究はサイバー脅威環境におけるセキュリティ構造・脆弱性の検証を目的としています。(主要検出項目: attack, exploit, drift)
...
- **arXiv ID**: `2511.12265v2`
- **論文URL**: [https://arxiv.org/abs/2511.12265v2](https://arxiv.org/abs/2511.12265v2)
- **PDFリンク**: [https://arxiv.org/pdf/2511.12265v2.pdf](https://arxiv.org/pdf/2511.12265v2.pdf)
- **著者**: Rui Wang, Zeming Wei, Xiyue Zhang, Meng Sun
- **公開日時**: `2025-11-15T15:42:40Z`
- **カテゴリ**: `cs.LG, cs.AI, cs.CR, cs.CV, math.OC`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-15/2511.12265_meta.json) | [`PDF`](../../raw_data/2025-11-15/2511.12265.pdf) | [`TXT`](../../raw_data/2025-11-15/2511.12265.txt)
