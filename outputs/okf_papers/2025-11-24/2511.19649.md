...
title_ja: "Synthetic Data: AI's New Weapon Against Android Malware（セキュリティ分析論文）"
description: "Synthetic Data: AI's New Weapon Against Android Malware（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.19649v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-24/2511.19649_meta.json"
  published_date: "2025-11-24T19:27:58Z"
  authors:
...
### (日本語題名: Synthetic Data: AI's New Weapon Against Android Malware（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.19649v1`](https://arxiv.org/abs/2511.19649v1) | Raw Meta = [`2511.19649_meta.json`](../../raw_data/2025-11-24/2511.19649_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Synthetic Data: AI's New Weapon Against Android Malware（セキュリティ分析論文）」（原題: Synthetic Data: AI's New Weapon Against Android Malware / arXiv: 2511.19649v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.19649v1`
- **論文URL**: [https://arxiv.org/abs/2511.19649v1](https://arxiv.org/abs/2511.19649v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.19649v1.pdf](https://arxiv.org/pdf/2511.19649v1.pdf)
- **著者**: Angelo Gaspar Diniz Nogueira, Kayua Oleques Paim, Hendrio Bragança, Rodrigo Brandão Mansilha, Diego Kreutz
- **公開日時**: `2025-11-24T19:27:58Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-24/2511.19649_meta.json) | [`PDF`](../../raw_data/2025-11-24/2511.19649.pdf) | [`TXT`](../../raw_data/2025-11-24/2511.19649.txt)
