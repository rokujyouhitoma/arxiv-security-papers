...
title_ja: "Prompt Inversion Attack against Collaborative Inference of 大規模言語モデル"
description: "Prompt Inversion Attack against Collaborative Inference of 大規模言語モデル — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.09022v3"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-12/2503.09022_meta.json"
  published_date: "2025-03-12T03:20:03Z"
  authors:
    - "Wenjie Qu"
    - "Yuguang Zhou"
    - "Yongji Wu"
...
### (日本語題名: Prompt Inversion Attack against Collaborative Inference of 大規模言語モデル)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.09022v3`](https://arxiv.org/abs/2503.09022v3) | Raw Meta = [`2503.09022_meta.json`](../../raw_data/2025-03-12/2503.09022_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Prompt Inversion Attack against Collaborative Inference of 大規模言語モデル」（原題: Prompt Inversion Attack against Collaborative Inference of Large Language Models / arXiv: 2503.09022v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.09022v3`
- **論文URL**: [https://arxiv.org/abs/2503.09022v3](https://arxiv.org/abs/2503.09022v3)
- **PDFリンク**: [https://arxiv.org/pdf/2503.09022v3.pdf](https://arxiv.org/pdf/2503.09022v3.pdf)
- **著者**: Wenjie Qu, Yuguang Zhou, Yongji Wu, Tingsong Xiao, Binhang Yuan, Yiming Li, Jiaheng Zhang
- **公開日時**: `2025-03-12T03:20:03Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-12/2503.09022_meta.json) | [`PDF`](../../raw_data/2025-03-12/2503.09022.pdf) | [`TXT`](../../raw_data/2025-03-12/2503.09022.txt)
