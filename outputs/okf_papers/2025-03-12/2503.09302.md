...
title_ja: "Detecting and Preventing Data Poisoning Attacks on AI Models（セキュリティ分析論文）"
description: "Detecting and Preventing Data Poisoning Attacks on AI Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.09302v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-12/2503.09302_meta.json"
  published_date: "2025-03-12T11:55:01Z"
  authors:
    - "Halima I. Kure"
    - "Pradipta Sarkar"
    - "Ahmed B. Ndanusa"
...
### (日本語題名: Detecting and Preventing Data Poisoning Attacks on AI Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.09302v1`](https://arxiv.org/abs/2503.09302v1) | Raw Meta = [`2503.09302_meta.json`](../../raw_data/2025-03-12/2503.09302_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Detecting and Preventing Data Poisoning Attacks on AI Models（セキュリティ分析論文）」（原題: Detecting and Preventing Data Poisoning Attacks on AI Models / arXiv: 2503.09302v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2503.09302v1](https://arxiv.org/abs/2503.09302v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.09302v1.pdf](https://arxiv.org/pdf/2503.09302v1.pdf)
- **著者**: Halima I. Kure, Pradipta Sarkar, Ahmed B. Ndanusa, Augustine O. Nwajana
- **公開日時**: `2025-03-12T11:55:01Z`
- **カテゴリ**: `cs.CR, eess.IV`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-12/2503.09302_meta.json) | [`PDF`](../../raw_data/2025-03-12/2503.09302.pdf) | [`TXT`](../../raw_data/2025-03-12/2503.09302.txt)
