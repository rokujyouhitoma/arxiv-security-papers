...
title_ja: "CTFusion: A CTF-based Benchmark for LLM Agent Evaluation（セキュリティ分析論文）"
description: "CTFusion: A CTF-based Benchmark for LLM Agent Evaluation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.11504v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-12/2605.11504_meta.json"
  published_date: "2026-05-12T04:23:42Z"
  authors:
    - "Dongjun Lee"
    - "Ga-eun Bae"
    - "Insu Yun"
...
### (日本語題名: CTFusion: A CTF-based Benchmark for LLM Agent Evaluation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.11504v2`](https://arxiv.org/abs/2605.11504v2) | Raw Meta = [`2605.11504_meta.json`](../../raw_data/2026-05-12/2605.11504_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「CTFusion: A CTF-based Benchmark for LLM Agent Evaluation（セキュリティ分析論文）」（原題: CTFusion: A CTF-based Benchmark for LLM Agent Evaluation / arXiv: 2605.11504v2）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.11504v2`
- **論文URL**: [https://arxiv.org/abs/2605.11504v2](https://arxiv.org/abs/2605.11504v2)
- **PDFリンク**: [https://arxiv.org/pdf/2605.11504v2.pdf](https://arxiv.org/pdf/2605.11504v2.pdf)
- **著者**: Dongjun Lee, Ga-eun Bae, Insu Yun
- **公開日時**: `2026-05-12T04:23:42Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-12/2605.11504_meta.json) | [`PDF`](../../raw_data/2026-05-12/2605.11504.pdf) | [`TXT`](../../raw_data/2026-05-12/2605.11504.txt)
