...
title_ja: "SMSR: Certified Defence Against Runtime Memory Poisoning in Persistent LLM Agent Systems（セキュリティ分析論文）"
description: "SMSR: Certified Defence Against Runtime Memory Poisoning in Persistent LLM Agent Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.12703v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-10/2606.12703_meta.json"
  published_date: "2026-06-10T21:45:52Z"
  authors:
    - "Tarun Sharma"
trust:
...
### (日本語題名: SMSR: Certified Defence Against Runtime Memory Poisoning in Persistent LLM Agent Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.12703v1`](https://arxiv.org/abs/2606.12703v1) | Raw Meta = [`2606.12703_meta.json`](../../raw_data/2026-06-10/2606.12703_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SMSR: Certified Defence Against Runtime Memory Poisoning in Persistent LLM Agent Systems（セキュリティ分析論文）」（原題: SMSR: Certified Defence Against Runtime Memory Poisoning in Persistent LLM Agent Systems / arXiv: 2606.12703v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.12703v1`
- **論文URL**: [https://arxiv.org/abs/2606.12703v1](https://arxiv.org/abs/2606.12703v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.12703v1.pdf](https://arxiv.org/pdf/2606.12703v1.pdf)
- **著者**: Tarun Sharma
- **公開日時**: `2026-06-10T21:45:52Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-10/2606.12703_meta.json) | [`PDF`](../../raw_data/2026-06-10/2606.12703.pdf) | [`TXT`](../../raw_data/2026-06-10/2606.12703.txt)
