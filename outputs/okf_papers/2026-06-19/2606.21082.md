...
title_ja: "Scalable Hierarchical Attention Transformers for Multi-Turn Jailbreak Detection in Long Conversations（セキュリティ分析論文）"
description: "Scalable Hierarchical Attention Transformers for Multi-Turn Jailbreak Detection in Long Conversations（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.21082v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-19/2606.21082_meta.json"
  published_date: "2026-06-19T04:05:43Z"
  authors:
    - "Chenhui Hu"
    - "Muhammed Salih"
    - "Sudipto Guha"
...
### (日本語題名: Scalable Hierarchical Attention Transformers for Multi-Turn Jailbreak Detection in Long Conversations（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.21082v1`](https://arxiv.org/abs/2606.21082v1) | Raw Meta = [`2606.21082_meta.json`](../../raw_data/2026-06-19/2606.21082_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Scalable Hierarchical Attention Transformers for Multi-Turn Jailbreak Detection in Long Conversations（セキュリティ分析論文）」（原題: Scalable Hierarchical Attention Transformers for Multi-Turn Jailbreak Detection in Long Conversations / arXiv: 2606.21082v1）は、cs.CL 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.21082v1`
- **論文URL**: [https://arxiv.org/abs/2606.21082v1](https://arxiv.org/abs/2606.21082v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.21082v1.pdf](https://arxiv.org/pdf/2606.21082v1.pdf)
- **著者**: Chenhui Hu, Muhammed Salih, Sudipto Guha, Subramanian Srinivasan
- **公開日時**: `2026-06-19T04:05:43Z`
- **カテゴリ**: `cs.CL, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-19/2606.21082_meta.json) | [`PDF`](../../raw_data/2026-06-19/2606.21082.pdf) | [`TXT`](../../raw_data/2026-06-19/2606.21082.txt)
