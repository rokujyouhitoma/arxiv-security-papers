...
title_ja: "LoginTrap: Uncovering Task-Agnostic Phishing-Style Indirect Prompt Injection Attacks against LLM-based Web Agents（セキュリティ分析論文）"
description: "LoginTrap: Uncovering Task-Agnostic Phishing-Style Indirect Prompt Injection Attacks against LLM-based Web Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.04741v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-05/2608.04741_meta.json"
  published_date: "2026-08-05T12:08:16Z"
  authors:
    - "Longtao Guo"
    - "Zelin Zhang"
    - "Kaifeng Huang"
...
### (日本語題名: LoginTrap: Uncovering Task-Agnostic Phishing-Style Indirect Prompt Injection Attacks against LLM-based Web Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.04741v1`](https://arxiv.org/abs/2608.04741v1) | Raw Meta = [`2608.04741_meta.json`](../../raw_data/2026-08-05/2608.04741_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「LoginTrap: Uncovering Task-Agnostic Phishing-Style Indirect Prompt Injection Attacks against LLM-based Web Agents（セキュリティ分析論文）」（原題: LoginTrap: Uncovering Task-Agnostic Phishing-Style Indirect Prompt Injection Attacks against LLM-based Web Agents / arXiv: 2608.04741v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.04741v1`
- **論文URL**: [https://arxiv.org/abs/2608.04741v1](https://arxiv.org/abs/2608.04741v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.04741v1.pdf](https://arxiv.org/pdf/2608.04741v1.pdf)
- **著者**: Longtao Guo, Zelin Zhang, Kaifeng Huang, Yang Shi
- **公開日時**: `2026-08-05T12:08:16Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-05/2608.04741_meta.json) | [`PDF`](../../raw_data/2026-08-05/2608.04741.pdf) | [`TXT`](../../raw_data/2026-08-05/2608.04741.txt)
