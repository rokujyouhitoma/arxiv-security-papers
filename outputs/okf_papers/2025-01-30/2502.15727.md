...
title_ja: "Retrieval Augmented Generation Based LLM Evaluation For Protocol State Machine Inference With Chain-of-Thought Reasoning（セキュリティ分析論文）"
description: "Retrieval Augmented Generation Based LLM Evaluation For Protocol State Machine Inference With Chain-of-Thought Reasoning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.15727v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-30/2502.15727_meta.json"
  published_date: "2025-01-30T01:03:49Z"
  authors:
    - "Youssef Maklad"
    - "Fares Wael"
    - "Wael Elsersy"
...
### (日本語題名: Retrieval Augmented Generation Based LLM Evaluation For Protocol State Machine Inference With Chain-of-Thought Reasoning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.15727v2`](https://arxiv.org/abs/2502.15727v2) | Raw Meta = [`2502.15727_meta.json`](../../raw_data/2025-01-30/2502.15727_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Retrieval Augmented Generation Based LLM Evaluation For Protocol State Machine Inference With Chain-of-Thought Reasoning（セキュリティ分析論文）」（原題: Retrieval Augmented Generation Based LLM Evaluation For Protocol State Machine Inference With Chain-of-Thought Reasoning / arXiv: 2502.15727v2）は、cs.NI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.15727v2`
- **論文URL**: [https://arxiv.org/abs/2502.15727v2](https://arxiv.org/abs/2502.15727v2)
- **PDFリンク**: [https://arxiv.org/pdf/2502.15727v2.pdf](https://arxiv.org/pdf/2502.15727v2.pdf)
- **著者**: Youssef Maklad, Fares Wael, Wael Elsersy, Ali Hamdi
- **公開日時**: `2025-01-30T01:03:49Z`
- **カテゴリ**: `cs.NI, cs.AI, cs.CR, cs.IR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-30/2502.15727_meta.json) | [`PDF`](../../raw_data/2025-01-30/2502.15727.pdf) | [`TXT`](../../raw_data/2025-01-30/2502.15727.txt)
