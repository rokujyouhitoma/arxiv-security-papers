...
title_ja: "When Are LLM Inferences Acceptable? User Reactions and Control Preferences for Inferred Personal Information（セキュリティ分析論文）"
description: "When Are LLM Inferences Acceptable? User Reactions and Control Preferences for Inferred Personal Information（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.10013v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-11/2605.10013_meta.json"
  published_date: "2026-05-11T05:39:48Z"
  authors:
    - "Kyzyl Monteiro"
    - "Minjung Park"
    - "Alexander Ioffrida"
...
### (日本語題名: When Are LLM Inferences Acceptable? User Reactions and Control Preferences for Inferred Personal Information（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.10013v1`](https://arxiv.org/abs/2605.10013v1) | Raw Meta = [`2605.10013_meta.json`](../../raw_data/2026-05-11/2605.10013_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「When Are LLM Inferences Acceptable? User Reactions and Control Preferences for Inferred Personal Information（セキュリティ分析論文）」（原題: When Are LLM Inferences Acceptable? User Reactions and Control Preferences for Inferred Personal Information / arXiv: 2605.10013v1）は、cs.HC 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.10013v1`
- **論文URL**: [https://arxiv.org/abs/2605.10013v1](https://arxiv.org/abs/2605.10013v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.10013v1.pdf](https://arxiv.org/pdf/2605.10013v1.pdf)
- **著者**: Kyzyl Monteiro, Minjung Park, Alexander Ioffrida, Angelina Sanna, Hao-Ping, Lee, Niloofar Mireshghallah, Yang Wang, Sauvik Das
- **公開日時**: `2026-05-11T05:39:48Z`
- **カテゴリ**: `cs.HC, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-11/2605.10013_meta.json) | [`PDF`](../../raw_data/2026-05-11/2605.10013.pdf) | [`TXT`](../../raw_data/2026-05-11/2605.10013.txt)
