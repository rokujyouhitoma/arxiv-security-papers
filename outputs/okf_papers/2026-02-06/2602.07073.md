...
title_ja: "Pro-ZD: A Transferable Graph Neural Network Approach for Proactive Zero-Day Threats Mitigation（セキュリティ分析論文）"
description: "Pro-ZD: A Transferable Graph Neural Network Approach for Proactive Zero-Day Threats Mitigation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.07073v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-06/2602.07073_meta.json"
  published_date: "2026-02-06T00:29:08Z"
  authors:
    - "Nardine Basta"
    - "Firas Ben Hmida"
    - "Houssem Jmal"
...
### (日本語題名: Pro-ZD: A Transferable Graph Neural Network Approach for Proactive Zero-Day Threats Mitigation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.07073v1`](https://arxiv.org/abs/2602.07073v1) | Raw Meta = [`2602.07073_meta.json`](../../raw_data/2026-02-06/2602.07073_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Pro-ZD: A Transferable Graph Neural Network Approach for Proactive Zero-Day Threats Mitigation（セキュリティ分析論文）」（原題: Pro-ZD: A Transferable Graph Neural Network Approach for Proactive Zero-Day Threats Mitigation / arXiv: 2602.07073v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.07073v1`
- **論文URL**: [https://arxiv.org/abs/2602.07073v1](https://arxiv.org/abs/2602.07073v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.07073v1.pdf](https://arxiv.org/pdf/2602.07073v1.pdf)
- **著者**: Nardine Basta, Firas Ben Hmida, Houssem Jmal, Muhammad Ikram, Mohamed Ali Kaafar, Andy Walker
- **公開日時**: `2026-02-06T00:29:08Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-06/2602.07073_meta.json) | [`PDF`](../../raw_data/2026-02-06/2602.07073.pdf) | [`TXT`](../../raw_data/2026-02-06/2602.07073.txt)
