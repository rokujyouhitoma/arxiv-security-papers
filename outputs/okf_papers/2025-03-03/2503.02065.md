...
title_ja: "Too Much to Trust? Measuring the Security and Cognitive Impacts of Explainability in AI-Driven SOCs（セキュリティ分析論文）"
description: "Too Much to Trust? Measuring the Security and Cognitive Impacts of Explainability in AI-Driven SOCs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.02065v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.IR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-03/2503.02065_meta.json"
  published_date: "2025-03-03T21:39:15Z"
  authors:
    - "Nidhi Rastogi"
    - "Shirid Pant"
    - "Devang Dhanuka"
...
### (日本語題名: Too Much to Trust? Measuring the Security and Cognitive Impacts of Explainability in AI-Driven SOCs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.02065v2`](https://arxiv.org/abs/2503.02065v2) | Raw Meta = [`2503.02065_meta.json`](../../raw_data/2025-03-03/2503.02065_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Too Much to Trust? Measuring the Security and Cognitive Impacts of Explainability in AI-Driven SOCs（セキュリティ分析論文）」（原題: Too Much to Trust? Measuring the Security and Cognitive Impacts of Explainability in AI-Driven SOCs / arXiv: 2503.02065v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2503.02065v2](https://arxiv.org/abs/2503.02065v2)
- **PDFリンク**: [https://arxiv.org/pdf/2503.02065v2.pdf](https://arxiv.org/pdf/2503.02065v2.pdf)
- **著者**: Nidhi Rastogi, Shirid Pant, Devang Dhanuka, Amulya Saxena, Pranjal Mairal
- **公開日時**: `2025-03-03T21:39:15Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.IR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-03/2503.02065_meta.json) | [`PDF`](../../raw_data/2025-03-03/2503.02065.pdf) | [`TXT`](../../raw_data/2025-03-03/2503.02065.txt)
