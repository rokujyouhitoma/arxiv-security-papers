...
title_ja: "Jailbreaking Generative AI: Empowering Novices to Conduct Phishing Attacks（セキュリティ分析論文）"
description: "Jailbreaking Generative AI: Empowering Novices to Conduct Phishing Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.01395v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-03/2503.01395_meta.json"
  published_date: "2025-03-03T10:51:10Z"
  authors:
    - "Rina Mishra"
    - "Gaurav Varshney"
    - "Shreya Singh"
...
### (日本語題名: Jailbreaking Generative AI: Empowering Novices to Conduct Phishing Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.01395v1`](https://arxiv.org/abs/2503.01395v1) | Raw Meta = [`2503.01395_meta.json`](../../raw_data/2025-03-03/2503.01395_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Jailbreaking Generative AI: Empowering Novices to Conduct Phishing Attacks（セキュリティ分析論文）」（原題: Jailbreaking Generative AI: Empowering Novices to Conduct Phishing Attacks / arXiv: 2503.01395v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.01395v1`
- **論文URL**: [https://arxiv.org/abs/2503.01395v1](https://arxiv.org/abs/2503.01395v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.01395v1.pdf](https://arxiv.org/pdf/2503.01395v1.pdf)
- **著者**: Rina Mishra, Gaurav Varshney, Shreya Singh
- **公開日時**: `2025-03-03T10:51:10Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-03/2503.01395_meta.json) | [`PDF`](../../raw_data/2025-03-03/2503.01395.pdf) | [`TXT`](../../raw_data/2025-03-03/2503.01395.txt)
