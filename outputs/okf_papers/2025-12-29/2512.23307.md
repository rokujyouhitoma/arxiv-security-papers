...
title_ja: "RobustMask: Certified Robustness against Adversarial Neural Ranking Attack via Randomized Masking（セキュリティ分析論文）"
description: "RobustMask: Certified Robustness against Adversarial Neural Ranking Attack via Randomized Masking（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.23307v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-29/2512.23307_meta.json"
  published_date: "2025-12-29T08:51:35Z"
  authors:
    - "Jiawei Liu"
    - "Zhuo Chen"
    - "Rui Zhu"
...
### (日本語題名: RobustMask: Certified Robustness against Adversarial Neural Ranking Attack via Randomized Masking（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.23307v1`](https://arxiv.org/abs/2512.23307v1) | Raw Meta = [`2512.23307_meta.json`](../../raw_data/2025-12-29/2512.23307_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「RobustMask: Certified Robustness against Adversarial Neural Ranking Attack via Randomized Masking（セキュリティ分析論文）」（原題: RobustMask: Certified Robustness against Adversarial Neural Ranking Attack via Randomized Masking / arXiv: 2512.23307v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.23307v1`
- **論文URL**: [https://arxiv.org/abs/2512.23307v1](https://arxiv.org/abs/2512.23307v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.23307v1.pdf](https://arxiv.org/pdf/2512.23307v1.pdf)
- **著者**: Jiawei Liu, Zhuo Chen, Rui Zhu, Miaokun Chen, Yuyang Gong, Wei Lu, Xiaofeng Wang
- **公開日時**: `2025-12-29T08:51:35Z`
- **カテゴリ**: `cs.CR, cs.IR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-29/2512.23307_meta.json) | [`PDF`](../../raw_data/2025-12-29/2512.23307.pdf) | [`TXT`](../../raw_data/2025-12-29/2512.23307.txt)
