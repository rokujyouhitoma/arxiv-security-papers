...
title_ja: "Consensus Power Inequality: A Comparative Study of Blockchain Networks（セキュリティ分析論文）"
description: "Consensus Power Inequality: A Comparative Study of Blockchain Networks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.14393v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-17/2506.14393_meta.json"
  published_date: "2025-06-17T10:45:41Z"
  authors:
    - "Kamil Tylinski"
    - "Abylay Satybaldy"
    - "Paolo Tasca"
...
### (日本語題名: Consensus Power Inequality: A Comparative Study of Blockchain Networks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.14393v1`](https://arxiv.org/abs/2506.14393v1) | Raw Meta = [`2506.14393_meta.json`](../../raw_data/2025-06-17/2506.14393_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Consensus Power Inequality: A Comparative Study of Blockchain Networks（セキュリティ分析論文）」（原題: Consensus Power Inequality: A Comparative Study of Blockchain Networks / arXiv: 2506.14393v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.14393v1`
- **論文URL**: [https://arxiv.org/abs/2506.14393v1](https://arxiv.org/abs/2506.14393v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.14393v1.pdf](https://arxiv.org/pdf/2506.14393v1.pdf)
- **著者**: Kamil Tylinski, Abylay Satybaldy, Paolo Tasca
- **公開日時**: `2025-06-17T10:45:41Z`
- **カテゴリ**: `cs.CR, cs.DC`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-17/2506.14393_meta.json) | [`PDF`](../../raw_data/2025-06-17/2506.14393.pdf) | [`TXT`](../../raw_data/2025-06-17/2506.14393.txt)
