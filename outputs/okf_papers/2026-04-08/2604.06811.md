...
title_ja: "SkillTrojan: Backdoor Attacks on Skill-Based Agent Systems（セキュリティ分析論文）"
description: "SkillTrojan: Backdoor Attacks on Skill-Based Agent Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.06811v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-08/2604.06811_meta.json"
  published_date: "2026-04-08T08:24:48Z"
  authors:
    - "Yunhao Feng"
    - "Yifan Ding"
    - "Yingshui Tan"
...
### (日本語題名: SkillTrojan: Backdoor Attacks on Skill-Based Agent Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.06811v2`](https://arxiv.org/abs/2604.06811v2) | Raw Meta = [`2604.06811_meta.json`](../../raw_data/2026-04-08/2604.06811_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SkillTrojan: Backdoor Attacks on Skill-Based Agent Systems（セキュリティ分析論文）」（原題: SkillTrojan: Backdoor Attacks on Skill-Based Agent Systems / arXiv: 2604.06811v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.06811v2`
- **論文URL**: [https://arxiv.org/abs/2604.06811v2](https://arxiv.org/abs/2604.06811v2)
- **PDFリンク**: [https://arxiv.org/pdf/2604.06811v2.pdf](https://arxiv.org/pdf/2604.06811v2.pdf)
- **著者**: Yunhao Feng, Yifan Ding, Yingshui Tan, Boren Zheng, Yanming Guo, Xiaolong Li, Kun Zhai, Yishan Li, Wenke Huang
- **公開日時**: `2026-04-08T08:24:48Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-08/2604.06811_meta.json) | [`PDF`](../../raw_data/2026-04-08/2604.06811.pdf) | [`TXT`](../../raw_data/2026-04-08/2604.06811.txt)
