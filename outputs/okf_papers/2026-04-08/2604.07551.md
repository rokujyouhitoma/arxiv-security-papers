...
title_ja: "MCP-DPT: A Defense-Placement Taxonomy and Coverage Analysis for Model Context Protocol Security（セキュリティ分析論文）"
description: "MCP-DPT: A Defense-Placement Taxonomy and Coverage Analysis for Model Context Protocol Security（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.07551v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-08/2604.07551_meta.json"
  published_date: "2026-04-08T19:53:26Z"
  authors:
    - "Mehrdad Rostamzadeh"
    - "Sidhant Narula"
    - "Nahom Birhan"
...
### (日本語題名: MCP-DPT: A Defense-Placement Taxonomy and Coverage Analysis for Model Context Protocol Security（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.07551v1`](https://arxiv.org/abs/2604.07551v1) | Raw Meta = [`2604.07551_meta.json`](../../raw_data/2026-04-08/2604.07551_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MCP-DPT: A Defense-Placement Taxonomy and Coverage Analysis for Model Context Protocol Security（セキュリティ分析論文）」（原題: MCP-DPT: A Defense-Placement Taxonomy and Coverage Analysis for Model Context Protocol Security / arXiv: 2604.07551v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.07551v1`
- **論文URL**: [https://arxiv.org/abs/2604.07551v1](https://arxiv.org/abs/2604.07551v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.07551v1.pdf](https://arxiv.org/pdf/2604.07551v1.pdf)
- **著者**: Mehrdad Rostamzadeh, Sidhant Narula, Nahom Birhan, Mohammad Ghasemigol, Daniel Takabi
- **公開日時**: `2026-04-08T19:53:26Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-08/2604.07551_meta.json) | [`PDF`](../../raw_data/2026-04-08/2604.07551.pdf) | [`TXT`](../../raw_data/2026-04-08/2604.07551.txt)
