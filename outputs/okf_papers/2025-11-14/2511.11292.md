...
title_ja: "The Jasmin Compiler Preserves Cryptographic Security（セキュリティ分析論文）"
description: "The Jasmin Compiler Preserves Cryptographic Security（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.11292v1"
tags:
  - "cs.PL"
  - "executive-summary"
  - "cybersecurity"
...
### (日本語題名: The Jasmin Compiler Preserves Cryptographic Security（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.11292v1`](https://arxiv.org/abs/2511.11292v1) | Raw Meta = [`2511.11292_meta.json`](../../raw_data/2025-11-14/2511.11292_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「The Jasmin Compiler Preserves Cryptographic Security（セキュリティ分析論文）」（原題: The Jasmin Compiler Preserves Cryptographic Security / arXiv: 2511.11292v1）は、cs.PL 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.11292v1`
- **論文URL**: [https://arxiv.org/abs/2511.11292v1](https://arxiv.org/abs/2511.11292v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.11292v1.pdf](https://arxiv.org/pdf/2511.11292v1.pdf)
