...
title_ja: "SALT-V: Lightweight Authentication for 5G V2X Broadcasting（セキュリティ分析論文）"
description: "SALT-V: Lightweight Authentication for 5G V2X Broadcasting（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.11028v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-14/2511.11028_meta.json"
  published_date: "2025-11-14T07:32:21Z"
  authors:
    - "Liu Cao"
    - "Weizheng Wang"
    - "Qipeng Xie"
...
### (日本語題名: SALT-V: Lightweight Authentication for 5G V2X Broadcasting（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.11028v1`](https://arxiv.org/abs/2511.11028v1) | Raw Meta = [`2511.11028_meta.json`](../../raw_data/2025-11-14/2511.11028_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SALT-V: Lightweight Authentication for 5G V2X Broadcasting（セキュリティ分析論文）」（原題: SALT-V: Lightweight Authentication for 5G V2X Broadcasting / arXiv: 2511.11028v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.11028v1`
- **論文URL**: [https://arxiv.org/abs/2511.11028v1](https://arxiv.org/abs/2511.11028v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.11028v1.pdf](https://arxiv.org/pdf/2511.11028v1.pdf)
- **著者**: Liu Cao, Weizheng Wang, Qipeng Xie, Dongyu Wei, Lyutianyang Zhang
- **公開日時**: `2025-11-14T07:32:21Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-14/2511.11028_meta.json) | [`PDF`](../../raw_data/2025-11-14/2511.11028.pdf) | [`TXT`](../../raw_data/2025-11-14/2511.11028.txt)
