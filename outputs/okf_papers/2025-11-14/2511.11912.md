...
title_ja: "A Systematic Study of Model Extraction Attacks on Graph Foundation Models（セキュリティ分析論文）"
description: "A Systematic Study of Model Extraction Attacks on Graph Foundation Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.11912v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-14/2511.11912_meta.json"
  published_date: "2025-11-14T22:43:42Z"
  authors:
    - "Haoyan Xu"
    - "Ruizhi Qian"
    - "Jiate Li"
...
### (日本語題名: A Systematic Study of Model Extraction Attacks on Graph Foundation Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.11912v1`](https://arxiv.org/abs/2511.11912v1) | Raw Meta = [`2511.11912_meta.json`](../../raw_data/2025-11-14/2511.11912_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Systematic Study of Model Extraction Attacks on Graph Foundation Models（セキュリティ分析論文）」（原題: A Systematic Study of Model Extraction Attacks on Graph Foundation Models / arXiv: 2511.11912v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.11912v1`
- **論文URL**: [https://arxiv.org/abs/2511.11912v1](https://arxiv.org/abs/2511.11912v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.11912v1.pdf](https://arxiv.org/pdf/2511.11912v1.pdf)
- **著者**: Haoyan Xu, Ruizhi Qian, Jiate Li, Yushun Dong, Minghao Lin, Hanson Yan, Zhengtao Yao, Qinghua Liu, Junhao Dong, Ruopeng Huang, Yue Zhao, Mengyuan Li
- **公開日時**: `2025-11-14T22:43:42Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-14/2511.11912_meta.json) | [`PDF`](../../raw_data/2025-11-14/2511.11912.pdf) | [`TXT`](../../raw_data/2025-11-14/2511.11912.txt)
