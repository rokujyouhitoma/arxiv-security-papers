...
title_ja: "SecRL-Prune: Structured Reinforcement Learning-Based Pruning of CodeLLMs for Preserving Adversarial Code Mutation（セキュリティ分析論文）"
description: "SecRL-Prune: Structured Reinforcement Learning-Based Pruning of CodeLLMs for Preserving Adversarial Code Mutation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.06254v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-04/2606.06254_meta.json"
  published_date: "2026-06-04T14:55:14Z"
  authors:
...
### (日本語題名: SecRL-Prune: Structured Reinforcement Learning-Based Pruning of CodeLLMs for Preserving Adversarial Code Mutation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.06254v1`](https://arxiv.org/abs/2606.06254v1) | Raw Meta = [`2606.06254_meta.json`](../../raw_data/2026-06-04/2606.06254_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SecRL-Prune: Structured Reinforcement Learning-Based Pruning of CodeLLMs for Preserving Adversarial Code Mutation（セキュリティ分析論文）」（原題: SecRL-Prune: Structured Reinforcement Learning-Based Pruning of CodeLLMs for Preserving Adversarial Code Mutation / arXiv: 2606.06254v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.06254v1`
- **論文URL**: [https://arxiv.org/abs/2606.06254v1](https://arxiv.org/abs/2606.06254v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.06254v1.pdf](https://arxiv.org/pdf/2606.06254v1.pdf)
- **著者**: Parsa Memarzadehsaghezi, Pooria Madani, Khalil El-Khatib
- **公開日時**: `2026-06-04T14:55:14Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-04/2606.06254_meta.json) | [`PDF`](../../raw_data/2026-06-04/2606.06254.pdf) | [`TXT`](../../raw_data/2026-06-04/2606.06254.txt)
