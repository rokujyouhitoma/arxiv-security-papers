...
title_ja: "On the Internet, Nobody Knows You're an LLM Bot: Unmasking Web Agents with Multi-Layer Fingerprinting（セキュリティ分析論文）"
description: "On the Internet, Nobody Knows You're an LLM Bot: Unmasking Web Agents with Multi-Layer Fingerprinting（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.30119v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-29/2606.30119_meta.json"
  published_date: "2026-06-29T10:51:13Z"
  authors:
    - "Iliana Fayolle"
    - "Sihem Bouhenniche"
    - "Samuel Pélissier"
...
### (日本語題名: On the Internet, Nobody Knows You're an LLM Bot: Unmasking Web Agents with Multi-Layer Fingerprinting（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.30119v1`](https://arxiv.org/abs/2606.30119v1) | Raw Meta = [`2606.30119_meta.json`](../../raw_data/2026-06-29/2606.30119_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「On the Internet, Nobody Knows You're an LLM Bot: Unmasking Web Agents with Multi-Layer Fingerprinting（セキュリティ分析論文）」（原題: On the Internet, Nobody Knows You're an LLM Bot: Unmasking Web Agents with Multi-Layer Fingerprinting / arXiv: 2606.30119v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2606.30119v1`
- **論文URL**: [https://arxiv.org/abs/2606.30119v1](https://arxiv.org/abs/2606.30119v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.30119v1.pdf](https://arxiv.org/pdf/2606.30119v1.pdf)
- **著者**: Iliana Fayolle, Sihem Bouhenniche, Samuel Pélissier, Pierre Laperdrix, Clémentine Maurice, Walter Rudametkin
- **公開日時**: `2026-06-29T10:51:13Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-29/2606.30119_meta.json) | [`PDF`](../../raw_data/2026-06-29/2606.30119.pdf) | [`TXT`](../../raw_data/2026-06-29/2606.30119.txt)
