...
title_ja: "A Study on Mixup-Inspired Augmentation Methods for Software 脆弱性検出"
description: "A Study on Mixup-Inspired Augmentation Methods for Software 脆弱性検出 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.15632v3"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-22/2504.15632_meta.json"
  published_date: "2025-04-22T06:47:39Z"
  authors:
...
### (日本語題名: A Study on Mixup-Inspired Augmentation Methods for Software 脆弱性検出)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.15632v3`](https://arxiv.org/abs/2504.15632v3) | Raw Meta = [`2504.15632_meta.json`](../../raw_data/2025-04-22/2504.15632_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Study on Mixup-Inspired Augmentation Methods for Software 脆弱性検出」（原題: A Study on Mixup-Inspired Augmentation Methods for Software Vulnerability Detection / arXiv: 2504.15632v3）は、cs.SE 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.15632v3`
- **論文URL**: [https://arxiv.org/abs/2504.15632v3](https://arxiv.org/abs/2504.15632v3)
- **PDFリンク**: [https://arxiv.org/pdf/2504.15632v3.pdf](https://arxiv.org/pdf/2504.15632v3.pdf)
- **著者**: Seyed Shayan Daneshvar, Da Tan, Shaowei Wang, Carson Leung
- **公開日時**: `2025-04-22T06:47:39Z`
- **カテゴリ**: `cs.SE, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-22/2504.15632_meta.json) | [`PDF`](../../raw_data/2025-04-22/2504.15632.pdf) | [`TXT`](../../raw_data/2025-04-22/2504.15632.txt)
