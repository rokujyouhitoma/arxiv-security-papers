...
title_ja: "Exploring the Security Threats of Retriever Backdoors in Retrieval-Augmented Code Generation（セキュリティ分析論文）"
description: "Exploring the Security Threats of Retriever Backdoors in Retrieval-Augmented Code Generation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.21681v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-25/2512.21681_meta.json"
  published_date: "2025-12-25T13:53:46Z"
  authors:
    - "Tian Li"
    - "Bo Lin"
    - "Shangwen Wang"
...
### (日本語題名: Exploring the Security Threats of Retriever Backdoors in Retrieval-Augmented Code Generation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.21681v1`](https://arxiv.org/abs/2512.21681v1) | Raw Meta = [`2512.21681_meta.json`](../../raw_data/2025-12-25/2512.21681_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Exploring the Security Threats of Retriever Backdoors in Retrieval-Augmented Code Generation（セキュリティ分析論文）」（原題: Exploring the Security Threats of Retriever Backdoors in Retrieval-Augmented Code Generation / arXiv: 2512.21681v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2512.21681v1](https://arxiv.org/abs/2512.21681v1)
- **PDFリンク**: [https://arxiv.org/pdf/2512.21681v1.pdf](https://arxiv.org/pdf/2512.21681v1.pdf)
- **著者**: Tian Li, Bo Lin, Shangwen Wang, Yusong Tan
- **公開日時**: `2025-12-25T13:53:46Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-25/2512.21681_meta.json) | [`PDF`](../../raw_data/2025-12-25/2512.21681.pdf) | [`TXT`](../../raw_data/2025-12-25/2512.21681.txt)
