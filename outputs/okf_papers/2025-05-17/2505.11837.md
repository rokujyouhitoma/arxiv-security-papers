...
title_ja: "On Membership Inference Attacks in Knowledge Distillation（セキュリティ分析論文）"
description: "On Membership Inference Attacks in Knowledge Distillation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.11837v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-17/2505.11837_meta.json"
  published_date: "2025-05-17T04:54:26Z"
  authors:
    - "Ziyao Cui"
    - "Minxing Zhang"
    - "Jian Pei"
...
### (日本語題名: On Membership Inference Attacks in Knowledge Distillation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.11837v2`](https://arxiv.org/abs/2505.11837v2) | Raw Meta = [`2505.11837_meta.json`](../../raw_data/2025-05-17/2505.11837_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「On Membership Inference Attacks in Knowledge Distillation（セキュリティ分析論文）」（原題: On Membership Inference Attacks in Knowledge Distillation / arXiv: 2505.11837v2）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.11837v2`
- **論文URL**: [https://arxiv.org/abs/2505.11837v2](https://arxiv.org/abs/2505.11837v2)
- **PDFリンク**: [https://arxiv.org/pdf/2505.11837v2.pdf](https://arxiv.org/pdf/2505.11837v2.pdf)
- **著者**: Ziyao Cui, Minxing Zhang, Jian Pei
- **公開日時**: `2025-05-17T04:54:26Z`
- **カテゴリ**: `cs.LG, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-17/2505.11837_meta.json) | [`PDF`](../../raw_data/2025-05-17/2505.11837.pdf) | [`TXT`](../../raw_data/2025-05-17/2505.11837.txt)
