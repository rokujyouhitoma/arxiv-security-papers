...
title_ja: "What Makes a Good LLM Agent for Real-world Penetration Testing?（セキュリティ分析論文）"
description: "What Makes a Good LLM Agent for Real-world Penetration Testing?（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.17622v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-19/2602.17622_meta.json"
  published_date: "2026-02-19T18:42:40Z"
  authors:
    - "Gelei Deng"
    - "Yi Liu"
    - "Yuekang Li"
...
### (日本語題名: What Makes a Good LLM Agent for Real-world Penetration Testing?（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.17622v1`](https://arxiv.org/abs/2602.17622v1) | Raw Meta = [`2602.17622_meta.json`](../../raw_data/2026-02-19/2602.17622_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「What Makes a Good LLM Agent for Real-world Penetration Testing?（セキュリティ分析論文）」（原題: What Makes a Good LLM Agent for Real-world Penetration Testing? / arXiv: 2602.17622v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2602.17622v1](https://arxiv.org/abs/2602.17622v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.17622v1.pdf](https://arxiv.org/pdf/2602.17622v1.pdf)
- **著者**: Gelei Deng, Yi Liu, Yuekang Li, Ruozhao Yang, Xiaofei Xie, Jie Zhang, Han Qiu, Tianwei Zhang
- **公開日時**: `2026-02-19T18:42:40Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-19/2602.17622_meta.json) | [`PDF`](../../raw_data/2026-02-19/2602.17622.pdf) | [`TXT`](../../raw_data/2026-02-19/2602.17622.txt)
