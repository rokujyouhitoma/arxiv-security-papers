...
title_ja: "StableAML: Machine Learning for Behavioral Wallet Detection in Stablecoin Anti-Money Laundering on Ethereum（セキュリティ分析論文）"
description: "StableAML: Machine Learning for Behavioral Wallet Detection in Stablecoin Anti-Money Laundering on Ethereum（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.17842v2"
tags:
  - "cs.CE"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-19/2602.17842_meta.json"
  published_date: "2026-02-19T21:13:39Z"
  authors:
    - "Luciano Juvinski"
    - "Haochen Li"
    - "Alessio Brini"
...
### (日本語題名: StableAML: Machine Learning for Behavioral Wallet Detection in Stablecoin Anti-Money Laundering on Ethereum（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.17842v2`](https://arxiv.org/abs/2602.17842v2) | Raw Meta = [`2602.17842_meta.json`](../../raw_data/2026-02-19/2602.17842_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「StableAML: Machine Learning for Behavioral Wallet Detection in Stablecoin Anti-Money Laundering on Ethereum（セキュリティ分析論文）」（原題: StableAML: Machine Learning for Behavioral Wallet Detection in Stablecoin Anti-Money Laundering on Ethereum / arXiv: 2602.17842v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.17842v2`
- **論文URL**: [https://arxiv.org/abs/2602.17842v2](https://arxiv.org/abs/2602.17842v2)
- **PDFリンク**: [https://arxiv.org/pdf/2602.17842v2.pdf](https://arxiv.org/pdf/2602.17842v2.pdf)
- **著者**: Luciano Juvinski, Haochen Li, Alessio Brini
- **公開日時**: `2026-02-19T21:13:39Z`
- **カテゴリ**: `cs.CR, cs.CE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-19/2602.17842_meta.json) | [`PDF`](../../raw_data/2026-02-19/2602.17842.pdf) | [`TXT`](../../raw_data/2026-02-19/2602.17842.txt)
