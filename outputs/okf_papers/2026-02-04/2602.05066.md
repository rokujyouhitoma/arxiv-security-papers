...
title_ja: "Bypassing AI Control Protocols via Agent-as-a-Proxy Attacks（セキュリティ分析論文）"
description: "Bypassing AI Control Protocols via Agent-as-a-Proxy Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.05066v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-04/2602.05066_meta.json"
  published_date: "2026-02-04T21:38:38Z"
  authors:
    - "Jafar Isbarov"
    - "Murat Kantarcioglu"
trust:
...
### (日本語題名: Bypassing AI Control Protocols via Agent-as-a-Proxy Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.05066v2`](https://arxiv.org/abs/2602.05066v2) | Raw Meta = [`2602.05066_meta.json`](../../raw_data/2026-02-04/2602.05066_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Bypassing AI Control Protocols via Agent-as-a-Proxy Attacks（セキュリティ分析論文）」（原題: Bypassing AI Control Protocols via Agent-as-a-Proxy Attacks / arXiv: 2602.05066v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2602.05066v2](https://arxiv.org/abs/2602.05066v2)
- **PDFリンク**: [https://arxiv.org/pdf/2602.05066v2.pdf](https://arxiv.org/pdf/2602.05066v2.pdf)
- **著者**: Jafar Isbarov, Murat Kantarcioglu
- **公開日時**: `2026-02-04T21:38:38Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-04/2602.05066_meta.json) | [`PDF`](../../raw_data/2026-02-04/2602.05066.pdf) | [`TXT`](../../raw_data/2026-02-04/2602.05066.txt)
