...
title_ja: "aCAPTCHA: Verifying That an Entity Is a Capable Agent via Asymmetric Hardness（セキュリティ分析論文）"
description: "aCAPTCHA: Verifying That an Entity Is a Capable Agent via Asymmetric Hardness（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.07116v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-07/2603.07116_meta.json"
  published_date: "2026-03-07T09:00:04Z"
  authors:
    - "Zuyao Xu"
    - "Xiang Li"
    - "Fubin Wu"
...
### (日本語題名: aCAPTCHA: Verifying That an Entity Is a Capable Agent via Asymmetric Hardness（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.07116v1`](https://arxiv.org/abs/2603.07116v1) | Raw Meta = [`2603.07116_meta.json`](../../raw_data/2026-03-07/2603.07116_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「aCAPTCHA: Verifying That an Entity Is a Capable Agent via Asymmetric Hardness（セキュリティ分析論文）」（原題: aCAPTCHA: Verifying That an Entity Is a Capable Agent via Asymmetric Hardness / arXiv: 2603.07116v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.07116v1`
- **論文URL**: [https://arxiv.org/abs/2603.07116v1](https://arxiv.org/abs/2603.07116v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.07116v1.pdf](https://arxiv.org/pdf/2603.07116v1.pdf)
- **著者**: Zuyao Xu, Xiang Li, Fubin Wu, Yuqi Qiu, Lu Sun, FaSheng Miao
- **公開日時**: `2026-03-07T09:00:04Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-07/2603.07116_meta.json) | [`PDF`](../../raw_data/2026-03-07/2603.07116.pdf) | [`TXT`](../../raw_data/2026-03-07/2603.07116.txt)
