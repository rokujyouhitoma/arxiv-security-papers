...
title_ja: "Secure Edge Computing Reference Architecture for Data-driven Structural Health Monitoring: Lessons Learned from Implementation and Benchmarking（セキュリティ分析論文）"
description: "Secure Edge Computing Reference Architecture for Data-driven Structural Health Monitoring: Lessons Learned from Implementation and Benchmarking（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.18857v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-24/2503.18857_meta.json"
  published_date: "2025-03-24T16:33:25Z"
  authors:
...
### (日本語題名: Secure Edge Computing Reference Architecture for Data-driven Structural Health Monitoring: Lessons Learned from Implementation and Benchmarking（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.18857v1`](https://arxiv.org/abs/2503.18857v1) | Raw Meta = [`2503.18857_meta.json`](../../raw_data/2025-03-24/2503.18857_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Secure Edge Computing Reference Architecture for Data-driven Structural Health Monitoring: Lessons Learned from Implementation and Benchmarking（セキュリティ分析論文）」（原題: Secure Edge Computing Reference Architecture for Data-driven Structural Health Monitoring: Lessons Learned from Implementation and Benchmarking / arXiv: 2503.18857v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.18857v1`
- **論文URL**: [https://arxiv.org/abs/2503.18857v1](https://arxiv.org/abs/2503.18857v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.18857v1.pdf](https://arxiv.org/pdf/2503.18857v1.pdf)
- **著者**: Sheikh Muhammad Farjad, Sandeep Reddy Patllola, Yonas Kassa, George Grispos, Robin Gandhi
- **公開日時**: `2025-03-24T16:33:25Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-24/2503.18857_meta.json) | [`PDF`](../../raw_data/2025-03-24/2503.18857.pdf) | [`TXT`](../../raw_data/2025-03-24/2503.18857.txt)
