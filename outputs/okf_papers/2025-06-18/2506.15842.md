...
title_ja: "A Sea of Cyber Threats: Maritime サイバーセキュリティ from the Perspective of Mariners"
description: "A Sea of Cyber Threats: Maritime サイバーセキュリティ from the Perspective of Mariners — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.15842v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-18/2506.15842_meta.json"
  published_date: "2025-06-18T19:45:35Z"
  authors:
    - "Anna Raymaker"
    - "Akshaya Kumar"
    - "Miuyin Yong Wong"
...
### (日本語題名: A Sea of Cyber Threats: Maritime サイバーセキュリティ from the Perspective of Mariners)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.15842v2`](https://arxiv.org/abs/2506.15842v2) | Raw Meta = [`2506.15842_meta.json`](../../raw_data/2025-06-18/2506.15842_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「A Sea of Cyber Threats: Maritime サイバーセキュリティ from the Perspective of Mariners」（原題: A Sea of Cyber Threats: Maritime Cybersecurity from the Perspective of Mariners / arXiv: 2506.15842v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.15842v2`
- **論文URL**: [https://arxiv.org/abs/2506.15842v2](https://arxiv.org/abs/2506.15842v2)
- **PDFリンク**: [https://arxiv.org/pdf/2506.15842v2.pdf](https://arxiv.org/pdf/2506.15842v2.pdf)
- **著者**: Anna Raymaker, Akshaya Kumar, Miuyin Yong Wong, Ryan Pickren, Animesh Chhotaray, Frank Li, Saman Zonouz, Raheem Beyah
- **公開日時**: `2025-06-18T19:45:35Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-18/2506.15842_meta.json) | [`PDF`](../../raw_data/2025-06-18/2506.15842.pdf) | [`TXT`](../../raw_data/2025-06-18/2506.15842.txt)
