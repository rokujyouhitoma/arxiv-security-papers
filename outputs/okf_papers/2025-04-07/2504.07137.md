...
title_ja: "Large Language Model (LLM) for Software Security: Code Analysis, Malware Analysis, Reverse Engineering（セキュリティ分析論文）"
description: "Large Language Model (LLM) for Software Security: Code Analysis, Malware Analysis, Reverse Engineering（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.07137v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-07/2504.07137_meta.json"
  published_date: "2025-04-07T22:32:46Z"
  authors:
    - "Hamed Jelodar"
    - "Samita Bai"
    - "Parisa Hamedi"
...
### (日本語題名: Large Language Model (LLM) for Software Security: Code Analysis, Malware Analysis, Reverse Engineering（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.07137v1`](https://arxiv.org/abs/2504.07137v1) | Raw Meta = [`2504.07137_meta.json`](../../raw_data/2025-04-07/2504.07137_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Large Language Model (LLM) for Software Security: Code Analysis, Malware Analysis, Reverse Engineering（セキュリティ分析論文）」（原題: Large Language Model (LLM) for Software Security: Code Analysis, Malware Analysis, Reverse Engineering / arXiv: 2504.07137v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.07137v1`
- **論文URL**: [https://arxiv.org/abs/2504.07137v1](https://arxiv.org/abs/2504.07137v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.07137v1.pdf](https://arxiv.org/pdf/2504.07137v1.pdf)
- **著者**: Hamed Jelodar, Samita Bai, Parisa Hamedi, Hesamodin Mohammadian, Roozbeh Razavi-Far, Ali Ghorbani
- **公開日時**: `2025-04-07T22:32:46Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-07/2504.07137_meta.json) | [`PDF`](../../raw_data/2025-04-07/2504.07137.pdf) | [`TXT`](../../raw_data/2025-04-07/2504.07137.txt)
