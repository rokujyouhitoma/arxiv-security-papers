...
title_ja: "AnywhereDoor: Multi-Target Backdoor Attacks on Object Detection（セキュリティ分析論文）"
description: "AnywhereDoor: Multi-Target Backdoor Attacks on Object Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.06529v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CV"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-09/2503.06529_meta.json"
  published_date: "2025-03-09T09:24:24Z"
  authors:
    - "Jialin Lu"
    - "Junjie Shan"
    - "Ziqi Zhao"
...
### (日本語題名: AnywhereDoor: Multi-Target Backdoor Attacks on Object Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.06529v2`](https://arxiv.org/abs/2503.06529v2) | Raw Meta = [`2503.06529_meta.json`](../../raw_data/2025-03-09/2503.06529_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「AnywhereDoor: Multi-Target Backdoor Attacks on Object Detection（セキュリティ分析論文）」（原題: AnywhereDoor: Multi-Target Backdoor Attacks on Object Detection / arXiv: 2503.06529v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.06529v2`
- **論文URL**: [https://arxiv.org/abs/2503.06529v2](https://arxiv.org/abs/2503.06529v2)
- **PDFリンク**: [https://arxiv.org/pdf/2503.06529v2.pdf](https://arxiv.org/pdf/2503.06529v2.pdf)
- **著者**: Jialin Lu, Junjie Shan, Ziqi Zhao, Ka-Ho Chow
- **公開日時**: `2025-03-09T09:24:24Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CV`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-09/2503.06529_meta.json) | [`PDF (arXiv)`](https://arxiv.org/pdf/2503.06529v2.pdf) | [`TXT`](../../raw_data/2025-03-09/2503.06529_raw_abstract.txt)
