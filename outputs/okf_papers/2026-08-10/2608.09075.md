...
resource: "https://arxiv.org/abs/2608.09075v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.CR"
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.09075v1`](https://arxiv.org/abs/2608.09075v1) | Raw Meta = [`2608.09075_meta.json`](../../raw_data/2026-08-10/2608.09075_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SLAC: Access-Driven CPU-to-GPU Side-channel Attacks via System-Level Cache on Apple Silicon（セキュリティ分析論文）」（原題: SLAC: Access-Driven CPU-to-GPU Side-channel Attacks via System-Level Cache on Apple Silicon / arXiv: 2608.09075v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.09075v1`
- **論文URL**: [https://arxiv.org/abs/2608.09075v1](https://arxiv.org/abs/2608.09075v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.09075v1.pdf](https://arxiv.org/pdf/2608.09075v1.pdf)
