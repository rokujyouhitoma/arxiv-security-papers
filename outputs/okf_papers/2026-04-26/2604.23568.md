...
title_ja: "Green-Red Watermarking for Recommender Systems（セキュリティ分析論文）"
description: "Green-Red Watermarking for Recommender Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.23568v1"
tags:
  - "arXiv"
  - "cs.IR"
  - "executive-summary"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-26/2604.23568_meta.json"
  published_date: "2026-04-26T07:16:44Z"
  authors:
    - "Lei Zhou"
    - "Min Gao"
    - "Zongwei Wang"
...
### (日本語題名: Green-Red Watermarking for Recommender Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.23568v1`](https://arxiv.org/abs/2604.23568v1) | Raw Meta = [`2604.23568_meta.json`](../../raw_data/2026-04-26/2604.23568_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Green-Red Watermarking for Recommender Systems（セキュリティ分析論文）」（原題: Green-Red Watermarking for Recommender Systems / arXiv: 2604.23568v1）は、cs.IR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.23568v1`
- **論文URL**: [https://arxiv.org/abs/2604.23568v1](https://arxiv.org/abs/2604.23568v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.23568v1.pdf](https://arxiv.org/pdf/2604.23568v1.pdf)
- **著者**: Lei Zhou, Min Gao, Zongwei Wang, Yibing Bai, Wentao Li
- **公開日時**: `2026-04-26T07:16:44Z`
- **カテゴリ**: `cs.IR, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-26/2604.23568_meta.json) | [`PDF`](../../raw_data/2026-04-26/2604.23568.pdf) | [`TXT`](../../raw_data/2026-04-26/2604.23568.txt)
