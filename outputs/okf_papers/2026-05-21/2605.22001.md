...
title_ja: "Blind Spots in the Guard: How Domain-Camouflaged Injection Attacks Evade Detection in Multi-Agent LLM Systems（セキュリティ分析論文）"
description: "Blind Spots in the Guard: How Domain-Camouflaged Injection Attacks Evade Detection in Multi-Agent LLM Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.22001v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-21/2605.22001_meta.json"
  published_date: "2026-05-21T04:58:11Z"
  authors:
    - "Aaditya Pai"
trust:
...
### (日本語題名: Blind Spots in the Guard: How Domain-Camouflaged Injection Attacks Evade Detection in Multi-Agent LLM Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.22001v1`](https://arxiv.org/abs/2605.22001v1) | Raw Meta = [`2605.22001_meta.json`](../../raw_data/2026-05-21/2605.22001_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Blind Spots in the Guard: How Domain-Camouflaged Injection Attacks Evade Detection in Multi-Agent LLM Systems（セキュリティ分析論文）」（原題: Blind Spots in the Guard: How Domain-Camouflaged Injection Attacks Evade Detection in Multi-Agent LLM Systems / arXiv: 2605.22001v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.22001v1`
- **論文URL**: [https://arxiv.org/abs/2605.22001v1](https://arxiv.org/abs/2605.22001v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.22001v1.pdf](https://arxiv.org/pdf/2605.22001v1.pdf)
- **著者**: Aaditya Pai
- **公開日時**: `2026-05-21T04:58:11Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-21/2605.22001_meta.json) | [`PDF`](../../raw_data/2026-05-21/2605.22001.pdf) | [`TXT`](../../raw_data/2026-05-21/2605.22001.txt)
