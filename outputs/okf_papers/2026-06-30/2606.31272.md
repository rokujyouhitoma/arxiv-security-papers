...
title_ja: "The Decomposition Is the Fingerprint: Per-Component Identity for Agent Skills（セキュリティ分析論文）"
description: "The Decomposition Is the Fingerprint: Per-Component Identity for Agent Skills（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.31272v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-30/2606.31272_meta.json"
  published_date: "2026-06-30T07:45:33Z"
  authors:
    - "Hongliang Liu"
    - "Yuhao Wu"
    - "Tung-Ling Li"
...
### (日本語題名: The Decomposition Is the Fingerprint: Per-Component Identity for Agent Skills（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.31272v1`](https://arxiv.org/abs/2606.31272v1) | Raw Meta = [`2606.31272_meta.json`](../../raw_data/2026-06-30/2606.31272_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「The Decomposition Is the Fingerprint: Per-Component Identity for Agent Skills（セキュリティ分析論文）」（原題: The Decomposition Is the Fingerprint: Per-Component Identity for Agent Skills / arXiv: 2606.31272v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2606.31272v1](https://arxiv.org/abs/2606.31272v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.31272v1.pdf](https://arxiv.org/pdf/2606.31272v1.pdf)
- **著者**: Hongliang Liu, Yuhao Wu, Tung-Ling Li
- **公開日時**: `2026-06-30T07:45:33Z`
- **カテゴリ**: `cs.CR, cs.CL, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-30/2606.31272_meta.json) | [`PDF`](../../raw_data/2026-06-30/2606.31272.pdf) | [`TXT`](../../raw_data/2026-06-30/2606.31272.txt)
