...
title_ja: "Dataset for Presence-Only Passive Reconnaissance in Wireless Smart-Grid Communicationsのベンチマーク評価"
description: "Dataset for Presence-Only Passive Reconnaissance in Wireless Smart-Grid Communicationsのベンチマーク評価 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2603.09590v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-03-10/2603.09590_meta.json"
  published_date: "2026-03-10T12:39:03Z"
  authors:
    - "Bochra Al Agha"
    - "Razane Tajeddine"
trust:
...
### (日本語題名: Dataset for Presence-Only Passive Reconnaissance in Wireless Smart-Grid Communicationsのベンチマーク評価)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2603.09590v1`](https://arxiv.org/abs/2603.09590v1) | Raw Meta = [`2603.09590_meta.json`](../../raw_data/2026-03-10/2603.09590_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Dataset for Presence-Only Passive Reconnaissance in Wireless Smart-Grid Communicationsのベンチマーク評価」（原題: Benchmarking Dataset for Presence-Only Passive Reconnaissance in Wireless Smart-Grid Communications / arXiv: 2603.09590v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2603.09590v1`
- **論文URL**: [https://arxiv.org/abs/2603.09590v1](https://arxiv.org/abs/2603.09590v1)
- **PDFリンク**: [https://arxiv.org/pdf/2603.09590v1.pdf](https://arxiv.org/pdf/2603.09590v1.pdf)
- **著者**: Bochra Al Agha, Razane Tajeddine
- **公開日時**: `2026-03-10T12:39:03Z`
- **カテゴリ**: `cs.CR, eess.SP`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-03-10/2603.09590_meta.json) | [`PDF`](../../raw_data/2026-03-10/2603.09590.pdf) | [`TXT`](../../raw_data/2026-03-10/2603.09590.txt)
