...
title_ja: "Effective Prompt Stealing Attack against Text-to-Image Diffusion Modelsに向けて"
description: "Effective Prompt Stealing Attack against Text-to-Image Diffusion Modelsに向けて — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.06837v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-09/2508.06837_meta.json"
  published_date: "2025-08-09T05:38:38Z"
  authors:
    - "Shiqian Zhao"
    - "Chong Wang"
    - "Yiming Li"
...
### (日本語題名: Effective Prompt Stealing Attack against Text-to-Image Diffusion Modelsに向けて)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.06837v2`](https://arxiv.org/abs/2508.06837v2) | Raw Meta = [`2508.06837_meta.json`](../../raw_data/2025-08-09/2508.06837_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Effective Prompt Stealing Attack against Text-to-Image Diffusion Modelsに向けて」（原題: Towards Effective Prompt Stealing Attack against Text-to-Image Diffusion Models / arXiv: 2508.06837v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.06837v2`
- **論文URL**: [https://arxiv.org/abs/2508.06837v2](https://arxiv.org/abs/2508.06837v2)
- **PDFリンク**: [https://arxiv.org/pdf/2508.06837v2.pdf](https://arxiv.org/pdf/2508.06837v2.pdf)
- **著者**: Shiqian Zhao, Chong Wang, Yiming Li, Yihao Huang, Wenjie Qu, Siew-Kei Lam, Yi Xie, Kangjie Chen, Jie Zhang, Tianwei Zhang
- **公開日時**: `2025-08-09T05:38:38Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-09/2508.06837_meta.json) | [`PDF`](../../raw_data/2025-08-09/2508.06837.pdf) | [`TXT`](../../raw_data/2025-08-09/2508.06837.txt)
