...
title_ja: "Capturing Monetarily Exploitable Vulnerability in Smart Contracts via Auditor Knowledge-Learning Fuzzing（セキュリティ分析論文）"
description: "Capturing Monetarily Exploitable Vulnerability in Smart Contracts via Auditor Knowledge-Learning Fuzzing（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.18395v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-20/2604.18395_meta.json"
  published_date: "2026-04-20T15:17:45Z"
  authors:
    - "Bowen Cai"
    - "Weiheng Bai"
    - "Hangyun Tang"
...
### (日本語題名: Capturing Monetarily Exploitable Vulnerability in Smart Contracts via Auditor Knowledge-Learning Fuzzing（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.18395v1`](https://arxiv.org/abs/2604.18395v1) | Raw Meta = [`2604.18395_meta.json`](../../raw_data/2026-04-20/2604.18395_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Capturing Monetarily Exploitable Vulnerability in Smart Contracts via Auditor Knowledge-Learning Fuzzing（セキュリティ分析論文）」（原題: Capturing Monetarily Exploitable Vulnerability in Smart Contracts via Auditor Knowledge-Learning Fuzzing / arXiv: 2604.18395v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.18395v1`
- **論文URL**: [https://arxiv.org/abs/2604.18395v1](https://arxiv.org/abs/2604.18395v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.18395v1.pdf](https://arxiv.org/pdf/2604.18395v1.pdf)
- **著者**: Bowen Cai, Weiheng Bai, Hangyun Tang, Youshui Lu, Kangjie Lu
- **公開日時**: `2026-04-20T15:17:45Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-20/2604.18395_meta.json) | [`PDF`](../../raw_data/2026-04-20/2604.18395.pdf) | [`TXT`](../../raw_data/2026-04-20/2604.18395.txt)
