...
title_ja: "Temporal UI State Inconsistency in Desktop GUI Agents: Formalizing and Defending Against TOCTOU Attacks on Computer-Use Agents（セキュリティ分析論文）"
description: "Temporal UI State Inconsistency in Desktop GUI Agents: Formalizing and Defending Against TOCTOU Attacks on Computer-Use Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.18860v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-20/2604.18860_meta.json"
  published_date: "2026-04-20T21:36:16Z"
  authors:
    - "Wenpeng Xu"
trust:
...
### (日本語題名: Temporal UI State Inconsistency in Desktop GUI Agents: Formalizing and Defending Against TOCTOU Attacks on Computer-Use Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.18860v1`](https://arxiv.org/abs/2604.18860v1) | Raw Meta = [`2604.18860_meta.json`](../../raw_data/2026-04-20/2604.18860_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Temporal UI State Inconsistency in Desktop GUI Agents: Formalizing and Defending Against TOCTOU Attacks on Computer-Use Agents（セキュリティ分析論文）」（原題: Temporal UI State Inconsistency in Desktop GUI Agents: Formalizing and Defending Against TOCTOU Attacks on Computer-Use Agents / arXiv: 2604.18860v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.18860v1`
- **論文URL**: [https://arxiv.org/abs/2604.18860v1](https://arxiv.org/abs/2604.18860v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.18860v1.pdf](https://arxiv.org/pdf/2604.18860v1.pdf)
- **著者**: Wenpeng Xu
- **公開日時**: `2026-04-20T21:36:16Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-20/2604.18860_meta.json) | [`PDF`](../../raw_data/2026-04-20/2604.18860.pdf) | [`TXT`](../../raw_data/2026-04-20/2604.18860.txt)
