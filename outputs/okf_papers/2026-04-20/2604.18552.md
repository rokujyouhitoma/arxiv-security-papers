...
resource: "https://arxiv.org/abs/2604.18552v2"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.18552v2`](https://arxiv.org/abs/2604.18552v2) | Raw Meta = [`2604.18552_meta.json`](../../raw_data/2026-04-20/2604.18552_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Do Privacy Policies Match with the Logs? Privacy Disclosure in Android Application Logsの実証研究」（原題: Do Privacy Policies Match with the Logs? An Empirical Study of Privacy Disclosure in Android Application Logs / arXiv: 2604.18552v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.18552v2`
- **論文URL**: [https://arxiv.org/abs/2604.18552v2](https://arxiv.org/abs/2604.18552v2)
- **PDFリンク**: [https://arxiv.org/pdf/2604.18552v2.pdf](https://arxiv.org/pdf/2604.18552v2.pdf)
