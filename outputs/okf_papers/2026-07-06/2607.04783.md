...
title_ja: "Ghost Traffic: ICMP Tunneling-Based Billing Bypass in LTE Networks（セキュリティ分析論文）"
description: "Ghost Traffic: ICMP Tunneling-Based Billing Bypass in LTE Networks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.04783v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-06/2607.04783_meta.json"
  published_date: "2026-07-06T08:12:53Z"
  authors:
    - "Jung Jin Kim"
    - "Sungyup Nam"
    - "Seungho Jeon"
...
### (日本語題名: Ghost Traffic: ICMP Tunneling-Based Billing Bypass in LTE Networks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.04783v1`](https://arxiv.org/abs/2607.04783v1) | Raw Meta = [`2607.04783_meta.json`](../../raw_data/2026-07-06/2607.04783_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Ghost Traffic: ICMP Tunneling-Based Billing Bypass in LTE Networks（セキュリティ分析論文）」（原題: Ghost Traffic: ICMP Tunneling-Based Billing Bypass in LTE Networks / arXiv: 2607.04783v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.04783v1`
- **論文URL**: [https://arxiv.org/abs/2607.04783v1](https://arxiv.org/abs/2607.04783v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.04783v1.pdf](https://arxiv.org/pdf/2607.04783v1.pdf)
- **著者**: Jung Jin Kim, Sungyup Nam, Seungho Jeon
- **公開日時**: `2026-07-06T08:12:53Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-06/2607.04783_meta.json) | [`PDF`](../../raw_data/2026-07-06/2607.04783.pdf) | [`TXT`](../../raw_data/2026-07-06/2607.04783.txt)
