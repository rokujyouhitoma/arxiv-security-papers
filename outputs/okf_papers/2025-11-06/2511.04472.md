---
type: "security-paper"
title: "Evading and crashing anti-malware solutions via data collection overloading during analysis serialization"
title_ja: "Evading and crashing anti-malware solutions via data collection overloading during analysis serialization（セキュリティ分析論文）"
description: "Evading and crashing anti-malware solutions via data collection overloading during analysis serialization（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.04472v3"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-06/2511.04472_meta.json"
  published_date: "2025-11-06T15:45:03Z"
  authors:
    - "Evgenios Gkritsis"
...
### (日本語題名: Evading and crashing anti-malware solutions via data collection overloading during analysis serialization（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.04472v3`](https://arxiv.org/abs/2511.04472v3) | Raw Meta = [`2511.04472_meta.json`](../../raw_data/2025-11-06/2511.04472_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Evading and crashing anti-malware solutions via data collection overloading during analysis serialization（セキュリティ分析論文）」（原題: Evading and crashing anti-malware solutions via data collection overloading during analysis serialization / arXiv: 2511.04472v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.04472v3`
- **論文URL**: [https://arxiv.org/abs/2511.04472v3](https://arxiv.org/abs/2511.04472v3)
- **PDFリンク**: [https://arxiv.org/pdf/2511.04472v3.pdf](https://arxiv.org/pdf/2511.04472v3.pdf)
- **著者**: Evgenios Gkritsis, Constantinos Patsakis, George Stergiopoulos
- **公開日時**: `2025-11-06T15:45:03Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-06/2511.04472_meta.json) | [`PDF`](../../raw_data/2025-11-06/2511.04472.pdf) | [`TXT`](../../raw_data/2025-11-06/2511.04472.txt)
