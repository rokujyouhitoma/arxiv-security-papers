...
title_ja: "TSAI-MetaFraud: A Benchmark Dataset for Financial Fraud Transaction and Behavioral Risk Detection in Metaverse Ecosystems（セキュリティ分析論文）"
description: "TSAI-MetaFraud: A Benchmark Dataset for Financial Fraud Transaction and Behavioral Risk Detection in Metaverse Ecosystems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.09528v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-10/2607.09528_meta.json"
  published_date: "2026-07-10T15:36:13Z"
  authors:
    - "Refat Ishrak Hemel"
    - "Ehsan Hallaji"
    - "Roozbeh Razavi-Far"
...
### (日本語題名: TSAI-MetaFraud: A Benchmark Dataset for Financial Fraud Transaction and Behavioral Risk Detection in Metaverse Ecosystems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.09528v1`](https://arxiv.org/abs/2607.09528v1) | Raw Meta = [`2607.09528_meta.json`](../../raw_data/2026-07-10/2607.09528_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「TSAI-MetaFraud: A Benchmark Dataset for Financial Fraud Transaction and Behavioral Risk Detection in Metaverse Ecosystems（セキュリティ分析論文）」（原題: TSAI-MetaFraud: A Benchmark Dataset for Financial Fraud Transaction and Behavioral Risk Detection in Metaverse Ecosystems / arXiv: 2607.09528v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2607.09528v1](https://arxiv.org/abs/2607.09528v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.09528v1.pdf](https://arxiv.org/pdf/2607.09528v1.pdf)
- **著者**: Refat Ishrak Hemel, Ehsan Hallaji, Roozbeh Razavi-Far
- **公開日時**: `2026-07-10T15:36:13Z`
- **カテゴリ**: `cs.LG, cs.CR, cs.DB, cs.SI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-10/2607.09528_meta.json) | [`PDF`](../../raw_data/2026-07-10/2607.09528.pdf) | [`TXT`](../../raw_data/2026-07-10/2607.09528.txt)
