...
title_ja: "Explainability-Aware Evaluation of Transfer Learning Models for IoT DDoS Detection Under Resource Constraints（セキュリティ分析論文）"
description: "Explainability-Aware Evaluation of Transfer Learning Models for IoT DDoS Detection Under Resource Constraints（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.22488v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-25/2602.22488_meta.json"
  published_date: "2026-02-25T23:56:11Z"
  authors:
    - "Nelly Elsayed"
trust:
...
### (日本語題名: Explainability-Aware Evaluation of Transfer Learning Models for IoT DDoS Detection Under Resource Constraints（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.22488v1`](https://arxiv.org/abs/2602.22488v1) | Raw Meta = [`2602.22488_meta.json`](../../raw_data/2026-02-25/2602.22488_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Explainability-Aware Evaluation of Transfer Learning Models for IoT DDoS Detection Under Resource Constraints（セキュリティ分析論文）」（原題: Explainability-Aware Evaluation of Transfer Learning Models for IoT DDoS Detection Under Resource Constraints / arXiv: 2602.22488v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.22488v1`
- **論文URL**: [https://arxiv.org/abs/2602.22488v1](https://arxiv.org/abs/2602.22488v1)
- **PDFリンク**: [https://arxiv.org/pdf/2602.22488v1.pdf](https://arxiv.org/pdf/2602.22488v1.pdf)
- **著者**: Nelly Elsayed
- **公開日時**: `2026-02-25T23:56:11Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-25/2602.22488_meta.json) | [`PDF`](../../raw_data/2026-02-25/2602.22488.pdf) | [`TXT`](../../raw_data/2026-02-25/2602.22488.txt)
