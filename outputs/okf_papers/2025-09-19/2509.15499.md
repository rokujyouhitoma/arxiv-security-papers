...
title_ja: "Adversarially Robust Assembly Language Model for Packed Executables Detection（セキュリティ分析論文）"
description: "Adversarially Robust Assembly Language Model for Packed Executables Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.15499v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-19/2509.15499_meta.json"
  published_date: "2025-09-19T00:33:27Z"
  authors:
    - "Shijia Li"
    - "Jiang Ming"
    - "Lanqing Liu"
...
### (日本語題名: Adversarially Robust Assembly Language Model for Packed Executables Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.15499v1`](https://arxiv.org/abs/2509.15499v1) | Raw Meta = [`2509.15499_meta.json`](../../raw_data/2025-09-19/2509.15499_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Adversarially Robust Assembly Language Model for Packed Executables Detection（セキュリティ分析論文）」（原題: Adversarially Robust Assembly Language Model for Packed Executables Detection / arXiv: 2509.15499v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.15499v1`
- **論文URL**: [https://arxiv.org/abs/2509.15499v1](https://arxiv.org/abs/2509.15499v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.15499v1.pdf](https://arxiv.org/pdf/2509.15499v1.pdf)
- **著者**: Shijia Li, Jiang Ming, Lanqing Liu, Longwei Yang, Ni Zhang, Chunfu Jia
- **公開日時**: `2025-09-19T00:33:27Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-19/2509.15499_meta.json) | [`PDF`](../../raw_data/2025-09-19/2509.15499.pdf) | [`TXT`](../../raw_data/2025-09-19/2509.15499.txt)
