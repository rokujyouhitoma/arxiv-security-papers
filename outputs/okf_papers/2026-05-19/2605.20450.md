...
title_ja: "SMA-DP: Spectral Memory-Aware Differential Privacy for Deep Learning（セキュリティ分析論文）"
description: "SMA-DP: Spectral Memory-Aware Differential Privacy for Deep Learning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.20450v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-19/2605.20450_meta.json"
  published_date: "2026-05-19T20:02:19Z"
  authors:
...
### (日本語題名: SMA-DP: Spectral Memory-Aware Differential Privacy for Deep Learning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.20450v1`](https://arxiv.org/abs/2605.20450v1) | Raw Meta = [`2605.20450_meta.json`](../../raw_data/2026-05-19/2605.20450_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SMA-DP: Spectral Memory-Aware Differential Privacy for Deep Learning（セキュリティ分析論文）」（原題: SMA-DP: Spectral Memory-Aware Differential Privacy for Deep Learning / arXiv: 2605.20450v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.20450v1`
- **論文URL**: [https://arxiv.org/abs/2605.20450v1](https://arxiv.org/abs/2605.20450v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.20450v1.pdf](https://arxiv.org/pdf/2605.20450v1.pdf)
- **著者**: Mohammad Partohaghighi, Roummel Marcia
- **公開日時**: `2026-05-19T20:02:19Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-19/2605.20450_meta.json) | [`PDF`](../../raw_data/2026-05-19/2605.20450.pdf) | [`TXT`](../../raw_data/2026-05-19/2605.20450.txt)
