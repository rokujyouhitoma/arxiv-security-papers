...
title_ja: "High-Rate Public-Key Pseudorandom Codes for Edit Errors（セキュリティ分析論文）"
description: "High-Rate Public-Key Pseudorandom Codes for Edit Errors（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.19402v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-19/2605.19402_meta.json"
  published_date: "2026-05-19T05:57:25Z"
  authors:
    - "Shengtang Huang"
    - "Xin Li"
    - "Songtao Mao"
...
### (日本語題名: High-Rate Public-Key Pseudorandom Codes for Edit Errors（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.19402v2`](https://arxiv.org/abs/2605.19402v2) | Raw Meta = [`2605.19402_meta.json`](../../raw_data/2026-05-19/2605.19402_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「High-Rate Public-Key Pseudorandom Codes for Edit Errors（セキュリティ分析論文）」（原題: High-Rate Public-Key Pseudorandom Codes for Edit Errors / arXiv: 2605.19402v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.19402v2`
- **論文URL**: [https://arxiv.org/abs/2605.19402v2](https://arxiv.org/abs/2605.19402v2)
- **PDFリンク**: [https://arxiv.org/pdf/2605.19402v2.pdf](https://arxiv.org/pdf/2605.19402v2.pdf)
- **著者**: Shengtang Huang, Xin Li, Songtao Mao, Zhaienhe Zhou
- **公開日時**: `2026-05-19T05:57:25Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-19/2605.19402_meta.json) | [`PDF`](../../raw_data/2026-05-19/2605.19402.pdf) | [`TXT`](../../raw_data/2026-05-19/2605.19402.txt)
