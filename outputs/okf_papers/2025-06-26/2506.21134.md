...
title_ja: "Inside Job: Defending Kubernetes Clusters Against Network Misconfigurations（セキュリティ分析論文）"
description: "Inside Job: Defending Kubernetes Clusters Against Network Misconfigurations（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.21134v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-26/2506.21134_meta.json"
  published_date: "2025-06-26T10:31:44Z"
  authors:
    - "Jacopo Bufalino"
...
### (日本語題名: Inside Job: Defending Kubernetes Clusters Against Network Misconfigurations（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.21134v1`](https://arxiv.org/abs/2506.21134v1) | Raw Meta = [`2506.21134_meta.json`](../../raw_data/2025-06-26/2506.21134_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Inside Job: Defending Kubernetes Clusters Against Network Misconfigurations（セキュリティ分析論文）」（原題: Inside Job: Defending Kubernetes Clusters Against Network Misconfigurations / arXiv: 2506.21134v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2506.21134v1](https://arxiv.org/abs/2506.21134v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.21134v1.pdf](https://arxiv.org/pdf/2506.21134v1.pdf)
- **著者**: Jacopo Bufalino, Jose Luis Martin-Navarro, Mario Di Francesco, Tuomas Aura
- **公開日時**: `2025-06-26T10:31:44Z`
- **カテゴリ**: `cs.CR, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-26/2506.21134_meta.json) | [`PDF`](../../raw_data/2025-06-26/2506.21134.pdf) | [`TXT`](../../raw_data/2025-06-26/2506.21134.txt)
