...
title_ja: "Now You (Still) See Me: Detecting Evasive Steganographic Payloads in LLMs（セキュリティ分析論文）"
description: "Now You (Still) See Me: Detecting Evasive Steganographic Payloads in LLMs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.09411v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.IT"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-08/2606.09411_meta.json"
  published_date: "2026-06-08T12:27:11Z"
  authors:
    - "Charles Westphal"
    - "Timothy Douglas"
    - "Keivan Navaie"
...
### (日本語題名: Now You (Still) See Me: Detecting Evasive Steganographic Payloads in LLMs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.09411v1`](https://arxiv.org/abs/2606.09411v1) | Raw Meta = [`2606.09411_meta.json`](../../raw_data/2026-06-08/2606.09411_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Now You (Still) See Me: Detecting Evasive Steganographic Payloads in LLMs（セキュリティ分析論文）」（原題: Now You (Still) See Me: Detecting Evasive Steganographic Payloads in LLMs / arXiv: 2606.09411v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2606.09411v1](https://arxiv.org/abs/2606.09411v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.09411v1.pdf](https://arxiv.org/pdf/2606.09411v1.pdf)
- **著者**: Charles Westphal, Timothy Douglas, Keivan Navaie, Tiago Pimentel, Fernando E. Rosas
- **公開日時**: `2026-06-08T12:27:11Z`
- **カテゴリ**: `cs.CR, cs.IT, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-08/2606.09411_meta.json) | [`PDF`](../../raw_data/2026-06-08/2606.09411.pdf) | [`TXT`](../../raw_data/2026-06-08/2606.09411.txt)
