...
title_ja: "MER-Inspector: Assessing model extraction risks from an attack-agnostic perspective（セキュリティ分析論文）"
description: "MER-Inspector: Assessing model extraction risks from an attack-agnostic perspective（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.18578v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-23/2509.18578_meta.json"
  published_date: "2025-09-23T02:57:57Z"
  authors:
    - "Xinwei Zhang"
    - "Haibo Hu"
    - "Qingqing Ye"
...
### (日本語題名: MER-Inspector: Assessing model extraction risks from an attack-agnostic perspective（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.18578v1`](https://arxiv.org/abs/2509.18578v1) | Raw Meta = [`2509.18578_meta.json`](../../raw_data/2025-09-23/2509.18578_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MER-Inspector: Assessing model extraction risks from an attack-agnostic perspective（セキュリティ分析論文）」（原題: MER-Inspector: Assessing model extraction risks from an attack-agnostic perspective / arXiv: 2509.18578v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.18578v1`
- **論文URL**: [https://arxiv.org/abs/2509.18578v1](https://arxiv.org/abs/2509.18578v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.18578v1.pdf](https://arxiv.org/pdf/2509.18578v1.pdf)
- **著者**: Xinwei Zhang, Haibo Hu, Qingqing Ye, Li Bai, Huadi Zheng
- **公開日時**: `2025-09-23T02:57:57Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-23/2509.18578_meta.json) | [`PDF`](../../raw_data/2025-09-23/2509.18578.pdf) | [`TXT`](../../raw_data/2025-09-23/2509.18578.txt)
