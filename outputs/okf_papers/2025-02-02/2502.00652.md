...
title_ja: "Reformulation is All You Need: Addressing Malicious Text Features in DNNs（セキュリティ分析論文）"
description: "Reformulation is All You Need: Addressing Malicious Text Features in DNNs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.00652v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-02-02/2502.00652_meta.json"
  published_date: "2025-02-02T03:39:43Z"
  authors:
    - "Yi Jiang"
    - "Oubo Ma"
    - "Yong Yang"
...
### (日本語題名: Reformulation is All You Need: Addressing Malicious Text Features in DNNs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.00652v2`](https://arxiv.org/abs/2502.00652v2) | Raw Meta = [`2502.00652_meta.json`](../../raw_data/2025-02-02/2502.00652_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Reformulation is All You Need: Addressing Malicious Text Features in DNNs（セキュリティ分析論文）」（原題: Reformulation is All You Need: Addressing Malicious Text Features in DNNs / arXiv: 2502.00652v2）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.00652v2`
- **論文URL**: [https://arxiv.org/abs/2502.00652v2](https://arxiv.org/abs/2502.00652v2)
- **PDFリンク**: [https://arxiv.org/pdf/2502.00652v2.pdf](https://arxiv.org/pdf/2502.00652v2.pdf)
- **著者**: Yi Jiang, Oubo Ma, Yong Yang, Tong Zhang, Shouling Ji
- **公開日時**: `2025-02-02T03:39:43Z`
- **カテゴリ**: `cs.LG, cs.CL, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-02-02/2502.00652_meta.json) | [`PDF`](../../raw_data/2025-02-02/2502.00652.pdf) | [`TXT`](../../raw_data/2025-02-02/2502.00652.txt)
