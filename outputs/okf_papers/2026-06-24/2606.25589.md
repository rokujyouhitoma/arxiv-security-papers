...
title_ja: "Leaking Circuit Secrets: Gradient Leakage Attacks on Graph Neural Networks（セキュリティ分析論文）"
description: "Leaking Circuit Secrets: Gradient Leakage Attacks on Graph Neural Networks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2606.25589v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-06-24/2606.25589_meta.json"
  published_date: "2026-06-24T08:59:28Z"
  authors:
    - "Rupesh Raj Karn"
    - "Johann Knechtel"
    - "Ozgur Sinanoglu"
...
### (日本語題名: Leaking Circuit Secrets: Gradient Leakage Attacks on Graph Neural Networks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2606.25589v1`](https://arxiv.org/abs/2606.25589v1) | Raw Meta = [`2606.25589_meta.json`](../../raw_data/2026-06-24/2606.25589_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Leaking Circuit Secrets: Gradient Leakage Attacks on Graph Neural Networks（セキュリティ分析論文）」（原題: Leaking Circuit Secrets: Gradient Leakage Attacks on Graph Neural Networks / arXiv: 2606.25589v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2606.25589v1](https://arxiv.org/abs/2606.25589v1)
- **PDFリンク**: [https://arxiv.org/pdf/2606.25589v1.pdf](https://arxiv.org/pdf/2606.25589v1.pdf)
- **著者**: Rupesh Raj Karn, Johann Knechtel, Ozgur Sinanoglu
- **公開日時**: `2026-06-24T08:59:28Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-06-24/2606.25589_meta.json) | [`PDF`](../../raw_data/2026-06-24/2606.25589.pdf) | [`TXT`](../../raw_data/2026-06-24/2606.25589.txt)
