...
title_ja: "Hermes: Efficient Global Homomorphic Aggregation over Mutable Packed Ciphertexts（セキュリティ分析論文）"
description: "Hermes: Efficient Global Homomorphic Aggregation over Mutable Packed Ciphertexts（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.03308v5"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.DB"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-03/2506.03308_meta.json"
  published_date: "2025-06-03T18:48:17Z"
  authors:
    - "Dongfang Zhao"
trust:
...
### (日本語題名: Hermes: Efficient Global Homomorphic Aggregation over Mutable Packed Ciphertexts（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.03308v5`](https://arxiv.org/abs/2506.03308v5) | Raw Meta = [`2506.03308_meta.json`](../../raw_data/2025-06-03/2506.03308_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Hermes: Efficient Global Homomorphic Aggregation over Mutable Packed Ciphertexts（セキュリティ分析論文）」（原題: Hermes: Efficient Global Homomorphic Aggregation over Mutable Packed Ciphertexts / arXiv: 2506.03308v5）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.03308v5`
- **論文URL**: [https://arxiv.org/abs/2506.03308v5](https://arxiv.org/abs/2506.03308v5)
- **PDFリンク**: [https://arxiv.org/pdf/2506.03308v5.pdf](https://arxiv.org/pdf/2506.03308v5.pdf)
- **著者**: Dongfang Zhao
- **公開日時**: `2025-06-03T18:48:17Z`
- **カテゴリ**: `cs.CR, cs.DB`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-03/2506.03308_meta.json) | [`PDF`](../../raw_data/2025-06-03/2506.03308.pdf) | [`TXT`](../../raw_data/2025-06-03/2506.03308.txt)
