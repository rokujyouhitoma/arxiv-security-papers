...
title_ja: "MISLEADER: Defending against Model Extraction with Ensembles of Distilled Models（セキュリティ分析論文）"
description: "MISLEADER: Defending against Model Extraction with Ensembles of Distilled Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.02362v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-03/2506.02362_meta.json"
  published_date: "2025-06-03T01:37:09Z"
  authors:
    - "Xueqi Cheng"
    - "Minxing Zheng"
    - "Shixiang Zhu"
...
### (日本語題名: MISLEADER: Defending against Model Extraction with Ensembles of Distilled Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.02362v1`](https://arxiv.org/abs/2506.02362v1) | Raw Meta = [`2506.02362_meta.json`](../../raw_data/2025-06-03/2506.02362_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「MISLEADER: Defending against Model Extraction with Ensembles of Distilled Models（セキュリティ分析論文）」（原題: MISLEADER: Defending against Model Extraction with Ensembles of Distilled Models / arXiv: 2506.02362v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.02362v1`
- **論文URL**: [https://arxiv.org/abs/2506.02362v1](https://arxiv.org/abs/2506.02362v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.02362v1.pdf](https://arxiv.org/pdf/2506.02362v1.pdf)
- **著者**: Xueqi Cheng, Minxing Zheng, Shixiang Zhu, Yushun Dong
- **公開日時**: `2025-06-03T01:37:09Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-03/2506.02362_meta.json) | [`PDF`](../../raw_data/2025-06-03/2506.02362.pdf) | [`TXT`](../../raw_data/2025-06-03/2506.02362.txt)
