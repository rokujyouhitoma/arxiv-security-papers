...
title_ja: "FBID: IoTネットワークにおける堅牢な分布外攻撃検出のための適応的パーソナライズ連合学習"
description: "FBID: IoTネットワークにおける堅牢な分布外攻撃検出のための適応的パーソナライズ連合学習 — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.04073v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-04/2608.04073_meta.json"
  published_date: "2026-08-04T15:59:33Z"
  authors:
    - "An Khanh Bui"
    - "Cong Thanh Nguyen"
    - "Hoang-Anh Pham"
...
### (日本語題名: FBID: IoTネットワークにおける堅牢な分布外攻撃検出のための適応的パーソナライズ連合学習)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.04073v1`](https://arxiv.org/abs/2608.04073v1) | Raw Meta = [`2608.04073_meta.json`](../../raw_data/2026-08-04/2608.04073_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「FBID: IoTネットワークにおける堅牢な分布外攻撃検出のための適応的パーソナライズ連合学習」（原題: FBID: Adaptive Personalized Federated Learning for Robust Out-of-Distribution Attack Detection in IoT Networks / arXiv: 2608.04073v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.04073v1`
- **論文URL**: [https://arxiv.org/abs/2608.04073v1](https://arxiv.org/abs/2608.04073v1)
- **PDFリンク**: [https://arxiv.org/pdf/2608.04073v1.pdf](https://arxiv.org/pdf/2608.04073v1.pdf)
- **著者**: An Khanh Bui, Cong Thanh Nguyen, Hoang-Anh Pham, Hoang Thai Dinh, Diep N. Nguyen
- **公開日時**: `2026-08-04T15:59:33Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-04/2608.04073_meta.json) | [`PDF`](../../raw_data/2026-08-04/2608.04073.pdf) | [`TXT`](../../raw_data/2026-08-04/2608.04073.txt)
