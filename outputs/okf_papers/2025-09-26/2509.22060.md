...
title_ja: "Decoding Deception: Understanding Automatic Speech Recognition Vulnerabilities in Evasion and Poisoning Attacks（セキュリティ分析論文）"
description: "Decoding Deception: Understanding Automatic Speech Recognition Vulnerabilities in Evasion and Poisoning Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.22060v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-26/2509.22060_meta.json"
  published_date: "2025-09-26T08:42:59Z"
  authors:
    - "Aravindhan G"
...
### (日本語題名: Decoding Deception: Understanding Automatic Speech Recognition Vulnerabilities in Evasion and Poisoning Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.22060v2`](https://arxiv.org/abs/2509.22060v2) | Raw Meta = [`2509.22060_meta.json`](../../raw_data/2025-09-26/2509.22060_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Decoding Deception: Understanding Automatic Speech Recognition Vulnerabilities in Evasion and Poisoning Attacks（セキュリティ分析論文）」（原題: Decoding Deception: Understanding Automatic Speech Recognition Vulnerabilities in Evasion and Poisoning Attacks / arXiv: 2509.22060v2）は、cs.SD 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.22060v2`
- **論文URL**: [https://arxiv.org/abs/2509.22060v2](https://arxiv.org/abs/2509.22060v2)
- **PDFリンク**: [https://arxiv.org/pdf/2509.22060v2.pdf](https://arxiv.org/pdf/2509.22060v2.pdf)
- **著者**: Aravindhan G, Yuvaraj Govindarajulu, Parin Shah
- **公開日時**: `2025-09-26T08:42:59Z`
- **カテゴリ**: `cs.SD, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-26/2509.22060_meta.json) | [`PDF (arXiv)`](https://arxiv.org/pdf/2509.22060v2.pdf) | [`TXT`](../../raw_data/2025-09-26/2509.22060_raw_abstract.txt)
