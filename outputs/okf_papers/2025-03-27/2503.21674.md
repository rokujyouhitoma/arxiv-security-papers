...
title_ja: "Intelligent IoT Attack Detection Design via ODLLM with Feature Ranking-based Knowledge Base（セキュリティ分析論文）"
description: "Intelligent IoT Attack Detection Design via ODLLM with Feature Ranking-based Knowledge Base（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.21674v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.NI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-27/2503.21674_meta.json"
  published_date: "2025-03-27T16:41:57Z"
  authors:
    - "Satvik Verma"
    - "Qun Wang"
    - "E. Wes Bethel"
...
### (日本語題名: Intelligent IoT Attack Detection Design via ODLLM with Feature Ranking-based Knowledge Base（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.21674v1`](https://arxiv.org/abs/2503.21674v1) | Raw Meta = [`2503.21674_meta.json`](../../raw_data/2025-03-27/2503.21674_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Intelligent IoT Attack Detection Design via ODLLM with Feature Ranking-based Knowledge Base（セキュリティ分析論文）」（原題: Intelligent IoT Attack Detection Design via ODLLM with Feature Ranking-based Knowledge Base / arXiv: 2503.21674v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.21674v1`
- **論文URL**: [https://arxiv.org/abs/2503.21674v1](https://arxiv.org/abs/2503.21674v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.21674v1.pdf](https://arxiv.org/pdf/2503.21674v1.pdf)
- **著者**: Satvik Verma, Qun Wang, E. Wes Bethel
- **公開日時**: `2025-03-27T16:41:57Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-27/2503.21674_meta.json) | [`PDF`](../../raw_data/2025-03-27/2503.21674.pdf) | [`TXT`](../../raw_data/2025-03-27/2503.21674.txt)
