---
type: "security-paper"
title: "Claimed or Attested? A Commit-Signature Dataset and Identity Trust Tiers across the World of Code"
title_ja: "Claimed or Attested? A Commit-Signature Dataset and Identity Trust Tiers across the World of Code（セキュリティ分析論文）"
description: "Claimed or Attested? A Commit-Signature Dataset and Identity Trust Tiers across the World of Code（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.06194v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.SE"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-07/2607.06194_meta.json"
  published_date: "2026-07-07T12:19:25Z"
  authors:
    - "Audris Mockus"
trust:
...
### (日本語題名: Claimed or Attested? A Commit-Signature Dataset and Identity Trust Tiers across the World of Code（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.06194v1`](https://arxiv.org/abs/2607.06194v1) | Raw Meta = [`2607.06194_meta.json`](../../raw_data/2026-07-07/2607.06194_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Claimed or Attested? A Commit-Signature Dataset and Identity Trust Tiers across the World of Code（セキュリティ分析論文）」（原題: Claimed or Attested? A Commit-Signature Dataset and Identity Trust Tiers across the World of Code / arXiv: 2607.06194v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2607.06194v1](https://arxiv.org/abs/2607.06194v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.06194v1.pdf](https://arxiv.org/pdf/2607.06194v1.pdf)
- **著者**: Audris Mockus
- **公開日時**: `2026-07-07T12:19:25Z`
- **カテゴリ**: `cs.CR, cs.SE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-07/2607.06194_meta.json) | [`PDF`](../../raw_data/2026-07-07/2607.06194.pdf) | [`TXT`](../../raw_data/2026-07-07/2607.06194.txt)
