...
title_ja: "Structural Dependency Analysis for Masked NTT Hardware: Scalable Pre-Silicon Verification of Post-Quantum Cryptographic Accelerators（セキュリティ分析論文）"
description: "Structural Dependency Analysis for Masked NTT Hardware: Scalable Pre-Silicon Verification of Post-Quantum Cryptographic Accelerators（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.15249v2"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-16/2604.15249_meta.json"
  published_date: "2026-04-16T17:25:01Z"
  authors:
    - "Ray Iskander"
    - "Khaled Kirah"
trust:
...
### (日本語題名: Structural Dependency Analysis for Masked NTT Hardware: Scalable Pre-Silicon Verification of Post-Quantum Cryptographic Accelerators（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.15249v2`](https://arxiv.org/abs/2604.15249v2) | Raw Meta = [`2604.15249_meta.json`](../../raw_data/2026-04-16/2604.15249_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Structural Dependency Analysis for Masked NTT Hardware: Scalable Pre-Silicon Verification of Post-Quantum Cryptographic Accelerators（セキュリティ分析論文）」（原題: Structural Dependency Analysis for Masked NTT Hardware: Scalable Pre-Silicon Verification of Post-Quantum Cryptographic Accelerators / arXiv: 2604.15249v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.15249v2`
- **論文URL**: [https://arxiv.org/abs/2604.15249v2](https://arxiv.org/abs/2604.15249v2)
- **PDFリンク**: [https://arxiv.org/pdf/2604.15249v2.pdf](https://arxiv.org/pdf/2604.15249v2.pdf)
- **著者**: Ray Iskander, Khaled Kirah
- **公開日時**: `2026-04-16T17:25:01Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-16/2604.15249_meta.json) | [`PDF`](../../raw_data/2026-04-16/2604.15249.pdf) | [`TXT`](../../raw_data/2026-04-16/2604.15249.txt)
