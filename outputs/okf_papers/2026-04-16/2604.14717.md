...
title_ja: "Layered Mutability: Continuity and Governance in Persistent Self-Modifying Agents（セキュリティ分析論文）"
description: "Layered Mutability: Continuity and Governance in Persistent Self-Modifying Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.14717v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-16/2604.14717_meta.json"
  published_date: "2026-04-16T07:27:35Z"
  authors:
    - "Krti Tallam"
trust:
...
### (日本語題名: Layered Mutability: Continuity and Governance in Persistent Self-Modifying Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.14717v2`](https://arxiv.org/abs/2604.14717v2) | Raw Meta = [`2604.14717_meta.json`](../../raw_data/2026-04-16/2604.14717_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Layered Mutability: Continuity and Governance in Persistent Self-Modifying Agents（セキュリティ分析論文）」（原題: Layered Mutability: Continuity and Governance in Persistent Self-Modifying Agents / arXiv: 2604.14717v2）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.14717v2`
- **論文URL**: [https://arxiv.org/abs/2604.14717v2](https://arxiv.org/abs/2604.14717v2)
- **PDFリンク**: [https://arxiv.org/pdf/2604.14717v2.pdf](https://arxiv.org/pdf/2604.14717v2.pdf)
- **著者**: Krti Tallam
- **公開日時**: `2026-04-16T07:27:35Z`
- **カテゴリ**: `cs.AI, cs.CR, cs.CY, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-16/2604.14717_meta.json) | [`PDF`](../../raw_data/2026-04-16/2604.14717.pdf) | [`TXT`](../../raw_data/2026-04-16/2604.14717.txt)
