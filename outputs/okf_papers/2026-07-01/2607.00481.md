...
title_ja: "Beyond the Prompt: Jailbreaking Function-Calling LLMs via Simulated Moderation Traces（セキュリティ分析論文）"
description: "Beyond the Prompt: Jailbreaking Function-Calling LLMs via Simulated Moderation Traces（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.00481v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-01/2607.00481_meta.json"
  published_date: "2026-07-01T06:08:07Z"
  authors:
    - "Junlong Liu"
    - "Haobo Wang"
    - "Weiqi Luo"
...
### (日本語題名: Beyond the Prompt: Jailbreaking Function-Calling LLMs via Simulated Moderation Traces（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.00481v1`](https://arxiv.org/abs/2607.00481v1) | Raw Meta = [`2607.00481_meta.json`](../../raw_data/2026-07-01/2607.00481_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Beyond the Prompt: Jailbreaking Function-Calling LLMs via Simulated Moderation Traces（セキュリティ分析論文）」（原題: Beyond the Prompt: Jailbreaking Function-Calling LLMs via Simulated Moderation Traces / arXiv: 2607.00481v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.00481v1`
- **論文URL**: [https://arxiv.org/abs/2607.00481v1](https://arxiv.org/abs/2607.00481v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.00481v1.pdf](https://arxiv.org/pdf/2607.00481v1.pdf)
- **著者**: Junlong Liu, Haobo Wang, Weiqi Luo, Xiaojun Jia
- **公開日時**: `2026-07-01T06:08:07Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-01/2607.00481_meta.json) | [`PDF`](../../raw_data/2026-07-01/2607.00481.pdf) | [`TXT`](../../raw_data/2026-07-01/2607.00481.txt)
