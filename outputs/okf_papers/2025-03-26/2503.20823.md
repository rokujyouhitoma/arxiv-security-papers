...
title_ja: "Playing the Fool: Jailbreaking LLMs and Multimodal LLMs with Out-of-Distribution Strategy（セキュリティ分析論文）"
description: "Playing the Fool: Jailbreaking LLMs and Multimodal LLMs with Out-of-Distribution Strategy（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2503.20823v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-03-26/2503.20823_meta.json"
  published_date: "2025-03-26T01:25:24Z"
  authors:
    - "Joonhyun Jeong"
    - "Seyun Bae"
    - "Yeonsung Jung"
...
### (日本語題名: Playing the Fool: Jailbreaking LLMs and Multimodal LLMs with Out-of-Distribution Strategy（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2503.20823v1`](https://arxiv.org/abs/2503.20823v1) | Raw Meta = [`2503.20823_meta.json`](../../raw_data/2025-03-26/2503.20823_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Playing the Fool: Jailbreaking LLMs and Multimodal LLMs with Out-of-Distribution Strategy（セキュリティ分析論文）」（原題: Playing the Fool: Jailbreaking LLMs and Multimodal LLMs with Out-of-Distribution Strategy / arXiv: 2503.20823v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2503.20823v1`
- **論文URL**: [https://arxiv.org/abs/2503.20823v1](https://arxiv.org/abs/2503.20823v1)
- **PDFリンク**: [https://arxiv.org/pdf/2503.20823v1.pdf](https://arxiv.org/pdf/2503.20823v1.pdf)
- **著者**: Joonhyun Jeong, Seyun Bae, Yeonsung Jung, Jaeryong Hwang, Eunho Yang
- **公開日時**: `2025-03-26T01:25:24Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-03-26/2503.20823_meta.json) | [`PDF`](../../raw_data/2025-03-26/2503.20823.pdf) | [`TXT`](../../raw_data/2025-03-26/2503.20823.txt)
