...
title_ja: "SUDP: Secret-Use Delegation Protocol for Agentic Systems（セキュリティ分析論文）"
description: "SUDP: Secret-Use Delegation Protocol for Agentic Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.24920v3"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-27/2604.24920_meta.json"
  published_date: "2026-04-27T19:02:08Z"
  authors:
    - "Xiaohang Yu"
    - "Hejia Geng"
    - "Xinmeng Zeng"
...
### (日本語題名: SUDP: Secret-Use Delegation Protocol for Agentic Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.24920v3`](https://arxiv.org/abs/2604.24920v3) | Raw Meta = [`2604.24920_meta.json`](../../raw_data/2026-04-27/2604.24920_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SUDP: Secret-Use Delegation Protocol for Agentic Systems（セキュリティ分析論文）」（原題: SUDP: Secret-Use Delegation Protocol for Agentic Systems / arXiv: 2604.24920v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.24920v3`
- **論文URL**: [https://arxiv.org/abs/2604.24920v3](https://arxiv.org/abs/2604.24920v3)
- **PDFリンク**: [https://arxiv.org/pdf/2604.24920v3.pdf](https://arxiv.org/pdf/2604.24920v3.pdf)
- **著者**: Xiaohang Yu, Hejia Geng, Xinmeng Zeng, William Knottenbelt
- **公開日時**: `2026-04-27T19:02:08Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-27/2604.24920_meta.json) | [`PDF`](../../raw_data/2026-04-27/2604.24920.pdf) | [`TXT`](../../raw_data/2026-04-27/2604.24920.txt)
