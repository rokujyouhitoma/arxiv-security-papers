...
title_ja: "Holmes: An Evidence-Grounded LLM Agent for Auditable DDoS Investigation in Cloud Networks（セキュリティ分析論文）"
description: "Holmes: An Evidence-Grounded LLM Agent for Auditable DDoS Investigation in Cloud Networks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2601.14601v1"
tags:
  - "cs.NI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-01-21/2601.14601_meta.json"
  published_date: "2026-01-21T02:39:46Z"
  authors:
    - "Haodong Chen"
    - "Ziheng Zhang"
    - "Jinghui Jiang"
...
### (日本語題名: Holmes: An Evidence-Grounded LLM Agent for Auditable DDoS Investigation in Cloud Networks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2601.14601v1`](https://arxiv.org/abs/2601.14601v1) | Raw Meta = [`2601.14601_meta.json`](../../raw_data/2026-01-21/2601.14601_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Holmes: An Evidence-Grounded LLM Agent for Auditable DDoS Investigation in Cloud Networks（セキュリティ分析論文）」（原題: Holmes: An Evidence-Grounded LLM Agent for Auditable DDoS Investigation in Cloud Networks / arXiv: 2601.14601v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2601.14601v1`
- **論文URL**: [https://arxiv.org/abs/2601.14601v1](https://arxiv.org/abs/2601.14601v1)
- **PDFリンク**: [https://arxiv.org/pdf/2601.14601v1.pdf](https://arxiv.org/pdf/2601.14601v1.pdf)
- **著者**: Haodong Chen, Ziheng Zhang, Jinghui Jiang, Qiang Su, Qiao Xiang
- **公開日時**: `2026-01-21T02:39:46Z`
- **カテゴリ**: `cs.CR, cs.NI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-01-21/2601.14601_meta.json) | [`PDF`](../../raw_data/2026-01-21/2601.14601.pdf) | [`TXT`](../../raw_data/2026-01-21/2601.14601.txt)
