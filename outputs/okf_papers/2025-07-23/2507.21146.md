...
title_ja: "Unifying Quantitative Security Benchmarking for Multi Agent Systemsに向けて"
description: "Unifying Quantitative Security Benchmarking for Multi Agent Systemsに向けて — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.21146v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-23/2507.21146_meta.json"
  published_date: "2025-07-23T13:51:28Z"
  authors:
    - "Gauri Sharma"
    - "Vidhi Kulkarni"
    - "Miles King"
...
### (日本語題名: Unifying Quantitative Security Benchmarking for Multi Agent Systemsに向けて)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.21146v1`](https://arxiv.org/abs/2507.21146v1) | Raw Meta = [`2507.21146_meta.json`](../../raw_data/2025-07-23/2507.21146_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Unifying Quantitative Security Benchmarking for Multi Agent Systemsに向けて」（原題: Towards Unifying Quantitative Security Benchmarking for Multi Agent Systems / arXiv: 2507.21146v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2507.21146v1](https://arxiv.org/abs/2507.21146v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.21146v1.pdf](https://arxiv.org/pdf/2507.21146v1.pdf)
- **著者**: Gauri Sharma, Vidhi Kulkarni, Miles King, Ken Huang
- **公開日時**: `2025-07-23T13:51:28Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-23/2507.21146_meta.json) | [`PDF`](../../raw_data/2025-07-23/2507.21146.pdf) | [`TXT`](../../raw_data/2025-07-23/2507.21146.txt)
