...
title_ja: "Threshold-Protected Searchable Sharing: Privacy Preserving Aggregated-ANN Search for Collaborative RAG（セキュリティ分析論文）"
description: "Threshold-Protected Searchable Sharing: Privacy Preserving Aggregated-ANN Search for Collaborative RAG（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.17199v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-23/2507.17199_meta.json"
  published_date: "2025-07-23T04:45:01Z"
  authors:
    - "Ruoyang Rykie Guo"
trust:
...
### (日本語題名: Threshold-Protected Searchable Sharing: Privacy Preserving Aggregated-ANN Search for Collaborative RAG（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.17199v1`](https://arxiv.org/abs/2507.17199v1) | Raw Meta = [`2507.17199_meta.json`](../../raw_data/2025-07-23/2507.17199_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Threshold-Protected Searchable Sharing: Privacy Preserving Aggregated-ANN Search for Collaborative RAG（セキュリティ分析論文）」（原題: Threshold-Protected Searchable Sharing: Privacy Preserving Aggregated-ANN Search for Collaborative RAG / arXiv: 2507.17199v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.17199v1`
- **論文URL**: [https://arxiv.org/abs/2507.17199v1](https://arxiv.org/abs/2507.17199v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.17199v1.pdf](https://arxiv.org/pdf/2507.17199v1.pdf)
- **著者**: Ruoyang Rykie Guo
- **公開日時**: `2025-07-23T04:45:01Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-23/2507.17199_meta.json) | [`PDF`](../../raw_data/2025-07-23/2507.17199.pdf) | [`TXT`](../../raw_data/2025-07-23/2507.17199.txt)
