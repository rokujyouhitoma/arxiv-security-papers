...
title_ja: "Lower Bounds for Public-Private Learning under Distribution Shift（セキュリティ分析論文）"
description: "Lower Bounds for Public-Private Learning under Distribution Shift（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.17895v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-23/2507.17895_meta.json"
  published_date: "2025-07-23T19:46:08Z"
  authors:
    - "Amrith Setlur"
    - "Pratiksha Thaker"
    - "Jonathan Ullman"
...
### (日本語題名: Lower Bounds for Public-Private Learning under Distribution Shift（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.17895v1`](https://arxiv.org/abs/2507.17895v1) | Raw Meta = [`2507.17895_meta.json`](../../raw_data/2025-07-23/2507.17895_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Lower Bounds for Public-Private Learning under Distribution Shift（セキュリティ分析論文）」（原題: Lower Bounds for Public-Private Learning under Distribution Shift / arXiv: 2507.17895v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2507.17895v1`
- **論文URL**: [https://arxiv.org/abs/2507.17895v1](https://arxiv.org/abs/2507.17895v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.17895v1.pdf](https://arxiv.org/pdf/2507.17895v1.pdf)
- **著者**: Amrith Setlur, Pratiksha Thaker, Jonathan Ullman
- **公開日時**: `2025-07-23T19:46:08Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-23/2507.17895_meta.json) | [`PDF`](../../raw_data/2025-07-23/2507.17895.pdf) | [`TXT`](../../raw_data/2025-07-23/2507.17895.txt)
