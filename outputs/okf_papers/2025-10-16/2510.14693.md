...
title_ja: "FibRace: a large-scale benchmark of client-side proving on mobile devices（セキュリティ分析論文）"
description: "FibRace: a large-scale benchmark of client-side proving on mobile devices（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.14693v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-10-16/2510.14693_meta.json"
  published_date: "2025-10-16T13:59:00Z"
  authors:
    - "Simon Malatrait"
    - "Alex Sirac"
trust:
...
### (日本語題名: FibRace: a large-scale benchmark of client-side proving on mobile devices（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.14693v1`](https://arxiv.org/abs/2510.14693v1) | Raw Meta = [`2510.14693_meta.json`](../../raw_data/2025-10-16/2510.14693_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「FibRace: a large-scale benchmark of client-side proving on mobile devices（セキュリティ分析論文）」（原題: FibRace: a large-scale benchmark of client-side proving on mobile devices / arXiv: 2510.14693v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2510.14693v1`
- **論文URL**: [https://arxiv.org/abs/2510.14693v1](https://arxiv.org/abs/2510.14693v1)
- **PDFリンク**: [https://arxiv.org/pdf/2510.14693v1.pdf](https://arxiv.org/pdf/2510.14693v1.pdf)
- **著者**: Simon Malatrait, Alex Sirac
- **公開日時**: `2025-10-16T13:59:00Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-10-16/2510.14693_meta.json) | [`PDF`](../../raw_data/2025-10-16/2510.14693.pdf) | [`TXT`](../../raw_data/2025-10-16/2510.14693.txt)
