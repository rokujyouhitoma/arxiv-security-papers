...
title_ja: "SecureScan: An AI-Driven Multi-Layer Framework for Malware and Phishing Detection Using Logistic Regression and Threat Intelligence Integration（セキュリティ分析論文）"
description: "SecureScan: An AI-Driven Multi-Layer Framework for Malware and Phishing Detection Using Logistic Regression and Threat Intelligence Integration（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.10750v2"
tags:
  - "cs.AI"
  - "cs.CV"
  - "executive-summary"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-11/2602.10750_meta.json"
  published_date: "2026-02-11T11:26:11Z"
  authors:
    - "Rumman Firdos"
    - "Aman Dangi"
trust:
...
### (日本語題名: SecureScan: An AI-Driven Multi-Layer Framework for Malware and Phishing Detection Using Logistic Regression and Threat Intelligence Integration（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.10750v2`](https://arxiv.org/abs/2602.10750v2) | Raw Meta = [`2602.10750_meta.json`](../../raw_data/2026-02-11/2602.10750_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SecureScan: An AI-Driven Multi-Layer Framework for Malware and Phishing Detection Using Logistic Regression and Threat Intelligence Integration（セキュリティ分析論文）」（原題: SecureScan: An AI-Driven Multi-Layer Framework for Malware and Phishing Detection Using Logistic Regression and Threat Intelligence Integration / arXiv: 2602.10750v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.10750v2`
- **論文URL**: [https://arxiv.org/abs/2602.10750v2](https://arxiv.org/abs/2602.10750v2)
- **PDFリンク**: [https://arxiv.org/pdf/2602.10750v2.pdf](https://arxiv.org/pdf/2602.10750v2.pdf)
- **著者**: Rumman Firdos, Aman Dangi
- **公開日時**: `2026-02-11T11:26:11Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CV, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-11/2602.10750_meta.json) | [`PDF`](../../raw_data/2026-02-11/2602.10750.pdf) | [`TXT`](../../raw_data/2026-02-11/2602.10750.txt)
