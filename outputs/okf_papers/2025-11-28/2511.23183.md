...
title_ja: "Identification of Malicious Posts on the Dark Web Using Supervised Machine Learning（セキュリティ分析論文）"
description: "Identification of Malicious Posts on the Dark Web Using Supervised Machine Learning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2511.23183v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-11-28/2511.23183_meta.json"
  published_date: "2025-11-28T13:51:18Z"
  authors:
...
### (日本語題名: Identification of Malicious Posts on the Dark Web Using Supervised Machine Learning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2511.23183v1`](https://arxiv.org/abs/2511.23183v1) | Raw Meta = [`2511.23183_meta.json`](../../raw_data/2025-11-28/2511.23183_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Identification of Malicious Posts on the Dark Web Using Supervised Machine Learning（セキュリティ分析論文）」（原題: Identification of Malicious Posts on the Dark Web Using Supervised Machine Learning / arXiv: 2511.23183v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2511.23183v1`
- **論文URL**: [https://arxiv.org/abs/2511.23183v1](https://arxiv.org/abs/2511.23183v1)
- **PDFリンク**: [https://arxiv.org/pdf/2511.23183v1.pdf](https://arxiv.org/pdf/2511.23183v1.pdf)
- **著者**: Sebastião Alves de Jesus Filho, Gustavo Di Giovanni Bernardo, Paulo Henrique Ribeiro Gabriel, Bruno Bogaz Zarpelão, Rodrigo Sanches Miani
- **公開日時**: `2025-11-28T13:51:18Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-11-28/2511.23183_meta.json) | [`PDF`](../../raw_data/2025-11-28/2511.23183.pdf) | [`TXT`](../../raw_data/2025-11-28/2511.23183.txt)
