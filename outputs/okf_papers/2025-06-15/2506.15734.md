...
title_ja: "The Safety Reminder: A Soft Prompt to Reactivate Delayed Safety Awareness in Vision-Language Models（セキュリティ分析論文）"
description: "The Safety Reminder: A Soft Prompt to Reactivate Delayed Safety Awareness in Vision-Language Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.15734v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-06-15/2506.15734_meta.json"
  published_date: "2025-06-15T12:48:38Z"
  authors:
    - "Peiyuan Tang"
    - "Haojie Xin"
    - "Xiaodong Zhang"
...
### (日本語題名: The Safety Reminder: A Soft Prompt to Reactivate Delayed Safety Awareness in Vision-Language Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.15734v1`](https://arxiv.org/abs/2506.15734v1) | Raw Meta = [`2506.15734_meta.json`](../../raw_data/2025-06-15/2506.15734_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「The Safety Reminder: A Soft Prompt to Reactivate Delayed Safety Awareness in Vision-Language Models（セキュリティ分析論文）」（原題: The Safety Reminder: A Soft Prompt to Reactivate Delayed Safety Awareness in Vision-Language Models / arXiv: 2506.15734v1）は、cs.AI 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.15734v1`
- **論文URL**: [https://arxiv.org/abs/2506.15734v1](https://arxiv.org/abs/2506.15734v1)
- **PDFリンク**: [https://arxiv.org/pdf/2506.15734v1.pdf](https://arxiv.org/pdf/2506.15734v1.pdf)
- **著者**: Peiyuan Tang, Haojie Xin, Xiaodong Zhang, Jun Sun, Qin Xia, Zijiang Yang
- **公開日時**: `2025-06-15T12:48:38Z`
- **カテゴリ**: `cs.AI, cs.CL, cs.CR, cs.CV, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-06-15/2506.15734_meta.json) | [`PDF`](../../raw_data/2025-06-15/2506.15734.pdf) | [`TXT`](../../raw_data/2025-06-15/2506.15734.txt)
