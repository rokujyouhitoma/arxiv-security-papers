...
title_ja: "GhostPrompt: Cross-Image Adversarial Prompt for Vision-Language Models（セキュリティ分析論文）"
description: "GhostPrompt: Cross-Image Adversarial Prompt for Vision-Language Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.19683v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-22/2607.19683_meta.json"
  published_date: "2026-07-22T02:33:56Z"
  authors:
    - "Li Zeng"
    - "Zeyu Ye"
    - "Meng Xie"
...
### (日本語題名: GhostPrompt: Cross-Image Adversarial Prompt for Vision-Language Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.19683v1`](https://arxiv.org/abs/2607.19683v1) | Raw Meta = [`2607.19683_meta.json`](../../raw_data/2026-07-22/2607.19683_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「GhostPrompt: Cross-Image Adversarial Prompt for Vision-Language Models（セキュリティ分析論文）」（原題: GhostPrompt: Cross-Image Adversarial Prompt for Vision-Language Models / arXiv: 2607.19683v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.19683v1`
- **論文URL**: [https://arxiv.org/abs/2607.19683v1](https://arxiv.org/abs/2607.19683v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.19683v1.pdf](https://arxiv.org/pdf/2607.19683v1.pdf)
- **著者**: Li Zeng, Zeyu Ye, Meng Xie, Hangtao Zhang, Xianlong Wang, Yanchun Li, Zhetao Li
- **公開日時**: `2026-07-22T02:33:56Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-22/2607.19683_meta.json) | [`PDF`](../../raw_data/2026-07-22/2607.19683.pdf) | [`TXT`](../../raw_data/2026-07-22/2607.19683.txt)
