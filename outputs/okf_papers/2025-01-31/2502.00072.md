...
title_ja: "LLM Cyber Evaluations Don't Capture Real-World Risk（セキュリティ分析論文）"
description: "LLM Cyber Evaluations Don't Capture Real-World Risk（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2502.00072v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-01-31/2502.00072_meta.json"
  published_date: "2025-01-31T05:33:48Z"
  authors:
    - "Kamilė Lukošiūtė"
    - "Adam Swanda"
trust:
...
### (日本語題名: LLM Cyber Evaluations Don't Capture Real-World Risk（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2502.00072v1`](https://arxiv.org/abs/2502.00072v1) | Raw Meta = [`2502.00072_meta.json`](../../raw_data/2025-01-31/2502.00072_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「LLM Cyber Evaluations Don't Capture Real-World Risk（セキュリティ分析論文）」（原題: LLM Cyber Evaluations Don't Capture Real-World Risk / arXiv: 2502.00072v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2502.00072v1`
- **論文URL**: [https://arxiv.org/abs/2502.00072v1](https://arxiv.org/abs/2502.00072v1)
- **PDFリンク**: [https://arxiv.org/pdf/2502.00072v1.pdf](https://arxiv.org/pdf/2502.00072v1.pdf)
- **著者**: Kamilė Lukošiūtė, Adam Swanda
- **公開日時**: `2025-01-31T05:33:48Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CL, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-01-31/2502.00072_meta.json) | [`PDF`](../../raw_data/2025-01-31/2502.00072.pdf) | [`TXT`](../../raw_data/2025-01-31/2502.00072.txt)
