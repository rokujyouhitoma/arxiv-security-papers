...
title_ja: "RPG-AE: Neuro-Symbolic Graph Autoencoders with Rare Pattern Mining for Provenance-Based Anomaly Detection（セキュリティ分析論文）"
description: "RPG-AE: Neuro-Symbolic Graph Autoencoders with Rare Pattern Mining for Provenance-Based Anomaly Detection（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.02929v2"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-03/2602.02929_meta.json"
  published_date: "2026-02-03T00:02:37Z"
  authors:
    - "Asif Tauhid"
...
### (日本語題名: RPG-AE: Neuro-Symbolic Graph Autoencoders with Rare Pattern Mining for Provenance-Based Anomaly Detection（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.02929v2`](https://arxiv.org/abs/2602.02929v2) | Raw Meta = [`2602.02929_meta.json`](../../raw_data/2026-02-03/2602.02929_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「RPG-AE: Neuro-Symbolic Graph Autoencoders with Rare Pattern Mining for Provenance-Based Anomaly Detection（セキュリティ分析論文）」（原題: RPG-AE: Neuro-Symbolic Graph Autoencoders with Rare Pattern Mining for Provenance-Based Anomaly Detection / arXiv: 2602.02929v2）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.02929v2`
- **論文URL**: [https://arxiv.org/abs/2602.02929v2](https://arxiv.org/abs/2602.02929v2)
- **PDFリンク**: [https://arxiv.org/pdf/2602.02929v2.pdf](https://arxiv.org/pdf/2602.02929v2.pdf)
- **著者**: Asif Tauhid, Sidahmed Benabderrahmane, Mohamad Altrabulsi, Ahamed Foisal, Talal Rahwan
- **公開日時**: `2026-02-03T00:02:37Z`
- **カテゴリ**: `cs.LG, cs.AI, cs.CR, cs.NE`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-03/2602.02929_meta.json) | [`PDF`](../../raw_data/2026-02-03/2602.02929.pdf) | [`TXT`](../../raw_data/2026-02-03/2602.02929.txt)
