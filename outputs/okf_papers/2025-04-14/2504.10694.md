...
title_ja: "The Jailbreak Tax: How Useful are Your Jailbreak Outputs?（セキュリティ分析論文）"
description: "The Jailbreak Tax: How Useful are Your Jailbreak Outputs?（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.10694v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-14/2504.10694_meta.json"
  published_date: "2025-04-14T20:30:41Z"
  authors:
    - "Kristina Nikolić"
    - "Luze Sun"
    - "Jie Zhang"
...
### (日本語題名: The Jailbreak Tax: How Useful are Your Jailbreak Outputs?（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.10694v1`](https://arxiv.org/abs/2504.10694v1) | Raw Meta = [`2504.10694_meta.json`](../../raw_data/2025-04-14/2504.10694_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「The Jailbreak Tax: How Useful are Your Jailbreak Outputs?（セキュリティ分析論文）」（原題: The Jailbreak Tax: How Useful are Your Jailbreak Outputs? / arXiv: 2504.10694v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2504.10694v1](https://arxiv.org/abs/2504.10694v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.10694v1.pdf](https://arxiv.org/pdf/2504.10694v1.pdf)
- **著者**: Kristina Nikolić, Luze Sun, Jie Zhang, Florian Tramèr
- **公開日時**: `2025-04-14T20:30:41Z`
- **カテゴリ**: `cs.LG, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-14/2504.10694_meta.json) | [`PDF`](../../raw_data/2025-04-14/2504.10694.pdf) | [`TXT`](../../raw_data/2025-04-14/2504.10694.txt)
