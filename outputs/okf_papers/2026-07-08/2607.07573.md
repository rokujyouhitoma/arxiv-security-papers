...
title_ja: "Multi-Class vs. Multi-Label BERT for CVE-to-CWE Mapping: How Taxonomy Structure Shapes the Errors（セキュリティ分析論文）"
description: "Multi-Class vs. Multi-Label BERT for CVE-to-CWE Mapping: How Taxonomy Structure Shapes the Errors（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.07573v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-08/2607.07573_meta.json"
  published_date: "2026-07-08T16:01:21Z"
  authors:
    - "Ana Schwengber Kelm"
...
### (日本語題名: Multi-Class vs. Multi-Label BERT for CVE-to-CWE Mapping: How Taxonomy Structure Shapes the Errors（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.07573v1`](https://arxiv.org/abs/2607.07573v1) | Raw Meta = [`2607.07573_meta.json`](../../raw_data/2026-07-08/2607.07573_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Multi-Class vs. Multi-Label BERT for CVE-to-CWE Mapping: How Taxonomy Structure Shapes the Errors（セキュリティ分析論文）」（原題: Multi-Class vs. Multi-Label BERT for CVE-to-CWE Mapping: How Taxonomy Structure Shapes the Errors / arXiv: 2607.07573v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.07573v1`
- **論文URL**: [https://arxiv.org/abs/2607.07573v1](https://arxiv.org/abs/2607.07573v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.07573v1.pdf](https://arxiv.org/pdf/2607.07573v1.pdf)
- **著者**: Ana Schwengber Kelm, Christian Bockermann, Jörg Frochte
- **公開日時**: `2026-07-08T16:01:21Z`
- **カテゴリ**: `cs.LG, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-08/2607.07573_meta.json) | [`PDF`](../../raw_data/2026-07-08/2607.07573.pdf) | [`TXT`](../../raw_data/2026-07-08/2607.07573.txt)
