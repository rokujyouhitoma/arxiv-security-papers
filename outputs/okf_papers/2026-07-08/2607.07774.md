...
title_ja: "ScopeJudge: Cost-Aware Pre-Execution Gating for Offensive Security Agents（セキュリティ分析論文）"
description: "ScopeJudge: Cost-Aware Pre-Execution Gating for Offensive Security Agents（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.07774v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-08/2607.07774_meta.json"
  published_date: "2026-07-08T16:46:06Z"
  authors:
    - "Shane Caldwell"
    - "Max Harley"
    - "Ads Dawson"
...
### (日本語題名: ScopeJudge: Cost-Aware Pre-Execution Gating for Offensive Security Agents（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.07774v2`](https://arxiv.org/abs/2607.07774v2) | Raw Meta = [`2607.07774_meta.json`](../../raw_data/2026-07-08/2607.07774_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「ScopeJudge: Cost-Aware Pre-Execution Gating for Offensive Security Agents（セキュリティ分析論文）」（原題: ScopeJudge: Cost-Aware Pre-Execution Gating for Offensive Security Agents / arXiv: 2607.07774v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.07774v2`
- **論文URL**: [https://arxiv.org/abs/2607.07774v2](https://arxiv.org/abs/2607.07774v2)
- **PDFリンク**: [https://arxiv.org/pdf/2607.07774v2.pdf](https://arxiv.org/pdf/2607.07774v2.pdf)
- **著者**: Shane Caldwell, Max Harley, Ads Dawson, Michael Kouremetis, Vincent Abruzzo, Will Pearce
- **公開日時**: `2026-07-08T16:46:06Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-08/2607.07774_meta.json) | [`PDF`](../../raw_data/2026-07-08/2607.07774.pdf) | [`TXT`](../../raw_data/2026-07-08/2607.07774.txt)
