...
title_ja: "Cyber Dynamics I: Finite Macrostates for Behavioral Anomaly Detection in Network Telemetry（セキュリティ分析論文）"
description: "Cyber Dynamics I: Finite Macrostates for Behavioral Anomaly Detection in Network Telemetry（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2607.07075v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-07-08/2607.07075_meta.json"
  published_date: "2026-07-08T07:07:08Z"
  authors:
    - "Abdul Rahman"
    - "Eranga Bandara"
    - "Sachin Shetty"
...
### (日本語題名: Cyber Dynamics I: Finite Macrostates for Behavioral Anomaly Detection in Network Telemetry（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2607.07075v1`](https://arxiv.org/abs/2607.07075v1) | Raw Meta = [`2607.07075_meta.json`](../../raw_data/2026-07-08/2607.07075_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Cyber Dynamics I: Finite Macrostates for Behavioral Anomaly Detection in Network Telemetry（セキュリティ分析論文）」（原題: Cyber Dynamics I: Finite Macrostates for Behavioral Anomaly Detection in Network Telemetry / arXiv: 2607.07075v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2607.07075v1`
- **論文URL**: [https://arxiv.org/abs/2607.07075v1](https://arxiv.org/abs/2607.07075v1)
- **PDFリンク**: [https://arxiv.org/pdf/2607.07075v1.pdf](https://arxiv.org/pdf/2607.07075v1.pdf)
- **著者**: Abdul Rahman, Eranga Bandara, Sachin Shetty
- **公開日時**: `2026-07-08T07:07:08Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-07-08/2607.07075_meta.json) | [`PDF`](../../raw_data/2026-07-08/2607.07075.pdf) | [`TXT`](../../raw_data/2026-07-08/2607.07075.txt)
