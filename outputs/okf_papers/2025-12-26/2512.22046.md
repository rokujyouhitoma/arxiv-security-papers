...
title_ja: "Backdoor Attacks on Prompt-Driven Video Segmentation Foundation Models（セキュリティ分析論文）"
description: "Backdoor Attacks on Prompt-Driven Video Segmentation Foundation Models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2512.22046v2"
tags:
  - "cs.CV"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-12-26/2512.22046_meta.json"
  published_date: "2025-12-26T14:48:58Z"
  authors:
    - "Zongmin Zhang"
    - "Zhen Sun"
    - "Yifan Liao"
...
### (日本語題名: Backdoor Attacks on Prompt-Driven Video Segmentation Foundation Models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2512.22046v2`](https://arxiv.org/abs/2512.22046v2) | Raw Meta = [`2512.22046_meta.json`](../../raw_data/2025-12-26/2512.22046_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Backdoor Attacks on Prompt-Driven Video Segmentation Foundation Models（セキュリティ分析論文）」（原題: Backdoor Attacks on Prompt-Driven Video Segmentation Foundation Models / arXiv: 2512.22046v2）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2512.22046v2`
- **論文URL**: [https://arxiv.org/abs/2512.22046v2](https://arxiv.org/abs/2512.22046v2)
- **PDFリンク**: [https://arxiv.org/pdf/2512.22046v2.pdf](https://arxiv.org/pdf/2512.22046v2.pdf)
- **著者**: Zongmin Zhang, Zhen Sun, Yifan Liao, Wenhan Dong, Xinlei He, Xingshuo Han, Shengmin Xu, Xinyi Huang
- **公開日時**: `2025-12-26T14:48:58Z`
- **カテゴリ**: `cs.CV, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-12-26/2512.22046_meta.json) | [`PDF`](../../raw_data/2025-12-26/2512.22046.pdf) | [`TXT`](../../raw_data/2025-12-26/2512.22046.txt)
