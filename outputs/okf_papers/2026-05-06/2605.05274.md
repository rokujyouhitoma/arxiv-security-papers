...
title_ja: "Sealing the Audit-Runtime Gap for LLM Skills（セキュリティ分析論文）"
description: "Sealing the Audit-Runtime Gap for LLM Skills（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.05274v1"
tags:
  - "arXiv"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-06/2605.05274_meta.json"
  published_date: "2026-05-06T14:23:22Z"
  authors:
    - "Tingda Shen"
    - "Yebo Feng"
    - "Konglin Zhu"
...
### (日本語題名: Sealing the Audit-Runtime Gap for LLM Skills（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.05274v1`](https://arxiv.org/abs/2605.05274v1) | Raw Meta = [`2605.05274_meta.json`](../../raw_data/2026-05-06/2605.05274_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Sealing the Audit-Runtime Gap for LLM Skills（セキュリティ分析論文）」（原題: Sealing the Audit-Runtime Gap for LLM Skills / arXiv: 2605.05274v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.05274v1`
- **論文URL**: [https://arxiv.org/abs/2605.05274v1](https://arxiv.org/abs/2605.05274v1)
- **PDFリンク**: [https://arxiv.org/pdf/2605.05274v1.pdf](https://arxiv.org/pdf/2605.05274v1.pdf)
- **著者**: Tingda Shen, Yebo Feng, Konglin Zhu, Xiaojun Jia, Yang Liu, Lin Zhang
- **公開日時**: `2026-05-06T14:23:22Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-06/2605.05274_meta.json) | [`PDF`](../../raw_data/2026-05-06/2605.05274.pdf) | [`TXT`](../../raw_data/2026-05-06/2605.05274.txt)
