...
title_ja: "Structure Disruption: Subverting Malicious Diffusion-Based Inpainting via Self-Attention Query Perturbation（セキュリティ分析論文）"
description: "Structure Disruption: Subverting Malicious Diffusion-Based Inpainting via Self-Attention Query Perturbation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.19425v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-26/2505.19425_meta.json"
  published_date: "2025-05-26T02:32:22Z"
  authors:
    - "Yuhao He"
    - "Jinyu Tian"
    - "Haiwei Wu"
...
### (日本語題名: Structure Disruption: Subverting Malicious Diffusion-Based Inpainting via Self-Attention Query Perturbation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.19425v1`](https://arxiv.org/abs/2505.19425v1) | Raw Meta = [`2505.19425_meta.json`](../../raw_data/2025-05-26/2505.19425_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Structure Disruption: Subverting Malicious Diffusion-Based Inpainting via Self-Attention Query Perturbation（セキュリティ分析論文）」（原題: Structure Disruption: Subverting Malicious Diffusion-Based Inpainting via Self-Attention Query Perturbation / arXiv: 2505.19425v1）は、cs.CV 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.19425v1`
- **論文URL**: [https://arxiv.org/abs/2505.19425v1](https://arxiv.org/abs/2505.19425v1)
- **PDFリンク**: [https://arxiv.org/pdf/2505.19425v1.pdf](https://arxiv.org/pdf/2505.19425v1.pdf)
- **著者**: Yuhao He, Jinyu Tian, Haiwei Wu, Jianqing Li
- **公開日時**: `2025-05-26T02:32:22Z`
- **カテゴリ**: `cs.CV, cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-26/2505.19425_meta.json) | [`PDF`](../../raw_data/2025-05-26/2505.19425.pdf) | [`TXT`](../../raw_data/2025-05-26/2505.19425.txt)
