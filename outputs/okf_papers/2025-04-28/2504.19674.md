...
title_ja: "SAGE: A Generic Framework for LLM Safety Evaluation（セキュリティ分析論文）"
description: "SAGE: A Generic Framework for LLM Safety Evaluation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.19674v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-28/2504.19674_meta.json"
  published_date: "2025-04-28T11:01:08Z"
  authors:
    - "Madhur Jindal"
    - "Hari Shrawgi"
    - "Parag Agrawal"
...
### (日本語題名: SAGE: A Generic Framework for LLM Safety Evaluation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.19674v2`](https://arxiv.org/abs/2504.19674v2) | Raw Meta = [`2504.19674_meta.json`](../../raw_data/2025-04-28/2504.19674_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SAGE: A Generic Framework for LLM Safety Evaluation（セキュリティ分析論文）」（原題: SAGE: A Generic Framework for LLM Safety Evaluation / arXiv: 2504.19674v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.19674v2`
- **論文URL**: [https://arxiv.org/abs/2504.19674v2](https://arxiv.org/abs/2504.19674v2)
- **PDFリンク**: [https://arxiv.org/pdf/2504.19674v2.pdf](https://arxiv.org/pdf/2504.19674v2.pdf)
- **著者**: Madhur Jindal, Hari Shrawgi, Parag Agrawal, Sandipan Dandapat
- **公開日時**: `2025-04-28T11:01:08Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-28/2504.19674_meta.json) | [`PDF`](../../raw_data/2025-04-28/2504.19674.pdf) | [`TXT`](../../raw_data/2025-04-28/2504.19674.txt)
