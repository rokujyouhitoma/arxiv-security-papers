...
title_ja: "Safety Anchor: Defending Harmful Fine-tuning via Geometric Bottlenecks（セキュリティ分析論文）"
description: "Safety Anchor: Defending Harmful Fine-tuning via Geometric Bottlenecks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2605.05995v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-05-07/2605.05995_meta.json"
  published_date: "2026-05-07T10:47:53Z"
  authors:
    - "Guoxin Lu"
    - "Letian Sha"
    - "Qing Wang"
...
### (日本語題名: Safety Anchor: Defending Harmful Fine-tuning via Geometric Bottlenecks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2605.05995v2`](https://arxiv.org/abs/2605.05995v2) | Raw Meta = [`2605.05995_meta.json`](../../raw_data/2026-05-07/2605.05995_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Safety Anchor: Defending Harmful Fine-tuning via Geometric Bottlenecks（セキュリティ分析論文）」（原題: Safety Anchor: Defending Harmful Fine-tuning via Geometric Bottlenecks / arXiv: 2605.05995v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2605.05995v2`
- **論文URL**: [https://arxiv.org/abs/2605.05995v2](https://arxiv.org/abs/2605.05995v2)
- **PDFリンク**: [https://arxiv.org/pdf/2605.05995v2.pdf](https://arxiv.org/pdf/2605.05995v2.pdf)
- **著者**: Guoxin Lu, Letian Sha, Qing Wang, Peijie Sun, Hao Zhou, Hua Dai, Fu Xiao
- **公開日時**: `2026-05-07T10:47:53Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-05-07/2605.05995_meta.json) | [`PDF`](../../raw_data/2026-05-07/2605.05995.pdf) | [`TXT`](../../raw_data/2026-05-07/2605.05995.txt)
