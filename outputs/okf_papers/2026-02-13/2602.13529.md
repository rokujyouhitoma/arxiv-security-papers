...
title_ja: "SecureGate: Learning When to Reveal PII Safely via Token-Gated Dual-Adapters for Federated LLMs（セキュリティ分析論文）"
description: "SecureGate: Learning When to Reveal PII Safely via Token-Gated Dual-Adapters for Federated LLMs（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2602.13529v2"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-02-13/2602.13529_meta.json"
  published_date: "2026-02-13T23:53:32Z"
  authors:
    - "Mohamed Shaaban"
    - "Mohamed Elmahallawy"
trust:
...
### (日本語題名: SecureGate: Learning When to Reveal PII Safely via Token-Gated Dual-Adapters for Federated LLMs（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2602.13529v2`](https://arxiv.org/abs/2602.13529v2) | Raw Meta = [`2602.13529_meta.json`](../../raw_data/2026-02-13/2602.13529_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「SecureGate: Learning When to Reveal PII Safely via Token-Gated Dual-Adapters for Federated LLMs（セキュリティ分析論文）」（原題: SecureGate: Learning When to Reveal PII Safely via Token-Gated Dual-Adapters for Federated LLMs / arXiv: 2602.13529v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2602.13529v2`
- **論文URL**: [https://arxiv.org/abs/2602.13529v2](https://arxiv.org/abs/2602.13529v2)
- **PDFリンク**: [https://arxiv.org/pdf/2602.13529v2.pdf](https://arxiv.org/pdf/2602.13529v2.pdf)
- **著者**: Mohamed Shaaban, Mohamed Elmahallawy
- **公開日時**: `2026-02-13T23:53:32Z`
- **カテゴリ**: `cs.CR, cs.CL`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-02-13/2602.13529_meta.json) | [`PDF`](../../raw_data/2026-02-13/2602.13529.pdf) | [`TXT`](../../raw_data/2026-02-13/2602.13529.txt)
