...
title_ja: "Compact and Selective Disclosure for Verifiable Credentials（セキュリティ分析論文）"
description: "Compact and Selective Disclosure for Verifiable Credentials（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2506.00262v2"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-30/2506.00262_meta.json"
  published_date: "2025-05-30T21:53:07Z"
  authors:
    - "Alessandro Buldini"
    - "Carlo Mazzocca"
    - "Rebecca Montanari"
...
### (日本語題名: Compact and Selective Disclosure for Verifiable Credentials（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2506.00262v2`](https://arxiv.org/abs/2506.00262v2) | Raw Meta = [`2506.00262_meta.json`](../../raw_data/2025-05-30/2506.00262_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Compact and Selective Disclosure for Verifiable Credentials（セキュリティ分析論文）」（原題: Compact and Selective Disclosure for Verifiable Credentials / arXiv: 2506.00262v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2506.00262v2`
- **論文URL**: [https://arxiv.org/abs/2506.00262v2](https://arxiv.org/abs/2506.00262v2)
- **PDFリンク**: [https://arxiv.org/pdf/2506.00262v2.pdf](https://arxiv.org/pdf/2506.00262v2.pdf)
- **著者**: Alessandro Buldini, Carlo Mazzocca, Rebecca Montanari, Selcuk Uluagac
- **公開日時**: `2025-05-30T21:53:07Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-30/2506.00262_meta.json) | [`PDF`](../../raw_data/2025-05-30/2506.00262.pdf) | [`TXT`](../../raw_data/2025-05-30/2506.00262.txt)
