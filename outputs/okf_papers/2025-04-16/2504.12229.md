...
title_ja: "Watermarking Needs Input Repetition Masking（セキュリティ分析論文）"
description: "Watermarking Needs Input Repetition Masking（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.12229v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-16/2504.12229_meta.json"
  published_date: "2025-04-16T16:25:26Z"
  authors:
    - "David Khachaturov"
    - "Robert Mullins"
    - "Ilia Shumailov"
...
### (日本語題名: Watermarking Needs Input Repetition Masking（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.12229v1`](https://arxiv.org/abs/2504.12229v1) | Raw Meta = [`2504.12229_meta.json`](../../raw_data/2025-04-16/2504.12229_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Watermarking Needs Input Repetition Masking（セキュリティ分析論文）」（原題: Watermarking Needs Input Repetition Masking / arXiv: 2504.12229v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.12229v1`
- **論文URL**: [https://arxiv.org/abs/2504.12229v1](https://arxiv.org/abs/2504.12229v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.12229v1.pdf](https://arxiv.org/pdf/2504.12229v1.pdf)
- **著者**: David Khachaturov, Robert Mullins, Ilia Shumailov, Sumanth Dathathri
- **公開日時**: `2025-04-16T16:25:26Z`
- **カテゴリ**: `cs.LG, cs.CL, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-16/2504.12229_meta.json) | [`PDF`](../../raw_data/2025-04-16/2504.12229.pdf) | [`TXT`](../../raw_data/2025-04-16/2504.12229.txt)
