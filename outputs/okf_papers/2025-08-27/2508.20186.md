...
title_ja: "AI Propaganda factories with language models（セキュリティ分析論文）"
description: "AI Propaganda factories with language models（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2508.20186v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-08-27/2508.20186_meta.json"
  published_date: "2025-08-27T18:04:45Z"
  authors:
    - "Lukasz Olejnik"
trust:
...
### (日本語題名: AI Propaganda factories with language models（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2508.20186v1`](https://arxiv.org/abs/2508.20186v1) | Raw Meta = [`2508.20186_meta.json`](../../raw_data/2025-08-27/2508.20186_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「AI Propaganda factories with language models（セキュリティ分析論文）」（原題: AI Propaganda factories with language models / arXiv: 2508.20186v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2508.20186v1`
- **論文URL**: [https://arxiv.org/abs/2508.20186v1](https://arxiv.org/abs/2508.20186v1)
- **PDFリンク**: [https://arxiv.org/pdf/2508.20186v1.pdf](https://arxiv.org/pdf/2508.20186v1.pdf)
- **著者**: Lukasz Olejnik
- **公開日時**: `2025-08-27T18:04:45Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CY`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-08-27/2508.20186_meta.json) | [`PDF`](../../raw_data/2025-08-27/2508.20186.pdf) | [`TXT`](../../raw_data/2025-08-27/2508.20186.txt)
