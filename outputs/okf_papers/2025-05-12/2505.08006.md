...
title_ja: "Evaluating Explanation Quality in X-IDS Using Feature Alignment Metrics（セキュリティ分析論文）"
description: "Evaluating Explanation Quality in X-IDS Using Feature Alignment Metrics（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.08006v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-12/2505.08006_meta.json"
  published_date: "2025-05-12T19:14:31Z"
  authors:
    - "Mohammed Alquliti"
    - "Erisa Karafili"
    - "BooJoong Kang"
...
### (日本語題名: Evaluating Explanation Quality in X-IDS Using Feature Alignment Metrics（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.08006v1`](https://arxiv.org/abs/2505.08006v1) | Raw Meta = [`2505.08006_meta.json`](../../raw_data/2025-05-12/2505.08006_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Evaluating Explanation Quality in X-IDS Using Feature Alignment Metrics（セキュリティ分析論文）」（原題: Evaluating Explanation Quality in X-IDS Using Feature Alignment Metrics / arXiv: 2505.08006v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2505.08006v1`
- **論文URL**: [https://arxiv.org/abs/2505.08006v1](https://arxiv.org/abs/2505.08006v1)
- **PDFリンク**: [https://arxiv.org/pdf/2505.08006v1.pdf](https://arxiv.org/pdf/2505.08006v1.pdf)
- **著者**: Mohammed Alquliti, Erisa Karafili, BooJoong Kang
- **公開日時**: `2025-05-12T19:14:31Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-12/2505.08006_meta.json) | [`PDF`](../../raw_data/2025-05-12/2505.08006.pdf) | [`TXT`](../../raw_data/2025-05-12/2505.08006.txt)
