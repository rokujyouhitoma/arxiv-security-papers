...
title_ja: "Self-Supervised Transformer-based Contrastive Learning for Intrusion Detection Systems（セキュリティ分析論文）"
description: "Self-Supervised Transformer-based Contrastive Learning for Intrusion Detection Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2505.08816v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.LG"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-05-12/2505.08816_meta.json"
  published_date: "2025-05-12T13:42:00Z"
  authors:
...
### (日本語題名: Self-Supervised Transformer-based Contrastive Learning for Intrusion Detection Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2505.08816v1`](https://arxiv.org/abs/2505.08816v1) | Raw Meta = [`2505.08816_meta.json`](../../raw_data/2025-05-12/2505.08816_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Self-Supervised Transformer-based Contrastive Learning for Intrusion Detection Systems（セキュリティ分析論文）」（原題: Self-Supervised Transformer-based Contrastive Learning for Intrusion Detection Systems / arXiv: 2505.08816v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2505.08816v1](https://arxiv.org/abs/2505.08816v1)
- **PDFリンク**: [https://arxiv.org/pdf/2505.08816v1.pdf](https://arxiv.org/pdf/2505.08816v1.pdf)
- **著者**: Ippokratis Koukoulis, Ilias Syrigos, Thanasis Korakis
- **公開日時**: `2025-05-12T13:42:00Z`
- **カテゴリ**: `cs.CR, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-05-12/2505.08816_meta.json) | [`PDF`](../../raw_data/2025-05-12/2505.08816.pdf) | [`TXT`](../../raw_data/2025-05-12/2505.08816.txt)
