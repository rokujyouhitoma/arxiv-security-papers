...
title_ja: "Anomaly Detection in Industrial Control Systems Based on Cross-Domain Representation Learning（セキュリティ分析論文）"
description: "Anomaly Detection in Industrial Control Systems Based on Cross-Domain Representation Learning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.11786v1"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-15/2509.11786_meta.json"
  published_date: "2025-09-15T11:12:09Z"
  authors:
    - "Dongyang Zhan"
    - "Wenqi Zhang"
    - "Lin Ye"
...
### (日本語題名: Anomaly Detection in Industrial Control Systems Based on Cross-Domain Representation Learning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.11786v1`](https://arxiv.org/abs/2509.11786v1) | Raw Meta = [`2509.11786_meta.json`](../../raw_data/2025-09-15/2509.11786_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Anomaly Detection in Industrial Control Systems Based on Cross-Domain Representation Learning（セキュリティ分析論文）」（原題: Anomaly Detection in Industrial Control Systems Based on Cross-Domain Representation Learning / arXiv: 2509.11786v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.11786v1`
- **論文URL**: [https://arxiv.org/abs/2509.11786v1](https://arxiv.org/abs/2509.11786v1)
- **PDFリンク**: [https://arxiv.org/pdf/2509.11786v1.pdf](https://arxiv.org/pdf/2509.11786v1.pdf)
- **著者**: Dongyang Zhan, Wenqi Zhang, Lin Ye, Xiangzhan Yu, Hongli Zhang, Zheng He
- **公開日時**: `2025-09-15T11:12:09Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-15/2509.11786_meta.json) | [`PDF`](../../raw_data/2025-09-15/2509.11786.pdf) | [`TXT`](../../raw_data/2025-09-15/2509.11786.txt)
