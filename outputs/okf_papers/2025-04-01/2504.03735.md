...
title_ja: "Misaligned Roles, Misplaced Images: Structural Input Perturbations Expose Multimodal Alignment Blind Spots（セキュリティ分析論文）"
description: "Misaligned Roles, Misplaced Images: Structural Input Perturbations Expose Multimodal Alignment Blind Spots（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2504.03735v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cs.CY"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-04-01/2504.03735_meta.json"
  published_date: "2025-04-01T03:54:36Z"
  authors:
    - "Erfan Shayegani"
    - "G M Shahariar"
    - "Sara Abdali"
...
### (日本語題名: Misaligned Roles, Misplaced Images: Structural Input Perturbations Expose Multimodal Alignment Blind Spots（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2504.03735v1`](https://arxiv.org/abs/2504.03735v1) | Raw Meta = [`2504.03735_meta.json`](../../raw_data/2025-04-01/2504.03735_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Misaligned Roles, Misplaced Images: Structural Input Perturbations Expose Multimodal Alignment Blind Spots（セキュリティ分析論文）」（原題: Misaligned Roles, Misplaced Images: Structural Input Perturbations Expose Multimodal Alignment Blind Spots / arXiv: 2504.03735v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2504.03735v1`
- **論文URL**: [https://arxiv.org/abs/2504.03735v1](https://arxiv.org/abs/2504.03735v1)
- **PDFリンク**: [https://arxiv.org/pdf/2504.03735v1.pdf](https://arxiv.org/pdf/2504.03735v1.pdf)
- **著者**: Erfan Shayegani, G M Shahariar, Sara Abdali, Lei Yu, Nael Abu-Ghazaleh, Yue Dong
- **公開日時**: `2025-04-01T03:54:36Z`
- **カテゴリ**: `cs.CR, cs.AI, cs.CL, cs.CY, cs.LG`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-04-01/2504.03735_meta.json) | [`PDF`](../../raw_data/2025-04-01/2504.03735.pdf) | [`TXT`](../../raw_data/2025-04-01/2504.03735.txt)
