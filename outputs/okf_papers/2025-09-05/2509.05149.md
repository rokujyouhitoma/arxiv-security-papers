...
title_ja: "Odoo-based Subcontract Inter-site Access Control Mechanism for Construction Projects（セキュリティ分析論文）"
description: "Odoo-based Subcontract Inter-site Access Control Mechanism for Construction Projects（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2509.05149v3"
tags:
  - "cybersecurity"
  - "executive-summary"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-09-05/2509.05149_meta.json"
  published_date: "2025-09-05T14:38:19Z"
  authors:
    - "Huy Hung Ho"
    - "Nhan Le Thanh"
    - "Nam Nguyen Hong"
...
### (日本語題名: Odoo-based Subcontract Inter-site Access Control Mechanism for Construction Projects（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2509.05149v3`](https://arxiv.org/abs/2509.05149v3) | Raw Meta = [`2509.05149_meta.json`](../../raw_data/2025-09-05/2509.05149_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Odoo-based Subcontract Inter-site Access Control Mechanism for Construction Projects（セキュリティ分析論文）」（原題: Odoo-based Subcontract Inter-site Access Control Mechanism for Construction Projects / arXiv: 2509.05149v3）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2509.05149v3`
- **論文URL**: [https://arxiv.org/abs/2509.05149v3](https://arxiv.org/abs/2509.05149v3)
- **PDFリンク**: [https://arxiv.org/pdf/2509.05149v3.pdf](https://arxiv.org/pdf/2509.05149v3.pdf)
- **著者**: Huy Hung Ho, Nhan Le Thanh, Nam Nguyen Hong, Phuong-D Nguyen
- **公開日時**: `2025-09-05T14:38:19Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-09-05/2509.05149_meta.json) | [`PDF`](../../raw_data/2025-09-05/2509.05149.pdf) | [`TXT`](../../raw_data/2025-09-05/2509.05149.txt)
