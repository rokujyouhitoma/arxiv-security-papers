...
title_ja: "Generalist++: A Meta-learning Framework for Mitigating Trade-off in Adversarial Training（セキュリティ分析論文）"
description: "Generalist++: A Meta-learning Framework for Mitigating Trade-off in Adversarial Training（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.13361v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-10-15/2510.13361_meta.json"
  published_date: "2025-10-15T09:47:54Z"
  authors:
    - "Yisen Wang"
    - "Yichuan Mo"
    - "Hongjun Wang"
...
### (日本語題名: Generalist++: A Meta-learning Framework for Mitigating Trade-off in Adversarial Training（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.13361v1`](https://arxiv.org/abs/2510.13361v1) | Raw Meta = [`2510.13361_meta.json`](../../raw_data/2025-10-15/2510.13361_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Generalist++: A Meta-learning Framework for Mitigating Trade-off in Adversarial Training（セキュリティ分析論文）」（原題: Generalist++: A Meta-learning Framework for Mitigating Trade-off in Adversarial Training / arXiv: 2510.13361v1）は、cs.LG 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2510.13361v1`
- **論文URL**: [https://arxiv.org/abs/2510.13361v1](https://arxiv.org/abs/2510.13361v1)
- **PDFリンク**: [https://arxiv.org/pdf/2510.13361v1.pdf](https://arxiv.org/pdf/2510.13361v1.pdf)
- **著者**: Yisen Wang, Yichuan Mo, Hongjun Wang, Junyi Li, Zhouchen Lin
- **公開日時**: `2025-10-15T09:47:54Z`
- **カテゴリ**: `cs.LG, cs.AI, cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-10-15/2510.13361_meta.json) | [`PDF`](../../raw_data/2025-10-15/2510.13361.pdf) | [`TXT`](../../raw_data/2025-10-15/2510.13361.txt)
