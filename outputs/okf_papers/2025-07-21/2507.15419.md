...
title_ja: "PhishIntentionLLM: Uncovering Phishing Website Intentions through Multi-Agent Retrieval-Augmented Generation（セキュリティ分析論文）"
description: "PhishIntentionLLM: Uncovering Phishing Website Intentions through Multi-Agent Retrieval-Augmented Generation（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2507.15419v1"
tags:
  - "cs.CR"
  - "arXiv"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-07-21/2507.15419_meta.json"
  published_date: "2025-07-21T09:20:43Z"
  authors:
    - "Wenhao Li"
    - "Selvakumar Manickam"
    - "Yung-wey Chong"
...
### (日本語題名: PhishIntentionLLM: Uncovering Phishing Website Intentions through Multi-Agent Retrieval-Augmented Generation（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2507.15419v1`](https://arxiv.org/abs/2507.15419v1) | Raw Meta = [`2507.15419_meta.json`](../../raw_data/2025-07-21/2507.15419_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「PhishIntentionLLM: Uncovering Phishing Website Intentions through Multi-Agent Retrieval-Augmented Generation（セキュリティ分析論文）」（原題: PhishIntentionLLM: Uncovering Phishing Website Intentions through Multi-Agent Retrieval-Augmented Generation / arXiv: 2507.15419v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2507.15419v1](https://arxiv.org/abs/2507.15419v1)
- **PDFリンク**: [https://arxiv.org/pdf/2507.15419v1.pdf](https://arxiv.org/pdf/2507.15419v1.pdf)
- **著者**: Wenhao Li, Selvakumar Manickam, Yung-wey Chong, Shankar Karuppayah
- **公開日時**: `2025-07-21T09:20:43Z`
- **カテゴリ**: `cs.CR`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-07-21/2507.15419_meta.json) | [`PDF`](../../raw_data/2025-07-21/2507.15419.pdf) | [`TXT`](../../raw_data/2025-07-21/2507.15419.txt)
