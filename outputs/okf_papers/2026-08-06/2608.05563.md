...
title_ja: "When Experience Becomes Instruction: Trajectory Poisoning in Self-Evolving Agent Skill Systems（セキュリティ分析論文）"
description: "When Experience Becomes Instruction: Trajectory Poisoning in Self-Evolving Agent Skill Systems（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2608.05563v2"
tags:
  - "arXiv"
  - "executive-summary"
  - "cs.AI"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-08-06/2608.05563_meta.json"
  published_date: "2026-08-06T03:32:43Z"
  authors:
    - "Jialuo Chen"
    - "Lingqi Jiang"
    - "Xinhao Deng"
...
### (日本語題名: When Experience Becomes Instruction: Trajectory Poisoning in Self-Evolving Agent Skill Systems（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2608.05563v2`](https://arxiv.org/abs/2608.05563v2) | Raw Meta = [`2608.05563_meta.json`](../../raw_data/2026-08-06/2608.05563_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「When Experience Becomes Instruction: Trajectory Poisoning in Self-Evolving Agent Skill Systems（セキュリティ分析論文）」（原題: When Experience Becomes Instruction: Trajectory Poisoning in Self-Evolving Agent Skill Systems / arXiv: 2608.05563v2）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2608.05563v2`
- **論文URL**: [https://arxiv.org/abs/2608.05563v2](https://arxiv.org/abs/2608.05563v2)
- **PDFリンク**: [https://arxiv.org/pdf/2608.05563v2.pdf](https://arxiv.org/pdf/2608.05563v2.pdf)
- **著者**: Jialuo Chen, Lingqi Jiang, Xinhao Deng, Xiaohu Du, Jianan Ma, Yunhao Feng, Yuqi Qing, Zhihao Yuan, Linkang Du, Jingyi Wang
- **公開日時**: `2026-08-06T03:32:43Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-08-06/2608.05563_meta.json) | [`PDF`](../../raw_data/2026-08-06/2608.05563.pdf) | [`TXT`](../../raw_data/2026-08-06/2608.05563.txt)
