...
title_ja: "Risk Psychology & Cyber-Attack Tactics（セキュリティ分析論文）"
description: "Risk Psychology & Cyber-Attack Tactics（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2510.20657v1"
tags:
  - "executive-summary"
  - "cybersecurity"
  - "cs.CR"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2025-10-23/2510.20657_meta.json"
  published_date: "2025-10-23T15:31:47Z"
  authors:
    - "Rubens Kim"
    - "Stephan Carney"
    - "Yvonne Fonken"
...
### (日本語題名: Risk Psychology & Cyber-Attack Tactics（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2510.20657v1`](https://arxiv.org/abs/2510.20657v1) | Raw Meta = [`2510.20657_meta.json`](../../raw_data/2025-10-23/2510.20657_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Risk Psychology & Cyber-Attack Tactics（セキュリティ分析論文）」（原題: Risk Psychology & Cyber-Attack Tactics / arXiv: 2510.20657v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2510.20657v1`
- **論文URL**: [https://arxiv.org/abs/2510.20657v1](https://arxiv.org/abs/2510.20657v1)
- **PDFリンク**: [https://arxiv.org/pdf/2510.20657v1.pdf](https://arxiv.org/pdf/2510.20657v1.pdf)
- **著者**: Rubens Kim, Stephan Carney, Yvonne Fonken, Soham Hans, Sofia Hirschmann, Stacy Marsella, Peggy Wu, Nikolos Gurney
- **公開日時**: `2025-10-23T15:31:47Z`
- **カテゴリ**: `cs.CR, cs.HC`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2025-10-23/2510.20657_meta.json) | [`PDF`](../../raw_data/2025-10-23/2510.20657.pdf) | [`TXT`](../../raw_data/2025-10-23/2510.20657.txt)
