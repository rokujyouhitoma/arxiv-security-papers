...
title_ja: "Conflicts Make Large Reasoning Models Vulnerable to Attacks（セキュリティ分析論文）"
description: "Conflicts Make Large Reasoning Models Vulnerable to Attacks（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.09750v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-10/2604.09750_meta.json"
  published_date: "2026-04-10T11:44:57Z"
  authors:
    - "Honghao Liu"
    - "Chengjin Xu"
    - "Xuhui Jiang"
...
### (日本語題名: Conflicts Make Large Reasoning Models Vulnerable to Attacks（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.09750v1`](https://arxiv.org/abs/2604.09750v1) | Raw Meta = [`2604.09750_meta.json`](../../raw_data/2026-04-10/2604.09750_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「Conflicts Make Large Reasoning Models Vulnerable to Attacks（セキュリティ分析論文）」（原題: Conflicts Make Large Reasoning Models Vulnerable to Attacks / arXiv: 2604.09750v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **論文URL**: [https://arxiv.org/abs/2604.09750v1](https://arxiv.org/abs/2604.09750v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.09750v1.pdf](https://arxiv.org/pdf/2604.09750v1.pdf)
- **著者**: Honghao Liu, Chengjin Xu, Xuhui Jiang, Cehao Yang, Shengming Yin, Zhengwu Ma, Lionel Ni, Jian Guo
- **公開日時**: `2026-04-10T11:44:57Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-10/2604.09750_meta.json) | [`PDF`](../../raw_data/2026-04-10/2604.09750.pdf) | [`TXT`](../../raw_data/2026-04-10/2604.09750.txt)
