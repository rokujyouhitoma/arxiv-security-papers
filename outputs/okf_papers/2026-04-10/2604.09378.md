...
title_ja: "BadSkill: Backdoor Attacks on Agent Skills via Model-in-Skill Poisoning（セキュリティ分析論文）"
description: "BadSkill: Backdoor Attacks on Agent Skills via Model-in-Skill Poisoning（セキュリティ分析論文） — 課題分析と防御モデルの検証"
resource: "https://arxiv.org/abs/2604.09378v1"
tags:
  - "cs.AI"
  - "executive-summary"
  - "cybersecurity"
...
provenance:
  source: "arxiv.org"
  raw_meta_file: "../../raw_data/2026-04-10/2604.09378_meta.json"
  published_date: "2026-04-10T14:48:29Z"
  authors:
    - "Guiyao Tie"
    - "Jiawen Shi"
    - "Pan Zhou"
...
### (日本語題名: BadSkill: Backdoor Attacks on Agent Skills via Model-in-Skill Poisoning（セキュリティ分析論文）)

> [!NOTE]
> **OKF Metadata**: Type = `security-paper` | arXiv ID = [`2604.09378v1`](https://arxiv.org/abs/2604.09378v1) | Raw Meta = [`2604.09378_meta.json`](../../raw_data/2026-04-10/2604.09378_meta.json)

## エグゼクティブサマリー (Executive Summary)

### 1. 概要 (Overview & Key Finding)
本論文「BadSkill: Backdoor Attacks on Agent Skills via Model-in-Skill Poisoning（セキュリティ分析論文）」（原題: BadSkill: Backdoor Attacks on Agent Skills via Model-in-Skill Poisoning / arXiv: 2604.09378v1）は、cs.CR 分野における最新セキュリティ研究成果を取り扱っています。
...
- **arXiv ID**: `2604.09378v1`
- **論文URL**: [https://arxiv.org/abs/2604.09378v1](https://arxiv.org/abs/2604.09378v1)
- **PDFリンク**: [https://arxiv.org/pdf/2604.09378v1.pdf](https://arxiv.org/pdf/2604.09378v1.pdf)
- **著者**: Guiyao Tie, Jiawen Shi, Pan Zhou, Lichao Sun
- **公開日時**: `2026-04-10T14:48:29Z`
- **カテゴリ**: `cs.CR, cs.AI`
- **保存済みRawデータ**: [`JSON`](../../raw_data/2026-04-10/2604.09378_meta.json) | [`PDF`](../../raw_data/2026-04-10/2604.09378.pdf) | [`TXT`](../../raw_data/2026-04-10/2604.09378.txt)
