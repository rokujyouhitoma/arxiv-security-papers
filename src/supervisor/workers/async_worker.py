...
class AsyncWorker(BaseWorker):
    ...
    def _parse_request_payload(self, raw_data: bytes) -> Optional[Dict[str, Any]]:
        """Parses raw HTTP stream bytes into WSGI environ dict."""
        ...
        return {
            ...
            "wsgi.input": asyncio.get_event_loop().run_in_executor(None, lambda: None),
    ...
    def _execute_app(self, environ: Dict[str, Any]) -> bytes:
        """Executes WSGI app and formats HTTP response bytes."""
